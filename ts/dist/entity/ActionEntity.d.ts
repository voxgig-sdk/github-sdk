...
import type { Action, ActionLoadMatch, ActionListMatch, ActionCreateData, ActionUpdateData, ActionRemoveMatch } from '../GithubTypes';
declare class ActionEntity extends GithubEntityBase<Action> {
