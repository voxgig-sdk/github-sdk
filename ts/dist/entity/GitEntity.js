...
exports.GitEntity = void 0;
const GithubEntityBase_1 = require("../GithubEntityBase");
// TODO: needs Entity superclass
class GitEntity extends GithubEntityBase_1.GithubEntityBase {
    ...
    make() {
        return new GitEntity(this._client, this.entopts());
    }
    ...
    async remove(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<GitEntity> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
...
//# sourceMappingURL=GitEntity.js.map