...
(0, node_test_1.describe)('FullRepositoryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-full_repository', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-full_repository', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_FULL_REPOSITORY_ENTID'];
...
//# sourceMappingURL=FullRepositoryDirect.test.js.map