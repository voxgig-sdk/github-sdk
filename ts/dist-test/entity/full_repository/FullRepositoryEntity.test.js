...
(0, node_test_1.describe)('FullRepositoryEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'full_repository.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != full_repository_ref01_data.id);
        // UPDATE
        ...
        (0, node_assert_1.default)(full_repository_ref01_resdata_up0.id === full_repository_ref01_data_up0.id);
        (0, node_assert_1.default)(full_repository_ref01_resdata_up0[full_repository_ref01_markdef_up0.name] === full_repository_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(full_repository_ref01_data_dt0.id === full_repository_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/full_repository/FullRepositoryTestData.json');
    ...
    let idmap = transform(['full_repository01', 'full_repository02', 'full_repository03', 'org01', 'org02', 'org03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=FullRepositoryEntity.test.js.map