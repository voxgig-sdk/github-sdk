...
(0, node_test_1.describe)('DiffEntryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-diff_entry', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-diff_entry', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_DIFF_ENTRY_ENTID'];
...
//# sourceMappingURL=DiffEntryDirect.test.js.map