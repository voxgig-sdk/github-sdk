...
(0, node_test_1.describe)('HookDeliveryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-hook_delivery', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-hook_delivery', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["hook_id01", "id01", "owner01", "repo01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_HOOK_DELIVERY_ENTID'];
...
//# sourceMappingURL=HookDeliveryDirect.test.js.map