...
(0, node_test_1.describe)('ParticipationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-participation', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-participation', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_PARTICIPATION_ENTID'];
...
//# sourceMappingURL=ParticipationDirect.test.js.map