...
(0, node_test_1.describe)('InstallationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'installation.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(installation_ref01_resdata_up0.id === installation_ref01_data_up0.id);
        (0, node_assert_1.default)(installation_ref01_resdata_up0[installation_ref01_markdef_up0.name] === installation_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(installation_ref01_data_dt0.id === installation_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/installation/InstallationTestData.json');
    ...
    let idmap = transform(['installation01', 'installation02', 'installation03', 'org01', 'org02', 'org03', 'repo01', 'repo02', 'repo03', 'user01', 'user02', 'user03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_INSTALLATION_ENTID'];
...
//# sourceMappingURL=InstallationEntity.test.js.map