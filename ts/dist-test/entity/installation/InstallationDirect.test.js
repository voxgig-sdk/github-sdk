...
(0, node_test_1.describe)('InstallationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-installation', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-installation', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-installation', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-installation', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_INSTALLATION_ENTID'];
...
//# sourceMappingURL=InstallationDirect.test.js.map