...
(0, node_test_1.describe)('BranchRestrictionPolicyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-branch_restriction_policy', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-branch_restriction_policy', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["branch01", "owner01", "repo01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_BRANCH_RESTRICTION_POLICY_ENTID'];
...
//# sourceMappingURL=BranchRestrictionPolicyDirect.test.js.map