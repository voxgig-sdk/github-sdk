...
(0, node_test_1.describe)('ContentFileDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-content_file', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-content_file', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["dir01", "owner01", "repo01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CONTENT_FILE_ENTID'];
...
//# sourceMappingURL=ContentFileDirect.test.js.map