...
(0, node_test_1.describe)('ReferrerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-referrer', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-referrer', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_REFERRER_ENTID'];
...
//# sourceMappingURL=ReferrerDirect.test.js.map