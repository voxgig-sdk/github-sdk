...
(0, node_test_1.describe)('RuleSuiteDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-rule_suite', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-rule_suite', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-rule_suite', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-rule_suite', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_RULE_SUITE_ENTID'];
...
//# sourceMappingURL=RuleSuiteDirect.test.js.map