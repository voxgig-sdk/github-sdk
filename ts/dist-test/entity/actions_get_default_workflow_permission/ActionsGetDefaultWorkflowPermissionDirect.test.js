...
(0, node_test_1.describe)('ActionsGetDefaultWorkflowPermissionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-actions_get_default_workflow_permission', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-actions_get_default_workflow_permission', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ACTIONS_GET_DEFAULT_WORKFLOW_PERMISSION_ENTID'];
...
//# sourceMappingURL=ActionsGetDefaultWorkflowPermissionDirect.test.js.map