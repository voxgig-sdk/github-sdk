...
(0, node_test_1.describe)('RepositoryRulesetEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'repository_ruleset.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != repository_ruleset_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(repository_ruleset_ref01_list, { id: repository_ruleset_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(repository_ruleset_ref01_resdata_up0.id === repository_ruleset_ref01_data_up0.id);
        (0, node_assert_1.default)(repository_ruleset_ref01_resdata_up0[repository_ruleset_ref01_markdef_up0.name] === repository_ruleset_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(repository_ruleset_ref01_data_dt0.id === repository_ruleset_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/repository_ruleset/RepositoryRulesetTestData.json');
    ...
    let idmap = transform(['repository_ruleset01', 'repository_ruleset02', 'repository_ruleset03', 'org01', 'org02', 'org03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_REPOSITORY_RULESET_ENTID'];
...
//# sourceMappingURL=RepositoryRulesetEntity.test.js.map