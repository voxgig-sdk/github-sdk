...
(0, node_test_1.describe)('CodespaceEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'codespace.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != codespace_ref01_data.id);
        // LIST
        const codespace_ref01_match = {};
        codespace_ref01_match['secret_name'] = setup.idmap['secret_name01'];
        const codespace_ref01_list = (await codespace_ref01_ent.list(codespace_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(codespace_ref01_list, { id: codespace_ref01_data.id })));
        // UPDATE
        const codespace_ref01_data_up0 = {};
        ...
        codespace_ref01_data_up0[codespace_ref01_markdef_up0.name] = codespace_ref01_markdef_up0.value;
        const codespace_ref01_resdata_up0 = (await codespace_ref01_ent.update(codespace_ref01_data_up0)).data();
        (0, node_assert_1.default)(codespace_ref01_resdata_up0.id === codespace_ref01_data_up0.id);
        (0, node_assert_1.default)(codespace_ref01_resdata_up0[codespace_ref01_markdef_up0.name] === codespace_ref01_markdef_up0.value);
        // LOAD
        const codespace_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(codespace_ref01_data_dt0.id === codespace_ref01_data.id);
        // REMOVE
        const codespace_ref01_match_rm0 = { id: codespace_ref01_data.id };
        await codespace_ref01_ent.remove(codespace_ref01_match_rm0);
        // LIST
        const codespace_ref01_match_rt0 = {};
        codespace_ref01_match_rt0['secret_name'] = setup.idmap['secret_name01'];
        const codespace_ref01_list_rt0 = (await codespace_ref01_ent.list(codespace_ref01_match_rt0)).map((e) => e.data());
        (0, node_assert_1.default)(isempty(select(codespace_ref01_list_rt0, { id: codespace_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/codespace/CodespaceTestData.json');
...
//# sourceMappingURL=CodespaceEntity.test.js.map