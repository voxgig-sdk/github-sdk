...
(0, node_test_1.describe)('ProjectCollaboratorPermissionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-project_collaborator_permission', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-project_collaborator_permission', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["project_id01", "username01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_PROJECT_COLLABORATOR_PERMISSION_ENTID'];
...
//# sourceMappingURL=ProjectCollaboratorPermissionDirect.test.js.map