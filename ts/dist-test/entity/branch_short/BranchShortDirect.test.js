...
(0, node_test_1.describe)('BranchShortDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-branch_short', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-branch_short', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_BRANCH_SHORT_ENTID'];
...
//# sourceMappingURL=BranchShortDirect.test.js.map