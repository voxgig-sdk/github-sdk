...
(0, node_test_1.describe)('OrganizationRoleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-organization_role', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-organization_role', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ORGANIZATION_ROLE_ENTID'];
...
//# sourceMappingURL=OrganizationRoleDirect.test.js.map