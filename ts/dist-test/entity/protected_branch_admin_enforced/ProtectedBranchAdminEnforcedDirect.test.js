...
(0, node_test_1.describe)('ProtectedBranchAdminEnforcedDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-protected_branch_admin_enforced', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-protected_branch_admin_enforced', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_PROTECTED_BRANCH_ADMIN_ENFORCED_ENTID'];
...
//# sourceMappingURL=ProtectedBranchAdminEnforcedDirect.test.js.map