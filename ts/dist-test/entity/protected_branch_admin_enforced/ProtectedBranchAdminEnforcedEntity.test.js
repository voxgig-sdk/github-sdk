...
(0, node_test_1.describe)('ProtectedBranchAdminEnforcedEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'protected_branch_admin_enforced.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != protected_branch_admin_enforced_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/protected_branch_admin_enforced/ProtectedBranchAdminEnforcedTestData.json');
    ...
    let idmap = transform(['protected_branch_admin_enforced01', 'protected_branch_admin_enforced02', 'protected_branch_admin_enforced03', 'repo01', 'repo02', 'repo03', 'branch01', 'branch02', 'branch03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_PROTECTED_BRANCH_ADMIN_ENFORCED_ENTID'];
...
//# sourceMappingURL=ProtectedBranchAdminEnforcedEntity.test.js.map