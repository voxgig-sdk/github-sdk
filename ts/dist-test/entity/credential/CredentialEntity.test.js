...
(0, node_test_1.describe)('CredentialEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set GITHUB_TEST_CREDENTIAL_ENTID JSON to run live');
            return;
        }
        ...
        (0, node_assert_1.default)(null != credential_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_CREDENTIAL_ENTID'];
    ...
    idmap = env['GITHUB_TEST_CREDENTIAL_ENTID'];
