...
(0, node_test_1.describe)('GlobalAdvisoryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-global_advisory', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-global_advisory', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-global_advisory', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-global_advisory', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_GLOBAL_ADVISORY_ENTID'];
...
//# sourceMappingURL=GlobalAdvisoryDirect.test.js.map