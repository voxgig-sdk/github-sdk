...
(0, node_test_1.describe)('DependencyGraphDiffDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-dependency_graph_diff', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-dependency_graph_diff', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["basehead01", "owner01", "repo01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_DEPENDENCY_GRAPH_DIFF_ENTID'];
...
//# sourceMappingURL=DependencyGraphDiffDirect.test.js.map