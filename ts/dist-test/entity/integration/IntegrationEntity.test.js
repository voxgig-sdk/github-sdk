...
(0, node_test_1.describe)('IntegrationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(integration_ref01_resdata_up0.id === integration_ref01_data_up0.id);
        (0, node_assert_1.default)(integration_ref01_resdata_up0[integration_ref01_markdef_up0.name] === integration_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(isempty(select(integration_ref01_list_rt0, { id: integration_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['integration01', 'integration02', 'integration03', 'app01', 'app02', 'app03', 'repo01', 'repo02', 'repo03', 'branch01', 'branch02', 'branch03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_INTEGRATION_ENTID'];
