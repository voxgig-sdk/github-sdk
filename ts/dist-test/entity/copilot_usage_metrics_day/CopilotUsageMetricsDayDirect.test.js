...
(0, node_test_1.describe)('CopilotUsageMetricsDayDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-copilot_usage_metrics_day', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-copilot_usage_metrics_day', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_COPILOT_USAGE_METRICS_DAY_ENTID'];
...
//# sourceMappingURL=CopilotUsageMetricsDayDirect.test.js.map