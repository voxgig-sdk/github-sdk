...
(0, node_test_1.describe)('OrgRepoCustomPropertyValueDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-org_repo_custom_property_value', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-org_repo_custom_property_value', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ORG_REPO_CUSTOM_PROPERTY_VALUE_ENTID'];
...
//# sourceMappingURL=OrgRepoCustomPropertyValueDirect.test.js.map