...
(0, node_test_1.describe)('ProjectColumnDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-project_column', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-project_column', setup.live))
            return;
        ...
        if (setup.live) {
            const listResult = await client.direct({
                ...
                method: 'GET',
                params: {
                    id: setup.idmap['project_column01'],
                },
            });
            if (!listResult.ok) {
    ...
    (0, node_test_1.test)('direct-list-project_column', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-project_column', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["project_column01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_PROJECT_COLUMN_ENTID'];
...
//# sourceMappingURL=ProjectColumnDirect.test.js.map