...
(0, node_test_1.describe)('ProjectColumnEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'project_column.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != project_column_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(project_column_ref01_list, { id: project_column_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(project_column_ref01_resdata_up0.id === project_column_ref01_data_up0.id);
        (0, node_assert_1.default)(project_column_ref01_resdata_up0[project_column_ref01_markdef_up0.name] === project_column_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(project_column_ref01_data_dt0.id === project_column_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/project_column/ProjectColumnTestData.json');
    ...
    let idmap = transform(['project_column01', 'project_column02', 'project_column03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_PROJECT_COLUMN_ENTID'];
...
//# sourceMappingURL=ProjectColumnEntity.test.js.map