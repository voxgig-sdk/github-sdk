...
(0, node_test_1.describe)('RulesetVersionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-ruleset_version', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-ruleset_version', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["ruleset_version01", "owner01", "repo01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_RULESET_VERSION_ENTID'];
...
//# sourceMappingURL=RulesetVersionDirect.test.js.map