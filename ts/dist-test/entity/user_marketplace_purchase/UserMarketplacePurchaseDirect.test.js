...
(0, node_test_1.describe)('UserMarketplacePurchaseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-user_marketplace_purchase', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-user_marketplace_purchase', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_USER_MARKETPLACE_PURCHASE_ENTID'];
...
//# sourceMappingURL=UserMarketplacePurchaseDirect.test.js.map