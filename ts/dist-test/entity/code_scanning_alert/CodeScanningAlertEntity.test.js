...
(0, node_test_1.describe)('CodeScanningAlertEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'code_scanning_alert.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(code_scanning_alert_ref01_resdata_up0.id === code_scanning_alert_ref01_data_up0.id);
        (0, node_assert_1.default)(code_scanning_alert_ref01_resdata_up0[code_scanning_alert_ref01_markdef_up0.name] === code_scanning_alert_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(code_scanning_alert_ref01_data_dt0.id === code_scanning_alert_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/code_scanning_alert/CodeScanningAlertTestData.json');
    ...
    let idmap = transform(['code_scanning_alert01', 'code_scanning_alert02', 'code_scanning_alert03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_CODE_SCANNING_ALERT_ENTID'];
...
//# sourceMappingURL=CodeScanningAlertEntity.test.js.map