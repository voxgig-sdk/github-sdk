...
(0, node_test_1.describe)('CodeScanningAlertDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-code_scanning_alert', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-code_scanning_alert', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["id01", "owner01", "repo01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CODE_SCANNING_ALERT_ENTID'];
...
//# sourceMappingURL=CodeScanningAlertDirect.test.js.map