...
(0, node_test_1.describe)('DependabotEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'update']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'dependabot.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(dependabot_ref01_resdata_up0.id === dependabot_ref01_data_up0.id);
        (0, node_assert_1.default)(dependabot_ref01_resdata_up0[dependabot_ref01_markdef_up0.name] === dependabot_ref01_markdef_up0.value);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/dependabot/DependabotTestData.json');
    ...
    let idmap = transform(['dependabot01', 'dependabot02', 'dependabot03', 'organization01', 'organization02', 'organization03', 'org01', 'org02', 'org03', 'repo01', 'repo02', 'repo03', 'org01', 'org02', 'org03', 'secret01', 'secret02', 'secret03', 'repo01', 'repo02', 'repo03', 'secret01', 'secret02', 'secret03', 'org01', 'org02', 'org03', 'secret01', 'secret02', 'secret03', 'repository01', 'repository02', 'repository03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_DEPENDABOT_ENTID'];
...
//# sourceMappingURL=DependabotEntity.test.js.map