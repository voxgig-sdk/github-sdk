...
(0, node_test_1.describe)('DependabotDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-dependabot', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-dependabot', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["org01", "secret_name01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_DEPENDABOT_ENTID'];
...
//# sourceMappingURL=DependabotDirect.test.js.map