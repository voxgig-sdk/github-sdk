...
(0, node_test_1.describe)('MembershipDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-membership', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-membership', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["enterprise01", "team01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-membership', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-membership', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["enterprise01", "enterprise_team01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_MEMBERSHIP_ENTID'];
...
//# sourceMappingURL=MembershipDirect.test.js.map