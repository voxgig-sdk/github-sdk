...
(0, node_test_1.describe)('CodeScanningSarifsStatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-code_scanning_sarifs_status', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-code_scanning_sarifs_status', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["owner01", "repo01", "sarif_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CODE_SCANNING_SARIFS_STATUS_ENTID'];
...
//# sourceMappingURL=CodeScanningSarifsStatusDirect.test.js.map