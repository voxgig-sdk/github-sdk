...
(0, node_test_1.describe)('ActionsRepositoryPermissionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-actions_repository_permission', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-actions_repository_permission', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ACTIONS_REPOSITORY_PERMISSION_ENTID'];
...
//# sourceMappingURL=ActionsRepositoryPermissionDirect.test.js.map