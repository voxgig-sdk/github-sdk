...
(0, node_test_1.describe)('IntegrationInstallationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-integration_installation', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-integration_installation', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_INTEGRATION_INSTALLATION_ENTID'];
...
//# sourceMappingURL=IntegrationInstallationDirect.test.js.map