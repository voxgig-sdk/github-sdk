...
(0, node_test_1.describe)('WebhookConfigDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-webhook_config', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-webhook_config', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["hook_id01", "owner01", "repo01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_WEBHOOK_CONFIG_ENTID'];
...
//# sourceMappingURL=WebhookConfigDirect.test.js.map