...
(0, node_test_1.describe)('BranchDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-branch', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-branch', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_BRANCH_ENTID'];
