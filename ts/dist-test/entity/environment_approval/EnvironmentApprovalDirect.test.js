...
(0, node_test_1.describe)('EnvironmentApprovalDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-environment_approval', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-environment_approval', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["owner01", "repo01", "run01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ENVIRONMENT_APPROVAL_ENTID'];
...
//# sourceMappingURL=EnvironmentApprovalDirect.test.js.map