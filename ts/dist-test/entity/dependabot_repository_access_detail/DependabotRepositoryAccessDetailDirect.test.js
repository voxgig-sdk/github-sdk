...
(0, node_test_1.describe)('DependabotRepositoryAccessDetailDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-dependabot_repository_access_detail', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-dependabot_repository_access_detail', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_DEPENDABOT_REPOSITORY_ACCESS_DETAIL_ENTID'];
...
//# sourceMappingURL=DependabotRepositoryAccessDetailDirect.test.js.map