...
(0, node_test_1.describe)('PrivateRegistryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-private_registry', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-private_registry', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-private_registry', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-private_registry', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["org01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_PRIVATE_REGISTRY_ENTID'];
...
//# sourceMappingURL=PrivateRegistryDirect.test.js.map