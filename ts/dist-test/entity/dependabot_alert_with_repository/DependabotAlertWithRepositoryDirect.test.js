...
(0, node_test_1.describe)('DependabotAlertWithRepositoryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-dependabot_alert_with_repository', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-dependabot_alert_with_repository', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_DEPENDABOT_ALERT_WITH_REPOSITORY_ENTID'];
...
//# sourceMappingURL=DependabotAlertWithRepositoryDirect.test.js.map