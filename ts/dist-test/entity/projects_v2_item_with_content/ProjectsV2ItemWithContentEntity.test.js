...
(0, node_test_1.describe)('ProjectsV2ItemWithContentEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'projects_v2_item_with_content.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(projects_v2_item_with_content_ref01_resdata_up0.id === projects_v2_item_with_content_ref01_data_up0.id);
        (0, node_assert_1.default)(projects_v2_item_with_content_ref01_resdata_up0[projects_v2_item_with_content_ref01_markdef_up0.name] === projects_v2_item_with_content_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(projects_v2_item_with_content_ref01_data_dt0.id === projects_v2_item_with_content_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/projects_v2_item_with_content/ProjectsV2ItemWithContentTestData.json');
    ...
    let idmap = transform(['projects_v2_item_with_content01', 'projects_v2_item_with_content02', 'projects_v2_item_with_content03', 'org01', 'org02', 'org03', 'projects_v201', 'projects_v202', 'projects_v203', 'user01', 'user02', 'user03', 'projects_v201', 'projects_v202', 'projects_v203', 'org01', 'org02', 'org03', 'projects_v201', 'projects_v202', 'projects_v203', 'item01', 'item02', 'item03', 'user01', 'user02', 'user03', 'projects_v201', 'projects_v202', 'projects_v203', 'item01', 'item02', 'item03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_PROJECTS_V2_ITEM_WITH_CONTENT_ENTID'];
...
//# sourceMappingURL=ProjectsV2ItemWithContentEntity.test.js.map