...
(0, node_test_1.describe)('ProjectsV2ItemWithContentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-projects_v2_item_with_content', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-projects_v2_item_with_content', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["item01", "org01", "projects_v201"]))
            return;
        ...
        if (setup.live) {
            ...
            const candidateId = listArr[0]?.item_id ?? listArr[0]?.id;
            if (null == candidateId) {
                return; // skip: list response shape does not expose load identifier
            }
            params.item_id = candidateId;
    ...
    (0, node_test_1.test)('direct-list-projects_v2_item_with_content', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-projects_v2_item_with_content', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["org01", "project_number01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_PROJECTS_V2_ITEM_WITH_CONTENT_ENTID'];
...
//# sourceMappingURL=ProjectsV2ItemWithContentDirect.test.js.map