...
(0, node_test_1.describe)('RunnerApplicationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-runner_application', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-runner_application', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_RUNNER_APPLICATION_ENTID'];
...
//# sourceMappingURL=RunnerApplicationDirect.test.js.map