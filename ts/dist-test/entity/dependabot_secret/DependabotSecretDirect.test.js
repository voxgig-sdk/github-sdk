...
(0, node_test_1.describe)('DependabotSecretDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-dependabot_secret', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-dependabot_secret', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_DEPENDABOT_SECRET_ENTID'];
...
//# sourceMappingURL=DependabotSecretDirect.test.js.map