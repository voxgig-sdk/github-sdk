...
(0, node_test_1.describe)('CodeScanningAnalysiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-code_scanning_analysi', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-code_scanning_analysi', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["analysis01", "owner01", "repo01"]))
            return;
        ...
        if (setup.live) {
            ...
            const candidateId = listArr[0]?.analysis_id ?? listArr[0]?.id;
            if (null == candidateId) {
                return; // skip: list response shape does not expose load identifier
            }
            params.analysis_id = candidateId;
    ...
    (0, node_test_1.test)('direct-list-code_scanning_analysi', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-code_scanning_analysi', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CODE_SCANNING_ANALYSI_ENTID'];
...
//# sourceMappingURL=CodeScanningAnalysiDirect.test.js.map