...
(0, node_test_1.describe)('WorkflowRunUsageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-workflow_run_usage', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-workflow_run_usage', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["owner01", "repo01", "run_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_WORKFLOW_RUN_USAGE_ENTID'];
...
//# sourceMappingURL=WorkflowRunUsageDirect.test.js.map