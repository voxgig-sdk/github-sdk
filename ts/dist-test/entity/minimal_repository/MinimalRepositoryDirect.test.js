...
(0, node_test_1.describe)('MinimalRepositoryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-minimal_repository', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-minimal_repository', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_MINIMAL_REPOSITORY_ENTID'];
...
//# sourceMappingURL=MinimalRepositoryDirect.test.js.map