...
(0, node_test_1.describe)('RunnerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-runner', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-runner', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_RUNNER_ENTID'];
...
//# sourceMappingURL=RunnerDirect.test.js.map