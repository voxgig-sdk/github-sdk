...
(0, node_test_1.describe)('OrganizationInvitationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'organization_invitation.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['organization_invitation01', 'organization_invitation02', 'organization_invitation03', 'org01', 'org02', 'org03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_ORGANIZATION_INVITATION_ENTID'];
    ...
    idmap = env['GITHUB_TEST_ORGANIZATION_INVITATION_ENTID'];
