...
(0, node_test_1.describe)('OrganizationInvitationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-organization_invitation', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-organization_invitation', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ORGANIZATION_INVITATION_ENTID'];
...
//# sourceMappingURL=OrganizationInvitationDirect.test.js.map