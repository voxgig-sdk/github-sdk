...
(0, node_test_1.describe)('EmptyObjectEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'empty_object.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != empty_object_ref01_data);
        // UPDATE
        ...
        (0, node_assert_1.default)(null != empty_object_ref01_resdata_up0);
        (0, node_assert_1.default)(empty_object_ref01_resdata_up0[empty_object_ref01_markdef_up0.name] === empty_object_ref01_markdef_up0.value);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/empty_object/EmptyObjectTestData.json');
...
//# sourceMappingURL=EmptyObjectEntity.test.js.map