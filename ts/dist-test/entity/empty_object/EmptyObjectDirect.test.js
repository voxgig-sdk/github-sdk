...
(0, node_test_1.describe)('EmptyObjectDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-empty_object', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-empty_object', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["subject_digest01", "username01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_EMPTY_OBJECT_ENTID'];
...
//# sourceMappingURL=EmptyObjectDirect.test.js.map