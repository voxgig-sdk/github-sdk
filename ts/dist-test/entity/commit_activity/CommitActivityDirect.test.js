...
(0, node_test_1.describe)('CommitActivityDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-commit_activity', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-commit_activity', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_COMMIT_ACTIVITY_ENTID'];
...
//# sourceMappingURL=CommitActivityDirect.test.js.map