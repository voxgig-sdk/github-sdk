...
(0, node_test_1.describe)('CopilotEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'load', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'copilot.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != copilot_ref01_data);
        // LIST
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/copilot/CopilotTestData.json');
    ...
    let idmap = transform(['copilot01', 'copilot02', 'copilot03', 'org01', 'org02', 'org03', 'org01', 'org02', 'org03', 'member01', 'member02', 'member03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_COPILOT_ENTID'];
...
//# sourceMappingURL=CopilotEntity.test.js.map