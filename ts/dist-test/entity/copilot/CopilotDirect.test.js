...
(0, node_test_1.describe)('CopilotDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-copilot', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-copilot', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["org01", "username01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-copilot', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-copilot', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_COPILOT_ENTID'];
...
//# sourceMappingURL=CopilotDirect.test.js.map