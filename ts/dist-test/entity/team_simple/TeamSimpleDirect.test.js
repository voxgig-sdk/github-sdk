...
(0, node_test_1.describe)('TeamSimpleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-team_simple', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-team_simple', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_TEAM_SIMPLE_ENTID'];
...
//# sourceMappingURL=TeamSimpleDirect.test.js.map