...
(0, node_test_1.describe)('StatusCheckPolicyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-status_check_policy', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-status_check_policy', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_STATUS_CHECK_POLICY_ENTID'];
...
//# sourceMappingURL=StatusCheckPolicyDirect.test.js.map