...
(0, node_test_1.describe)('CodeSecurityConfigurationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'code_security_configuration.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != code_security_configuration_ref01_data.id);
        // LIST
        const code_security_configuration_ref01_match = {};
        code_security_configuration_ref01_match['enterprise'] = setup.idmap['enterprise01'];
        const code_security_configuration_ref01_list = (await code_security_configuration_ref01_ent.list(code_security_configuration_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(code_security_configuration_ref01_list, { id: code_security_configuration_ref01_data.id })));
        // UPDATE
        const code_security_configuration_ref01_data_up0 = {};
        ...
        code_security_configuration_ref01_data_up0[code_security_configuration_ref01_markdef_up0.name] = code_security_configuration_ref01_markdef_up0.value;
        ...
        (0, node_assert_1.default)(code_security_configuration_ref01_resdata_up0.id === code_security_configuration_ref01_data_up0.id);
        (0, node_assert_1.default)(code_security_configuration_ref01_resdata_up0[code_security_configuration_ref01_markdef_up0.name] === code_security_configuration_ref01_markdef_up0.value);
        // LOAD
        const code_security_configuration_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(code_security_configuration_ref01_data_dt0.id === code_security_configuration_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/code_security_configuration/CodeSecurityConfigurationTestData.json');
...
//# sourceMappingURL=CodeSecurityConfigurationEntity.test.js.map