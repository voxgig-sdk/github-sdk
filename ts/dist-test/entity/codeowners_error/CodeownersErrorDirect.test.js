...
(0, node_test_1.describe)('CodeownersErrorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-codeowners_error', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-codeowners_error', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CODEOWNERS_ERROR_ENTID'];
...
//# sourceMappingURL=CodeownersErrorDirect.test.js.map