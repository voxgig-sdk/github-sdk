...
(0, node_test_1.describe)('ApiInsightsSummaryStatDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_insights_summary_stat', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_insights_summary_stat', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["actor_id01", "actor_type01", "org01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_API_INSIGHTS_SUMMARY_STAT_ENTID'];
...
//# sourceMappingURL=ApiInsightsSummaryStatDirect.test.js.map