...
(0, node_test_1.describe)('FollowerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-follower', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-follower', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_FOLLOWER_ENTID'];
...
//# sourceMappingURL=FollowerDirect.test.js.map