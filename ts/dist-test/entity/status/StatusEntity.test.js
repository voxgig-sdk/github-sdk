...
(0, node_test_1.describe)('StatusEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != status_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(status_ref01_list, { id: status_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['status01', 'status02', 'status03', 'repo01', 'repo02', 'repo03', 'repo01', 'repo02', 'repo03', 'commit01', 'commit02', 'commit03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_STATUS_ENTID'];
