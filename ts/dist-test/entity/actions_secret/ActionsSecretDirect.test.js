...
(0, node_test_1.describe)('ActionsSecretDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-actions_secret', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-actions_secret', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ACTIONS_SECRET_ENTID'];
...
//# sourceMappingURL=ActionsSecretDirect.test.js.map