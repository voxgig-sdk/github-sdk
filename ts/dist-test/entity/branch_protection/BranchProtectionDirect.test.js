...
(0, node_test_1.describe)('BranchProtectionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-branch_protection', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-branch_protection', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_BRANCH_PROTECTION_ENTID'];
...
//# sourceMappingURL=BranchProtectionDirect.test.js.map