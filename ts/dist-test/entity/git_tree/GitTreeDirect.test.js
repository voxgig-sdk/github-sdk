...
(0, node_test_1.describe)('GitTreeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-git_tree', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-git_tree', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_GIT_TREE_ENTID'];
...
//# sourceMappingURL=GitTreeDirect.test.js.map