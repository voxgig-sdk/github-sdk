...
(0, node_test_1.describe)('GistEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(gist_ref01_resdata_up0.id === gist_ref01_data_up0.id);
        (0, node_assert_1.default)(gist_ref01_resdata_up0[gist_ref01_markdef_up0.name] === gist_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(gist_ref01_data_dt0.id === gist_ref01_data.id);
        // REMOVE
        const gist_ref01_match_rm0 = { id: gist_ref01_data.id };
        ...
        (0, node_assert_1.default)(isempty(select(gist_ref01_list_rt0, { id: gist_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['gist01', 'gist02', 'gist03', 'comment01', 'comment02', 'comment03', 'gist01', 'gist02', 'gist03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_GIST_ENTID'];
