...
(0, node_test_1.describe)('OrganizationSecretScanningAlertDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-organization_secret_scanning_alert', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-organization_secret_scanning_alert', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ORGANIZATION_SECRET_SCANNING_ALERT_ENTID'];
...
//# sourceMappingURL=OrganizationSecretScanningAlertDirect.test.js.map