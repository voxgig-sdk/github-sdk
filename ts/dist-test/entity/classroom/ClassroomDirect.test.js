...
(0, node_test_1.describe)('ClassroomDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-classroom', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-classroom', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-classroom', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-classroom', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CLASSROOM_ENTID'];
...
//# sourceMappingURL=ClassroomDirect.test.js.map