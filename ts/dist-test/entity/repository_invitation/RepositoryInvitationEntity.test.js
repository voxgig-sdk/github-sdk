...
(0, node_test_1.describe)('RepositoryInvitationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'update']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'repository_invitation.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(repository_invitation_ref01_resdata_up0.id === repository_invitation_ref01_data_up0.id);
        (0, node_assert_1.default)(repository_invitation_ref01_resdata_up0[repository_invitation_ref01_markdef_up0.name] === repository_invitation_ref01_markdef_up0.value);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/repository_invitation/RepositoryInvitationTestData.json');
    ...
    let idmap = transform(['repository_invitation01', 'repository_invitation02', 'repository_invitation03', 'repo01', 'repo02', 'repo03', 'repo01', 'repo02', 'repo03', 'collaborator01', 'collaborator02', 'collaborator03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_REPOSITORY_INVITATION_ENTID'];
...
//# sourceMappingURL=RepositoryInvitationEntity.test.js.map