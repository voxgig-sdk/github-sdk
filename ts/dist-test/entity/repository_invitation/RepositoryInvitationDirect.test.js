...
(0, node_test_1.describe)('RepositoryInvitationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-repository_invitation', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-repository_invitation', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_REPOSITORY_INVITATION_ENTID'];
...
//# sourceMappingURL=RepositoryInvitationDirect.test.js.map