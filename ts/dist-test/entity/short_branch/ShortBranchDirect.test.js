...
(0, node_test_1.describe)('ShortBranchDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-short_branch', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-short_branch', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_SHORT_BRANCH_ENTID'];
...
//# sourceMappingURL=ShortBranchDirect.test.js.map