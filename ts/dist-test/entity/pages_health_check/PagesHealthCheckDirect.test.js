...
(0, node_test_1.describe)('PagesHealthCheckDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-pages_health_check', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-pages_health_check', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_PAGES_HEALTH_CHECK_ENTID'];
...
//# sourceMappingURL=PagesHealthCheckDirect.test.js.map