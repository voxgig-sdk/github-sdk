...
(0, node_test_1.describe)('CheckEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set GITHUB_TEST_CHECK_ENTID JSON to run live');
            return;
        }
        ...
        check_ref01_match['owner'] = setup.idmap['owner01'];
        check_ref01_match['ref'] = setup.idmap['ref01'];
        check_ref01_match['repo'] = setup.idmap['repo01'];
...
function basicSetup(extra) {
    ...
    let idmap = transform(['check01', 'check02', 'check03', 'repo01', 'repo02', 'repo03', 'check_suite01', 'check_suite02', 'check_suite03', 'repo01', 'repo02', 'repo03', 'commit01', 'commit02', 'commit03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_CHECK_ENTID'];
    ...
    idmap = env['GITHUB_TEST_CHECK_ENTID'];
