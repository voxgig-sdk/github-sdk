...
(0, node_test_1.describe)('CheckAnnotationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-check_annotation', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-check_annotation', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["check_run01", "owner01", "repo01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CHECK_ANNOTATION_ENTID'];
...
//# sourceMappingURL=CheckAnnotationDirect.test.js.map