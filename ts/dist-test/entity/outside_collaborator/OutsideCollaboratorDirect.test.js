...
(0, node_test_1.describe)('OutsideCollaboratorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-outside_collaborator', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-outside_collaborator', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_OUTSIDE_COLLABORATOR_ENTID'];
...
//# sourceMappingURL=OutsideCollaboratorDirect.test.js.map