...
function basicSetup(extra) {
    ...
    let idmap = transform(['language01', 'language02', 'language03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_LANGUAGE_ENTID'];
    ...
    idmap = env['GITHUB_TEST_LANGUAGE_ENTID'];
