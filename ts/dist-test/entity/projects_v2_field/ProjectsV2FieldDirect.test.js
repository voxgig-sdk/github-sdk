...
(0, node_test_1.describe)('ProjectsV2FieldDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-projects_v2_field', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-projects_v2_field', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["org01", "projects_v201"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-projects_v2_field', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-projects_v2_field', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_PROJECTS_V2_FIELD_ENTID'];
...
//# sourceMappingURL=ProjectsV2FieldDirect.test.js.map