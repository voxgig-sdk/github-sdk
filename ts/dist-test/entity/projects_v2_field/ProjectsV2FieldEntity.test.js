...
(0, node_test_1.describe)('ProjectsV2FieldEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'projects_v2_field.' + op, live))
                return;
        }
        ...
        let projects_v2_field_ref01_data = Object.values(setup.data.existing.projects_v2_field)[0];
        // LIST
        const projects_v2_field_ref01_ent = client.ProjectsV2Field();
        const projects_v2_field_ref01_match = {};
        ...
        const projects_v2_field_ref01_list = (await projects_v2_field_ref01_ent.list(projects_v2_field_ref01_match)).map((e) => e.data());
        // LOAD
        const projects_v2_field_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(projects_v2_field_ref01_data_dt0.id === projects_v2_field_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/projects_v2_field/ProjectsV2FieldTestData.json');
    ...
    let idmap = transform(['projects_v2_field01', 'projects_v2_field02', 'projects_v2_field03', 'org01', 'org02', 'org03', 'projects_v201', 'projects_v202', 'projects_v203', 'user01', 'user02', 'user03', 'projects_v201', 'projects_v202', 'projects_v203'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ProjectsV2FieldEntity.test.js.map