...
(0, node_test_1.describe)('ActionsHostedRunnerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-actions_hosted_runner', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-actions_hosted_runner', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ACTIONS_HOSTED_RUNNER_ENTID'];
...
//# sourceMappingURL=ActionsHostedRunnerDirect.test.js.map