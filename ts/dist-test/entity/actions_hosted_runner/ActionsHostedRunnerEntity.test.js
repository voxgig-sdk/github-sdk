...
(0, node_test_1.describe)('ActionsHostedRunnerEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'actions_hosted_runner.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != actions_hosted_runner_ref01_data.id);
        // UPDATE
        ...
        (0, node_assert_1.default)(actions_hosted_runner_ref01_resdata_up0.id === actions_hosted_runner_ref01_data_up0.id);
        (0, node_assert_1.default)(actions_hosted_runner_ref01_resdata_up0[actions_hosted_runner_ref01_markdef_up0.name] === actions_hosted_runner_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(actions_hosted_runner_ref01_data_dt0.id === actions_hosted_runner_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/actions_hosted_runner/ActionsHostedRunnerTestData.json');
    ...
    let idmap = transform(['actions_hosted_runner01', 'actions_hosted_runner02', 'actions_hosted_runner03', 'org01', 'org02', 'org03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_ACTIONS_HOSTED_RUNNER_ENTID'];
...
//# sourceMappingURL=ActionsHostedRunnerEntity.test.js.map