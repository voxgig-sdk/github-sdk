...
(0, node_test_1.describe)('ActionsArtifactAndLogRetentionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-actions_artifact_and_log_retention', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-actions_artifact_and_log_retention', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ACTIONS_ARTIFACT_AND_LOG_RETENTION_ENTID'];
...
//# sourceMappingURL=ActionsArtifactAndLogRetentionDirect.test.js.map