...
(0, node_test_1.describe)('BaseGistDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-base_gist', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-base_gist', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_BASE_GIST_ENTID'];
...
//# sourceMappingURL=BaseGistDirect.test.js.map