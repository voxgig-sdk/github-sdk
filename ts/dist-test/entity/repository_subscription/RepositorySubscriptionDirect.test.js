...
(0, node_test_1.describe)('RepositorySubscriptionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-repository_subscription', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-repository_subscription', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_REPOSITORY_SUBSCRIPTION_ENTID'];
...
//# sourceMappingURL=RepositorySubscriptionDirect.test.js.map