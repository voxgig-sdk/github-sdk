...
(0, node_test_1.describe)('ActionsHostedRunnerLimitDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-actions_hosted_runner_limit', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-actions_hosted_runner_limit', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ACTIONS_HOSTED_RUNNER_LIMIT_ENTID'];
...
//# sourceMappingURL=ActionsHostedRunnerLimitDirect.test.js.map