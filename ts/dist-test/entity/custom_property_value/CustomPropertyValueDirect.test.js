...
(0, node_test_1.describe)('CustomPropertyValueDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-custom_property_value', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-custom_property_value', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CUSTOM_PROPERTY_VALUE_ENTID'];
...
//# sourceMappingURL=CustomPropertyValueDirect.test.js.map