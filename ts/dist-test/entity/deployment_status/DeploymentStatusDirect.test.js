...
(0, node_test_1.describe)('DeploymentStatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-deployment_status', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-deployment_status', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["deployment01", "owner01", "repo01"]))
            return;
        ...
        if (setup.live) {
            const listResult = await client.direct({
                ...
                method: 'GET',
                params: {
                    id: setup.idmap['deployment_status01'],
    ...
    (0, node_test_1.test)('direct-list-deployment_status', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-deployment_status', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["deployment_status01", "owner01", "repo01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_DEPLOYMENT_STATUS_ENTID'];
...
//# sourceMappingURL=DeploymentStatusDirect.test.js.map