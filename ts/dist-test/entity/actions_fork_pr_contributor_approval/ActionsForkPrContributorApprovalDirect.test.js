...
(0, node_test_1.describe)('ActionsForkPrContributorApprovalDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-actions_fork_pr_contributor_approval', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-actions_fork_pr_contributor_approval', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ACTIONS_FORK_PR_CONTRIBUTOR_APPROVAL_ENTID'];
...
//# sourceMappingURL=ActionsForkPrContributorApprovalDirect.test.js.map