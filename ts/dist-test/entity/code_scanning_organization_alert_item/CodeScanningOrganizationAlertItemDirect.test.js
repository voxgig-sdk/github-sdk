...
(0, node_test_1.describe)('CodeScanningOrganizationAlertItemDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-code_scanning_organization_alert_item', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-code_scanning_organization_alert_item', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CODE_SCANNING_ORGANIZATION_ALERT_ITEM_ENTID'];
...
//# sourceMappingURL=CodeScanningOrganizationAlertItemDirect.test.js.map