...
(0, node_test_1.describe)('CodeFrequencyStatDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-code_frequency_stat', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-code_frequency_stat', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CODE_FREQUENCY_STAT_ENTID'];
...
//# sourceMappingURL=CodeFrequencyStatDirect.test.js.map