...
(0, node_test_1.describe)('DeploymentBranchPolicyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-deployment_branch_policy', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-deployment_branch_policy', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_DEPLOYMENT_BRANCH_POLICY_ENTID'];
...
//# sourceMappingURL=DeploymentBranchPolicyDirect.test.js.map