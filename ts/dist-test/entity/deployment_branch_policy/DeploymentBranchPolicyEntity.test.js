...
(0, node_test_1.describe)('DeploymentBranchPolicyEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'deployment_branch_policy.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != deployment_branch_policy_ref01_data.id);
        // UPDATE
        ...
        (0, node_assert_1.default)(deployment_branch_policy_ref01_resdata_up0.id === deployment_branch_policy_ref01_data_up0.id);
        (0, node_assert_1.default)(deployment_branch_policy_ref01_resdata_up0[deployment_branch_policy_ref01_markdef_up0.name] === deployment_branch_policy_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(deployment_branch_policy_ref01_data_dt0.id === deployment_branch_policy_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/deployment_branch_policy/DeploymentBranchPolicyTestData.json');
    ...
    let idmap = transform(['deployment_branch_policy01', 'deployment_branch_policy02', 'deployment_branch_policy03', 'repo01', 'repo02', 'repo03', 'environment01', 'environment02', 'environment03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_DEPLOYMENT_BRANCH_POLICY_ENTID'];
...
//# sourceMappingURL=DeploymentBranchPolicyEntity.test.js.map