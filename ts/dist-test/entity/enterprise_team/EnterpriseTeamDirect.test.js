...
(0, node_test_1.describe)('EnterpriseTeamDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-enterprise_team', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-enterprise_team', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-enterprise_team', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-enterprise_team', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["enterprise01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ENTERPRISE_TEAM_ENTID'];
...
//# sourceMappingURL=EnterpriseTeamDirect.test.js.map