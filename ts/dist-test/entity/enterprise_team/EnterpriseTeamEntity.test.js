...
(0, node_test_1.describe)('EnterpriseTeamEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'enterprise_team.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != enterprise_team_ref01_data.id);
        // LIST
        const enterprise_team_ref01_match = {};
        enterprise_team_ref01_match['enterprise'] = setup.idmap['enterprise01'];
        const enterprise_team_ref01_list = (await enterprise_team_ref01_ent.list(enterprise_team_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(enterprise_team_ref01_list, { id: enterprise_team_ref01_data.id })));
        // UPDATE
        const enterprise_team_ref01_data_up0 = {};
        ...
        enterprise_team_ref01_data_up0[enterprise_team_ref01_markdef_up0.name] = enterprise_team_ref01_markdef_up0.value;
        const enterprise_team_ref01_resdata_up0 = (await enterprise_team_ref01_ent.update(enterprise_team_ref01_data_up0)).data();
        (0, node_assert_1.default)(enterprise_team_ref01_resdata_up0.id === enterprise_team_ref01_data_up0.id);
        (0, node_assert_1.default)(enterprise_team_ref01_resdata_up0[enterprise_team_ref01_markdef_up0.name] === enterprise_team_ref01_markdef_up0.value);
        // LOAD
        const enterprise_team_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(enterprise_team_ref01_data_dt0.id === enterprise_team_ref01_data.id);
        // REMOVE
        const enterprise_team_ref01_match_rm0 = { id: enterprise_team_ref01_data.id };
        await enterprise_team_ref01_ent.remove(enterprise_team_ref01_match_rm0);
        // LIST
        const enterprise_team_ref01_match_rt0 = {};
        enterprise_team_ref01_match_rt0['enterprise'] = setup.idmap['enterprise01'];
        const enterprise_team_ref01_list_rt0 = (await enterprise_team_ref01_ent.list(enterprise_team_ref01_match_rt0)).map((e) => e.data());
        (0, node_assert_1.default)(isempty(select(enterprise_team_ref01_list_rt0, { id: enterprise_team_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/enterprise_team/EnterpriseTeamTestData.json');
    ...
    let idmap = transform(['enterprise_team01', 'enterprise_team02', 'enterprise_team03', 'enterpris01', 'enterpris02', 'enterpris03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=EnterpriseTeamEntity.test.js.map