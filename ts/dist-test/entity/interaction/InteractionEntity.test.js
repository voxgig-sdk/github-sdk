...
(0, node_test_1.describe)('InteractionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let interaction_ref01_data = Object.values(setup.data.existing.interaction)[0];
...
function basicSetup(extra) {
    ...
    let idmap = transform(['interaction01', 'interaction02', 'interaction03', 'org01', 'org02', 'org03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_INTERACTION_ENTID'];
    ...
    idmap = env['GITHUB_TEST_INTERACTION_ENTID'];
