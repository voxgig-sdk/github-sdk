...
(0, node_test_1.describe)('KeyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-key', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-key', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-key', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-key', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_KEY_ENTID'];
...
//# sourceMappingURL=KeyDirect.test.js.map