...
(0, node_test_1.describe)('SecretScanningScanHistoryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-secret_scanning_scan_history', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-secret_scanning_scan_history', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_SECRET_SCANNING_SCAN_HISTORY_ENTID'];
...
//# sourceMappingURL=SecretScanningScanHistoryDirect.test.js.map