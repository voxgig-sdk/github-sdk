...
(0, node_test_1.describe)('ActionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-action', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-action', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["archive_format01", "artifact01", "owner01", "repo01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-action', async (t) => {
        ...
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-action', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["owner01", "repo01", "workflow01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ACTION_ENTID'];
...
//# sourceMappingURL=ActionDirect.test.js.map