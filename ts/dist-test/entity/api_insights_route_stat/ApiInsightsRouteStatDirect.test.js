...
(0, node_test_1.describe)('ApiInsightsRouteStatDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-api_insights_route_stat', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_insights_route_stat', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_API_INSIGHTS_ROUTE_STAT_ENTID'];
...
//# sourceMappingURL=ApiInsightsRouteStatDirect.test.js.map