...
(0, node_test_1.describe)('CodeSecurityDefaultConfigurationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-code_security_default_configuration', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-code_security_default_configuration', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CODE_SECURITY_DEFAULT_CONFIGURATION_ENTID'];
...
//# sourceMappingURL=CodeSecurityDefaultConfigurationDirect.test.js.map