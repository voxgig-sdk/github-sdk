...
(0, node_test_1.describe)('NetworkSettingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-network_setting', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-network_setting', setup.live))
            return;
...
//# sourceMappingURL=NetworkSettingDirect.test.js.map