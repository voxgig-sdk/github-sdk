...
(0, node_test_1.describe)('CodeScanningVariantAnalysiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-code_scanning_variant_analysi', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-code_scanning_variant_analysi', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["codeql_variant_analysis_id01", "owner01", "repo01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CODE_SCANNING_VARIANT_ANALYSI_ENTID'];
...
//# sourceMappingURL=CodeScanningVariantAnalysiDirect.test.js.map