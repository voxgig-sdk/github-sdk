...
(0, node_test_1.describe)('ArtifactDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-artifact', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-artifact', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ARTIFACT_ENTID'];
...
//# sourceMappingURL=ArtifactDirect.test.js.map