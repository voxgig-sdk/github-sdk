...
(0, node_test_1.describe)('ArtifactEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'artifact.' + op, live))
                return;
        }
        ...
        let artifact_ref01_data = Object.values(setup.data.existing.artifact)[0];
        // LOAD
...
function basicSetup(extra) {
    ...
    let idmap = transform(['artifact01', 'artifact02', 'artifact03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
