...
(0, node_test_1.describe)('ProjectsClassicEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'update', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'projects_classic.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != projects_classic_ref01_data);
        // UPDATE
        ...
        (0, node_assert_1.default)(null != projects_classic_ref01_resdata_up0);
        (0, node_assert_1.default)(projects_classic_ref01_resdata_up0[projects_classic_ref01_markdef_up0.name] === projects_classic_ref01_markdef_up0.value);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/projects_classic/ProjectsClassicTestData.json');
    ...
    let idmap = transform(['projects_classic01', 'projects_classic02', 'projects_classic03', 'column01', 'column02', 'column03', 'project01', 'project02', 'project03', 'collaborator01', 'collaborator02', 'collaborator03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_PROJECTS_CLASSIC_ENTID'];
...
//# sourceMappingURL=ProjectsClassicEntity.test.js.map