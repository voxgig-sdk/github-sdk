...
(0, node_test_1.describe)('FeedDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-feed', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-feed', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_FEED_ENTID'];
...
//# sourceMappingURL=FeedDirect.test.js.map