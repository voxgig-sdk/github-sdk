...
(0, node_test_1.describe)('AppDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-app', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-app', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["installation01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_APP_ENTID'];
