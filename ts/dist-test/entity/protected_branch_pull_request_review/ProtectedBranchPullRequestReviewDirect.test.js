...
(0, node_test_1.describe)('ProtectedBranchPullRequestReviewDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-protected_branch_pull_request_review', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-protected_branch_pull_request_review', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["branch_id01", "owner01", "repo01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_PROTECTED_BRANCH_PULL_REQUEST_REVIEW_ENTID'];
...
//# sourceMappingURL=ProtectedBranchPullRequestReviewDirect.test.js.map