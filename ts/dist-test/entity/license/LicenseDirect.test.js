...
(0, node_test_1.describe)('LicenseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-license', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-license', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-license', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-license', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_LICENSE_ENTID'];
...
//# sourceMappingURL=LicenseDirect.test.js.map