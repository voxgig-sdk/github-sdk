...
(0, node_test_1.describe)('ReviewCommentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-review_comment', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-review_comment', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["review_comment01", "owner01", "pull01", "repo01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_REVIEW_COMMENT_ENTID'];
...
//# sourceMappingURL=ReviewCommentDirect.test.js.map