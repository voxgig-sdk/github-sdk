...
(0, node_test_1.describe)('OidcCustomSubRepoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-oidc_custom_sub_repo', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-oidc_custom_sub_repo', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_OIDC_CUSTOM_SUB_REPO_ENTID'];
...
//# sourceMappingURL=OidcCustomSubRepoDirect.test.js.map