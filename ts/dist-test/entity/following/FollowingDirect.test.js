...
(0, node_test_1.describe)('FollowingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-following', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-following', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_FOLLOWING_ENTID'];
...
//# sourceMappingURL=FollowingDirect.test.js.map