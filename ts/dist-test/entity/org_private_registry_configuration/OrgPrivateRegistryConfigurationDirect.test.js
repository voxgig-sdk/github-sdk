...
(0, node_test_1.describe)('OrgPrivateRegistryConfigurationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-org_private_registry_configuration', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-org_private_registry_configuration', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["org_id01", "secret_name01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ORG_PRIVATE_REGISTRY_CONFIGURATION_ENTID'];
...
//# sourceMappingURL=OrgPrivateRegistryConfigurationDirect.test.js.map