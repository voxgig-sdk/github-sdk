...
(0, node_test_1.describe)('ActionsForkPrWorkflowsPrivateRepoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-actions_fork_pr_workflows_private_repo', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-actions_fork_pr_workflows_private_repo', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ACTIONS_FORK_PR_WORKFLOWS_PRIVATE_REPO_ENTID'];
...
//# sourceMappingURL=ActionsForkPrWorkflowsPrivateRepoDirect.test.js.map