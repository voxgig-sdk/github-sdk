...
(0, node_test_1.describe)('ActionsVariableDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-actions_variable', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-actions_variable', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ACTIONS_VARIABLE_ENTID'];
...
//# sourceMappingURL=ActionsVariableDirect.test.js.map