...
(0, node_test_1.describe)('SimpleClassroomAssignmentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-simple_classroom_assignment', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-simple_classroom_assignment', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["classroom01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_SIMPLE_CLASSROOM_ASSIGNMENT_ENTID'];
...
//# sourceMappingURL=SimpleClassroomAssignmentDirect.test.js.map