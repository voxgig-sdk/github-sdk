...
(0, node_test_1.describe)('DependabotPublicKeyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-dependabot_public_key', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-dependabot_public_key', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_DEPENDABOT_PUBLIC_KEY_ENTID'];
...
//# sourceMappingURL=DependabotPublicKeyDirect.test.js.map