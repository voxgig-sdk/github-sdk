...
(0, node_test_1.describe)('CustomPropertyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-custom_property', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-custom_property', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["custom_property_name01", "org01"]))
            return;
        ...
        if (setup.live) {
            ...
            const candidateId = listArr[0]?.custom_property_name ?? listArr[0]?.id;
            if (null == candidateId) {
                return; // skip: list response shape does not expose load identifier
            }
            params.custom_property_name = candidateId;
    ...
    (0, node_test_1.test)('direct-list-custom_property', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-custom_property', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CUSTOM_PROPERTY_ENTID'];
...
//# sourceMappingURL=CustomPropertyDirect.test.js.map