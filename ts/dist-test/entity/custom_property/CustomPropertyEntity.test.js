...
(0, node_test_1.describe)('CustomPropertyEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'custom_property.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != custom_property_ref01_resdata_up0);
        (0, node_assert_1.default)(custom_property_ref01_resdata_up0[custom_property_ref01_markdef_up0.name] === custom_property_ref01_markdef_up0.value);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/custom_property/CustomPropertyTestData.json');
    ...
    let idmap = transform(['custom_property01', 'custom_property02', 'custom_property03', 'org01', 'org02', 'org03', 'org01', 'org02', 'org03', 'schema01', 'schema02', 'schema03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_CUSTOM_PROPERTY_ENTID'];
...
//# sourceMappingURL=CustomPropertyEntity.test.js.map