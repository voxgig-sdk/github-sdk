...
(0, node_test_1.describe)('PorterAuthorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-porter_author', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-porter_author', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_PORTER_AUTHOR_ENTID'];
...
//# sourceMappingURL=PorterAuthorDirect.test.js.map