...
(0, node_test_1.describe)('CampaignEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'campaign.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(campaign_ref01_resdata_up0.id === campaign_ref01_data_up0.id);
        (0, node_assert_1.default)(campaign_ref01_resdata_up0[campaign_ref01_markdef_up0.name] === campaign_ref01_markdef_up0.value);
        // LOAD
        ...
        // REMOVE
        const campaign_ref01_match_rm0 = { id: campaign_ref01_data.id };
        ...
        (0, node_assert_1.default)(isempty(select(campaign_ref01_list_rt0, { id: campaign_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['campaign01', 'campaign02', 'campaign03', 'org01', 'org02', 'org03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_CAMPAIGN_ENTID'];
