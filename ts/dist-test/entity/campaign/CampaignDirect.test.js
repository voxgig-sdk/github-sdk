...
(0, node_test_1.describe)('CampaignDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-campaign', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-campaign', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-campaign', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-campaign', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["org01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CAMPAIGN_ENTID'];
...
//# sourceMappingURL=CampaignDirect.test.js.map