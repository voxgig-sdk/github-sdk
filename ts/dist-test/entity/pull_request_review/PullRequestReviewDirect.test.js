...
(0, node_test_1.describe)('PullRequestReviewDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-pull_request_review', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-pull_request_review', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["owner01", "pull01", "repo01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-pull_request_review', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-pull_request_review', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["owner01", "pull_number01", "repo01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_PULL_REQUEST_REVIEW_ENTID'];
...
//# sourceMappingURL=PullRequestReviewDirect.test.js.map