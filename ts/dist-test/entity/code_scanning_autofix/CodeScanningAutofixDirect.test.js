...
(0, node_test_1.describe)('CodeScanningAutofixDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-code_scanning_autofix', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-code_scanning_autofix', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CODE_SCANNING_AUTOFIX_ENTID'];
...
//# sourceMappingURL=CodeScanningAutofixDirect.test.js.map