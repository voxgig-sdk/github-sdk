...
function basicSetup(extra) {
    ...
    let idmap = transform(['project01', 'project02', 'project03', 'org01', 'org02', 'org03', 'repo01', 'repo02', 'repo03', 'user01', 'user02', 'user03', 'org01', 'org02', 'org03', 'projects_v201', 'projects_v202', 'projects_v203', 'item01', 'item02', 'item03', 'user01', 'user02', 'user03', 'projects_v201', 'projects_v202', 'projects_v203', 'item01', 'item02', 'item03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_PROJECT_ENTID'];
