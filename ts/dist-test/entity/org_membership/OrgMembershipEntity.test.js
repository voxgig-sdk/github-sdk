...
(0, node_test_1.describe)('OrgMembershipEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'org_membership.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(org_membership_ref01_resdata_up0.id === org_membership_ref01_data_up0.id);
        (0, node_assert_1.default)(org_membership_ref01_resdata_up0[org_membership_ref01_markdef_up0.name] === org_membership_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(org_membership_ref01_data_dt0.id === org_membership_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/org_membership/OrgMembershipTestData.json');
    ...
    let idmap = transform(['org_membership01', 'org_membership02', 'org_membership03', 'org01', 'org02', 'org03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_ORG_MEMBERSHIP_ENTID'];
...
//# sourceMappingURL=OrgMembershipEntity.test.js.map