...
(0, node_test_1.describe)('GitCommitDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-git_commit', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-git_commit', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_GIT_COMMIT_ENTID'];
...
//# sourceMappingURL=GitCommitDirect.test.js.map