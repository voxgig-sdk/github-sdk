...
(0, node_test_1.describe)('ContributorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-contributor', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-contributor', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CONTRIBUTOR_ENTID'];
...
//# sourceMappingURL=ContributorDirect.test.js.map