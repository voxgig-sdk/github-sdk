...
(0, node_test_1.describe)('OrgDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-org', async (t) => {
        ...
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-org', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["subject_digest01"]))
            return;
        ...
        if (setup.live) {
            ...
            params.id = 'direct01';
            params.subject_digest = 'direct02';
        }
        const result = await client.direct({
            path: 'orgs/{id}/attestations/{subject_digest}',
            method: 'GET',
            params,
            query,
        });
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ORG_ENTID'];
