...
(0, node_test_1.describe)('SelectedActionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-selected_action', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-selected_action', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_SELECTED_ACTION_ENTID'];
...
//# sourceMappingURL=SelectedActionDirect.test.js.map