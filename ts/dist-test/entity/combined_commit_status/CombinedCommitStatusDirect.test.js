...
(0, node_test_1.describe)('CombinedCommitStatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-combined_commit_status', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-combined_commit_status', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["owner01", "ref01", "repo01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_COMBINED_COMMIT_STATUS_ENTID'];
...
//# sourceMappingURL=CombinedCommitStatusDirect.test.js.map