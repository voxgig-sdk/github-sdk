...
(0, node_test_1.describe)('CombinedCommitStatusEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'combined_commit_status.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/combined_commit_status/CombinedCommitStatusTestData.json');
    ...
    let idmap = transform(['combined_commit_status01', 'combined_commit_status02', 'combined_commit_status03', 'repo01', 'repo02', 'repo03', 'commit01', 'commit02', 'commit03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_COMBINED_COMMIT_STATUS_ENTID'];
...
//# sourceMappingURL=CombinedCommitStatusEntity.test.js.map