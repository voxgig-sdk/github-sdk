...
(0, node_test_1.describe)('GistCommitDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-gist_commit', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-gist_commit', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["gist_commit01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_GIST_COMMIT_ENTID'];
...
//# sourceMappingURL=GistCommitDirect.test.js.map