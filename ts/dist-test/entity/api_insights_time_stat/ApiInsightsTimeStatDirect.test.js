...
(0, node_test_1.describe)('ApiInsightsTimeStatDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_insights_time_stat', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_insights_time_stat', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["org01", "user01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-api_insights_time_stat', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_insights_time_stat', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["actor01", "actor_type01", "org01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
//# sourceMappingURL=ApiInsightsTimeStatDirect.test.js.map