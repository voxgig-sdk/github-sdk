...
(0, node_test_1.describe)('RunnerGroupDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-runner_group', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-runner_group', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_RUNNER_GROUP_ENTID'];
...
//# sourceMappingURL=RunnerGroupDirect.test.js.map