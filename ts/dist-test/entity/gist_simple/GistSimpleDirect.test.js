...
(0, node_test_1.describe)('GistSimpleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-gist_simple', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-gist_simple', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["gist_simple01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_GIST_SIMPLE_ENTID'];
...
//# sourceMappingURL=GistSimpleDirect.test.js.map