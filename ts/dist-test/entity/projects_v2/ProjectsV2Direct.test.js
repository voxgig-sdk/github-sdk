...
(0, node_test_1.describe)('ProjectsV2Direct', async () => {
    ...
    (0, node_test_1.test)('direct-load-projects_v2', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-projects_v2', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-projects_v2', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-projects_v2', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["org01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_PROJECTS_V2_ENTID'];
...
//# sourceMappingURL=ProjectsV2Direct.test.js.map