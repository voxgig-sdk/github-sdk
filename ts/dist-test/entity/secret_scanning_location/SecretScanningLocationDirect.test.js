...
(0, node_test_1.describe)('SecretScanningLocationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-secret_scanning_location', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-secret_scanning_location', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["alert_number01", "owner01", "repo01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_SECRET_SCANNING_LOCATION_ENTID'];
...
//# sourceMappingURL=SecretScanningLocationDirect.test.js.map