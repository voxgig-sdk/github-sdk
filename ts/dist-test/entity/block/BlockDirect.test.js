...
(0, node_test_1.describe)('BlockDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-block', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-block', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_BLOCK_ENTID'];
...
//# sourceMappingURL=BlockDirect.test.js.map