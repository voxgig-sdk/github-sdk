...
(0, node_test_1.describe)('OidcCustomSubDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-oidc_custom_sub', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-oidc_custom_sub', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_OIDC_CUSTOM_SUB_ENTID'];
...
//# sourceMappingURL=OidcCustomSubDirect.test.js.map