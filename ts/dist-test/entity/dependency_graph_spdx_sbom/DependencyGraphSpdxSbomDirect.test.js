...
(0, node_test_1.describe)('DependencyGraphSpdxSbomDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-dependency_graph_spdx_sbom', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-dependency_graph_spdx_sbom', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_DEPENDENCY_GRAPH_SPDX_SBOM_ENTID'];
...
//# sourceMappingURL=DependencyGraphSpdxSbomDirect.test.js.map