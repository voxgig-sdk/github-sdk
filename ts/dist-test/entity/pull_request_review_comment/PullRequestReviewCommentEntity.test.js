...
(0, node_test_1.describe)('PullRequestReviewCommentEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'pull_request_review_comment.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != pull_request_review_comment_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(pull_request_review_comment_ref01_list, { id: pull_request_review_comment_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(pull_request_review_comment_ref01_resdata_up0.id === pull_request_review_comment_ref01_data_up0.id);
        (0, node_assert_1.default)(pull_request_review_comment_ref01_resdata_up0[pull_request_review_comment_ref01_markdef_up0.name] === pull_request_review_comment_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(pull_request_review_comment_ref01_data_dt0.id === pull_request_review_comment_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/pull_request_review_comment/PullRequestReviewCommentTestData.json');
    ...
    let idmap = transform(['pull_request_review_comment01', 'pull_request_review_comment02', 'pull_request_review_comment03', 'repo01', 'repo02', 'repo03', 'repo01', 'repo02', 'repo03', 'pull01', 'pull02', 'pull03', 'repo01', 'repo02', 'repo03', 'pull01', 'pull02', 'pull03', 'comment01', 'comment02', 'comment03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_PULL_REQUEST_REVIEW_COMMENT_ENTID'];
...
//# sourceMappingURL=PullRequestReviewCommentEntity.test.js.map