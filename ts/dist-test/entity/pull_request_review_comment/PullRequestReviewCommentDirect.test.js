...
(0, node_test_1.describe)('PullRequestReviewCommentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-pull_request_review_comment', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-pull_request_review_comment', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-pull_request_review_comment', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-pull_request_review_comment', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_PULL_REQUEST_REVIEW_COMMENT_ENTID'];
...
//# sourceMappingURL=PullRequestReviewCommentDirect.test.js.map