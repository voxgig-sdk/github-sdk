...
(0, node_test_1.describe)('FileCommitEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['update']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'file_commit.' + op, live))
                return;
        }
        ...
        let file_commit_ref01_data = Object.values(setup.data.existing.file_commit)[0];
        // UPDATE
        const file_commit_ref01_ent = client.FileCommit();
        const file_commit_ref01_data_up0 = {};
        ...
        file_commit_ref01_data_up0[file_commit_ref01_markdef_up0.name] = file_commit_ref01_markdef_up0.value;
        const file_commit_ref01_resdata_up0 = (await file_commit_ref01_ent.update(file_commit_ref01_data_up0)).data();
        (0, node_assert_1.default)(null != file_commit_ref01_resdata_up0);
        (0, node_assert_1.default)(file_commit_ref01_resdata_up0[file_commit_ref01_markdef_up0.name] === file_commit_ref01_markdef_up0.value);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/file_commit/FileCommitTestData.json');
    ...
    let idmap = transform(['file_commit01', 'file_commit02', 'file_commit03', 'repo01', 'repo02', 'repo03', 'content01', 'content02', 'content03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=FileCommitEntity.test.js.map