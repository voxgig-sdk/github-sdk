...
(0, node_test_1.describe)('OrgHookDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-org_hook', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-org_hook', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-org_hook', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-org_hook', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["org_hook01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ORG_HOOK_ENTID'];
...
//# sourceMappingURL=OrgHookDirect.test.js.map