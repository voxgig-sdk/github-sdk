...
(0, node_test_1.describe)('OrgHookEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'org_hook.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != org_hook_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(org_hook_ref01_list, { id: org_hook_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(org_hook_ref01_resdata_up0.id === org_hook_ref01_data_up0.id);
        (0, node_assert_1.default)(org_hook_ref01_resdata_up0[org_hook_ref01_markdef_up0.name] === org_hook_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(org_hook_ref01_data_dt0.id === org_hook_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/org_hook/OrgHookTestData.json');
    ...
    let idmap = transform(['org_hook01', 'org_hook02', 'org_hook03', 'org01', 'org02', 'org03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_ORG_HOOK_ENTID'];
...
//# sourceMappingURL=OrgHookEntity.test.js.map