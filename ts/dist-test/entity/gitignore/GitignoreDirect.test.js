...
(0, node_test_1.describe)('GitignoreDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-gitignore', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-gitignore', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_GITIGNORE_ENTID'];
...
//# sourceMappingURL=GitignoreDirect.test.js.map