...
(0, node_test_1.describe)('MarketplacePurchaseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-marketplace_purchase', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-marketplace_purchase', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-marketplace_purchase', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-marketplace_purchase', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["plan01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_MARKETPLACE_PURCHASE_ENTID'];
...
//# sourceMappingURL=MarketplacePurchaseDirect.test.js.map