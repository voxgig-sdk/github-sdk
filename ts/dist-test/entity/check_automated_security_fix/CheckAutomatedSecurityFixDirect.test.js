...
(0, node_test_1.describe)('CheckAutomatedSecurityFixDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-check_automated_security_fix', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-check_automated_security_fix', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CHECK_AUTOMATED_SECURITY_FIX_ENTID'];
...
//# sourceMappingURL=CheckAutomatedSecurityFixDirect.test.js.map