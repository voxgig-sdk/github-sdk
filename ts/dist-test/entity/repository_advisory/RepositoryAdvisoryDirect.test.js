...
(0, node_test_1.describe)('RepositoryAdvisoryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-repository_advisory', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-repository_advisory', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["ghsa01", "owner01", "repo01"]))
            return;
        ...
        if (setup.live) {
            ...
            const candidateId = listArr[0]?.ghsa_id ?? listArr[0]?.id;
            if (null == candidateId) {
                return; // skip: list response shape does not expose load identifier
            }
            params.ghsa_id = candidateId;
    ...
    (0, node_test_1.test)('direct-list-repository_advisory', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-repository_advisory', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_REPOSITORY_ADVISORY_ENTID'];
...
//# sourceMappingURL=RepositoryAdvisoryDirect.test.js.map