...
(0, node_test_1.describe)('RepositoryAdvisoryEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'repository_advisory.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != repository_advisory_ref01_data);
        // LIST
        ...
        (0, node_assert_1.default)(null != repository_advisory_ref01_resdata_up0);
        (0, node_assert_1.default)(repository_advisory_ref01_resdata_up0[repository_advisory_ref01_markdef_up0.name] === repository_advisory_ref01_markdef_up0.value);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/repository_advisory/RepositoryAdvisoryTestData.json');
    ...
    let idmap = transform(['repository_advisory01', 'repository_advisory02', 'repository_advisory03', 'org01', 'org02', 'org03', 'repo01', 'repo02', 'repo03', 'repo01', 'repo02', 'repo03', 'security_advisory01', 'security_advisory02', 'security_advisory03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_REPOSITORY_ADVISORY_ENTID'];
...
//# sourceMappingURL=RepositoryAdvisoryEntity.test.js.map