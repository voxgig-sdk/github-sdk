...
(0, node_test_1.describe)('SshSigningKeyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-ssh_signing_key', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ssh_signing_key', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-ssh_signing_key', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-ssh_signing_key', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_SSH_SIGNING_KEY_ENTID'];
...
//# sourceMappingURL=SshSigningKeyDirect.test.js.map