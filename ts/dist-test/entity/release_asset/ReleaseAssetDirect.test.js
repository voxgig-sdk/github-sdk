...
(0, node_test_1.describe)('ReleaseAssetDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-release_asset', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-release_asset', setup.live))
            return;
        ...
        if (setup.live) {
            const listResult = await client.direct({
                ...
                method: 'GET',
                params: {
                    id: setup.idmap['release_asset01'],
    ...
    (0, node_test_1.test)('direct-list-release_asset', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-release_asset', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["release_asset01", "owner01", "repo01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_RELEASE_ASSET_ENTID'];
...
//# sourceMappingURL=ReleaseAssetDirect.test.js.map