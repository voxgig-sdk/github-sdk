...
(0, node_test_1.describe)('ReleaseAssetEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'release_asset.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != release_asset_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(release_asset_ref01_list, { id: release_asset_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(release_asset_ref01_resdata_up0.id === release_asset_ref01_data_up0.id);
        (0, node_assert_1.default)(release_asset_ref01_resdata_up0[release_asset_ref01_markdef_up0.name] === release_asset_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(release_asset_ref01_data_dt0.id === release_asset_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/release_asset/ReleaseAssetTestData.json');
    ...
    let idmap = transform(['release_asset01', 'release_asset02', 'release_asset03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_RELEASE_ASSET_ENTID'];
...
//# sourceMappingURL=ReleaseAssetEntity.test.js.map