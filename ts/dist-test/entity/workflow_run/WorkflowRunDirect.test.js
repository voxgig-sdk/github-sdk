...
(0, node_test_1.describe)('WorkflowRunDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-workflow_run', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-workflow_run', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["attempt_number01", "owner01", "repo01", "run_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_WORKFLOW_RUN_ENTID'];
...
//# sourceMappingURL=WorkflowRunDirect.test.js.map