...
(0, node_test_1.describe)('CodeScanningVariantAnalysisRepoTaskDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-code_scanning_variant_analysis_repo_task', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-code_scanning_variant_analysis_repo_task', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["codeql_variant_analysis_id01", "owner01", "repo01", "repo_name01", "repo_owner01"]))
            return;
...
//# sourceMappingURL=CodeScanningVariantAnalysisRepoTaskDirect.test.js.map