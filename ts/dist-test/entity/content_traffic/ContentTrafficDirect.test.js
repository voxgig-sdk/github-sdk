...
(0, node_test_1.describe)('ContentTrafficDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-content_traffic', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-content_traffic', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CONTENT_TRAFFIC_ENTID'];
...
//# sourceMappingURL=ContentTrafficDirect.test.js.map