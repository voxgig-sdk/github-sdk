...
(0, node_test_1.describe)('OrganizationDependabotSecretDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-organization_dependabot_secret', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-organization_dependabot_secret', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["id01", "org_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ORGANIZATION_DEPENDABOT_SECRET_ENTID'];
...
//# sourceMappingURL=OrganizationDependabotSecretDirect.test.js.map