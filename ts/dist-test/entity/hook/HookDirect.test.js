...
(0, node_test_1.describe)('HookDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-hook', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-hook', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-hook', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-hook', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["owner01", "repo01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_HOOK_ENTID'];
...
//# sourceMappingURL=HookDirect.test.js.map