...
(0, node_test_1.describe)('HookEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(!isempty(select(hook_ref01_list, { id: hook_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(hook_ref01_resdata_up0[hook_ref01_markdef_up0.name] === hook_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(hook_ref01_data_dt0.id === hook_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['hook01', 'hook02', 'hook03', 'repo01', 'repo02', 'repo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
