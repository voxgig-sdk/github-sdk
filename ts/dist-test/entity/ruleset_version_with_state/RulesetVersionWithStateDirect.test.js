...
(0, node_test_1.describe)('RulesetVersionWithStateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-ruleset_version_with_state', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ruleset_version_with_state', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["owner01", "repo01", "ruleset_id01", "version_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_RULESET_VERSION_WITH_STATE_ENTID'];
...
//# sourceMappingURL=RulesetVersionWithStateDirect.test.js.map