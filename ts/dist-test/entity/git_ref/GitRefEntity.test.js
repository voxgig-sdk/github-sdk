...
(0, node_test_1.describe)('GitRefEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'git_ref.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != git_ref_ref01_data.id);
        // UPDATE
        ...
        (0, node_assert_1.default)(git_ref_ref01_resdata_up0.id === git_ref_ref01_data_up0.id);
        (0, node_assert_1.default)(git_ref_ref01_resdata_up0[git_ref_ref01_markdef_up0.name] === git_ref_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(git_ref_ref01_data_dt0.id === git_ref_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/git_ref/GitRefTestData.json');
    ...
    let idmap = transform(['git_ref01', 'git_ref02', 'git_ref03', 'repo01', 'repo02', 'repo03', 'repo01', 'repo02', 'repo03', 'matching_ref01', 'matching_ref02', 'matching_ref03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_GIT_REF_ENTID'];
...
//# sourceMappingURL=GitRefEntity.test.js.map