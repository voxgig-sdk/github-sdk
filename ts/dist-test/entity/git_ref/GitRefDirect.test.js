...
(0, node_test_1.describe)('GitRefDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-git_ref', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-git_ref', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_GIT_REF_ENTID'];
...
//# sourceMappingURL=GitRefDirect.test.js.map