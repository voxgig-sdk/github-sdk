...
(0, node_test_1.describe)('HookDeliveryItemDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-hook_delivery_item', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-hook_delivery_item', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["hook_delivery_item01", "owner01", "repo01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_HOOK_DELIVERY_ITEM_ENTID'];
...
//# sourceMappingURL=HookDeliveryItemDirect.test.js.map