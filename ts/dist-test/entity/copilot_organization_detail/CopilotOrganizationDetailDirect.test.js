...
(0, node_test_1.describe)('CopilotOrganizationDetailDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-copilot_organization_detail', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-copilot_organization_detail', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_COPILOT_ORGANIZATION_DETAIL_ENTID'];
...
//# sourceMappingURL=CopilotOrganizationDetailDirect.test.js.map