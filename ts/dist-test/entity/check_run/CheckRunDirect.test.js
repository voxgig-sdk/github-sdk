...
(0, node_test_1.describe)('CheckRunDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-check_run', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-check_run', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CHECK_RUN_ENTID'];
...
//# sourceMappingURL=CheckRunDirect.test.js.map