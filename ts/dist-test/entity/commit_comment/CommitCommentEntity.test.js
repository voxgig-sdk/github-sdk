...
(0, node_test_1.describe)('CommitCommentEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'commit_comment.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != commit_comment_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(commit_comment_ref01_list, { id: commit_comment_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(commit_comment_ref01_resdata_up0.id === commit_comment_ref01_data_up0.id);
        (0, node_assert_1.default)(commit_comment_ref01_resdata_up0[commit_comment_ref01_markdef_up0.name] === commit_comment_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(commit_comment_ref01_data_dt0.id === commit_comment_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/commit_comment/CommitCommentTestData.json');
    ...
    let idmap = transform(['commit_comment01', 'commit_comment02', 'commit_comment03', 'repo01', 'repo02', 'repo03', 'repo01', 'repo02', 'repo03', 'commit01', 'commit02', 'commit03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CommitCommentEntity.test.js.map