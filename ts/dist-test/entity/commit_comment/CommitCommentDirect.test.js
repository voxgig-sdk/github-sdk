...
(0, node_test_1.describe)('CommitCommentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-commit_comment', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-commit_comment', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-commit_comment', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-commit_comment', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["commit_sha01", "owner01", "repo01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_COMMIT_COMMENT_ENTID'];
...
//# sourceMappingURL=CommitCommentDirect.test.js.map