...
(0, node_test_1.describe)('CommitComparisonDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-commit_comparison', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-commit_comparison', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_COMMIT_COMPARISON_ENTID'];
...
//# sourceMappingURL=CommitComparisonDirect.test.js.map