...
(0, node_test_1.describe)('ThreadSubscriptionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'thread_subscription.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(thread_subscription_ref01_resdata_up0.id === thread_subscription_ref01_data_up0.id);
        (0, node_assert_1.default)(thread_subscription_ref01_resdata_up0[thread_subscription_ref01_markdef_up0.name] === thread_subscription_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(thread_subscription_ref01_data_dt0.id === thread_subscription_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/thread_subscription/ThreadSubscriptionTestData.json');
    ...
    let idmap = transform(['thread_subscription01', 'thread_subscription02', 'thread_subscription03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_THREAD_SUBSCRIPTION_ENTID'];
...
//# sourceMappingURL=ThreadSubscriptionEntity.test.js.map