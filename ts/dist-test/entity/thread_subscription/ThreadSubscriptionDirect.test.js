...
(0, node_test_1.describe)('ThreadSubscriptionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-thread_subscription', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-thread_subscription', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_THREAD_SUBSCRIPTION_ENTID'];
...
//# sourceMappingURL=ThreadSubscriptionDirect.test.js.map