...
(0, node_test_1.describe)('GpgKeyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-gpg_key', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-gpg_key', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-gpg_key', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-gpg_key', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_GPG_KEY_ENTID'];
...
//# sourceMappingURL=GpgKeyDirect.test.js.map