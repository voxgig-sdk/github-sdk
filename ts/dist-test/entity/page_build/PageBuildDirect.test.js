...
(0, node_test_1.describe)('PageBuildDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-page_build', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-page_build', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-page_build', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-page_build', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["owner01", "repo01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_PAGE_BUILD_ENTID'];
...
//# sourceMappingURL=PageBuildDirect.test.js.map