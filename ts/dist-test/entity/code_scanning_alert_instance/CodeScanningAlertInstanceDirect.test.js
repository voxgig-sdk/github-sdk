...
(0, node_test_1.describe)('CodeScanningAlertInstanceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-code_scanning_alert_instance', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-code_scanning_alert_instance', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CODE_SCANNING_ALERT_INSTANCE_ENTID'];
...
//# sourceMappingURL=CodeScanningAlertInstanceDirect.test.js.map