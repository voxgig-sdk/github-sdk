...
(0, node_test_1.describe)('GitignoreTemplateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-gitignore_template', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-gitignore_template', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_GITIGNORE_TEMPLATE_ENTID'];
...
//# sourceMappingURL=GitignoreTemplateDirect.test.js.map