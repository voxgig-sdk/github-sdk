...
(0, node_test_1.describe)('NetworkConfigurationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'network_configuration.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != network_configuration_ref01_data.id);
        // UPDATE
        ...
        (0, node_assert_1.default)(network_configuration_ref01_resdata_up0.id === network_configuration_ref01_data_up0.id);
        (0, node_assert_1.default)(network_configuration_ref01_resdata_up0[network_configuration_ref01_markdef_up0.name] === network_configuration_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(network_configuration_ref01_data_dt0.id === network_configuration_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/network_configuration/NetworkConfigurationTestData.json');
    ...
    let idmap = transform(['network_configuration01', 'network_configuration02', 'network_configuration03', 'org01', 'org02', 'org03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=NetworkConfigurationEntity.test.js.map