...
(0, node_test_1.describe)('NetworkConfigurationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-network_configuration', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-network_configuration', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_NETWORK_CONFIGURATION_ENTID'];
...
//# sourceMappingURL=NetworkConfigurationDirect.test.js.map