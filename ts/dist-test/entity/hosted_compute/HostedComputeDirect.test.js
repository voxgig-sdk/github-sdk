...
(0, node_test_1.describe)('HostedComputeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-hosted_compute', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-hosted_compute', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_HOSTED_COMPUTE_ENTID'];
...
//# sourceMappingURL=HostedComputeDirect.test.js.map