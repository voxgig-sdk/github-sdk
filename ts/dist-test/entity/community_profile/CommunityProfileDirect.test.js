...
(0, node_test_1.describe)('CommunityProfileDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-community_profile', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-community_profile', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_COMMUNITY_PROFILE_ENTID'];
...
//# sourceMappingURL=CommunityProfileDirect.test.js.map