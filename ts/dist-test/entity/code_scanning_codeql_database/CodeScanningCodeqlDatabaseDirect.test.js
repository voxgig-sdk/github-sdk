...
(0, node_test_1.describe)('CodeScanningCodeqlDatabaseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-code_scanning_codeql_database', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-code_scanning_codeql_database', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["language01", "owner01", "repo01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-code_scanning_codeql_database', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-code_scanning_codeql_database', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CODE_SCANNING_CODEQL_DATABASE_ENTID'];
...
//# sourceMappingURL=CodeScanningCodeqlDatabaseDirect.test.js.map