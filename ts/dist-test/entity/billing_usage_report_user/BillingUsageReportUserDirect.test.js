...
(0, node_test_1.describe)('BillingUsageReportUserDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-billing_usage_report_user', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-billing_usage_report_user', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_BILLING_USAGE_REPORT_USER_ENTID'];
...
//# sourceMappingURL=BillingUsageReportUserDirect.test.js.map