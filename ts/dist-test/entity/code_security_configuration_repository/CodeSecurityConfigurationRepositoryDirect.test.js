...
(0, node_test_1.describe)('CodeSecurityConfigurationRepositoryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-code_security_configuration_repository', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-code_security_configuration_repository', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["configuration01", "enterprise01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CODE_SECURITY_CONFIGURATION_REPOSITORY_ENTID'];
...
//# sourceMappingURL=CodeSecurityConfigurationRepositoryDirect.test.js.map