...
(0, node_test_1.describe)('ActionsCacheListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-actions_cache_list', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-actions_cache_list', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ACTIONS_CACHE_LIST_ENTID'];
...
//# sourceMappingURL=ActionsCacheListDirect.test.js.map