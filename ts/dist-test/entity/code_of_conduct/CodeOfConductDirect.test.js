...
(0, node_test_1.describe)('CodeOfConductDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-code_of_conduct', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-code_of_conduct', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["key01"]))
            return;
        ...
        if (setup.live) {
            ...
            const candidateId = listArr[0]?.key ?? listArr[0]?.id;
            if (null == candidateId) {
                return; // skip: list response shape does not expose load identifier
            }
            params.key = candidateId;
    ...
    (0, node_test_1.test)('direct-list-code_of_conduct', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-code_of_conduct', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CODE_OF_CONDUCT_ENTID'];
...
//# sourceMappingURL=CodeOfConductDirect.test.js.map