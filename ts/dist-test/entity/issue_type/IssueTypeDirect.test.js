...
(0, node_test_1.describe)('IssueTypeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-issue_type', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-issue_type', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ISSUE_TYPE_ENTID'];
...
//# sourceMappingURL=IssueTypeDirect.test.js.map