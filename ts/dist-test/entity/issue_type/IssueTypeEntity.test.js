...
(0, node_test_1.describe)('IssueTypeEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'issue_type.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != issue_type_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(issue_type_ref01_list, { id: issue_type_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(issue_type_ref01_resdata_up0.id === issue_type_ref01_data_up0.id);
        (0, node_assert_1.default)(issue_type_ref01_resdata_up0[issue_type_ref01_markdef_up0.name] === issue_type_ref01_markdef_up0.value);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/issue_type/IssueTypeTestData.json');
    ...
    let idmap = transform(['issue_type01', 'issue_type02', 'issue_type03', 'org01', 'org02', 'org03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GITHUB_TEST_ISSUE_TYPE_ENTID'];
...
//# sourceMappingURL=IssueTypeEntity.test.js.map