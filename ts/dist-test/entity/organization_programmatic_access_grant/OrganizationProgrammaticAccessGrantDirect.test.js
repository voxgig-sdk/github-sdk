...
(0, node_test_1.describe)('OrganizationProgrammaticAccessGrantDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-organization_programmatic_access_grant', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-organization_programmatic_access_grant', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ORGANIZATION_PROGRAMMATIC_ACCESS_GRANT_ENTID'];
...
//# sourceMappingURL=OrganizationProgrammaticAccessGrantDirect.test.js.map