...
(0, node_test_1.describe)('RepositoryRuleDetailedDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-repository_rule_detailed', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-repository_rule_detailed', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_REPOSITORY_RULE_DETAILED_ENTID'];
...
//# sourceMappingURL=RepositoryRuleDetailedDirect.test.js.map