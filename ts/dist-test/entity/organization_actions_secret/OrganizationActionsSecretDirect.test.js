...
(0, node_test_1.describe)('OrganizationActionsSecretDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-organization_actions_secret', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-organization_actions_secret', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_ORGANIZATION_ACTIONS_SECRET_ENTID'];
...
//# sourceMappingURL=OrganizationActionsSecretDirect.test.js.map