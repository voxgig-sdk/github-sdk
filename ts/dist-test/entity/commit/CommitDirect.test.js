...
(0, node_test_1.describe)('CommitDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-commit', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-commit', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_COMMIT_ENTID'];
