...
(0, node_test_1.describe)('ClassroomAssignmentGradeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-classroom_assignment_grade', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-classroom_assignment_grade', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_CLASSROOM_ASSIGNMENT_GRADE_ENTID'];
...
//# sourceMappingURL=ClassroomAssignmentGradeDirect.test.js.map