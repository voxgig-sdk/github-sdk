...
(0, node_test_1.describe)('ApiInsightsUserStatDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_insights_user_stat', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_insights_user_stat', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_API_INSIGHTS_USER_STAT_ENTID'];
...
//# sourceMappingURL=ApiInsightsUserStatDirect.test.js.map