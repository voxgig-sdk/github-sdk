...
(0, node_test_1.describe)('GistCommentEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'gist_comment.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != gist_comment_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(gist_comment_ref01_list, { id: gist_comment_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(gist_comment_ref01_resdata_up0.id === gist_comment_ref01_data_up0.id);
        (0, node_assert_1.default)(gist_comment_ref01_resdata_up0[gist_comment_ref01_markdef_up0.name] === gist_comment_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(gist_comment_ref01_data_dt0.id === gist_comment_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/gist_comment/GistCommentTestData.json');
    ...
    let idmap = transform(['gist_comment01', 'gist_comment02', 'gist_comment03', 'gist01', 'gist02', 'gist03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=GistCommentEntity.test.js.map