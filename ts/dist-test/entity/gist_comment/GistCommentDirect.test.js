...
(0, node_test_1.describe)('GistCommentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-gist_comment', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-gist_comment', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["gist01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-gist_comment', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-gist_comment', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["gist_comment01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_GIST_COMMENT_ENTID'];
...
//# sourceMappingURL=GistCommentDirect.test.js.map