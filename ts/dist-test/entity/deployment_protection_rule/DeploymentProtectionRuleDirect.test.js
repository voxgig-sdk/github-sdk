...
(0, node_test_1.describe)('DeploymentProtectionRuleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-deployment_protection_rule', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-deployment_protection_rule', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["environment_id01", "id01", "owner01", "repo01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_DEPLOYMENT_PROTECTION_RULE_ENTID'];
...
//# sourceMappingURL=DeploymentProtectionRuleDirect.test.js.map