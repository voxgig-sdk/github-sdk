...
(0, node_test_1.describe)('SocialAccountDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-social_account', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-social_account', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_SOCIAL_ACCOUNT_ENTID'];
...
//# sourceMappingURL=SocialAccountDirect.test.js.map