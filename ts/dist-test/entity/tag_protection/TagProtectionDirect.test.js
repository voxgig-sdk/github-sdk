...
(0, node_test_1.describe)('TagProtectionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-tag_protection', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-tag_protection', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GITHUB_TEST_TAG_PROTECTION_ENTID'];
...
//# sourceMappingURL=TagProtectionDirect.test.js.map