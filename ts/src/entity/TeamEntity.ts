...
class TeamEntity extends GithubEntityBase<Team> {
  ...
  async create(this: any, reqdata?: TeamCreateData, ctrl?: Control): Promise<TeamEntity> {
  ...
  async update(this: any, reqdata?: TeamUpdateData, ctrl?: Control): Promise<TeamEntity> {
  ...
  async remove(
    this: any, reqmatch?: TeamRemoveMatch, ctrl?: Control,
  ): Promise<TeamEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<TeamEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
