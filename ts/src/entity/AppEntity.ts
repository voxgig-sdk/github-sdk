...
class AppEntity extends GithubEntityBase<App> {
  ...
  async list(this: any, reqmatch?: AppListMatch, ctrl?: Control): Promise<AppEntity[]> {
  ...
  async create(this: any, reqdata?: AppCreateData, ctrl?: Control): Promise<AppEntity> {
  ...
  async update(this: any, reqdata?: AppUpdateData, ctrl?: Control): Promise<AppEntity> {
  ...
  async remove(
    this: any, reqmatch?: AppRemoveMatch, ctrl?: Control,
  ): Promise<AppEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<AppEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
