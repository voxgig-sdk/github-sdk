...
import type {
  ...
  EnterpriseTeamMembershipRemoveMatch,
} from '../GithubTypes'

// TODO: needs Entity superclass
class EnterpriseTeamMembershipEntity extends GithubEntityBase<EnterpriseTeamMembership> {

  constructor(client: GithubSDK, entopts: any) {
    super(client, entopts)
    this.name = 'enterprise_team_membership'
    this.name_ = 'enterprise_team_membership'
    this.Name = 'EnterpriseTeamMembership'
  }


  make(this: EnterpriseTeamMembershipEntity) {
    return new EnterpriseTeamMembershipEntity(this._client, this.entopts())
  }
  ...
  async remove(
    this: any, reqmatch?: EnterpriseTeamMembershipRemoveMatch, ctrl?: Control,
  ): Promise<EnterpriseTeamMembershipEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<EnterpriseTeamMembershipEntity> return stays clean under strict null checks.
