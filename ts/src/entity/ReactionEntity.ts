...
class ReactionEntity extends GithubEntityBase<Reaction> {
  ...
  async remove(
    this: any, reqmatch?: ReactionRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<ReactionEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
