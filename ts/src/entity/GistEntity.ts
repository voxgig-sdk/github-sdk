...
class GistEntity extends GithubEntityBase<Gist> {
  ...
  async load(this: any, reqmatch?: GistLoadMatch, ctrl?: Control): Promise<GistEntity> {
  ...
  async update(this: any, reqdata?: GistUpdateData, ctrl?: Control): Promise<GistEntity> {
  ...
  async remove(
    this: any, reqmatch?: GistRemoveMatch, ctrl?: Control,
  ): Promise<GistEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<GistEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
