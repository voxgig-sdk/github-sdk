...
class PullEntity extends GithubEntityBase<Pull> {
  ...
  async update(this: any, reqdata?: PullUpdateData, ctrl?: Control): Promise<PullEntity> {
  ...
  async remove(
    this: any, reqmatch?: PullRemoveMatch, ctrl?: Control,
  ): Promise<PullEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<PullEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
