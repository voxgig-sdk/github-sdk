...
class MigrationEntity extends GithubEntityBase<Migration> {
  ...
  async load(this: any, reqmatch?: MigrationLoadMatch, ctrl?: Control): Promise<MigrationEntity> {
  ...
  async remove(
    this: any, reqmatch?: MigrationRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<MigrationEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
