...
class IntegrationEntity extends GithubEntityBase<Integration> {
  ...
  async update(this: any, reqdata?: IntegrationUpdateData, ctrl?: Control): Promise<IntegrationEntity> {
