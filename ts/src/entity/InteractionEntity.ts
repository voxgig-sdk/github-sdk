...
class InteractionEntity extends GithubEntityBase<Interaction> {
  ...
  async load(this: any, reqmatch?: InteractionLoadMatch, ctrl?: Control): Promise<InteractionEntity> {
  ...
  async remove(
    this: any, reqmatch?: InteractionRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<InteractionEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
