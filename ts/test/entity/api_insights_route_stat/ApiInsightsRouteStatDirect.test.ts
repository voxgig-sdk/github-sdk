...
describe('ApiInsightsRouteStatDirect', async () => {
  ...
  test('direct-list-api_insights_route_stat', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-api_insights_route_stat', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUB_TEST_API_INSIGHTS_ROUTE_STAT_ENTID']
