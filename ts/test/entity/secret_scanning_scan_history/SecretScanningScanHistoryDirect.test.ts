...
describe('SecretScanningScanHistoryDirect', async () => {
  ...
  test('direct-list-secret_scanning_scan_history', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-secret_scanning_scan_history', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUB_TEST_SECRET_SCANNING_SCAN_HISTORY_ENTID']
