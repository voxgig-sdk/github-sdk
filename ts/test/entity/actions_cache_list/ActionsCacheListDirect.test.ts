...
describe('ActionsCacheListDirect', async () => {
  ...
  test('direct-list-actions_cache_list', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-actions_cache_list', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUB_TEST_ACTIONS_CACHE_LIST_ENTID']
