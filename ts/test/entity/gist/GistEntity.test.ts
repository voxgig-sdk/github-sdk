...
describe('GistEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    ;(gist_ref01_data_up0 as any)[gist_ref01_markdef_up0.name] = gist_ref01_markdef_up0.value
    ...
    assert((gist_ref01_resdata_up0 as any)[gist_ref01_markdef_up0.name] === gist_ref01_markdef_up0.value)


    // LOAD
    const gist_ref01_match_dt0: any = {}
    ...
    // REMOVE
    const gist_ref01_match_rm0: any = { id: gist_ref01_data.id }
    await gist_ref01_ent.remove(gist_ref01_match_rm0)
  

    // LIST
    const gist_ref01_match_rt0: any = {}

    const gist_ref01_list_rt0 = (await gist_ref01_ent.list(gist_ref01_match_rt0)).map((e: any) => e.data())
