...
describe('CodeScanningDefaultSetupDirect', async () => {
  ...
  test('direct-list-code_scanning_default_setup', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-code_scanning_default_setup', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUB_TEST_CODE_SCANNING_DEFAULT_SETUP_ENTID']
