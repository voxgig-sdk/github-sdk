...
describe('ActionsHostedRunnerEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create', 'update', 'load']) {
      if (maybeSkipControl(t, 'entityOp', 'actions_hosted_runner.' + op, live)) return
    }
    ...
    // UPDATE
    const actions_hosted_runner_ref01_data_up0: any = {}
    ...
    ;(actions_hosted_runner_ref01_data_up0 as any)[actions_hosted_runner_ref01_markdef_up0.name] = actions_hosted_runner_ref01_markdef_up0.value
    ...
    assert((actions_hosted_runner_ref01_resdata_up0 as any)[actions_hosted_runner_ref01_markdef_up0.name] === actions_hosted_runner_ref01_markdef_up0.value)


    // LOAD
    const actions_hosted_runner_ref01_match_dt0: any = {}
