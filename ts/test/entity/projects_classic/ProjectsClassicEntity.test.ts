...
describe('ProjectsClassicEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create', 'update', 'remove']) {
      if (maybeSkipControl(t, 'entityOp', 'projects_classic.' + op, live)) return
    }
    ...
    // UPDATE
    const projects_classic_ref01_data_up0: any = {}
    ...
    ;(projects_classic_ref01_data_up0 as any)[projects_classic_ref01_markdef_up0.name] = projects_classic_ref01_markdef_up0.value
    ...
    assert((projects_classic_ref01_resdata_up0 as any)[projects_classic_ref01_markdef_up0.name] === projects_classic_ref01_markdef_up0.value)
