...
describe('GitRefEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create', 'update', 'load']) {
      if (maybeSkipControl(t, 'entityOp', 'git_ref.' + op, live)) return
    }
    ...
    // UPDATE
    const git_ref_ref01_data_up0: any = {}
    ...
    ;(git_ref_ref01_data_up0 as any)[git_ref_ref01_markdef_up0.name] = git_ref_ref01_markdef_up0.value
    ...
    assert((git_ref_ref01_resdata_up0 as any)[git_ref_ref01_markdef_up0.name] === git_ref_ref01_markdef_up0.value)


    // LOAD
    const git_ref_ref01_match_dt0: any = {}
