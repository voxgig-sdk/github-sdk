...
describe('ThreadSubscriptionEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['update', 'load']) {
      if (maybeSkipControl(t, 'entityOp', 'thread_subscription.' + op, live)) return
    }
    ...
    let thread_subscription_ref01_data = Object.values(setup.data.existing.thread_subscription)[0] as any

    // UPDATE
    const thread_subscription_ref01_ent = client.ThreadSubscription()
    const thread_subscription_ref01_data_up0: any = {}
    ...
    ;(thread_subscription_ref01_data_up0 as any)[thread_subscription_ref01_markdef_up0.name] = thread_subscription_ref01_markdef_up0.value
    ...
    assert((thread_subscription_ref01_resdata_up0 as any)[thread_subscription_ref01_markdef_up0.name] === thread_subscription_ref01_markdef_up0.value)


    // LOAD
    const thread_subscription_ref01_match_dt0: any = {}
