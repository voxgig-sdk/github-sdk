...
describe('PullEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    ;(pull_ref01_data_up0 as any)[pull_ref01_markdef_up0.name] = pull_ref01_markdef_up0.value
    ...
    assert((pull_ref01_resdata_up0 as any)[pull_ref01_markdef_up0.name] === pull_ref01_markdef_up0.value)
