...
describe('ProjectsV2ItemWithContentEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list', 'update', 'load']) {
      if (maybeSkipControl(t, 'entityOp', 'projects_v2_item_with_content.' + op, live)) return
    }
    ...
    let projects_v2_item_with_content_ref01_data = Object.values(setup.data.existing.projects_v2_item_with_content)[0] as any

    // LIST
    const projects_v2_item_with_content_ref01_ent = client.ProjectsV2ItemWithContent()
    const projects_v2_item_with_content_ref01_match: any = {}
    ...
    const projects_v2_item_with_content_ref01_list = (await projects_v2_item_with_content_ref01_ent.list(projects_v2_item_with_content_ref01_match)).map((e: any) => e.data())


    // UPDATE
    const projects_v2_item_with_content_ref01_data_up0: any = {}
    ...
    ;(projects_v2_item_with_content_ref01_data_up0 as any)[projects_v2_item_with_content_ref01_markdef_up0.name] = projects_v2_item_with_content_ref01_markdef_up0.value
    ...
    assert((projects_v2_item_with_content_ref01_resdata_up0 as any)[projects_v2_item_with_content_ref01_markdef_up0.name] === projects_v2_item_with_content_ref01_markdef_up0.value)


    // LOAD
    const projects_v2_item_with_content_ref01_match_dt0: any = {}
