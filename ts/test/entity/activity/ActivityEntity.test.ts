...
describe('ActivityEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    // UPDATE
    const activity_ref01_data_up0: any = {}
    ...
    ;(activity_ref01_data_up0 as any)[activity_ref01_markdef_up0.name] = activity_ref01_markdef_up0.value

    const activity_ref01_resdata_up0 = (await activity_ref01_ent.update(activity_ref01_data_up0)).data()
    assert(activity_ref01_resdata_up0.id === activity_ref01_data_up0.id)

    assert((activity_ref01_resdata_up0 as any)[activity_ref01_markdef_up0.name] === activity_ref01_markdef_up0.value)
...
function basicSetup(extra?: any) {
  ...
  let idmap = transform(
    ['activity01','activity02','activity03','thread01','thread02','thread03','repo01','repo02','repo03','starred01','starred02','starred03','user01','user02','user03'],
    {
      '`$PACK`': ['', {
        '`$KEY`': '`$COPY`',
