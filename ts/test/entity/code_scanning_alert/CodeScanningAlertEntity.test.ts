...
describe('CodeScanningAlertEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['update', 'load']) {
      if (maybeSkipControl(t, 'entityOp', 'code_scanning_alert.' + op, live)) return
    }
    ...
    let code_scanning_alert_ref01_data = Object.values(setup.data.existing.code_scanning_alert)[0] as any

    // UPDATE
    const code_scanning_alert_ref01_ent = client.CodeScanningAlert()
    const code_scanning_alert_ref01_data_up0: any = {}
    ...
    ;(code_scanning_alert_ref01_data_up0 as any)[code_scanning_alert_ref01_markdef_up0.name] = code_scanning_alert_ref01_markdef_up0.value
    ...
    assert((code_scanning_alert_ref01_resdata_up0 as any)[code_scanning_alert_ref01_markdef_up0.name] === code_scanning_alert_ref01_markdef_up0.value)


    // LOAD
    const code_scanning_alert_ref01_match_dt0: any = {}
