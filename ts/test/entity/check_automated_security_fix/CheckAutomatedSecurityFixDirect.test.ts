...
describe('CheckAutomatedSecurityFixDirect', async () => {
  ...
  test('direct-load-check_automated_security_fix', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-check_automated_security_fix', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUB_TEST_CHECK_AUTOMATED_SECURITY_FIX_ENTID']
