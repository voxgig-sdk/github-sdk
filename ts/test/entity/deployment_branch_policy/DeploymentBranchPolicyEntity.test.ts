...
describe('DeploymentBranchPolicyEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create', 'update', 'load']) {
      if (maybeSkipControl(t, 'entityOp', 'deployment_branch_policy.' + op, live)) return
    }
    ...
    // UPDATE
    const deployment_branch_policy_ref01_data_up0: any = {}
    ...
    ;(deployment_branch_policy_ref01_data_up0 as any)[deployment_branch_policy_ref01_markdef_up0.name] = deployment_branch_policy_ref01_markdef_up0.value
    ...
    assert((deployment_branch_policy_ref01_resdata_up0 as any)[deployment_branch_policy_ref01_markdef_up0.name] === deployment_branch_policy_ref01_markdef_up0.value)


    // LOAD
    const deployment_branch_policy_ref01_match_dt0: any = {}
