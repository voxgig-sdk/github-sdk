...
describe('ShortBranchDirect', async () => {
  ...
  test('direct-list-short_branch', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-short_branch', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUB_TEST_SHORT_BRANCH_ENTID']
