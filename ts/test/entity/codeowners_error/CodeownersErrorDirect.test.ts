...
describe('CodeownersErrorDirect', async () => {
  ...
  test('direct-list-codeowners_error', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-codeowners_error', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUB_TEST_CODEOWNERS_ERROR_ENTID']
