...
describe('ActionsForkPrContributorApprovalDirect', async () => {
  ...
  test('direct-load-actions_fork_pr_contributor_approval', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-actions_fork_pr_contributor_approval', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUB_TEST_ACTIONS_FORK_PR_CONTRIBUTOR_APPROVAL_ENTID']
