...
describe('RunnerApplicationDirect', async () => {
  ...
  test('direct-list-runner_application', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-runner_application', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUB_TEST_RUNNER_APPLICATION_ENTID']
