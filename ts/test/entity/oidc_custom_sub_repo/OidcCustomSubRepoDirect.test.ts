...
describe('OidcCustomSubRepoDirect', async () => {
  ...
  test('direct-list-oidc_custom_sub_repo', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-oidc_custom_sub_repo', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUB_TEST_OIDC_CUSTOM_SUB_REPO_ENTID']
