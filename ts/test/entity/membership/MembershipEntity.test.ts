...
describe('MembershipEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    ;(membership_ref01_data_up0 as any)[membership_ref01_markdef_up0.name] = membership_ref01_markdef_up0.value
    ...
    assert((membership_ref01_resdata_up0 as any)[membership_ref01_markdef_up0.name] === membership_ref01_markdef_up0.value)
