...
describe('BillingUsageReportUserDirect', async () => {
  ...
  test('direct-list-billing_usage_report_user', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-billing_usage_report_user', setup.live)) return
