...
describe('CodeFrequencyDirect', async () => {
  ...
  test('direct-list-code_frequency', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-code_frequency', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUB_TEST_CODE_FREQUENCY_ENTID']
