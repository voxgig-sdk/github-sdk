...
describe('SelectedActionDirect', async () => {
  ...
  test('direct-list-selected_action', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-selected_action', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUB_TEST_SELECTED_ACTION_ENTID']
