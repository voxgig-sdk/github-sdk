...
describe('PullRequestReviewCommentEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create', 'list', 'update', 'load']) {
      if (maybeSkipControl(t, 'entityOp', 'pull_request_review_comment.' + op, live)) return
    }
    ...
    // LIST
    const pull_request_review_comment_ref01_match: any = {}
    ...
    const pull_request_review_comment_ref01_list = (await pull_request_review_comment_ref01_ent.list(pull_request_review_comment_ref01_match)).map((e: any) => e.data())

    assert(!isempty(select(pull_request_review_comment_ref01_list, { id: pull_request_review_comment_ref01_data.id })))


    // UPDATE
    const pull_request_review_comment_ref01_data_up0: any = {}
    ...
    ;(pull_request_review_comment_ref01_data_up0 as any)[pull_request_review_comment_ref01_markdef_up0.name] = pull_request_review_comment_ref01_markdef_up0.value
    ...
    assert((pull_request_review_comment_ref01_resdata_up0 as any)[pull_request_review_comment_ref01_markdef_up0.name] === pull_request_review_comment_ref01_markdef_up0.value)


    // LOAD
    const pull_request_review_comment_ref01_match_dt0: any = {}
