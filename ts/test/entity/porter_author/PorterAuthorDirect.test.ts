...
describe('PorterAuthorDirect', async () => {
  ...
  test('direct-list-porter_author', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-porter_author', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUB_TEST_PORTER_AUTHOR_ENTID']
