...
describe('OrgMembershipEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['update', 'load']) {
      if (maybeSkipControl(t, 'entityOp', 'org_membership.' + op, live)) return
    }
    ...
    let org_membership_ref01_data = Object.values(setup.data.existing.org_membership)[0] as any

    // UPDATE
    const org_membership_ref01_ent = client.OrgMembership()
    const org_membership_ref01_data_up0: any = {}
    ...
    ;(org_membership_ref01_data_up0 as any)[org_membership_ref01_markdef_up0.name] = org_membership_ref01_markdef_up0.value
    ...
    assert((org_membership_ref01_resdata_up0 as any)[org_membership_ref01_markdef_up0.name] === org_membership_ref01_markdef_up0.value)


    // LOAD
    const org_membership_ref01_match_dt0: any = {}
