...
describe('PorterLargeFileDirect', async () => {
  ...
  test('direct-list-porter_large_file', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-porter_large_file', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUB_TEST_PORTER_LARGE_FILE_ENTID']
