...
describe('ReleaseAssetEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create', 'list', 'update', 'load']) {
      if (maybeSkipControl(t, 'entityOp', 'release_asset.' + op, live)) return
    }
    ...
    // LIST
    const release_asset_ref01_match: any = {}
    ...
    const release_asset_ref01_list = (await release_asset_ref01_ent.list(release_asset_ref01_match)).map((e: any) => e.data())

    assert(!isempty(select(release_asset_ref01_list, { id: release_asset_ref01_data.id })))


    // UPDATE
    const release_asset_ref01_data_up0: any = {}
    ...
    ;(release_asset_ref01_data_up0 as any)[release_asset_ref01_markdef_up0.name] = release_asset_ref01_markdef_up0.value
    ...
    assert((release_asset_ref01_resdata_up0 as any)[release_asset_ref01_markdef_up0.name] === release_asset_ref01_markdef_up0.value)


    // LOAD
    const release_asset_ref01_match_dt0: any = {}
