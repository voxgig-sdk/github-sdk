...
describe('TagProtectionDirect', async () => {
  ...
  test('direct-list-tag_protection', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-tag_protection', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUB_TEST_TAG_PROTECTION_ENTID']
