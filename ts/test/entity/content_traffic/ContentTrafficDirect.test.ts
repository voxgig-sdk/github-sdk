...
describe('ContentTrafficDirect', async () => {
  ...
  test('direct-list-content_traffic', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-content_traffic', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUB_TEST_CONTENT_TRAFFIC_ENTID']
