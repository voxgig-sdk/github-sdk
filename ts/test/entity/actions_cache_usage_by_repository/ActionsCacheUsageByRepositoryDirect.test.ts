...
describe('ActionsCacheUsageByRepositoryDirect', async () => {
  ...
  test('direct-load-actions_cache_usage_by_repository', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-actions_cache_usage_by_repository', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUB_TEST_ACTIONS_CACHE_USAGE_BY_REPOSITORY_ENTID']
