...
local ReleaseAssetEntity = {}
ReleaseAssetEntity.__index = ReleaseAssetEntity


function ReleaseAssetEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ReleaseAssetEntity)
  self._name = "release_asset"
  self._client = client
...
function ReleaseAssetEntity:get_name()
  return self._name
end


function ReleaseAssetEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ReleaseAssetEntity.new(self._client, opts)
end
...
function ReleaseAssetEntity:mark_deleted()
  self._deleted = true
end


function ReleaseAssetEntity:deleted()
  return true == self._deleted
end


function ReleaseAssetEntity:data_set(args)
  if args ~= nil then
...
function ReleaseAssetEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ReleaseAssetEntity:match_set(args)
  if args ~= nil then
...
function ReleaseAssetEntity:match_get()
...
function ReleaseAssetEntity:stream(action, args, callopts)
...
---@param reqmatch ReleaseAssetLoadMatch
---@param ctrl? table
---@return ReleaseAsset
---@return string? err
function ReleaseAssetEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ReleaseAssetListMatch
---@param ctrl? table
---@return ReleaseAsset[]
---@return string? err
function ReleaseAssetEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ReleaseAssetCreateData
---@param ctrl? table
---@return ReleaseAsset
---@return string? err
function ReleaseAssetEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ReleaseAssetUpdateData
---@param ctrl? table
---@return ReleaseAsset
---@return string? err
function ReleaseAssetEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ReleaseAssetEntity:_run_op(ctx, post_done)
  local utility = self._utility
