...
local MinimalRepositoryEntity = {}
MinimalRepositoryEntity.__index = MinimalRepositoryEntity


function MinimalRepositoryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MinimalRepositoryEntity)
  self._name = "minimal_repository"
  self._client = client
...
function MinimalRepositoryEntity:get_name()
  return self._name
end


function MinimalRepositoryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MinimalRepositoryEntity.new(self._client, opts)
end
...
function MinimalRepositoryEntity:mark_deleted()
  self._deleted = true
end


function MinimalRepositoryEntity:deleted()
  return true == self._deleted
end


function MinimalRepositoryEntity:data_set(args)
  if args ~= nil then
...
function MinimalRepositoryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MinimalRepositoryEntity:match_set(args)
  if args ~= nil then
...
function MinimalRepositoryEntity:match_get()
...
function MinimalRepositoryEntity:stream(action, args, callopts)
...
---@param reqmatch MinimalRepositoryListMatch
---@param ctrl? table
---@return MinimalRepository[]
---@return string? err
function MinimalRepositoryEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function MinimalRepositoryEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MinimalRepositoryEntity
