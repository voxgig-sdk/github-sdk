...
local RulesetVersionEntity = {}
RulesetVersionEntity.__index = RulesetVersionEntity


function RulesetVersionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RulesetVersionEntity)
  self._name = "ruleset_version"
  self._client = client
...
function RulesetVersionEntity:get_name()
  return self._name
end


function RulesetVersionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RulesetVersionEntity.new(self._client, opts)
end
...
function RulesetVersionEntity:mark_deleted()
  self._deleted = true
end


function RulesetVersionEntity:deleted()
  return true == self._deleted
end


function RulesetVersionEntity:data_set(args)
  if args ~= nil then
...
function RulesetVersionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RulesetVersionEntity:match_set(args)
  if args ~= nil then
...
function RulesetVersionEntity:match_get()
...
function RulesetVersionEntity:stream(action, args, callopts)
...
---@param reqmatch RulesetVersionListMatch
---@param ctrl? table
---@return RulesetVersion[]
---@return string? err
function RulesetVersionEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function RulesetVersionEntity:_run_op(ctx, post_done)
  local utility = self._utility
