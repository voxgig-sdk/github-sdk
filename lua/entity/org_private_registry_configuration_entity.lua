-- Github SDK OrgPrivateRegistryConfiguration entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local OrgPrivateRegistryConfigurationEntity = {}
OrgPrivateRegistryConfigurationEntity.__index = OrgPrivateRegistryConfigurationEntity


function OrgPrivateRegistryConfigurationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrgPrivateRegistryConfigurationEntity)
  self._name = "org_private_registry_configuration"
  self._client = client
...
function OrgPrivateRegistryConfigurationEntity:get_name()
  return self._name
end


function OrgPrivateRegistryConfigurationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrgPrivateRegistryConfigurationEntity.new(self._client, opts)
end
...
function OrgPrivateRegistryConfigurationEntity:mark_deleted()
  self._deleted = true
end


function OrgPrivateRegistryConfigurationEntity:deleted()
  return true == self._deleted
end


function OrgPrivateRegistryConfigurationEntity:data_set(args)
  if args ~= nil then
...
function OrgPrivateRegistryConfigurationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrgPrivateRegistryConfigurationEntity:match_set(args)
  if args ~= nil then
...
function OrgPrivateRegistryConfigurationEntity:match_get()
...
function OrgPrivateRegistryConfigurationEntity:stream(action, args, callopts)
...
---@param reqmatch OrgPrivateRegistryConfigurationLoadMatch
---@param ctrl? table
---@return OrgPrivateRegistryConfiguration
---@return string? err
function OrgPrivateRegistryConfigurationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function OrgPrivateRegistryConfigurationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrgPrivateRegistryConfigurationEntity
