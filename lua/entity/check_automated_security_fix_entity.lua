-- Github SDK CheckAutomatedSecurityFix entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CheckAutomatedSecurityFixEntity = {}
CheckAutomatedSecurityFixEntity.__index = CheckAutomatedSecurityFixEntity


function CheckAutomatedSecurityFixEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CheckAutomatedSecurityFixEntity)
  self._name = "check_automated_security_fix"
  self._client = client
...
function CheckAutomatedSecurityFixEntity:get_name()
  return self._name
end


function CheckAutomatedSecurityFixEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CheckAutomatedSecurityFixEntity.new(self._client, opts)
end
...
function CheckAutomatedSecurityFixEntity:mark_deleted()
  self._deleted = true
end


function CheckAutomatedSecurityFixEntity:deleted()
  return true == self._deleted
end


function CheckAutomatedSecurityFixEntity:data_set(args)
  if args ~= nil then
...
function CheckAutomatedSecurityFixEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CheckAutomatedSecurityFixEntity:match_set(args)
  if args ~= nil then
...
function CheckAutomatedSecurityFixEntity:match_get()
...
function CheckAutomatedSecurityFixEntity:stream(action, args, callopts)
...
---@param reqmatch CheckAutomatedSecurityFixLoadMatch
---@param ctrl? table
---@return CheckAutomatedSecurityFix
---@return string? err
function CheckAutomatedSecurityFixEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function CheckAutomatedSecurityFixEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CheckAutomatedSecurityFixEntity
