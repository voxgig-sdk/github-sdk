...
local PageBuildEntity = {}
PageBuildEntity.__index = PageBuildEntity


function PageBuildEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PageBuildEntity)
  self._name = "page_build"
  self._client = client
...
function PageBuildEntity:get_name()
  return self._name
end


function PageBuildEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PageBuildEntity.new(self._client, opts)
end
...
function PageBuildEntity:mark_deleted()
  self._deleted = true
end


function PageBuildEntity:deleted()
  return true == self._deleted
end


function PageBuildEntity:data_set(args)
  if args ~= nil then
...
function PageBuildEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PageBuildEntity:match_set(args)
  if args ~= nil then
...
function PageBuildEntity:match_get()
...
function PageBuildEntity:stream(action, args, callopts)
...
---@param reqmatch PageBuildLoadMatch
---@param ctrl? table
---@return PageBuild
---@return string? err
function PageBuildEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PageBuildListMatch
---@param ctrl? table
---@return PageBuild[]
---@return string? err
function PageBuildEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function PageBuildEntity:_run_op(ctx, post_done)
  local utility = self._utility
