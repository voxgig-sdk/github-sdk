...
local GitignoreTemplateEntity = {}
GitignoreTemplateEntity.__index = GitignoreTemplateEntity


function GitignoreTemplateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GitignoreTemplateEntity)
  self._name = "gitignore_template"
  self._client = client
...
function GitignoreTemplateEntity:get_name()
  return self._name
end


function GitignoreTemplateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GitignoreTemplateEntity.new(self._client, opts)
end
...
function GitignoreTemplateEntity:mark_deleted()
  self._deleted = true
end


function GitignoreTemplateEntity:deleted()
  return true == self._deleted
end


function GitignoreTemplateEntity:data_set(args)
  if args ~= nil then
...
function GitignoreTemplateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GitignoreTemplateEntity:match_set(args)
  if args ~= nil then
...
function GitignoreTemplateEntity:match_get()
...
function GitignoreTemplateEntity:stream(action, args, callopts)
...
---@param reqmatch GitignoreTemplateLoadMatch
---@param ctrl? table
---@return GitignoreTemplate
---@return string? err
function GitignoreTemplateEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GitignoreTemplateEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GitignoreTemplateEntity
