...
local PageBuildStatusEntity = {}
PageBuildStatusEntity.__index = PageBuildStatusEntity


function PageBuildStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PageBuildStatusEntity)
  self._name = "page_build_status"
  self._client = client
...
function PageBuildStatusEntity:get_name()
  return self._name
end


function PageBuildStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PageBuildStatusEntity.new(self._client, opts)
end
...
function PageBuildStatusEntity:mark_deleted()
  self._deleted = true
end


function PageBuildStatusEntity:deleted()
  return true == self._deleted
end


function PageBuildStatusEntity:data_set(args)
  if args ~= nil then
...
function PageBuildStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PageBuildStatusEntity:match_set(args)
  if args ~= nil then
...
function PageBuildStatusEntity:match_get()
...
function PageBuildStatusEntity:stream(action, args, callopts)
...
---@param reqdata PageBuildStatusCreateData
---@param ctrl? table
---@return PageBuildStatus
---@return string? err
function PageBuildStatusEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function PageBuildStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
