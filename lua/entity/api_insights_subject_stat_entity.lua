-- Github SDK ApiInsightsSubjectStat entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiInsightsSubjectStatEntity = {}
ApiInsightsSubjectStatEntity.__index = ApiInsightsSubjectStatEntity


function ApiInsightsSubjectStatEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiInsightsSubjectStatEntity)
  self._name = "api_insights_subject_stat"
  self._client = client
...
function ApiInsightsSubjectStatEntity:get_name()
  return self._name
end


function ApiInsightsSubjectStatEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiInsightsSubjectStatEntity.new(self._client, opts)
end
...
function ApiInsightsSubjectStatEntity:mark_deleted()
  self._deleted = true
end


function ApiInsightsSubjectStatEntity:deleted()
  return true == self._deleted
end


function ApiInsightsSubjectStatEntity:data_set(args)
  if args ~= nil then
...
function ApiInsightsSubjectStatEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiInsightsSubjectStatEntity:match_set(args)
  if args ~= nil then
...
function ApiInsightsSubjectStatEntity:match_get()
...
function ApiInsightsSubjectStatEntity:stream(action, args, callopts)
...
---@param reqmatch ApiInsightsSubjectStatListMatch
---@param ctrl? table
---@return ApiInsightsSubjectStat[]
---@return string? err
function ApiInsightsSubjectStatEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiInsightsSubjectStatEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiInsightsSubjectStatEntity
