...
local DependencyGraphSpdxSbomEntity = {}
DependencyGraphSpdxSbomEntity.__index = DependencyGraphSpdxSbomEntity


function DependencyGraphSpdxSbomEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DependencyGraphSpdxSbomEntity)
  self._name = "dependency_graph_spdx_sbom"
  self._client = client
...
function DependencyGraphSpdxSbomEntity:get_name()
  return self._name
end


function DependencyGraphSpdxSbomEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DependencyGraphSpdxSbomEntity.new(self._client, opts)
end
...
function DependencyGraphSpdxSbomEntity:mark_deleted()
  self._deleted = true
end


function DependencyGraphSpdxSbomEntity:deleted()
  return true == self._deleted
end


function DependencyGraphSpdxSbomEntity:data_set(args)
  if args ~= nil then
...
function DependencyGraphSpdxSbomEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DependencyGraphSpdxSbomEntity:match_set(args)
  if args ~= nil then
...
function DependencyGraphSpdxSbomEntity:match_get()
...
function DependencyGraphSpdxSbomEntity:stream(action, args, callopts)
...
---@param reqmatch DependencyGraphSpdxSbomLoadMatch
---@param ctrl? table
---@return DependencyGraphSpdxSbom
---@return string? err
function DependencyGraphSpdxSbomEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function DependencyGraphSpdxSbomEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DependencyGraphSpdxSbomEntity
