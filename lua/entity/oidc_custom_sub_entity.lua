...
local OidcCustomSubEntity = {}
OidcCustomSubEntity.__index = OidcCustomSubEntity


function OidcCustomSubEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OidcCustomSubEntity)
  self._name = "oidc_custom_sub"
  self._client = client
...
function OidcCustomSubEntity:get_name()
  return self._name
end


function OidcCustomSubEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OidcCustomSubEntity.new(self._client, opts)
end
...
function OidcCustomSubEntity:mark_deleted()
  self._deleted = true
end


function OidcCustomSubEntity:deleted()
  return true == self._deleted
end


function OidcCustomSubEntity:data_set(args)
  if args ~= nil then
...
function OidcCustomSubEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OidcCustomSubEntity:match_set(args)
  if args ~= nil then
...
function OidcCustomSubEntity:match_get()
...
function OidcCustomSubEntity:stream(action, args, callopts)
...
---@param reqmatch OidcCustomSubListMatch
---@param ctrl? table
---@return OidcCustomSub[]
---@return string? err
function OidcCustomSubEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function OidcCustomSubEntity:_run_op(ctx, post_done)
  local utility = self._utility
