...
local SimpleClassroomAssignmentEntity = {}
SimpleClassroomAssignmentEntity.__index = SimpleClassroomAssignmentEntity


function SimpleClassroomAssignmentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SimpleClassroomAssignmentEntity)
  self._name = "simple_classroom_assignment"
  self._client = client
...
function SimpleClassroomAssignmentEntity:get_name()
  return self._name
end


function SimpleClassroomAssignmentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SimpleClassroomAssignmentEntity.new(self._client, opts)
end
...
function SimpleClassroomAssignmentEntity:mark_deleted()
  self._deleted = true
end


function SimpleClassroomAssignmentEntity:deleted()
  return true == self._deleted
end


function SimpleClassroomAssignmentEntity:data_set(args)
  if args ~= nil then
...
function SimpleClassroomAssignmentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SimpleClassroomAssignmentEntity:match_set(args)
  if args ~= nil then
...
function SimpleClassroomAssignmentEntity:match_get()
...
function SimpleClassroomAssignmentEntity:stream(action, args, callopts)
...
---@param reqmatch SimpleClassroomAssignmentListMatch
---@param ctrl? table
---@return SimpleClassroomAssignment[]
---@return string? err
function SimpleClassroomAssignmentEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function SimpleClassroomAssignmentEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SimpleClassroomAssignmentEntity
