...
local CodespaceEntity = {}
CodespaceEntity.__index = CodespaceEntity


function CodespaceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CodespaceEntity)
  self._name = "codespace"
  self._client = client
...
function CodespaceEntity:get_name()
  return self._name
end


function CodespaceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CodespaceEntity.new(self._client, opts)
end
...
function CodespaceEntity:mark_deleted()
  self._deleted = true
end


function CodespaceEntity:deleted()
  return true == self._deleted
end


function CodespaceEntity:data_set(args)
  if args ~= nil then
...
function CodespaceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CodespaceEntity:match_set(args)
  if args ~= nil then
...
function CodespaceEntity:match_get()
...
function CodespaceEntity:stream(action, args, callopts)
...
---@param reqmatch CodespaceLoadMatch
---@param ctrl? table
---@return Codespace
---@return string? err
function CodespaceEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch CodespaceListMatch
---@param ctrl? table
---@return Codespace[]
---@return string? err
function CodespaceEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata CodespaceCreateData
---@param ctrl? table
---@return Codespace
---@return string? err
function CodespaceEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata CodespaceUpdateData
---@param ctrl? table
---@return Codespace
---@return string? err
function CodespaceEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch CodespaceRemoveMatch
---@param ctrl? table
---@return Codespace
---@return string? err
function CodespaceEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function CodespaceEntity:_run_op(ctx, post_done)
  local utility = self._utility
