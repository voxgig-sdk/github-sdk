-- Github SDK OrgPrivateRegistryConfigurationWithSelectedRepository entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity = {}
OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity.__index = OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity


function OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity)
  self._name = "org_private_registry_configuration_with_selected_repository"
  self._client = client
...
function OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity:get_name()
  return self._name
end


function OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity.new(self._client, opts)
end
...
function OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity:mark_deleted()
  self._deleted = true
end


function OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity:deleted()
  return true == self._deleted
end


function OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity:data_set(args)
  if args ~= nil then
...
function OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity:match_set(args)
  if args ~= nil then
...
function OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity:match_get()
...
function OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity:stream(action, args, callopts)
...
---@param reqdata OrgPrivateRegistryConfigurationWithSelectedRepositoryCreateData
---@param ctrl? table
---@return OrgPrivateRegistryConfigurationWithSelectedRepository
---@return string? err
function OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity
