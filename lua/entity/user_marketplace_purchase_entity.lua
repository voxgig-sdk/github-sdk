...
local UserMarketplacePurchaseEntity = {}
UserMarketplacePurchaseEntity.__index = UserMarketplacePurchaseEntity


function UserMarketplacePurchaseEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UserMarketplacePurchaseEntity)
  self._name = "user_marketplace_purchase"
  self._client = client
...
function UserMarketplacePurchaseEntity:get_name()
  return self._name
end


function UserMarketplacePurchaseEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UserMarketplacePurchaseEntity.new(self._client, opts)
end
...
function UserMarketplacePurchaseEntity:mark_deleted()
  self._deleted = true
end


function UserMarketplacePurchaseEntity:deleted()
  return true == self._deleted
end


function UserMarketplacePurchaseEntity:data_set(args)
  if args ~= nil then
...
function UserMarketplacePurchaseEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UserMarketplacePurchaseEntity:match_set(args)
  if args ~= nil then
...
function UserMarketplacePurchaseEntity:match_get()
...
function UserMarketplacePurchaseEntity:stream(action, args, callopts)
...
---@param reqmatch UserMarketplacePurchaseListMatch
---@param ctrl? table
---@return UserMarketplacePurchase[]
---@return string? err
function UserMarketplacePurchaseEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function UserMarketplacePurchaseEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return UserMarketplacePurchaseEntity
