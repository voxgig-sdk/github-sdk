...
local ActionsCacheListEntity = {}
ActionsCacheListEntity.__index = ActionsCacheListEntity


function ActionsCacheListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ActionsCacheListEntity)
  self._name = "actions_cache_list"
  self._client = client
...
function ActionsCacheListEntity:get_name()
  return self._name
end


function ActionsCacheListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ActionsCacheListEntity.new(self._client, opts)
end
...
function ActionsCacheListEntity:mark_deleted()
  self._deleted = true
end


function ActionsCacheListEntity:deleted()
  return true == self._deleted
end


function ActionsCacheListEntity:data_set(args)
  if args ~= nil then
...
function ActionsCacheListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ActionsCacheListEntity:match_set(args)
  if args ~= nil then
...
function ActionsCacheListEntity:match_get()
...
function ActionsCacheListEntity:stream(action, args, callopts)
...
---@param reqmatch ActionsCacheListListMatch
---@param ctrl? table
---@return ActionsCacheList[]
---@return string? err
function ActionsCacheListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ActionsCacheListRemoveMatch
---@param ctrl? table
---@return ActionsCacheList
---@return string? err
function ActionsCacheListEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ActionsCacheListEntity:_run_op(ctx, post_done)
  local utility = self._utility
