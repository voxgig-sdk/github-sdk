...
---@param reqmatch CampaignLoadMatch
---@param ctrl? table
---@return Campaign
---@return string? err
function CampaignEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch CampaignListMatch
---@param ctrl? table
---@return Campaign[]
---@return string? err
function CampaignEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata CampaignCreateData
---@param ctrl? table
---@return Campaign
---@return string? err
function CampaignEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata CampaignUpdateData
---@param ctrl? table
---@return Campaign
---@return string? err
function CampaignEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch CampaignRemoveMatch
---@param ctrl? table
---@return Campaign
---@return string? err
function CampaignEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
