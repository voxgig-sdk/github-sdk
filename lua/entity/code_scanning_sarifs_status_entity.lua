...
local CodeScanningSarifsStatusEntity = {}
CodeScanningSarifsStatusEntity.__index = CodeScanningSarifsStatusEntity


function CodeScanningSarifsStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CodeScanningSarifsStatusEntity)
  self._name = "code_scanning_sarifs_status"
  self._client = client
...
function CodeScanningSarifsStatusEntity:get_name()
  return self._name
end


function CodeScanningSarifsStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CodeScanningSarifsStatusEntity.new(self._client, opts)
end
...
function CodeScanningSarifsStatusEntity:mark_deleted()
  self._deleted = true
end


function CodeScanningSarifsStatusEntity:deleted()
  return true == self._deleted
end


function CodeScanningSarifsStatusEntity:data_set(args)
  if args ~= nil then
...
function CodeScanningSarifsStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CodeScanningSarifsStatusEntity:match_set(args)
  if args ~= nil then
...
function CodeScanningSarifsStatusEntity:match_get()
...
function CodeScanningSarifsStatusEntity:stream(action, args, callopts)
...
---@param reqmatch CodeScanningSarifsStatusLoadMatch
---@param ctrl? table
---@return CodeScanningSarifsStatus
---@return string? err
function CodeScanningSarifsStatusEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function CodeScanningSarifsStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CodeScanningSarifsStatusEntity
