...
local EnterpriseTeamMembershipEntity = {}
EnterpriseTeamMembershipEntity.__index = EnterpriseTeamMembershipEntity


function EnterpriseTeamMembershipEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EnterpriseTeamMembershipEntity)
  self._name = "enterprise_team_membership"
  self._client = client
...
function EnterpriseTeamMembershipEntity:get_name()
  return self._name
end


function EnterpriseTeamMembershipEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EnterpriseTeamMembershipEntity.new(self._client, opts)
end
...
function EnterpriseTeamMembershipEntity:mark_deleted()
  self._deleted = true
end


function EnterpriseTeamMembershipEntity:deleted()
  return true == self._deleted
end


function EnterpriseTeamMembershipEntity:data_set(args)
  if args ~= nil then
...
function EnterpriseTeamMembershipEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EnterpriseTeamMembershipEntity:match_set(args)
  if args ~= nil then
...
function EnterpriseTeamMembershipEntity:match_get()
...
function EnterpriseTeamMembershipEntity:stream(action, args, callopts)
...
---@param reqmatch EnterpriseTeamMembershipRemoveMatch
---@param ctrl? table
---@return EnterpriseTeamMembership
---@return string? err
function EnterpriseTeamMembershipEntity:remove(reqmatch, ctrl)
  local utility = self._utility
...
function EnterpriseTeamMembershipEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EnterpriseTeamMembershipEntity
