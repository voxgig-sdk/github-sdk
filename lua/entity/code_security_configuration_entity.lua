...
local CodeSecurityConfigurationEntity = {}
CodeSecurityConfigurationEntity.__index = CodeSecurityConfigurationEntity


function CodeSecurityConfigurationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CodeSecurityConfigurationEntity)
  self._name = "code_security_configuration"
  self._client = client
...
function CodeSecurityConfigurationEntity:get_name()
  return self._name
end


function CodeSecurityConfigurationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CodeSecurityConfigurationEntity.new(self._client, opts)
end
...
function CodeSecurityConfigurationEntity:mark_deleted()
  self._deleted = true
end


function CodeSecurityConfigurationEntity:deleted()
  return true == self._deleted
end


function CodeSecurityConfigurationEntity:data_set(args)
  if args ~= nil then
...
function CodeSecurityConfigurationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CodeSecurityConfigurationEntity:match_set(args)
  if args ~= nil then
...
function CodeSecurityConfigurationEntity:match_get()
...
function CodeSecurityConfigurationEntity:stream(action, args, callopts)
...
---@param reqmatch CodeSecurityConfigurationLoadMatch
---@param ctrl? table
---@return CodeSecurityConfiguration
---@return string? err
function CodeSecurityConfigurationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch CodeSecurityConfigurationListMatch
---@param ctrl? table
---@return CodeSecurityConfiguration[]
---@return string? err
function CodeSecurityConfigurationEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata CodeSecurityConfigurationCreateData
---@param ctrl? table
---@return CodeSecurityConfiguration
---@return string? err
function CodeSecurityConfigurationEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata CodeSecurityConfigurationUpdateData
---@param ctrl? table
---@return CodeSecurityConfiguration
---@return string? err
function CodeSecurityConfigurationEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function CodeSecurityConfigurationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CodeSecurityConfigurationEntity
