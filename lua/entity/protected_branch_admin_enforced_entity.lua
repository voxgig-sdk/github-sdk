...
local ProtectedBranchAdminEnforcedEntity = {}
ProtectedBranchAdminEnforcedEntity.__index = ProtectedBranchAdminEnforcedEntity


function ProtectedBranchAdminEnforcedEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ProtectedBranchAdminEnforcedEntity)
  self._name = "protected_branch_admin_enforced"
  self._client = client
...
function ProtectedBranchAdminEnforcedEntity:get_name()
  return self._name
end


function ProtectedBranchAdminEnforcedEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ProtectedBranchAdminEnforcedEntity.new(self._client, opts)
end
...
function ProtectedBranchAdminEnforcedEntity:mark_deleted()
  self._deleted = true
end


function ProtectedBranchAdminEnforcedEntity:deleted()
  return true == self._deleted
end


function ProtectedBranchAdminEnforcedEntity:data_set(args)
  if args ~= nil then
...
function ProtectedBranchAdminEnforcedEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ProtectedBranchAdminEnforcedEntity:match_set(args)
  if args ~= nil then
...
function ProtectedBranchAdminEnforcedEntity:match_get()
...
function ProtectedBranchAdminEnforcedEntity:stream(action, args, callopts)
...
---@param reqmatch ProtectedBranchAdminEnforcedLoadMatch
---@param ctrl? table
---@return ProtectedBranchAdminEnforced
---@return string? err
function ProtectedBranchAdminEnforcedEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ProtectedBranchAdminEnforcedCreateData
---@param ctrl? table
---@return ProtectedBranchAdminEnforced
---@return string? err
function ProtectedBranchAdminEnforcedEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ProtectedBranchAdminEnforcedEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ProtectedBranchAdminEnforcedEntity
