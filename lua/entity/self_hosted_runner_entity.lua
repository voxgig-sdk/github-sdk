...
local SelfHostedRunnerEntity = {}
SelfHostedRunnerEntity.__index = SelfHostedRunnerEntity


function SelfHostedRunnerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SelfHostedRunnerEntity)
  self._name = "self_hosted_runner"
  self._client = client
...
function SelfHostedRunnerEntity:get_name()
  return self._name
end


function SelfHostedRunnerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SelfHostedRunnerEntity.new(self._client, opts)
end
...
function SelfHostedRunnerEntity:mark_deleted()
  self._deleted = true
end


function SelfHostedRunnerEntity:deleted()
  return true == self._deleted
end


function SelfHostedRunnerEntity:data_set(args)
  if args ~= nil then
...
function SelfHostedRunnerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SelfHostedRunnerEntity:match_set(args)
  if args ~= nil then
...
function SelfHostedRunnerEntity:match_get()
...
function SelfHostedRunnerEntity:stream(action, args, callopts)
...
---@param reqmatch SelfHostedRunnerLoadMatch
---@param ctrl? table
---@return SelfHostedRunner
---@return string? err
function SelfHostedRunnerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function SelfHostedRunnerEntity:_run_op(ctx, post_done)
  local utility = self._utility
