...
local BranchWithProtectionEntity = {}
BranchWithProtectionEntity.__index = BranchWithProtectionEntity


function BranchWithProtectionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BranchWithProtectionEntity)
  self._name = "branch_with_protection"
  self._client = client
...
function BranchWithProtectionEntity:get_name()
  return self._name
end


function BranchWithProtectionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BranchWithProtectionEntity.new(self._client, opts)
end
...
function BranchWithProtectionEntity:mark_deleted()
  self._deleted = true
end


function BranchWithProtectionEntity:deleted()
  return true == self._deleted
end


function BranchWithProtectionEntity:data_set(args)
  if args ~= nil then
...
function BranchWithProtectionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BranchWithProtectionEntity:match_set(args)
  if args ~= nil then
...
function BranchWithProtectionEntity:match_get()
...
function BranchWithProtectionEntity:stream(action, args, callopts)
...
---@param reqdata BranchWithProtectionCreateData
---@param ctrl? table
---@return BranchWithProtection
---@return string? err
function BranchWithProtectionEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function BranchWithProtectionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return BranchWithProtectionEntity
