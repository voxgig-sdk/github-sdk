...
local OutsideCollaboratorEntity = {}
OutsideCollaboratorEntity.__index = OutsideCollaboratorEntity


function OutsideCollaboratorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutsideCollaboratorEntity)
  self._name = "outside_collaborator"
  self._client = client
...
function OutsideCollaboratorEntity:get_name()
  return self._name
end


function OutsideCollaboratorEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OutsideCollaboratorEntity.new(self._client, opts)
end
...
function OutsideCollaboratorEntity:mark_deleted()
  self._deleted = true
end


function OutsideCollaboratorEntity:deleted()
  return true == self._deleted
end


function OutsideCollaboratorEntity:data_set(args)
  if args ~= nil then
...
function OutsideCollaboratorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutsideCollaboratorEntity:match_set(args)
  if args ~= nil then
...
function OutsideCollaboratorEntity:match_get()
...
function OutsideCollaboratorEntity:stream(action, args, callopts)
...
---@param reqmatch OutsideCollaboratorListMatch
---@param ctrl? table
---@return OutsideCollaborator[]
---@return string? err
function OutsideCollaboratorEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function OutsideCollaboratorEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutsideCollaboratorEntity
