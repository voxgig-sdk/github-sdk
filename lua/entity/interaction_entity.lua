...
---@param reqmatch InteractionLoadMatch
---@param ctrl? table
---@return Interaction
---@return string? err
function InteractionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch InteractionRemoveMatch
---@param ctrl? table
---@return Interaction
---@return string? err
function InteractionEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
