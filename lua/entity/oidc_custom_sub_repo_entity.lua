...
local OidcCustomSubRepoEntity = {}
OidcCustomSubRepoEntity.__index = OidcCustomSubRepoEntity


function OidcCustomSubRepoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OidcCustomSubRepoEntity)
  self._name = "oidc_custom_sub_repo"
  self._client = client
...
function OidcCustomSubRepoEntity:get_name()
  return self._name
end


function OidcCustomSubRepoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OidcCustomSubRepoEntity.new(self._client, opts)
end
...
function OidcCustomSubRepoEntity:mark_deleted()
  self._deleted = true
end


function OidcCustomSubRepoEntity:deleted()
  return true == self._deleted
end


function OidcCustomSubRepoEntity:data_set(args)
  if args ~= nil then
...
function OidcCustomSubRepoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OidcCustomSubRepoEntity:match_set(args)
  if args ~= nil then
...
function OidcCustomSubRepoEntity:match_get()
...
function OidcCustomSubRepoEntity:stream(action, args, callopts)
...
---@param reqmatch OidcCustomSubRepoListMatch
---@param ctrl? table
---@return OidcCustomSubRepo[]
---@return string? err
function OidcCustomSubRepoEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function OidcCustomSubRepoEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OidcCustomSubRepoEntity
