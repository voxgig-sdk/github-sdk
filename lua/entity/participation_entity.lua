...
local ParticipationEntity = {}
ParticipationEntity.__index = ParticipationEntity


function ParticipationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ParticipationEntity)
  self._name = "participation"
  self._client = client
...
function ParticipationEntity:get_name()
  return self._name
end


function ParticipationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ParticipationEntity.new(self._client, opts)
end
...
function ParticipationEntity:mark_deleted()
  self._deleted = true
end


function ParticipationEntity:deleted()
  return true == self._deleted
end


function ParticipationEntity:data_set(args)
  if args ~= nil then
...
function ParticipationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ParticipationEntity:match_set(args)
  if args ~= nil then
...
function ParticipationEntity:match_get()
...
function ParticipationEntity:stream(action, args, callopts)
...
---@param reqmatch ParticipationListMatch
---@param ctrl? table
---@return Participation[]
---@return string? err
function ParticipationEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ParticipationEntity:_run_op(ctx, post_done)
  local utility = self._utility
