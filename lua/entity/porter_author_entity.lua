...
local PorterAuthorEntity = {}
PorterAuthorEntity.__index = PorterAuthorEntity


function PorterAuthorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PorterAuthorEntity)
  self._name = "porter_author"
  self._client = client
...
function PorterAuthorEntity:get_name()
  return self._name
end


function PorterAuthorEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PorterAuthorEntity.new(self._client, opts)
end
...
function PorterAuthorEntity:mark_deleted()
  self._deleted = true
end


function PorterAuthorEntity:deleted()
  return true == self._deleted
end


function PorterAuthorEntity:data_set(args)
  if args ~= nil then
...
function PorterAuthorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PorterAuthorEntity:match_set(args)
  if args ~= nil then
...
function PorterAuthorEntity:match_get()
...
function PorterAuthorEntity:stream(action, args, callopts)
...
---@param reqmatch PorterAuthorListMatch
---@param ctrl? table
---@return PorterAuthor[]
---@return string? err
function PorterAuthorEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata PorterAuthorUpdateData
---@param ctrl? table
---@return PorterAuthor
---@return string? err
function PorterAuthorEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function PorterAuthorEntity:_run_op(ctx, post_done)
  local utility = self._utility
