...
local PagesHealthCheckEntity = {}
PagesHealthCheckEntity.__index = PagesHealthCheckEntity


function PagesHealthCheckEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PagesHealthCheckEntity)
  self._name = "pages_health_check"
  self._client = client
...
function PagesHealthCheckEntity:get_name()
  return self._name
end


function PagesHealthCheckEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PagesHealthCheckEntity.new(self._client, opts)
end
...
function PagesHealthCheckEntity:mark_deleted()
  self._deleted = true
end


function PagesHealthCheckEntity:deleted()
  return true == self._deleted
end


function PagesHealthCheckEntity:data_set(args)
  if args ~= nil then
...
function PagesHealthCheckEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PagesHealthCheckEntity:match_set(args)
  if args ~= nil then
...
function PagesHealthCheckEntity:match_get()
...
function PagesHealthCheckEntity:stream(action, args, callopts)
...
---@param reqmatch PagesHealthCheckLoadMatch
---@param ctrl? table
---@return PagesHealthCheck
---@return string? err
function PagesHealthCheckEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function PagesHealthCheckEntity:_run_op(ctx, post_done)
  local utility = self._utility
