...
local CommunityProfileEntity = {}
CommunityProfileEntity.__index = CommunityProfileEntity


function CommunityProfileEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CommunityProfileEntity)
  self._name = "community_profile"
  self._client = client
...
function CommunityProfileEntity:get_name()
  return self._name
end


function CommunityProfileEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CommunityProfileEntity.new(self._client, opts)
end
...
function CommunityProfileEntity:mark_deleted()
  self._deleted = true
end


function CommunityProfileEntity:deleted()
  return true == self._deleted
end


function CommunityProfileEntity:data_set(args)
  if args ~= nil then
...
function CommunityProfileEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CommunityProfileEntity:match_set(args)
  if args ~= nil then
...
function CommunityProfileEntity:match_get()
...
function CommunityProfileEntity:stream(action, args, callopts)
...
---@param reqmatch CommunityProfileLoadMatch
---@param ctrl? table
---@return CommunityProfile
---@return string? err
function CommunityProfileEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function CommunityProfileEntity:_run_op(ctx, post_done)
  local utility = self._utility
