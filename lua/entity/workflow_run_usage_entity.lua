...
local WorkflowRunUsageEntity = {}
WorkflowRunUsageEntity.__index = WorkflowRunUsageEntity


function WorkflowRunUsageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WorkflowRunUsageEntity)
  self._name = "workflow_run_usage"
  self._client = client
...
function WorkflowRunUsageEntity:get_name()
  return self._name
end


function WorkflowRunUsageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WorkflowRunUsageEntity.new(self._client, opts)
end
...
function WorkflowRunUsageEntity:mark_deleted()
  self._deleted = true
end


function WorkflowRunUsageEntity:deleted()
  return true == self._deleted
end


function WorkflowRunUsageEntity:data_set(args)
  if args ~= nil then
...
function WorkflowRunUsageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WorkflowRunUsageEntity:match_set(args)
  if args ~= nil then
...
function WorkflowRunUsageEntity:match_get()
...
function WorkflowRunUsageEntity:stream(action, args, callopts)
...
---@param reqmatch WorkflowRunUsageLoadMatch
---@param ctrl? table
---@return WorkflowRunUsage
---@return string? err
function WorkflowRunUsageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function WorkflowRunUsageEntity:_run_op(ctx, post_done)
  local utility = self._utility
