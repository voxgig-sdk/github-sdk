-- Github SDK ApiInsightsRouteStat entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ApiInsightsRouteStatEntity = {}
ApiInsightsRouteStatEntity.__index = ApiInsightsRouteStatEntity


function ApiInsightsRouteStatEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiInsightsRouteStatEntity)
  self._name = "api_insights_route_stat"
  self._client = client
...
function ApiInsightsRouteStatEntity:get_name()
  return self._name
end


function ApiInsightsRouteStatEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiInsightsRouteStatEntity.new(self._client, opts)
end
...
function ApiInsightsRouteStatEntity:mark_deleted()
  self._deleted = true
end


function ApiInsightsRouteStatEntity:deleted()
  return true == self._deleted
end


function ApiInsightsRouteStatEntity:data_set(args)
  if args ~= nil then
...
function ApiInsightsRouteStatEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiInsightsRouteStatEntity:match_set(args)
  if args ~= nil then
...
function ApiInsightsRouteStatEntity:match_get()
...
function ApiInsightsRouteStatEntity:stream(action, args, callopts)
...
---@param reqmatch ApiInsightsRouteStatListMatch
---@param ctrl? table
---@return ApiInsightsRouteStat[]
---@return string? err
function ApiInsightsRouteStatEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiInsightsRouteStatEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiInsightsRouteStatEntity
