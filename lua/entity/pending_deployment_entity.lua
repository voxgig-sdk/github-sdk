...
local PendingDeploymentEntity = {}
PendingDeploymentEntity.__index = PendingDeploymentEntity


function PendingDeploymentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PendingDeploymentEntity)
  self._name = "pending_deployment"
  self._client = client
...
function PendingDeploymentEntity:get_name()
  return self._name
end


function PendingDeploymentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PendingDeploymentEntity.new(self._client, opts)
end
...
function PendingDeploymentEntity:mark_deleted()
  self._deleted = true
end


function PendingDeploymentEntity:deleted()
  return true == self._deleted
end


function PendingDeploymentEntity:data_set(args)
  if args ~= nil then
...
function PendingDeploymentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PendingDeploymentEntity:match_set(args)
  if args ~= nil then
...
function PendingDeploymentEntity:match_get()
...
function PendingDeploymentEntity:stream(action, args, callopts)
...
---@param reqmatch PendingDeploymentListMatch
---@param ctrl? table
---@return PendingDeployment[]
---@return string? err
function PendingDeploymentEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function PendingDeploymentEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PendingDeploymentEntity
