-- Github SDK PrivateUser entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local PrivateUserEntity = {}
PrivateUserEntity.__index = PrivateUserEntity


function PrivateUserEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PrivateUserEntity)
  self._name = "private_user"
  self._client = client
...
function PrivateUserEntity:get_name()
  return self._name
end


function PrivateUserEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PrivateUserEntity.new(self._client, opts)
end
...
function PrivateUserEntity:mark_deleted()
  self._deleted = true
end


function PrivateUserEntity:deleted()
  return true == self._deleted
end


function PrivateUserEntity:data_set(args)
  if args ~= nil then
...
function PrivateUserEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PrivateUserEntity:match_set(args)
  if args ~= nil then
...
function PrivateUserEntity:match_get()
...
function PrivateUserEntity:stream(action, args, callopts)
...
function PrivateUserEntity:_run_op(ctx, post_done)
  local utility = self._utility
