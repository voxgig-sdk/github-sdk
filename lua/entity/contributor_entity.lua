...
local ContributorEntity = {}
ContributorEntity.__index = ContributorEntity


function ContributorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ContributorEntity)
  self._name = "contributor"
  self._client = client
...
function ContributorEntity:get_name()
  return self._name
end


function ContributorEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ContributorEntity.new(self._client, opts)
end
...
function ContributorEntity:mark_deleted()
  self._deleted = true
end


function ContributorEntity:deleted()
  return true == self._deleted
end


function ContributorEntity:data_set(args)
  if args ~= nil then
...
function ContributorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ContributorEntity:match_set(args)
  if args ~= nil then
...
function ContributorEntity:match_get()
...
function ContributorEntity:stream(action, args, callopts)
...
---@param reqmatch ContributorListMatch
---@param ctrl? table
---@return Contributor[]
---@return string? err
function ContributorEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ContributorEntity:_run_op(ctx, post_done)
  local utility = self._utility
