...
local RepositoryRuleDetailedEntity = {}
RepositoryRuleDetailedEntity.__index = RepositoryRuleDetailedEntity


function RepositoryRuleDetailedEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepositoryRuleDetailedEntity)
  self._name = "repository_rule_detailed"
  self._client = client
...
function RepositoryRuleDetailedEntity:get_name()
  return self._name
end


function RepositoryRuleDetailedEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepositoryRuleDetailedEntity.new(self._client, opts)
end
...
function RepositoryRuleDetailedEntity:mark_deleted()
  self._deleted = true
end


function RepositoryRuleDetailedEntity:deleted()
  return true == self._deleted
end


function RepositoryRuleDetailedEntity:data_set(args)
  if args ~= nil then
...
function RepositoryRuleDetailedEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepositoryRuleDetailedEntity:match_set(args)
  if args ~= nil then
...
function RepositoryRuleDetailedEntity:match_get()
...
function RepositoryRuleDetailedEntity:stream(action, args, callopts)
...
---@param reqmatch RepositoryRuleDetailedLoadMatch
---@param ctrl? table
---@return RepositoryRuleDetailed
---@return string? err
function RepositoryRuleDetailedEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function RepositoryRuleDetailedEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RepositoryRuleDetailedEntity
