...
local BranchRestrictionPolicyEntity = {}
BranchRestrictionPolicyEntity.__index = BranchRestrictionPolicyEntity


function BranchRestrictionPolicyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BranchRestrictionPolicyEntity)
  self._name = "branch_restriction_policy"
  self._client = client
...
function BranchRestrictionPolicyEntity:get_name()
  return self._name
end


function BranchRestrictionPolicyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BranchRestrictionPolicyEntity.new(self._client, opts)
end
...
function BranchRestrictionPolicyEntity:mark_deleted()
  self._deleted = true
end


function BranchRestrictionPolicyEntity:deleted()
  return true == self._deleted
end


function BranchRestrictionPolicyEntity:data_set(args)
  if args ~= nil then
...
function BranchRestrictionPolicyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BranchRestrictionPolicyEntity:match_set(args)
  if args ~= nil then
...
function BranchRestrictionPolicyEntity:match_get()
...
function BranchRestrictionPolicyEntity:stream(action, args, callopts)
...
---@param reqmatch BranchRestrictionPolicyListMatch
---@param ctrl? table
---@return BranchRestrictionPolicy[]
---@return string? err
function BranchRestrictionPolicyEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function BranchRestrictionPolicyEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return BranchRestrictionPolicyEntity
