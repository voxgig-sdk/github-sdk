...
local BranchShortEntity = {}
BranchShortEntity.__index = BranchShortEntity


function BranchShortEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BranchShortEntity)
  self._name = "branch_short"
  self._client = client
...
function BranchShortEntity:get_name()
  return self._name
end


function BranchShortEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BranchShortEntity.new(self._client, opts)
end
...
function BranchShortEntity:mark_deleted()
  self._deleted = true
end


function BranchShortEntity:deleted()
  return true == self._deleted
end


function BranchShortEntity:data_set(args)
  if args ~= nil then
...
function BranchShortEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BranchShortEntity:match_set(args)
  if args ~= nil then
...
function BranchShortEntity:match_get()
...
function BranchShortEntity:stream(action, args, callopts)
...
---@param reqmatch BranchShortListMatch
---@param ctrl? table
---@return BranchShort[]
---@return string? err
function BranchShortEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function BranchShortEntity:_run_op(ctx, post_done)
  local utility = self._utility
