...
local BranchProtectionEntity = {}
BranchProtectionEntity.__index = BranchProtectionEntity


function BranchProtectionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BranchProtectionEntity)
  self._name = "branch_protection"
  self._client = client
...
function BranchProtectionEntity:get_name()
  return self._name
end


function BranchProtectionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BranchProtectionEntity.new(self._client, opts)
end
...
function BranchProtectionEntity:mark_deleted()
  self._deleted = true
end


function BranchProtectionEntity:deleted()
  return true == self._deleted
end


function BranchProtectionEntity:data_set(args)
  if args ~= nil then
...
function BranchProtectionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BranchProtectionEntity:match_set(args)
  if args ~= nil then
...
function BranchProtectionEntity:match_get()
...
function BranchProtectionEntity:stream(action, args, callopts)
...
---@param reqmatch BranchProtectionLoadMatch
---@param ctrl? table
---@return BranchProtection
---@return string? err
function BranchProtectionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function BranchProtectionEntity:_run_op(ctx, post_done)
  local utility = self._utility
