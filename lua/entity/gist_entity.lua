...
---@param reqmatch GistLoadMatch
---@param ctrl? table
---@return Gist
---@return string? err
function GistEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata GistUpdateData
---@param ctrl? table
---@return Gist
---@return string? err
function GistEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch GistRemoveMatch
---@param ctrl? table
---@return Gist
---@return string? err
function GistEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
