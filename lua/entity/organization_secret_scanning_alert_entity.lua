-- Github SDK OrganizationSecretScanningAlert entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local OrganizationSecretScanningAlertEntity = {}
OrganizationSecretScanningAlertEntity.__index = OrganizationSecretScanningAlertEntity


function OrganizationSecretScanningAlertEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrganizationSecretScanningAlertEntity)
  self._name = "organization_secret_scanning_alert"
  self._client = client
...
function OrganizationSecretScanningAlertEntity:get_name()
  return self._name
end


function OrganizationSecretScanningAlertEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrganizationSecretScanningAlertEntity.new(self._client, opts)
end
...
function OrganizationSecretScanningAlertEntity:mark_deleted()
  self._deleted = true
end


function OrganizationSecretScanningAlertEntity:deleted()
  return true == self._deleted
end


function OrganizationSecretScanningAlertEntity:data_set(args)
  if args ~= nil then
...
function OrganizationSecretScanningAlertEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrganizationSecretScanningAlertEntity:match_set(args)
  if args ~= nil then
...
function OrganizationSecretScanningAlertEntity:match_get()
...
function OrganizationSecretScanningAlertEntity:stream(action, args, callopts)
...
---@param reqmatch OrganizationSecretScanningAlertListMatch
---@param ctrl? table
---@return OrganizationSecretScanningAlert[]
---@return string? err
function OrganizationSecretScanningAlertEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function OrganizationSecretScanningAlertEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrganizationSecretScanningAlertEntity
