...
local MilestoneEntity = {}
MilestoneEntity.__index = MilestoneEntity


function MilestoneEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MilestoneEntity)
  self._name = "milestone"
  self._client = client
...
function MilestoneEntity:get_name()
  return self._name
end


function MilestoneEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MilestoneEntity.new(self._client, opts)
end
...
function MilestoneEntity:mark_deleted()
  self._deleted = true
end


function MilestoneEntity:deleted()
  return true == self._deleted
end


function MilestoneEntity:data_set(args)
  if args ~= nil then
...
function MilestoneEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MilestoneEntity:match_set(args)
  if args ~= nil then
...
function MilestoneEntity:match_get()
...
function MilestoneEntity:stream(action, args, callopts)
...
---@param reqmatch MilestoneLoadMatch
---@param ctrl? table
---@return Milestone
---@return string? err
function MilestoneEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch MilestoneListMatch
---@param ctrl? table
---@return Milestone[]
---@return string? err
function MilestoneEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata MilestoneCreateData
---@param ctrl? table
---@return Milestone
---@return string? err
function MilestoneEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata MilestoneUpdateData
---@param ctrl? table
---@return Milestone
---@return string? err
function MilestoneEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function MilestoneEntity:_run_op(ctx, post_done)
  local utility = self._utility
