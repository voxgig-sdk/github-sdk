...
local PrivateRegistryEntity = {}
PrivateRegistryEntity.__index = PrivateRegistryEntity


function PrivateRegistryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PrivateRegistryEntity)
  self._name = "private_registry"
  self._client = client
...
function PrivateRegistryEntity:get_name()
  return self._name
end


function PrivateRegistryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PrivateRegistryEntity.new(self._client, opts)
end
...
function PrivateRegistryEntity:mark_deleted()
  self._deleted = true
end


function PrivateRegistryEntity:deleted()
  return true == self._deleted
end


function PrivateRegistryEntity:data_set(args)
  if args ~= nil then
...
function PrivateRegistryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PrivateRegistryEntity:match_set(args)
  if args ~= nil then
...
function PrivateRegistryEntity:match_get()
...
function PrivateRegistryEntity:stream(action, args, callopts)
...
---@param reqmatch PrivateRegistryLoadMatch
---@param ctrl? table
---@return PrivateRegistry
---@return string? err
function PrivateRegistryEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PrivateRegistryListMatch
---@param ctrl? table
---@return PrivateRegistry[]
---@return string? err
function PrivateRegistryEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata PrivateRegistryUpdateData
---@param ctrl? table
---@return PrivateRegistry
---@return string? err
function PrivateRegistryEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch PrivateRegistryRemoveMatch
---@param ctrl? table
---@return PrivateRegistry
---@return string? err
function PrivateRegistryEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function PrivateRegistryEntity:_run_op(ctx, post_done)
  local utility = self._utility
