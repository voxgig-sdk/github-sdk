-- Github SDK CodeScanningAutofixCommit entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CodeScanningAutofixCommitEntity = {}
CodeScanningAutofixCommitEntity.__index = CodeScanningAutofixCommitEntity


function CodeScanningAutofixCommitEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CodeScanningAutofixCommitEntity)
  self._name = "code_scanning_autofix_commit"
  self._client = client
...
function CodeScanningAutofixCommitEntity:get_name()
  return self._name
end


function CodeScanningAutofixCommitEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CodeScanningAutofixCommitEntity.new(self._client, opts)
end
...
function CodeScanningAutofixCommitEntity:mark_deleted()
  self._deleted = true
end


function CodeScanningAutofixCommitEntity:deleted()
  return true == self._deleted
end


function CodeScanningAutofixCommitEntity:data_set(args)
  if args ~= nil then
...
function CodeScanningAutofixCommitEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CodeScanningAutofixCommitEntity:match_set(args)
  if args ~= nil then
...
function CodeScanningAutofixCommitEntity:match_get()
...
function CodeScanningAutofixCommitEntity:stream(action, args, callopts)
...
---@param reqdata CodeScanningAutofixCommitCreateData
---@param ctrl? table
---@return CodeScanningAutofixCommit
---@return string? err
function CodeScanningAutofixCommitEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function CodeScanningAutofixCommitEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CodeScanningAutofixCommitEntity
