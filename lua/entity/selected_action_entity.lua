...
local SelectedActionEntity = {}
SelectedActionEntity.__index = SelectedActionEntity


function SelectedActionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SelectedActionEntity)
  self._name = "selected_action"
  self._client = client
...
function SelectedActionEntity:get_name()
  return self._name
end


function SelectedActionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SelectedActionEntity.new(self._client, opts)
end
...
function SelectedActionEntity:mark_deleted()
  self._deleted = true
end


function SelectedActionEntity:deleted()
  return true == self._deleted
end


function SelectedActionEntity:data_set(args)
  if args ~= nil then
...
function SelectedActionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SelectedActionEntity:match_set(args)
  if args ~= nil then
...
function SelectedActionEntity:match_get()
...
function SelectedActionEntity:stream(action, args, callopts)
...
---@param reqmatch SelectedActionListMatch
---@param ctrl? table
---@return SelectedAction[]
---@return string? err
function SelectedActionEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function SelectedActionEntity:_run_op(ctx, post_done)
  local utility = self._utility
