...
local OrganizationActionsVariableEntity = {}
OrganizationActionsVariableEntity.__index = OrganizationActionsVariableEntity


function OrganizationActionsVariableEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrganizationActionsVariableEntity)
  self._name = "organization_actions_variable"
  self._client = client
...
function OrganizationActionsVariableEntity:get_name()
  return self._name
end


function OrganizationActionsVariableEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrganizationActionsVariableEntity.new(self._client, opts)
end
...
function OrganizationActionsVariableEntity:mark_deleted()
  self._deleted = true
end


function OrganizationActionsVariableEntity:deleted()
  return true == self._deleted
end


function OrganizationActionsVariableEntity:data_set(args)
  if args ~= nil then
...
function OrganizationActionsVariableEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrganizationActionsVariableEntity:match_set(args)
  if args ~= nil then
...
function OrganizationActionsVariableEntity:match_get()
...
function OrganizationActionsVariableEntity:stream(action, args, callopts)
...
---@param reqmatch OrganizationActionsVariableLoadMatch
---@param ctrl? table
---@return OrganizationActionsVariable
---@return string? err
function OrganizationActionsVariableEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function OrganizationActionsVariableEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrganizationActionsVariableEntity
