...
local OrganizationActionsSecretEntity = {}
OrganizationActionsSecretEntity.__index = OrganizationActionsSecretEntity


function OrganizationActionsSecretEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrganizationActionsSecretEntity)
  self._name = "organization_actions_secret"
  self._client = client
...
function OrganizationActionsSecretEntity:get_name()
  return self._name
end


function OrganizationActionsSecretEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrganizationActionsSecretEntity.new(self._client, opts)
end
...
function OrganizationActionsSecretEntity:mark_deleted()
  self._deleted = true
end


function OrganizationActionsSecretEntity:deleted()
  return true == self._deleted
end


function OrganizationActionsSecretEntity:data_set(args)
  if args ~= nil then
...
function OrganizationActionsSecretEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrganizationActionsSecretEntity:match_set(args)
  if args ~= nil then
...
function OrganizationActionsSecretEntity:match_get()
...
function OrganizationActionsSecretEntity:stream(action, args, callopts)
...
---@param reqmatch OrganizationActionsSecretLoadMatch
---@param ctrl? table
---@return OrganizationActionsSecret
---@return string? err
function OrganizationActionsSecretEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function OrganizationActionsSecretEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrganizationActionsSecretEntity
