...
local SecurityAdvisoryEntity = {}
SecurityAdvisoryEntity.__index = SecurityAdvisoryEntity


function SecurityAdvisoryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SecurityAdvisoryEntity)
  self._name = "security_advisory"
  self._client = client
...
function SecurityAdvisoryEntity:get_name()
  return self._name
end


function SecurityAdvisoryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SecurityAdvisoryEntity.new(self._client, opts)
end
...
function SecurityAdvisoryEntity:mark_deleted()
  self._deleted = true
end


function SecurityAdvisoryEntity:deleted()
  return true == self._deleted
end


function SecurityAdvisoryEntity:data_set(args)
  if args ~= nil then
...
function SecurityAdvisoryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SecurityAdvisoryEntity:match_set(args)
  if args ~= nil then
...
function SecurityAdvisoryEntity:match_get()
...
function SecurityAdvisoryEntity:stream(action, args, callopts)
...
---@param reqdata SecurityAdvisoryCreateData
---@param ctrl? table
---@return SecurityAdvisory
---@return string? err
function SecurityAdvisoryEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function SecurityAdvisoryEntity:_run_op(ctx, post_done)
  local utility = self._utility
