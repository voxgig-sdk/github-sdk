...
local HookDeliveryItemEntity = {}
HookDeliveryItemEntity.__index = HookDeliveryItemEntity


function HookDeliveryItemEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, HookDeliveryItemEntity)
  self._name = "hook_delivery_item"
  self._client = client
...
function HookDeliveryItemEntity:get_name()
  return self._name
end


function HookDeliveryItemEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return HookDeliveryItemEntity.new(self._client, opts)
end
...
function HookDeliveryItemEntity:mark_deleted()
  self._deleted = true
end


function HookDeliveryItemEntity:deleted()
  return true == self._deleted
end


function HookDeliveryItemEntity:data_set(args)
  if args ~= nil then
...
function HookDeliveryItemEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function HookDeliveryItemEntity:match_set(args)
  if args ~= nil then
...
function HookDeliveryItemEntity:match_get()
...
function HookDeliveryItemEntity:stream(action, args, callopts)
...
---@param reqmatch HookDeliveryItemListMatch
---@param ctrl? table
---@return HookDeliveryItem[]
---@return string? err
function HookDeliveryItemEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function HookDeliveryItemEntity:_run_op(ctx, post_done)
  local utility = self._utility
