...
local OrganizationInvitationEntity = {}
OrganizationInvitationEntity.__index = OrganizationInvitationEntity


function OrganizationInvitationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrganizationInvitationEntity)
  self._name = "organization_invitation"
  self._client = client
...
function OrganizationInvitationEntity:get_name()
  return self._name
end


function OrganizationInvitationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrganizationInvitationEntity.new(self._client, opts)
end
...
function OrganizationInvitationEntity:mark_deleted()
  self._deleted = true
end


function OrganizationInvitationEntity:deleted()
  return true == self._deleted
end


function OrganizationInvitationEntity:data_set(args)
  if args ~= nil then
...
function OrganizationInvitationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrganizationInvitationEntity:match_set(args)
  if args ~= nil then
...
function OrganizationInvitationEntity:match_get()
...
function OrganizationInvitationEntity:stream(action, args, callopts)
...
---@param reqmatch OrganizationInvitationListMatch
---@param ctrl? table
---@return OrganizationInvitation[]
---@return string? err
function OrganizationInvitationEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata OrganizationInvitationCreateData
---@param ctrl? table
---@return OrganizationInvitation
---@return string? err
function OrganizationInvitationEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function OrganizationInvitationEntity:_run_op(ctx, post_done)
  local utility = self._utility
