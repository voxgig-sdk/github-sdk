...
local RepositoryInvitationEntity = {}
RepositoryInvitationEntity.__index = RepositoryInvitationEntity


function RepositoryInvitationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepositoryInvitationEntity)
  self._name = "repository_invitation"
  self._client = client
...
function RepositoryInvitationEntity:get_name()
  return self._name
end


function RepositoryInvitationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepositoryInvitationEntity.new(self._client, opts)
end
...
function RepositoryInvitationEntity:mark_deleted()
  self._deleted = true
end


function RepositoryInvitationEntity:deleted()
  return true == self._deleted
end


function RepositoryInvitationEntity:data_set(args)
  if args ~= nil then
...
function RepositoryInvitationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepositoryInvitationEntity:match_set(args)
  if args ~= nil then
...
function RepositoryInvitationEntity:match_get()
...
function RepositoryInvitationEntity:stream(action, args, callopts)
...
---@param reqmatch RepositoryInvitationListMatch
---@param ctrl? table
---@return RepositoryInvitation[]
---@return string? err
function RepositoryInvitationEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata RepositoryInvitationUpdateData
---@param ctrl? table
---@return RepositoryInvitation
---@return string? err
function RepositoryInvitationEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function RepositoryInvitationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RepositoryInvitationEntity
