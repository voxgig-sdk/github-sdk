...
local ShortBranchEntity = {}
ShortBranchEntity.__index = ShortBranchEntity


function ShortBranchEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ShortBranchEntity)
  self._name = "short_branch"
  self._client = client
...
function ShortBranchEntity:get_name()
  return self._name
end


function ShortBranchEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ShortBranchEntity.new(self._client, opts)
end
...
function ShortBranchEntity:mark_deleted()
  self._deleted = true
end


function ShortBranchEntity:deleted()
  return true == self._deleted
end


function ShortBranchEntity:data_set(args)
  if args ~= nil then
...
function ShortBranchEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ShortBranchEntity:match_set(args)
  if args ~= nil then
...
function ShortBranchEntity:match_get()
...
function ShortBranchEntity:stream(action, args, callopts)
...
---@param reqmatch ShortBranchListMatch
---@param ctrl? table
---@return ShortBranch[]
---@return string? err
function ShortBranchEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ShortBranchEntity:_run_op(ctx, post_done)
  local utility = self._utility
