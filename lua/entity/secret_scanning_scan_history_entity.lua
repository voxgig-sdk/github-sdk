...
local SecretScanningScanHistoryEntity = {}
SecretScanningScanHistoryEntity.__index = SecretScanningScanHistoryEntity


function SecretScanningScanHistoryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SecretScanningScanHistoryEntity)
  self._name = "secret_scanning_scan_history"
  self._client = client
...
function SecretScanningScanHistoryEntity:get_name()
  return self._name
end


function SecretScanningScanHistoryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SecretScanningScanHistoryEntity.new(self._client, opts)
end
...
function SecretScanningScanHistoryEntity:mark_deleted()
  self._deleted = true
end


function SecretScanningScanHistoryEntity:deleted()
  return true == self._deleted
end


function SecretScanningScanHistoryEntity:data_set(args)
  if args ~= nil then
...
function SecretScanningScanHistoryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SecretScanningScanHistoryEntity:match_set(args)
  if args ~= nil then
...
function SecretScanningScanHistoryEntity:match_get()
...
function SecretScanningScanHistoryEntity:stream(action, args, callopts)
...
---@param reqmatch SecretScanningScanHistoryListMatch
---@param ctrl? table
---@return SecretScanningScanHistory[]
---@return string? err
function SecretScanningScanHistoryEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function SecretScanningScanHistoryEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SecretScanningScanHistoryEntity
