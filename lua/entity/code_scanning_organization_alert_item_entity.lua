-- Github SDK CodeScanningOrganizationAlertItem entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CodeScanningOrganizationAlertItemEntity = {}
CodeScanningOrganizationAlertItemEntity.__index = CodeScanningOrganizationAlertItemEntity


function CodeScanningOrganizationAlertItemEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CodeScanningOrganizationAlertItemEntity)
  self._name = "code_scanning_organization_alert_item"
  self._client = client
...
function CodeScanningOrganizationAlertItemEntity:get_name()
  return self._name
end


function CodeScanningOrganizationAlertItemEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CodeScanningOrganizationAlertItemEntity.new(self._client, opts)
end
...
function CodeScanningOrganizationAlertItemEntity:mark_deleted()
  self._deleted = true
end


function CodeScanningOrganizationAlertItemEntity:deleted()
  return true == self._deleted
end


function CodeScanningOrganizationAlertItemEntity:data_set(args)
  if args ~= nil then
...
function CodeScanningOrganizationAlertItemEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CodeScanningOrganizationAlertItemEntity:match_set(args)
  if args ~= nil then
...
function CodeScanningOrganizationAlertItemEntity:match_get()
...
function CodeScanningOrganizationAlertItemEntity:stream(action, args, callopts)
...
---@param reqmatch CodeScanningOrganizationAlertItemListMatch
---@param ctrl? table
---@return CodeScanningOrganizationAlertItem[]
---@return string? err
function CodeScanningOrganizationAlertItemEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CodeScanningOrganizationAlertItemEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CodeScanningOrganizationAlertItemEntity
