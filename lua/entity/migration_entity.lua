...
---@param reqmatch MigrationLoadMatch
---@param ctrl? table
---@return Migration
---@return string? err
function MigrationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch MigrationRemoveMatch
---@param ctrl? table
---@return Migration
---@return string? err
function MigrationEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
