-- Github SDK ActionsRepositoryPermission entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ActionsRepositoryPermissionEntity = {}
ActionsRepositoryPermissionEntity.__index = ActionsRepositoryPermissionEntity


function ActionsRepositoryPermissionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ActionsRepositoryPermissionEntity)
  self._name = "actions_repository_permission"
  self._client = client
...
function ActionsRepositoryPermissionEntity:get_name()
  return self._name
end


function ActionsRepositoryPermissionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ActionsRepositoryPermissionEntity.new(self._client, opts)
end
...
function ActionsRepositoryPermissionEntity:mark_deleted()
  self._deleted = true
end


function ActionsRepositoryPermissionEntity:deleted()
  return true == self._deleted
end


function ActionsRepositoryPermissionEntity:data_set(args)
  if args ~= nil then
...
function ActionsRepositoryPermissionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ActionsRepositoryPermissionEntity:match_set(args)
  if args ~= nil then
...
function ActionsRepositoryPermissionEntity:match_get()
...
function ActionsRepositoryPermissionEntity:stream(action, args, callopts)
...
---@param reqmatch ActionsRepositoryPermissionLoadMatch
---@param ctrl? table
---@return ActionsRepositoryPermission
---@return string? err
function ActionsRepositoryPermissionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ActionsRepositoryPermissionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ActionsRepositoryPermissionEntity
