...
local DeploymentStatusEntity = {}
DeploymentStatusEntity.__index = DeploymentStatusEntity


function DeploymentStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeploymentStatusEntity)
  self._name = "deployment_status"
  self._client = client
...
function DeploymentStatusEntity:get_name()
  return self._name
end


function DeploymentStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DeploymentStatusEntity.new(self._client, opts)
end
...
function DeploymentStatusEntity:mark_deleted()
  self._deleted = true
end


function DeploymentStatusEntity:deleted()
  return true == self._deleted
end


function DeploymentStatusEntity:data_set(args)
  if args ~= nil then
...
function DeploymentStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeploymentStatusEntity:match_set(args)
  if args ~= nil then
...
function DeploymentStatusEntity:match_get()
...
function DeploymentStatusEntity:stream(action, args, callopts)
...
---@param reqmatch DeploymentStatusLoadMatch
---@param ctrl? table
---@return DeploymentStatus
---@return string? err
function DeploymentStatusEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch DeploymentStatusListMatch
---@param ctrl? table
---@return DeploymentStatus[]
---@return string? err
function DeploymentStatusEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata DeploymentStatusCreateData
---@param ctrl? table
---@return DeploymentStatus
---@return string? err
function DeploymentStatusEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function DeploymentStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
