...
local BillingUsageReportUserEntity = {}
BillingUsageReportUserEntity.__index = BillingUsageReportUserEntity


function BillingUsageReportUserEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BillingUsageReportUserEntity)
  self._name = "billing_usage_report_user"
  self._client = client
...
function BillingUsageReportUserEntity:get_name()
  return self._name
end


function BillingUsageReportUserEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BillingUsageReportUserEntity.new(self._client, opts)
end
...
function BillingUsageReportUserEntity:mark_deleted()
  self._deleted = true
end


function BillingUsageReportUserEntity:deleted()
  return true == self._deleted
end


function BillingUsageReportUserEntity:data_set(args)
  if args ~= nil then
...
function BillingUsageReportUserEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BillingUsageReportUserEntity:match_set(args)
  if args ~= nil then
...
function BillingUsageReportUserEntity:match_get()
...
function BillingUsageReportUserEntity:stream(action, args, callopts)
...
---@param reqmatch BillingUsageReportUserListMatch
---@param ctrl? table
---@return BillingUsageReportUser[]
---@return string? err
function BillingUsageReportUserEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function BillingUsageReportUserEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return BillingUsageReportUserEntity
