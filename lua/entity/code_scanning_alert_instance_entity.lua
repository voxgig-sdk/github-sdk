...
local CodeScanningAlertInstanceEntity = {}
CodeScanningAlertInstanceEntity.__index = CodeScanningAlertInstanceEntity


function CodeScanningAlertInstanceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CodeScanningAlertInstanceEntity)
  self._name = "code_scanning_alert_instance"
  self._client = client
...
function CodeScanningAlertInstanceEntity:get_name()
  return self._name
end


function CodeScanningAlertInstanceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CodeScanningAlertInstanceEntity.new(self._client, opts)
end
...
function CodeScanningAlertInstanceEntity:mark_deleted()
  self._deleted = true
end


function CodeScanningAlertInstanceEntity:deleted()
  return true == self._deleted
end


function CodeScanningAlertInstanceEntity:data_set(args)
  if args ~= nil then
...
function CodeScanningAlertInstanceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CodeScanningAlertInstanceEntity:match_set(args)
  if args ~= nil then
...
function CodeScanningAlertInstanceEntity:match_get()
...
function CodeScanningAlertInstanceEntity:stream(action, args, callopts)
...
---@param reqmatch CodeScanningAlertInstanceListMatch
---@param ctrl? table
---@return CodeScanningAlertInstance[]
---@return string? err
function CodeScanningAlertInstanceEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CodeScanningAlertInstanceEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CodeScanningAlertInstanceEntity
