...
local PullRequestReviewEntity = {}
PullRequestReviewEntity.__index = PullRequestReviewEntity


function PullRequestReviewEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PullRequestReviewEntity)
  self._name = "pull_request_review"
  self._client = client
...
function PullRequestReviewEntity:get_name()
  return self._name
end


function PullRequestReviewEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PullRequestReviewEntity.new(self._client, opts)
end
...
function PullRequestReviewEntity:mark_deleted()
  self._deleted = true
end


function PullRequestReviewEntity:deleted()
  return true == self._deleted
end


function PullRequestReviewEntity:data_set(args)
  if args ~= nil then
...
function PullRequestReviewEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PullRequestReviewEntity:match_set(args)
  if args ~= nil then
...
function PullRequestReviewEntity:match_get()
...
function PullRequestReviewEntity:stream(action, args, callopts)
...
---@param reqmatch PullRequestReviewLoadMatch
---@param ctrl? table
---@return PullRequestReview
---@return string? err
function PullRequestReviewEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PullRequestReviewListMatch
---@param ctrl? table
---@return PullRequestReview[]
---@return string? err
function PullRequestReviewEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata PullRequestReviewCreateData
---@param ctrl? table
---@return PullRequestReview
---@return string? err
function PullRequestReviewEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata PullRequestReviewUpdateData
---@param ctrl? table
---@return PullRequestReview
---@return string? err
function PullRequestReviewEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch PullRequestReviewRemoveMatch
---@param ctrl? table
---@return PullRequestReview
---@return string? err
function PullRequestReviewEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function PullRequestReviewEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PullRequestReviewEntity
