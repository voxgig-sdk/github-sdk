...
local SshSigningKeyEntity = {}
SshSigningKeyEntity.__index = SshSigningKeyEntity


function SshSigningKeyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SshSigningKeyEntity)
  self._name = "ssh_signing_key"
  self._client = client
...
function SshSigningKeyEntity:get_name()
  return self._name
end


function SshSigningKeyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SshSigningKeyEntity.new(self._client, opts)
end
...
function SshSigningKeyEntity:mark_deleted()
  self._deleted = true
end


function SshSigningKeyEntity:deleted()
  return true == self._deleted
end


function SshSigningKeyEntity:data_set(args)
  if args ~= nil then
...
function SshSigningKeyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SshSigningKeyEntity:match_set(args)
  if args ~= nil then
...
function SshSigningKeyEntity:match_get()
...
function SshSigningKeyEntity:stream(action, args, callopts)
...
---@param reqmatch SshSigningKeyLoadMatch
---@param ctrl? table
---@return SshSigningKey
---@return string? err
function SshSigningKeyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch SshSigningKeyListMatch
---@param ctrl? table
---@return SshSigningKey[]
---@return string? err
function SshSigningKeyEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata SshSigningKeyCreateData
---@param ctrl? table
---@return SshSigningKey
---@return string? err
function SshSigningKeyEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function SshSigningKeyEntity:_run_op(ctx, post_done)
  local utility = self._utility
