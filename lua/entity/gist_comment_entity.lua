...
local GistCommentEntity = {}
GistCommentEntity.__index = GistCommentEntity


function GistCommentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GistCommentEntity)
  self._name = "gist_comment"
  self._client = client
...
function GistCommentEntity:get_name()
  return self._name
end


function GistCommentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GistCommentEntity.new(self._client, opts)
end
...
function GistCommentEntity:mark_deleted()
  self._deleted = true
end


function GistCommentEntity:deleted()
  return true == self._deleted
end


function GistCommentEntity:data_set(args)
  if args ~= nil then
...
function GistCommentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GistCommentEntity:match_set(args)
  if args ~= nil then
...
function GistCommentEntity:match_get()
...
function GistCommentEntity:stream(action, args, callopts)
...
---@param reqmatch GistCommentLoadMatch
---@param ctrl? table
---@return GistComment
---@return string? err
function GistCommentEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch GistCommentListMatch
---@param ctrl? table
---@return GistComment[]
---@return string? err
function GistCommentEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata GistCommentCreateData
---@param ctrl? table
---@return GistComment
---@return string? err
function GistCommentEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata GistCommentUpdateData
---@param ctrl? table
---@return GistComment
---@return string? err
function GistCommentEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function GistCommentEntity:_run_op(ctx, post_done)
  local utility = self._utility
