...
local ApiInsightsUserStatEntity = {}
ApiInsightsUserStatEntity.__index = ApiInsightsUserStatEntity


function ApiInsightsUserStatEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiInsightsUserStatEntity)
  self._name = "api_insights_user_stat"
  self._client = client
...
function ApiInsightsUserStatEntity:get_name()
  return self._name
end


function ApiInsightsUserStatEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiInsightsUserStatEntity.new(self._client, opts)
end
...
function ApiInsightsUserStatEntity:mark_deleted()
  self._deleted = true
end


function ApiInsightsUserStatEntity:deleted()
  return true == self._deleted
end


function ApiInsightsUserStatEntity:data_set(args)
  if args ~= nil then
...
function ApiInsightsUserStatEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiInsightsUserStatEntity:match_set(args)
  if args ~= nil then
...
function ApiInsightsUserStatEntity:match_get()
...
function ApiInsightsUserStatEntity:stream(action, args, callopts)
...
---@param reqmatch ApiInsightsUserStatLoadMatch
---@param ctrl? table
---@return ApiInsightsUserStat
---@return string? err
function ApiInsightsUserStatEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiInsightsUserStatEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiInsightsUserStatEntity
