...
local CodeScanningAlertEntity = {}
CodeScanningAlertEntity.__index = CodeScanningAlertEntity


function CodeScanningAlertEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CodeScanningAlertEntity)
  self._name = "code_scanning_alert"
  self._client = client
...
function CodeScanningAlertEntity:get_name()
  return self._name
end


function CodeScanningAlertEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CodeScanningAlertEntity.new(self._client, opts)
end
...
function CodeScanningAlertEntity:mark_deleted()
  self._deleted = true
end


function CodeScanningAlertEntity:deleted()
  return true == self._deleted
end


function CodeScanningAlertEntity:data_set(args)
  if args ~= nil then
...
function CodeScanningAlertEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CodeScanningAlertEntity:match_set(args)
  if args ~= nil then
...
function CodeScanningAlertEntity:match_get()
...
function CodeScanningAlertEntity:stream(action, args, callopts)
...
---@param reqmatch CodeScanningAlertLoadMatch
---@param ctrl? table
---@return CodeScanningAlert
---@return string? err
function CodeScanningAlertEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata CodeScanningAlertUpdateData
---@param ctrl? table
---@return CodeScanningAlert
---@return string? err
function CodeScanningAlertEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function CodeScanningAlertEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CodeScanningAlertEntity
