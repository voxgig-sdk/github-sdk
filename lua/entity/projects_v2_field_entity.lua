...
local ProjectsV2FieldEntity = {}
ProjectsV2FieldEntity.__index = ProjectsV2FieldEntity


function ProjectsV2FieldEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ProjectsV2FieldEntity)
  self._name = "projects_v2_field"
  self._client = client
...
function ProjectsV2FieldEntity:get_name()
  return self._name
end


function ProjectsV2FieldEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ProjectsV2FieldEntity.new(self._client, opts)
end
...
function ProjectsV2FieldEntity:mark_deleted()
  self._deleted = true
end


function ProjectsV2FieldEntity:deleted()
  return true == self._deleted
end


function ProjectsV2FieldEntity:data_set(args)
  if args ~= nil then
...
function ProjectsV2FieldEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ProjectsV2FieldEntity:match_set(args)
  if args ~= nil then
...
function ProjectsV2FieldEntity:match_get()
...
function ProjectsV2FieldEntity:stream(action, args, callopts)
...
---@param reqmatch ProjectsV2FieldLoadMatch
---@param ctrl? table
---@return ProjectsV2Field
---@return string? err
function ProjectsV2FieldEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ProjectsV2FieldListMatch
---@param ctrl? table
---@return ProjectsV2Field[]
---@return string? err
function ProjectsV2FieldEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function ProjectsV2FieldEntity:_run_op(ctx, post_done)
  local utility = self._utility
