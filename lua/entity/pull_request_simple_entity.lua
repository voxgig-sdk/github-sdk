...
local PullRequestSimpleEntity = {}
PullRequestSimpleEntity.__index = PullRequestSimpleEntity


function PullRequestSimpleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PullRequestSimpleEntity)
  self._name = "pull_request_simple"
  self._client = client
...
function PullRequestSimpleEntity:get_name()
  return self._name
end


function PullRequestSimpleEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PullRequestSimpleEntity.new(self._client, opts)
end
...
function PullRequestSimpleEntity:mark_deleted()
  self._deleted = true
end


function PullRequestSimpleEntity:deleted()
  return true == self._deleted
end


function PullRequestSimpleEntity:data_set(args)
  if args ~= nil then
...
function PullRequestSimpleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PullRequestSimpleEntity:match_set(args)
  if args ~= nil then
...
function PullRequestSimpleEntity:match_get()
...
function PullRequestSimpleEntity:stream(action, args, callopts)
...
---@param reqdata PullRequestSimpleCreateData
---@param ctrl? table
---@return PullRequestSimple
---@return string? err
function PullRequestSimpleEntity:create(reqdata, ctrl)
  local utility = self._utility
...
---@param reqmatch PullRequestSimpleRemoveMatch
---@param ctrl? table
---@return PullRequestSimple
---@return string? err
function PullRequestSimpleEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function PullRequestSimpleEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PullRequestSimpleEntity
