...
local DeploymentBranchPolicyEntity = {}
DeploymentBranchPolicyEntity.__index = DeploymentBranchPolicyEntity


function DeploymentBranchPolicyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeploymentBranchPolicyEntity)
  self._name = "deployment_branch_policy"
  self._client = client
...
function DeploymentBranchPolicyEntity:get_name()
  return self._name
end


function DeploymentBranchPolicyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DeploymentBranchPolicyEntity.new(self._client, opts)
end
...
function DeploymentBranchPolicyEntity:mark_deleted()
  self._deleted = true
end


function DeploymentBranchPolicyEntity:deleted()
  return true == self._deleted
end


function DeploymentBranchPolicyEntity:data_set(args)
  if args ~= nil then
...
function DeploymentBranchPolicyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeploymentBranchPolicyEntity:match_set(args)
  if args ~= nil then
...
function DeploymentBranchPolicyEntity:match_get()
...
function DeploymentBranchPolicyEntity:stream(action, args, callopts)
...
---@param reqmatch DeploymentBranchPolicyLoadMatch
---@param ctrl? table
---@return DeploymentBranchPolicy
---@return string? err
function DeploymentBranchPolicyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata DeploymentBranchPolicyCreateData
---@param ctrl? table
---@return DeploymentBranchPolicy
---@return string? err
function DeploymentBranchPolicyEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata DeploymentBranchPolicyUpdateData
---@param ctrl? table
---@return DeploymentBranchPolicy
---@return string? err
function DeploymentBranchPolicyEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function DeploymentBranchPolicyEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DeploymentBranchPolicyEntity
