...
local CodeScanningEntity = {}
CodeScanningEntity.__index = CodeScanningEntity


function CodeScanningEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CodeScanningEntity)
  self._name = "code_scanning"
  self._client = client
...
function CodeScanningEntity:get_name()
  return self._name
end


function CodeScanningEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CodeScanningEntity.new(self._client, opts)
end
...
function CodeScanningEntity:mark_deleted()
  self._deleted = true
end


function CodeScanningEntity:deleted()
  return true == self._deleted
end


function CodeScanningEntity:data_set(args)
  if args ~= nil then
...
function CodeScanningEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CodeScanningEntity:match_set(args)
  if args ~= nil then
...
function CodeScanningEntity:match_get()
...
function CodeScanningEntity:stream(action, args, callopts)
...
---@param reqdata CodeScanningCreateData
---@param ctrl? table
---@return CodeScanning
---@return string? err
function CodeScanningEntity:create(reqdata, ctrl)
  local utility = self._utility
...
---@param reqmatch CodeScanningRemoveMatch
---@param ctrl? table
---@return CodeScanning
---@return string? err
function CodeScanningEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function CodeScanningEntity:_run_op(ctx, post_done)
  local utility = self._utility
