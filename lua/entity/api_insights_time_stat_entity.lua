...
local ApiInsightsTimeStatEntity = {}
ApiInsightsTimeStatEntity.__index = ApiInsightsTimeStatEntity


function ApiInsightsTimeStatEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiInsightsTimeStatEntity)
  self._name = "api_insights_time_stat"
  self._client = client
...
function ApiInsightsTimeStatEntity:get_name()
  return self._name
end


function ApiInsightsTimeStatEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiInsightsTimeStatEntity.new(self._client, opts)
end
...
function ApiInsightsTimeStatEntity:mark_deleted()
  self._deleted = true
end


function ApiInsightsTimeStatEntity:deleted()
  return true == self._deleted
end


function ApiInsightsTimeStatEntity:data_set(args)
  if args ~= nil then
...
function ApiInsightsTimeStatEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiInsightsTimeStatEntity:match_set(args)
  if args ~= nil then
...
function ApiInsightsTimeStatEntity:match_get()
...
function ApiInsightsTimeStatEntity:stream(action, args, callopts)
...
---@param reqmatch ApiInsightsTimeStatLoadMatch
---@param ctrl? table
---@return ApiInsightsTimeStat
---@return string? err
function ApiInsightsTimeStatEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiInsightsTimeStatListMatch
---@param ctrl? table
---@return ApiInsightsTimeStat[]
---@return string? err
function ApiInsightsTimeStatEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function ApiInsightsTimeStatEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiInsightsTimeStatEntity
