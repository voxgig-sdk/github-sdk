-- Github SDK OrgRepoCustomPropertyValue entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local OrgRepoCustomPropertyValueEntity = {}
OrgRepoCustomPropertyValueEntity.__index = OrgRepoCustomPropertyValueEntity


function OrgRepoCustomPropertyValueEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrgRepoCustomPropertyValueEntity)
  self._name = "org_repo_custom_property_value"
  self._client = client
...
function OrgRepoCustomPropertyValueEntity:get_name()
  return self._name
end


function OrgRepoCustomPropertyValueEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrgRepoCustomPropertyValueEntity.new(self._client, opts)
end
...
function OrgRepoCustomPropertyValueEntity:mark_deleted()
  self._deleted = true
end


function OrgRepoCustomPropertyValueEntity:deleted()
  return true == self._deleted
end


function OrgRepoCustomPropertyValueEntity:data_set(args)
  if args ~= nil then
...
function OrgRepoCustomPropertyValueEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrgRepoCustomPropertyValueEntity:match_set(args)
  if args ~= nil then
...
function OrgRepoCustomPropertyValueEntity:match_get()
...
function OrgRepoCustomPropertyValueEntity:stream(action, args, callopts)
...
---@param reqmatch OrgRepoCustomPropertyValueListMatch
---@param ctrl? table
---@return OrgRepoCustomPropertyValue[]
---@return string? err
function OrgRepoCustomPropertyValueEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function OrgRepoCustomPropertyValueEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrgRepoCustomPropertyValueEntity
