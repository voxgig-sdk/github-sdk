...
local EnterpriseTeamEntity = {}
EnterpriseTeamEntity.__index = EnterpriseTeamEntity


function EnterpriseTeamEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EnterpriseTeamEntity)
  self._name = "enterprise_team"
  self._client = client
...
function EnterpriseTeamEntity:get_name()
  return self._name
end


function EnterpriseTeamEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EnterpriseTeamEntity.new(self._client, opts)
end
...
function EnterpriseTeamEntity:mark_deleted()
  self._deleted = true
end


function EnterpriseTeamEntity:deleted()
  return true == self._deleted
end


function EnterpriseTeamEntity:data_set(args)
  if args ~= nil then
...
function EnterpriseTeamEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EnterpriseTeamEntity:match_set(args)
  if args ~= nil then
...
function EnterpriseTeamEntity:match_get()
...
function EnterpriseTeamEntity:stream(action, args, callopts)
...
---@param reqmatch EnterpriseTeamLoadMatch
---@param ctrl? table
---@return EnterpriseTeam
---@return string? err
function EnterpriseTeamEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch EnterpriseTeamListMatch
---@param ctrl? table
---@return EnterpriseTeam[]
---@return string? err
function EnterpriseTeamEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata EnterpriseTeamCreateData
---@param ctrl? table
---@return EnterpriseTeam
---@return string? err
function EnterpriseTeamEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata EnterpriseTeamUpdateData
---@param ctrl? table
---@return EnterpriseTeam
---@return string? err
function EnterpriseTeamEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch EnterpriseTeamRemoveMatch
---@param ctrl? table
---@return EnterpriseTeam
---@return string? err
function EnterpriseTeamEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function EnterpriseTeamEntity:_run_op(ctx, post_done)
  local utility = self._utility
