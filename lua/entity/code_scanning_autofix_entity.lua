...
local CodeScanningAutofixEntity = {}
CodeScanningAutofixEntity.__index = CodeScanningAutofixEntity


function CodeScanningAutofixEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CodeScanningAutofixEntity)
  self._name = "code_scanning_autofix"
  self._client = client
...
function CodeScanningAutofixEntity:get_name()
  return self._name
end


function CodeScanningAutofixEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CodeScanningAutofixEntity.new(self._client, opts)
end
...
function CodeScanningAutofixEntity:mark_deleted()
  self._deleted = true
end


function CodeScanningAutofixEntity:deleted()
  return true == self._deleted
end


function CodeScanningAutofixEntity:data_set(args)
  if args ~= nil then
...
function CodeScanningAutofixEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CodeScanningAutofixEntity:match_set(args)
  if args ~= nil then
...
function CodeScanningAutofixEntity:match_get()
...
function CodeScanningAutofixEntity:stream(action, args, callopts)
...
---@param reqmatch CodeScanningAutofixLoadMatch
---@param ctrl? table
---@return CodeScanningAutofix
---@return string? err
function CodeScanningAutofixEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata CodeScanningAutofixCreateData
---@param ctrl? table
---@return CodeScanningAutofix
---@return string? err
function CodeScanningAutofixEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function CodeScanningAutofixEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CodeScanningAutofixEntity
