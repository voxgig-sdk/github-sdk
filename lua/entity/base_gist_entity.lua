...
local BaseGistEntity = {}
BaseGistEntity.__index = BaseGistEntity


function BaseGistEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BaseGistEntity)
  self._name = "base_gist"
  self._client = client
...
function BaseGistEntity:get_name()
  return self._name
end


function BaseGistEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BaseGistEntity.new(self._client, opts)
end
...
function BaseGistEntity:mark_deleted()
  self._deleted = true
end


function BaseGistEntity:deleted()
  return true == self._deleted
end


function BaseGistEntity:data_set(args)
  if args ~= nil then
...
function BaseGistEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BaseGistEntity:match_set(args)
  if args ~= nil then
...
function BaseGistEntity:match_get()
...
function BaseGistEntity:stream(action, args, callopts)
...
---@param reqmatch BaseGistListMatch
---@param ctrl? table
---@return BaseGist[]
---@return string? err
function BaseGistEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata BaseGistCreateData
---@param ctrl? table
---@return BaseGist
---@return string? err
function BaseGistEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function BaseGistEntity:_run_op(ctx, post_done)
  local utility = self._utility
