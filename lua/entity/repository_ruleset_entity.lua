...
local RepositoryRulesetEntity = {}
RepositoryRulesetEntity.__index = RepositoryRulesetEntity


function RepositoryRulesetEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepositoryRulesetEntity)
  self._name = "repository_ruleset"
  self._client = client
...
function RepositoryRulesetEntity:get_name()
  return self._name
end


function RepositoryRulesetEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepositoryRulesetEntity.new(self._client, opts)
end
...
function RepositoryRulesetEntity:mark_deleted()
  self._deleted = true
end


function RepositoryRulesetEntity:deleted()
  return true == self._deleted
end


function RepositoryRulesetEntity:data_set(args)
  if args ~= nil then
...
function RepositoryRulesetEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepositoryRulesetEntity:match_set(args)
  if args ~= nil then
...
function RepositoryRulesetEntity:match_get()
...
function RepositoryRulesetEntity:stream(action, args, callopts)
...
---@param reqmatch RepositoryRulesetLoadMatch
---@param ctrl? table
---@return RepositoryRuleset
---@return string? err
function RepositoryRulesetEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch RepositoryRulesetListMatch
---@param ctrl? table
---@return RepositoryRuleset[]
---@return string? err
function RepositoryRulesetEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata RepositoryRulesetCreateData
---@param ctrl? table
---@return RepositoryRuleset
---@return string? err
function RepositoryRulesetEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata RepositoryRulesetUpdateData
---@param ctrl? table
---@return RepositoryRuleset
---@return string? err
function RepositoryRulesetEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function RepositoryRulesetEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RepositoryRulesetEntity
