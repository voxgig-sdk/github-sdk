-- Github SDK SecretScanningPatternConfiguration entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local SecretScanningPatternConfigurationEntity = {}
SecretScanningPatternConfigurationEntity.__index = SecretScanningPatternConfigurationEntity


function SecretScanningPatternConfigurationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SecretScanningPatternConfigurationEntity)
  self._name = "secret_scanning_pattern_configuration"
  self._client = client
...
function SecretScanningPatternConfigurationEntity:get_name()
  return self._name
end


function SecretScanningPatternConfigurationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SecretScanningPatternConfigurationEntity.new(self._client, opts)
end
...
function SecretScanningPatternConfigurationEntity:mark_deleted()
  self._deleted = true
end


function SecretScanningPatternConfigurationEntity:deleted()
  return true == self._deleted
end


function SecretScanningPatternConfigurationEntity:data_set(args)
  if args ~= nil then
...
function SecretScanningPatternConfigurationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SecretScanningPatternConfigurationEntity:match_set(args)
  if args ~= nil then
...
function SecretScanningPatternConfigurationEntity:match_get()
...
function SecretScanningPatternConfigurationEntity:stream(action, args, callopts)
...
---@param reqmatch SecretScanningPatternConfigurationListMatch
---@param ctrl? table
---@return SecretScanningPatternConfiguration[]
---@return string? err
function SecretScanningPatternConfigurationEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function SecretScanningPatternConfigurationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SecretScanningPatternConfigurationEntity
