...
---@param reqmatch AppListMatch
---@param ctrl? table
---@return App[]
---@return string? err
function AppEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata AppCreateData
---@param ctrl? table
---@return App
---@return string? err
function AppEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata AppUpdateData
---@param ctrl? table
---@return App
---@return string? err
function AppEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch AppRemoveMatch
---@param ctrl? table
---@return App
---@return string? err
function AppEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
