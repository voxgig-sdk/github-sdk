...
local CodeSecurityEntity = {}
CodeSecurityEntity.__index = CodeSecurityEntity


function CodeSecurityEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CodeSecurityEntity)
  self._name = "code_security"
  self._client = client
...
function CodeSecurityEntity:get_name()
  return self._name
end


function CodeSecurityEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CodeSecurityEntity.new(self._client, opts)
end
...
function CodeSecurityEntity:mark_deleted()
  self._deleted = true
end


function CodeSecurityEntity:deleted()
  return true == self._deleted
end


function CodeSecurityEntity:data_set(args)
  if args ~= nil then
...
function CodeSecurityEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CodeSecurityEntity:match_set(args)
  if args ~= nil then
...
function CodeSecurityEntity:match_get()
...
function CodeSecurityEntity:stream(action, args, callopts)
...
---@param reqdata CodeSecurityUpdateData
---@param ctrl? table
---@return CodeSecurity
---@return string? err
function CodeSecurityEntity:update(reqdata, ctrl)
  local utility = self._utility
...
---@param reqmatch CodeSecurityRemoveMatch
---@param ctrl? table
---@return CodeSecurity
---@return string? err
function CodeSecurityEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function CodeSecurityEntity:_run_op(ctx, post_done)
  local utility = self._utility
