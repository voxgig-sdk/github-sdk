...
local ClassroomAssignmentGradeEntity = {}
ClassroomAssignmentGradeEntity.__index = ClassroomAssignmentGradeEntity


function ClassroomAssignmentGradeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ClassroomAssignmentGradeEntity)
  self._name = "classroom_assignment_grade"
  self._client = client
...
function ClassroomAssignmentGradeEntity:get_name()
  return self._name
end


function ClassroomAssignmentGradeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ClassroomAssignmentGradeEntity.new(self._client, opts)
end
...
function ClassroomAssignmentGradeEntity:mark_deleted()
  self._deleted = true
end


function ClassroomAssignmentGradeEntity:deleted()
  return true == self._deleted
end


function ClassroomAssignmentGradeEntity:data_set(args)
  if args ~= nil then
...
function ClassroomAssignmentGradeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ClassroomAssignmentGradeEntity:match_set(args)
  if args ~= nil then
...
function ClassroomAssignmentGradeEntity:match_get()
...
function ClassroomAssignmentGradeEntity:stream(action, args, callopts)
...
---@param reqmatch ClassroomAssignmentGradeListMatch
---@param ctrl? table
---@return ClassroomAssignmentGrade[]
---@return string? err
function ClassroomAssignmentGradeEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ClassroomAssignmentGradeEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ClassroomAssignmentGradeEntity
