...
local PagesDeploymentStatusEntity = {}
PagesDeploymentStatusEntity.__index = PagesDeploymentStatusEntity


function PagesDeploymentStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PagesDeploymentStatusEntity)
  self._name = "pages_deployment_status"
  self._client = client
...
function PagesDeploymentStatusEntity:get_name()
  return self._name
end


function PagesDeploymentStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PagesDeploymentStatusEntity.new(self._client, opts)
end
...
function PagesDeploymentStatusEntity:mark_deleted()
  self._deleted = true
end


function PagesDeploymentStatusEntity:deleted()
  return true == self._deleted
end


function PagesDeploymentStatusEntity:data_set(args)
  if args ~= nil then
...
function PagesDeploymentStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PagesDeploymentStatusEntity:match_set(args)
  if args ~= nil then
...
function PagesDeploymentStatusEntity:match_get()
...
function PagesDeploymentStatusEntity:stream(action, args, callopts)
...
---@param reqmatch PagesDeploymentStatusLoadMatch
---@param ctrl? table
---@return PagesDeploymentStatus
---@return string? err
function PagesDeploymentStatusEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata PagesDeploymentStatusCreateData
---@param ctrl? table
---@return PagesDeploymentStatus
---@return string? err
function PagesDeploymentStatusEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function PagesDeploymentStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PagesDeploymentStatusEntity
