...
local CodeScanningAnalysisDeletionEntity = {}
CodeScanningAnalysisDeletionEntity.__index = CodeScanningAnalysisDeletionEntity


function CodeScanningAnalysisDeletionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CodeScanningAnalysisDeletionEntity)
  self._name = "code_scanning_analysis_deletion"
  self._client = client
...
function CodeScanningAnalysisDeletionEntity:get_name()
  return self._name
end


function CodeScanningAnalysisDeletionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CodeScanningAnalysisDeletionEntity.new(self._client, opts)
end
...
function CodeScanningAnalysisDeletionEntity:mark_deleted()
  self._deleted = true
end


function CodeScanningAnalysisDeletionEntity:deleted()
  return true == self._deleted
end


function CodeScanningAnalysisDeletionEntity:data_set(args)
  if args ~= nil then
...
function CodeScanningAnalysisDeletionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CodeScanningAnalysisDeletionEntity:match_set(args)
  if args ~= nil then
...
function CodeScanningAnalysisDeletionEntity:match_get()
...
function CodeScanningAnalysisDeletionEntity:stream(action, args, callopts)
...
---@param reqmatch CodeScanningAnalysisDeletionRemoveMatch
---@param ctrl? table
---@return CodeScanningAnalysisDeletion
---@return string? err
function CodeScanningAnalysisDeletionEntity:remove(reqmatch, ctrl)
  local utility = self._utility
...
function CodeScanningAnalysisDeletionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CodeScanningAnalysisDeletionEntity
