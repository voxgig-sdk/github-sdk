-- Github SDK ActionsOrganizationPermission entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ActionsOrganizationPermissionEntity = {}
ActionsOrganizationPermissionEntity.__index = ActionsOrganizationPermissionEntity


function ActionsOrganizationPermissionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ActionsOrganizationPermissionEntity)
  self._name = "actions_organization_permission"
  self._client = client
...
function ActionsOrganizationPermissionEntity:get_name()
  return self._name
end


function ActionsOrganizationPermissionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ActionsOrganizationPermissionEntity.new(self._client, opts)
end
...
function ActionsOrganizationPermissionEntity:mark_deleted()
  self._deleted = true
end


function ActionsOrganizationPermissionEntity:deleted()
  return true == self._deleted
end


function ActionsOrganizationPermissionEntity:data_set(args)
  if args ~= nil then
...
function ActionsOrganizationPermissionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ActionsOrganizationPermissionEntity:match_set(args)
  if args ~= nil then
...
function ActionsOrganizationPermissionEntity:match_get()
...
function ActionsOrganizationPermissionEntity:stream(action, args, callopts)
...
---@param reqmatch ActionsOrganizationPermissionLoadMatch
---@param ctrl? table
---@return ActionsOrganizationPermission
---@return string? err
function ActionsOrganizationPermissionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ActionsOrganizationPermissionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ActionsOrganizationPermissionEntity
