...
local ApiOverviewEntity = {}
ApiOverviewEntity.__index = ApiOverviewEntity


function ApiOverviewEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiOverviewEntity)
  self._name = "api_overview"
  self._client = client
...
function ApiOverviewEntity:get_name()
  return self._name
end


function ApiOverviewEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiOverviewEntity.new(self._client, opts)
end
...
function ApiOverviewEntity:mark_deleted()
  self._deleted = true
end


function ApiOverviewEntity:deleted()
  return true == self._deleted
end


function ApiOverviewEntity:data_set(args)
  if args ~= nil then
...
function ApiOverviewEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiOverviewEntity:match_set(args)
  if args ~= nil then
...
function ApiOverviewEntity:match_get()
...
function ApiOverviewEntity:stream(action, args, callopts)
...
---@param reqmatch ApiOverviewListMatch
---@param ctrl? table
---@return ApiOverview[]
---@return string? err
function ApiOverviewEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ApiOverviewEntity:_run_op(ctx, post_done)
  local utility = self._utility
