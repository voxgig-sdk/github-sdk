...
---@param reqmatch ActionLoadMatch
---@param ctrl? table
---@return Action
---@return string? err
function ActionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ActionListMatch
---@param ctrl? table
---@return Action[]
---@return string? err
function ActionEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ActionUpdateData
---@param ctrl? table
---@return Action
---@return string? err
function ActionEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ActionRemoveMatch
---@param ctrl? table
---@return Action
---@return string? err
function ActionEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
