...
local SecretScanningEntity = {}
SecretScanningEntity.__index = SecretScanningEntity


function SecretScanningEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SecretScanningEntity)
  self._name = "secret_scanning"
  self._client = client
...
function SecretScanningEntity:get_name()
  return self._name
end


function SecretScanningEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SecretScanningEntity.new(self._client, opts)
end
...
function SecretScanningEntity:mark_deleted()
  self._deleted = true
end


function SecretScanningEntity:deleted()
  return true == self._deleted
end


function SecretScanningEntity:data_set(args)
  if args ~= nil then
...
function SecretScanningEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SecretScanningEntity:match_set(args)
  if args ~= nil then
...
function SecretScanningEntity:match_get()
...
function SecretScanningEntity:stream(action, args, callopts)
...
---@param reqdata SecretScanningUpdateData
---@param ctrl? table
---@return SecretScanning
---@return string? err
function SecretScanningEntity:update(reqdata, ctrl)
  local utility = self._utility
...
function SecretScanningEntity:_run_op(ctx, post_done)
  local utility = self._utility
