...
local RulesetVersionWithStateEntity = {}
RulesetVersionWithStateEntity.__index = RulesetVersionWithStateEntity


function RulesetVersionWithStateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RulesetVersionWithStateEntity)
  self._name = "ruleset_version_with_state"
  self._client = client
...
function RulesetVersionWithStateEntity:get_name()
  return self._name
end


function RulesetVersionWithStateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RulesetVersionWithStateEntity.new(self._client, opts)
end
...
function RulesetVersionWithStateEntity:mark_deleted()
  self._deleted = true
end


function RulesetVersionWithStateEntity:deleted()
  return true == self._deleted
end


function RulesetVersionWithStateEntity:data_set(args)
  if args ~= nil then
...
function RulesetVersionWithStateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RulesetVersionWithStateEntity:match_set(args)
  if args ~= nil then
...
function RulesetVersionWithStateEntity:match_get()
...
function RulesetVersionWithStateEntity:stream(action, args, callopts)
...
---@param reqmatch RulesetVersionWithStateLoadMatch
---@param ctrl? table
---@return RulesetVersionWithState
---@return string? err
function RulesetVersionWithStateEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function RulesetVersionWithStateEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RulesetVersionWithStateEntity
