...
local MarketplaceListingPlanEntity = {}
MarketplaceListingPlanEntity.__index = MarketplaceListingPlanEntity


function MarketplaceListingPlanEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MarketplaceListingPlanEntity)
  self._name = "marketplace_listing_plan"
  self._client = client
...
function MarketplaceListingPlanEntity:get_name()
  return self._name
end


function MarketplaceListingPlanEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MarketplaceListingPlanEntity.new(self._client, opts)
end
...
function MarketplaceListingPlanEntity:mark_deleted()
  self._deleted = true
end


function MarketplaceListingPlanEntity:deleted()
  return true == self._deleted
end


function MarketplaceListingPlanEntity:data_set(args)
  if args ~= nil then
...
function MarketplaceListingPlanEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MarketplaceListingPlanEntity:match_set(args)
  if args ~= nil then
...
function MarketplaceListingPlanEntity:match_get()
...
function MarketplaceListingPlanEntity:stream(action, args, callopts)
...
---@param reqmatch MarketplaceListingPlanListMatch
---@param ctrl? table
---@return MarketplaceListingPlan[]
---@return string? err
function MarketplaceListingPlanEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function MarketplaceListingPlanEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MarketplaceListingPlanEntity
