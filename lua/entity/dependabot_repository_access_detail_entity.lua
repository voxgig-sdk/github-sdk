-- Github SDK DependabotRepositoryAccessDetail entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local DependabotRepositoryAccessDetailEntity = {}
DependabotRepositoryAccessDetailEntity.__index = DependabotRepositoryAccessDetailEntity


function DependabotRepositoryAccessDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DependabotRepositoryAccessDetailEntity)
  self._name = "dependabot_repository_access_detail"
  self._client = client
...
function DependabotRepositoryAccessDetailEntity:get_name()
  return self._name
end


function DependabotRepositoryAccessDetailEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DependabotRepositoryAccessDetailEntity.new(self._client, opts)
end
...
function DependabotRepositoryAccessDetailEntity:mark_deleted()
  self._deleted = true
end


function DependabotRepositoryAccessDetailEntity:deleted()
  return true == self._deleted
end


function DependabotRepositoryAccessDetailEntity:data_set(args)
  if args ~= nil then
...
function DependabotRepositoryAccessDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DependabotRepositoryAccessDetailEntity:match_set(args)
  if args ~= nil then
...
function DependabotRepositoryAccessDetailEntity:match_get()
...
function DependabotRepositoryAccessDetailEntity:stream(action, args, callopts)
...
---@param reqmatch DependabotRepositoryAccessDetailListMatch
---@param ctrl? table
---@return DependabotRepositoryAccessDetail[]
---@return string? err
function DependabotRepositoryAccessDetailEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function DependabotRepositoryAccessDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DependabotRepositoryAccessDetailEntity
