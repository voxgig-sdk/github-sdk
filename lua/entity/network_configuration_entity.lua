...
local NetworkConfigurationEntity = {}
NetworkConfigurationEntity.__index = NetworkConfigurationEntity


function NetworkConfigurationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NetworkConfigurationEntity)
  self._name = "network_configuration"
  self._client = client
...
function NetworkConfigurationEntity:get_name()
  return self._name
end


function NetworkConfigurationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NetworkConfigurationEntity.new(self._client, opts)
end
...
function NetworkConfigurationEntity:mark_deleted()
  self._deleted = true
end


function NetworkConfigurationEntity:deleted()
  return true == self._deleted
end


function NetworkConfigurationEntity:data_set(args)
  if args ~= nil then
...
function NetworkConfigurationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NetworkConfigurationEntity:match_set(args)
  if args ~= nil then
...
function NetworkConfigurationEntity:match_get()
...
function NetworkConfigurationEntity:stream(action, args, callopts)
...
---@param reqmatch NetworkConfigurationLoadMatch
---@param ctrl? table
---@return NetworkConfiguration
---@return string? err
function NetworkConfigurationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata NetworkConfigurationCreateData
---@param ctrl? table
---@return NetworkConfiguration
---@return string? err
function NetworkConfigurationEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata NetworkConfigurationUpdateData
---@param ctrl? table
---@return NetworkConfiguration
---@return string? err
function NetworkConfigurationEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function NetworkConfigurationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return NetworkConfigurationEntity
