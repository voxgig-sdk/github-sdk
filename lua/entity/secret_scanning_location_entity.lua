...
local SecretScanningLocationEntity = {}
SecretScanningLocationEntity.__index = SecretScanningLocationEntity


function SecretScanningLocationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SecretScanningLocationEntity)
  self._name = "secret_scanning_location"
  self._client = client
...
function SecretScanningLocationEntity:get_name()
  return self._name
end


function SecretScanningLocationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SecretScanningLocationEntity.new(self._client, opts)
end
...
function SecretScanningLocationEntity:mark_deleted()
  self._deleted = true
end


function SecretScanningLocationEntity:deleted()
  return true == self._deleted
end


function SecretScanningLocationEntity:data_set(args)
  if args ~= nil then
...
function SecretScanningLocationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SecretScanningLocationEntity:match_set(args)
  if args ~= nil then
...
function SecretScanningLocationEntity:match_get()
...
function SecretScanningLocationEntity:stream(action, args, callopts)
...
---@param reqmatch SecretScanningLocationListMatch
---@param ctrl? table
---@return SecretScanningLocation[]
---@return string? err
function SecretScanningLocationEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function SecretScanningLocationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SecretScanningLocationEntity
