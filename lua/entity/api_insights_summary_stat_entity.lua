...
local ApiInsightsSummaryStatEntity = {}
ApiInsightsSummaryStatEntity.__index = ApiInsightsSummaryStatEntity


function ApiInsightsSummaryStatEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiInsightsSummaryStatEntity)
  self._name = "api_insights_summary_stat"
  self._client = client
...
function ApiInsightsSummaryStatEntity:get_name()
  return self._name
end


function ApiInsightsSummaryStatEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiInsightsSummaryStatEntity.new(self._client, opts)
end
...
function ApiInsightsSummaryStatEntity:mark_deleted()
  self._deleted = true
end


function ApiInsightsSummaryStatEntity:deleted()
  return true == self._deleted
end


function ApiInsightsSummaryStatEntity:data_set(args)
  if args ~= nil then
...
function ApiInsightsSummaryStatEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiInsightsSummaryStatEntity:match_set(args)
  if args ~= nil then
...
function ApiInsightsSummaryStatEntity:match_get()
...
function ApiInsightsSummaryStatEntity:stream(action, args, callopts)
...
---@param reqmatch ApiInsightsSummaryStatLoadMatch
---@param ctrl? table
---@return ApiInsightsSummaryStat
---@return string? err
function ApiInsightsSummaryStatEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApiInsightsSummaryStatEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApiInsightsSummaryStatEntity
