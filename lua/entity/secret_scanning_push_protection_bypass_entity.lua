-- Github SDK SecretScanningPushProtectionBypass entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local SecretScanningPushProtectionBypassEntity = {}
SecretScanningPushProtectionBypassEntity.__index = SecretScanningPushProtectionBypassEntity


function SecretScanningPushProtectionBypassEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SecretScanningPushProtectionBypassEntity)
  self._name = "secret_scanning_push_protection_bypass"
  self._client = client
...
function SecretScanningPushProtectionBypassEntity:get_name()
  return self._name
end


function SecretScanningPushProtectionBypassEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SecretScanningPushProtectionBypassEntity.new(self._client, opts)
end
...
function SecretScanningPushProtectionBypassEntity:mark_deleted()
  self._deleted = true
end


function SecretScanningPushProtectionBypassEntity:deleted()
  return true == self._deleted
end


function SecretScanningPushProtectionBypassEntity:data_set(args)
  if args ~= nil then
...
function SecretScanningPushProtectionBypassEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SecretScanningPushProtectionBypassEntity:match_set(args)
  if args ~= nil then
...
function SecretScanningPushProtectionBypassEntity:match_get()
...
function SecretScanningPushProtectionBypassEntity:stream(action, args, callopts)
...
---@param reqdata SecretScanningPushProtectionBypassCreateData
---@param ctrl? table
---@return SecretScanningPushProtectionBypass
---@return string? err
function SecretScanningPushProtectionBypassEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function SecretScanningPushProtectionBypassEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SecretScanningPushProtectionBypassEntity
