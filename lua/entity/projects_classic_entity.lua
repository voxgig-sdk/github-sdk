...
local ProjectsClassicEntity = {}
ProjectsClassicEntity.__index = ProjectsClassicEntity


function ProjectsClassicEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ProjectsClassicEntity)
  self._name = "projects_classic"
  self._client = client
...
function ProjectsClassicEntity:get_name()
  return self._name
end


function ProjectsClassicEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ProjectsClassicEntity.new(self._client, opts)
end
...
function ProjectsClassicEntity:mark_deleted()
  self._deleted = true
end


function ProjectsClassicEntity:deleted()
  return true == self._deleted
end


function ProjectsClassicEntity:data_set(args)
  if args ~= nil then
...
function ProjectsClassicEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ProjectsClassicEntity:match_set(args)
  if args ~= nil then
...
function ProjectsClassicEntity:match_get()
...
function ProjectsClassicEntity:stream(action, args, callopts)
...
---@param reqdata ProjectsClassicCreateData
---@param ctrl? table
---@return ProjectsClassic
---@return string? err
function ProjectsClassicEntity:create(reqdata, ctrl)
  local utility = self._utility
...
---@param reqdata ProjectsClassicUpdateData
---@param ctrl? table
---@return ProjectsClassic
---@return string? err
function ProjectsClassicEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ProjectsClassicRemoveMatch
---@param ctrl? table
---@return ProjectsClassic
---@return string? err
function ProjectsClassicEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ProjectsClassicEntity:_run_op(ctx, post_done)
  local utility = self._utility
