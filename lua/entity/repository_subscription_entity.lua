...
local RepositorySubscriptionEntity = {}
RepositorySubscriptionEntity.__index = RepositorySubscriptionEntity


function RepositorySubscriptionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepositorySubscriptionEntity)
  self._name = "repository_subscription"
  self._client = client
...
function RepositorySubscriptionEntity:get_name()
  return self._name
end


function RepositorySubscriptionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepositorySubscriptionEntity.new(self._client, opts)
end
...
function RepositorySubscriptionEntity:mark_deleted()
  self._deleted = true
end


function RepositorySubscriptionEntity:deleted()
  return true == self._deleted
end


function RepositorySubscriptionEntity:data_set(args)
  if args ~= nil then
...
function RepositorySubscriptionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepositorySubscriptionEntity:match_set(args)
  if args ~= nil then
...
function RepositorySubscriptionEntity:match_get()
...
function RepositorySubscriptionEntity:stream(action, args, callopts)
...
---@param reqmatch RepositorySubscriptionLoadMatch
---@param ctrl? table
---@return RepositorySubscription
---@return string? err
function RepositorySubscriptionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata RepositorySubscriptionUpdateData
---@param ctrl? table
---@return RepositorySubscription
---@return string? err
function RepositorySubscriptionEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function RepositorySubscriptionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RepositorySubscriptionEntity
