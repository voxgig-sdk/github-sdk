-- Github SDK RepositoryCollaboratorPermission entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local RepositoryCollaboratorPermissionEntity = {}
RepositoryCollaboratorPermissionEntity.__index = RepositoryCollaboratorPermissionEntity


function RepositoryCollaboratorPermissionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepositoryCollaboratorPermissionEntity)
  self._name = "repository_collaborator_permission"
  self._client = client
...
function RepositoryCollaboratorPermissionEntity:get_name()
  return self._name
end


function RepositoryCollaboratorPermissionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepositoryCollaboratorPermissionEntity.new(self._client, opts)
end
...
function RepositoryCollaboratorPermissionEntity:mark_deleted()
  self._deleted = true
end


function RepositoryCollaboratorPermissionEntity:deleted()
  return true == self._deleted
end


function RepositoryCollaboratorPermissionEntity:data_set(args)
  if args ~= nil then
...
function RepositoryCollaboratorPermissionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepositoryCollaboratorPermissionEntity:match_set(args)
  if args ~= nil then
...
function RepositoryCollaboratorPermissionEntity:match_get()
...
function RepositoryCollaboratorPermissionEntity:stream(action, args, callopts)
...
---@param reqmatch RepositoryCollaboratorPermissionLoadMatch
---@param ctrl? table
---@return RepositoryCollaboratorPermission
---@return string? err
function RepositoryCollaboratorPermissionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function RepositoryCollaboratorPermissionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RepositoryCollaboratorPermissionEntity
