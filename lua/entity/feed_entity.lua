...
local FeedEntity = {}
FeedEntity.__index = FeedEntity


function FeedEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FeedEntity)
  self._name = "feed"
  self._client = client
...
function FeedEntity:get_name()
  return self._name
end


function FeedEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FeedEntity.new(self._client, opts)
end
...
function FeedEntity:mark_deleted()
  self._deleted = true
end


function FeedEntity:deleted()
  return true == self._deleted
end


function FeedEntity:data_set(args)
  if args ~= nil then
...
function FeedEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FeedEntity:match_set(args)
  if args ~= nil then
...
function FeedEntity:stream(action, args, callopts)
...
---@param reqmatch FeedListMatch
---@param ctrl? table
---@return Feed[]
---@return string? err
function FeedEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function FeedEntity:_run_op(ctx, post_done)
  local utility = self._utility
