-- Github SDK CopilotOrganizationDetail entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CopilotOrganizationDetailEntity = {}
CopilotOrganizationDetailEntity.__index = CopilotOrganizationDetailEntity


function CopilotOrganizationDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CopilotOrganizationDetailEntity)
  self._name = "copilot_organization_detail"
  self._client = client
...
function CopilotOrganizationDetailEntity:get_name()
  return self._name
end


function CopilotOrganizationDetailEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CopilotOrganizationDetailEntity.new(self._client, opts)
end
...
function CopilotOrganizationDetailEntity:mark_deleted()
  self._deleted = true
end


function CopilotOrganizationDetailEntity:deleted()
  return true == self._deleted
end


function CopilotOrganizationDetailEntity:data_set(args)
  if args ~= nil then
...
function CopilotOrganizationDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CopilotOrganizationDetailEntity:match_set(args)
  if args ~= nil then
...
function CopilotOrganizationDetailEntity:match_get()
...
function CopilotOrganizationDetailEntity:stream(action, args, callopts)
...
---@param reqmatch CopilotOrganizationDetailLoadMatch
---@param ctrl? table
---@return CopilotOrganizationDetail
---@return string? err
function CopilotOrganizationDetailEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function CopilotOrganizationDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CopilotOrganizationDetailEntity
