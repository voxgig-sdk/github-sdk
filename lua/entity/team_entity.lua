...
---@param reqdata TeamCreateData
---@param ctrl? table
---@return Team
---@return string? err
function TeamEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata TeamUpdateData
---@param ctrl? table
---@return Team
---@return string? err
function TeamEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch TeamRemoveMatch
---@param ctrl? table
---@return Team
---@return string? err
function TeamEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
