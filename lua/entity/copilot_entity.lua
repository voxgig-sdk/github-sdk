...
local CopilotEntity = {}
CopilotEntity.__index = CopilotEntity


function CopilotEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CopilotEntity)
  self._name = "copilot"
  self._client = client
...
function CopilotEntity:get_name()
  return self._name
end


function CopilotEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CopilotEntity.new(self._client, opts)
end
...
function CopilotEntity:mark_deleted()
  self._deleted = true
end


function CopilotEntity:deleted()
  return true == self._deleted
end


function CopilotEntity:data_set(args)
  if args ~= nil then
...
function CopilotEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CopilotEntity:match_set(args)
  if args ~= nil then
...
function CopilotEntity:match_get()
...
function CopilotEntity:stream(action, args, callopts)
...
---@param reqmatch CopilotLoadMatch
---@param ctrl? table
---@return Copilot
---@return string? err
function CopilotEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch CopilotListMatch
---@param ctrl? table
---@return Copilot[]
---@return string? err
function CopilotEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata CopilotCreateData
---@param ctrl? table
---@return Copilot
---@return string? err
function CopilotEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqmatch CopilotRemoveMatch
---@param ctrl? table
---@return Copilot
---@return string? err
function CopilotEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function CopilotEntity:_run_op(ctx, post_done)
  local utility = self._utility
