...
local EmptyObjectEntity = {}
EmptyObjectEntity.__index = EmptyObjectEntity


function EmptyObjectEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmptyObjectEntity)
  self._name = "empty_object"
  self._client = client
...
function EmptyObjectEntity:get_name()
  return self._name
end


function EmptyObjectEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EmptyObjectEntity.new(self._client, opts)
end
...
function EmptyObjectEntity:mark_deleted()
  self._deleted = true
end


function EmptyObjectEntity:deleted()
  return true == self._deleted
end


function EmptyObjectEntity:data_set(args)
  if args ~= nil then
...
function EmptyObjectEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmptyObjectEntity:match_set(args)
  if args ~= nil then
...
function EmptyObjectEntity:match_get()
...
function EmptyObjectEntity:stream(action, args, callopts)
...
---@param reqmatch EmptyObjectLoadMatch
---@param ctrl? table
---@return EmptyObject
---@return string? err
function EmptyObjectEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata EmptyObjectCreateData
---@param ctrl? table
---@return EmptyObject
---@return string? err
function EmptyObjectEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata EmptyObjectUpdateData
---@param ctrl? table
---@return EmptyObject
---@return string? err
function EmptyObjectEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function EmptyObjectEntity:_run_op(ctx, post_done)
  local utility = self._utility
