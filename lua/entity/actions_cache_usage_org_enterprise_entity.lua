-- Github SDK ActionsCacheUsageOrgEnterprise entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ActionsCacheUsageOrgEnterpriseEntity = {}
ActionsCacheUsageOrgEnterpriseEntity.__index = ActionsCacheUsageOrgEnterpriseEntity


function ActionsCacheUsageOrgEnterpriseEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ActionsCacheUsageOrgEnterpriseEntity)
  self._name = "actions_cache_usage_org_enterprise"
  self._client = client
...
function ActionsCacheUsageOrgEnterpriseEntity:get_name()
  return self._name
end


function ActionsCacheUsageOrgEnterpriseEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ActionsCacheUsageOrgEnterpriseEntity.new(self._client, opts)
end
...
function ActionsCacheUsageOrgEnterpriseEntity:mark_deleted()
  self._deleted = true
end


function ActionsCacheUsageOrgEnterpriseEntity:deleted()
  return true == self._deleted
end


function ActionsCacheUsageOrgEnterpriseEntity:data_set(args)
  if args ~= nil then
...
function ActionsCacheUsageOrgEnterpriseEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ActionsCacheUsageOrgEnterpriseEntity:match_set(args)
  if args ~= nil then
...
function ActionsCacheUsageOrgEnterpriseEntity:match_get()
...
function ActionsCacheUsageOrgEnterpriseEntity:stream(action, args, callopts)
...
---@param reqmatch ActionsCacheUsageOrgEnterpriseLoadMatch
---@param ctrl? table
---@return ActionsCacheUsageOrgEnterprise
---@return string? err
function ActionsCacheUsageOrgEnterpriseEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ActionsCacheUsageOrgEnterpriseEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ActionsCacheUsageOrgEnterpriseEntity
