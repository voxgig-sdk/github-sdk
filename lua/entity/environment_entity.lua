...
---@param reqmatch EnvironmentLoadMatch
---@param ctrl? table
---@return Environment
---@return string? err
function EnvironmentEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata EnvironmentUpdateData
---@param ctrl? table
---@return Environment
---@return string? err
function EnvironmentEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
