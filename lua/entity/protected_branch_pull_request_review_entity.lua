...
local ProtectedBranchPullRequestReviewEntity = {}
ProtectedBranchPullRequestReviewEntity.__index = ProtectedBranchPullRequestReviewEntity


function ProtectedBranchPullRequestReviewEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ProtectedBranchPullRequestReviewEntity)
  self._name = "protected_branch_pull_request_review"
  self._client = client
...
function ProtectedBranchPullRequestReviewEntity:get_name()
  return self._name
end


function ProtectedBranchPullRequestReviewEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ProtectedBranchPullRequestReviewEntity.new(self._client, opts)
end
...
function ProtectedBranchPullRequestReviewEntity:mark_deleted()
  self._deleted = true
end


function ProtectedBranchPullRequestReviewEntity:deleted()
  return true == self._deleted
end


function ProtectedBranchPullRequestReviewEntity:data_set(args)
  if args ~= nil then
...
function ProtectedBranchPullRequestReviewEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ProtectedBranchPullRequestReviewEntity:match_set(args)
  if args ~= nil then
...
function ProtectedBranchPullRequestReviewEntity:match_get()
...
function ProtectedBranchPullRequestReviewEntity:stream(action, args, callopts)
...
---@param reqmatch ProtectedBranchPullRequestReviewLoadMatch
---@param ctrl? table
---@return ProtectedBranchPullRequestReview
---@return string? err
function ProtectedBranchPullRequestReviewEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ProtectedBranchPullRequestReviewUpdateData
---@param ctrl? table
---@return ProtectedBranchPullRequestReview
---@return string? err
function ProtectedBranchPullRequestReviewEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ProtectedBranchPullRequestReviewEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ProtectedBranchPullRequestReviewEntity
