-- Github SDK CodeSecurityConfigurationRepository entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CodeSecurityConfigurationRepositoryEntity = {}
CodeSecurityConfigurationRepositoryEntity.__index = CodeSecurityConfigurationRepositoryEntity


function CodeSecurityConfigurationRepositoryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CodeSecurityConfigurationRepositoryEntity)
  self._name = "code_security_configuration_repository"
  self._client = client
...
function CodeSecurityConfigurationRepositoryEntity:get_name()
  return self._name
end


function CodeSecurityConfigurationRepositoryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CodeSecurityConfigurationRepositoryEntity.new(self._client, opts)
end
...
function CodeSecurityConfigurationRepositoryEntity:mark_deleted()
  self._deleted = true
end


function CodeSecurityConfigurationRepositoryEntity:deleted()
  return true == self._deleted
end


function CodeSecurityConfigurationRepositoryEntity:data_set(args)
  if args ~= nil then
...
function CodeSecurityConfigurationRepositoryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CodeSecurityConfigurationRepositoryEntity:match_set(args)
  if args ~= nil then
...
function CodeSecurityConfigurationRepositoryEntity:match_get()
...
function CodeSecurityConfigurationRepositoryEntity:stream(action, args, callopts)
...
---@param reqmatch CodeSecurityConfigurationRepositoryListMatch
---@param ctrl? table
---@return CodeSecurityConfigurationRepository[]
---@return string? err
function CodeSecurityConfigurationRepositoryEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CodeSecurityConfigurationRepositoryEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CodeSecurityConfigurationRepositoryEntity
