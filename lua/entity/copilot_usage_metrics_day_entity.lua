...
local CopilotUsageMetricsDayEntity = {}
CopilotUsageMetricsDayEntity.__index = CopilotUsageMetricsDayEntity


function CopilotUsageMetricsDayEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CopilotUsageMetricsDayEntity)
  self._name = "copilot_usage_metrics_day"
  self._client = client
...
function CopilotUsageMetricsDayEntity:get_name()
  return self._name
end


function CopilotUsageMetricsDayEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CopilotUsageMetricsDayEntity.new(self._client, opts)
end
...
function CopilotUsageMetricsDayEntity:mark_deleted()
  self._deleted = true
end


function CopilotUsageMetricsDayEntity:deleted()
  return true == self._deleted
end


function CopilotUsageMetricsDayEntity:data_set(args)
  if args ~= nil then
...
function CopilotUsageMetricsDayEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CopilotUsageMetricsDayEntity:match_set(args)
  if args ~= nil then
...
function CopilotUsageMetricsDayEntity:match_get()
...
function CopilotUsageMetricsDayEntity:stream(action, args, callopts)
...
---@param reqmatch CopilotUsageMetricsDayListMatch
---@param ctrl? table
---@return CopilotUsageMetricsDay[]
---@return string? err
function CopilotUsageMetricsDayEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CopilotUsageMetricsDayEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CopilotUsageMetricsDayEntity
