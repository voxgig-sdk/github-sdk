-- Github SDK ActionsArtifactAndLogRetention entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ActionsArtifactAndLogRetentionEntity = {}
ActionsArtifactAndLogRetentionEntity.__index = ActionsArtifactAndLogRetentionEntity


function ActionsArtifactAndLogRetentionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ActionsArtifactAndLogRetentionEntity)
  self._name = "actions_artifact_and_log_retention"
  self._client = client
...
function ActionsArtifactAndLogRetentionEntity:get_name()
  return self._name
end


function ActionsArtifactAndLogRetentionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ActionsArtifactAndLogRetentionEntity.new(self._client, opts)
end
...
function ActionsArtifactAndLogRetentionEntity:mark_deleted()
  self._deleted = true
end


function ActionsArtifactAndLogRetentionEntity:deleted()
  return true == self._deleted
end


function ActionsArtifactAndLogRetentionEntity:data_set(args)
  if args ~= nil then
...
function ActionsArtifactAndLogRetentionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ActionsArtifactAndLogRetentionEntity:match_set(args)
  if args ~= nil then
...
function ActionsArtifactAndLogRetentionEntity:match_get()
...
function ActionsArtifactAndLogRetentionEntity:stream(action, args, callopts)
...
---@param reqmatch ActionsArtifactAndLogRetentionLoadMatch
---@param ctrl? table
---@return ActionsArtifactAndLogRetention
---@return string? err
function ActionsArtifactAndLogRetentionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ActionsArtifactAndLogRetentionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ActionsArtifactAndLogRetentionEntity
