-- Github SDK ActionsGetDefaultWorkflowPermission entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ActionsGetDefaultWorkflowPermissionEntity = {}
ActionsGetDefaultWorkflowPermissionEntity.__index = ActionsGetDefaultWorkflowPermissionEntity


function ActionsGetDefaultWorkflowPermissionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ActionsGetDefaultWorkflowPermissionEntity)
  self._name = "actions_get_default_workflow_permission"
  self._client = client
...
function ActionsGetDefaultWorkflowPermissionEntity:get_name()
  return self._name
end


function ActionsGetDefaultWorkflowPermissionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ActionsGetDefaultWorkflowPermissionEntity.new(self._client, opts)
end
...
function ActionsGetDefaultWorkflowPermissionEntity:mark_deleted()
  self._deleted = true
end


function ActionsGetDefaultWorkflowPermissionEntity:deleted()
  return true == self._deleted
end


function ActionsGetDefaultWorkflowPermissionEntity:data_set(args)
  if args ~= nil then
...
function ActionsGetDefaultWorkflowPermissionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ActionsGetDefaultWorkflowPermissionEntity:match_set(args)
  if args ~= nil then
...
function ActionsGetDefaultWorkflowPermissionEntity:match_get()
...
function ActionsGetDefaultWorkflowPermissionEntity:stream(action, args, callopts)
...
---@param reqmatch ActionsGetDefaultWorkflowPermissionLoadMatch
---@param ctrl? table
---@return ActionsGetDefaultWorkflowPermission
---@return string? err
function ActionsGetDefaultWorkflowPermissionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ActionsGetDefaultWorkflowPermissionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ActionsGetDefaultWorkflowPermissionEntity
