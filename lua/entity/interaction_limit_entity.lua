...
local InteractionLimitEntity = {}
InteractionLimitEntity.__index = InteractionLimitEntity


function InteractionLimitEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, InteractionLimitEntity)
  self._name = "interaction_limit"
  self._client = client
...
function InteractionLimitEntity:get_name()
  return self._name
end


function InteractionLimitEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return InteractionLimitEntity.new(self._client, opts)
end
...
function InteractionLimitEntity:mark_deleted()
  self._deleted = true
end


function InteractionLimitEntity:deleted()
  return true == self._deleted
end


function InteractionLimitEntity:data_set(args)
  if args ~= nil then
...
function InteractionLimitEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function InteractionLimitEntity:match_set(args)
  if args ~= nil then
...
function InteractionLimitEntity:match_get()
...
function InteractionLimitEntity:stream(action, args, callopts)
...
---@param reqdata InteractionLimitUpdateData
---@param ctrl? table
---@return InteractionLimit
---@return string? err
function InteractionLimitEntity:update(reqdata, ctrl)
  local utility = self._utility
...
function InteractionLimitEntity:_run_op(ctx, post_done)
  local utility = self._utility
