...
local HostedComputeEntity = {}
HostedComputeEntity.__index = HostedComputeEntity


function HostedComputeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, HostedComputeEntity)
  self._name = "hosted_compute"
  self._client = client
...
function HostedComputeEntity:get_name()
  return self._name
end


function HostedComputeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return HostedComputeEntity.new(self._client, opts)
end
...
function HostedComputeEntity:mark_deleted()
  self._deleted = true
end


function HostedComputeEntity:deleted()
  return true == self._deleted
end


function HostedComputeEntity:data_set(args)
  if args ~= nil then
...
function HostedComputeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function HostedComputeEntity:match_set(args)
  if args ~= nil then
...
function HostedComputeEntity:match_get()
...
function HostedComputeEntity:stream(action, args, callopts)
...
---@param reqmatch HostedComputeListMatch
---@param ctrl? table
---@return HostedCompute[]
---@return string? err
function HostedComputeEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch HostedComputeRemoveMatch
---@param ctrl? table
---@return HostedCompute
---@return string? err
function HostedComputeEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function HostedComputeEntity:_run_op(ctx, post_done)
  local utility = self._utility
