...
---@param reqmatch DeployKeyLoadMatch
---@param ctrl? table
---@return DeployKey
---@return string? err
function DeployKeyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch DeployKeyListMatch
---@param ctrl? table
---@return DeployKey[]
---@return string? err
function DeployKeyEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata DeployKeyCreateData
---@param ctrl? table
---@return DeployKey
---@return string? err
function DeployKeyEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
