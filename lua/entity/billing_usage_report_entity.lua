...
local BillingUsageReportEntity = {}
BillingUsageReportEntity.__index = BillingUsageReportEntity


function BillingUsageReportEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BillingUsageReportEntity)
  self._name = "billing_usage_report"
  self._client = client
...
function BillingUsageReportEntity:get_name()
  return self._name
end


function BillingUsageReportEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BillingUsageReportEntity.new(self._client, opts)
end
...
function BillingUsageReportEntity:mark_deleted()
  self._deleted = true
end


function BillingUsageReportEntity:deleted()
  return true == self._deleted
end


function BillingUsageReportEntity:data_set(args)
  if args ~= nil then
...
function BillingUsageReportEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BillingUsageReportEntity:match_set(args)
  if args ~= nil then
...
function BillingUsageReportEntity:match_get()
...
function BillingUsageReportEntity:stream(action, args, callopts)
...
---@param reqmatch BillingUsageReportListMatch
---@param ctrl? table
---@return BillingUsageReport[]
---@return string? err
function BillingUsageReportEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function BillingUsageReportEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return BillingUsageReportEntity
