...
local CommitComparisonEntity = {}
CommitComparisonEntity.__index = CommitComparisonEntity


function CommitComparisonEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CommitComparisonEntity)
  self._name = "commit_comparison"
  self._client = client
...
function CommitComparisonEntity:get_name()
  return self._name
end


function CommitComparisonEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CommitComparisonEntity.new(self._client, opts)
end
...
function CommitComparisonEntity:mark_deleted()
  self._deleted = true
end


function CommitComparisonEntity:deleted()
  return true == self._deleted
end


function CommitComparisonEntity:data_set(args)
  if args ~= nil then
...
function CommitComparisonEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CommitComparisonEntity:match_set(args)
  if args ~= nil then
...
function CommitComparisonEntity:match_get()
...
function CommitComparisonEntity:stream(action, args, callopts)
...
---@param reqmatch CommitComparisonLoadMatch
---@param ctrl? table
---@return CommitComparison
---@return string? err
function CommitComparisonEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function CommitComparisonEntity:_run_op(ctx, post_done)
  local utility = self._utility
