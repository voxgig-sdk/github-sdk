...
InstallationEntity.__index = InstallationEntity


function InstallationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, InstallationEntity)
  self._name = "installation"
  self._client = client
...
function InstallationEntity:get_name()
  return self._name
end


function InstallationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return InstallationEntity.new(self._client, opts)
end
...
function InstallationEntity:mark_deleted()
  self._deleted = true
end


function InstallationEntity:deleted()
  return true == self._deleted
end


function InstallationEntity:data_set(args)
  if args ~= nil then
...
function InstallationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function InstallationEntity:match_set(args)
  if args ~= nil then
...
function InstallationEntity:match_get()
...
function InstallationEntity:stream(action, args, callopts)
...
---@param reqmatch InstallationLoadMatch
---@param ctrl? table
---@return Installation
---@return string? err
function InstallationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch InstallationListMatch
---@param ctrl? table
---@return Installation[]
---@return string? err
function InstallationEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata InstallationUpdateData
---@param ctrl? table
---@return Installation
---@return string? err
function InstallationEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch InstallationRemoveMatch
---@param ctrl? table
---@return Installation
---@return string? err
function InstallationEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function InstallationEntity:_run_op(ctx, post_done)
  local utility = self._utility
