...
local CodeScanningDefaultSetupEntity = {}
CodeScanningDefaultSetupEntity.__index = CodeScanningDefaultSetupEntity


function CodeScanningDefaultSetupEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CodeScanningDefaultSetupEntity)
  self._name = "code_scanning_default_setup"
  self._client = client
...
function CodeScanningDefaultSetupEntity:get_name()
  return self._name
end


function CodeScanningDefaultSetupEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CodeScanningDefaultSetupEntity.new(self._client, opts)
end
...
function CodeScanningDefaultSetupEntity:mark_deleted()
  self._deleted = true
end


function CodeScanningDefaultSetupEntity:deleted()
  return true == self._deleted
end


function CodeScanningDefaultSetupEntity:data_set(args)
  if args ~= nil then
...
function CodeScanningDefaultSetupEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CodeScanningDefaultSetupEntity:match_set(args)
  if args ~= nil then
...
function CodeScanningDefaultSetupEntity:match_get()
...
function CodeScanningDefaultSetupEntity:stream(action, args, callopts)
...
---@param reqmatch CodeScanningDefaultSetupListMatch
---@param ctrl? table
---@return CodeScanningDefaultSetup[]
---@return string? err
function CodeScanningDefaultSetupEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CodeScanningDefaultSetupEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CodeScanningDefaultSetupEntity
