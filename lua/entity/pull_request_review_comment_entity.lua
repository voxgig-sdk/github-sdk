...
local PullRequestReviewCommentEntity = {}
PullRequestReviewCommentEntity.__index = PullRequestReviewCommentEntity


function PullRequestReviewCommentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PullRequestReviewCommentEntity)
  self._name = "pull_request_review_comment"
  self._client = client
...
function PullRequestReviewCommentEntity:get_name()
  return self._name
end


function PullRequestReviewCommentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PullRequestReviewCommentEntity.new(self._client, opts)
end
...
function PullRequestReviewCommentEntity:mark_deleted()
  self._deleted = true
end


function PullRequestReviewCommentEntity:deleted()
  return true == self._deleted
end


function PullRequestReviewCommentEntity:data_set(args)
  if args ~= nil then
...
function PullRequestReviewCommentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PullRequestReviewCommentEntity:match_set(args)
  if args ~= nil then
...
function PullRequestReviewCommentEntity:match_get()
...
function PullRequestReviewCommentEntity:stream(action, args, callopts)
...
---@param reqmatch PullRequestReviewCommentLoadMatch
---@param ctrl? table
---@return PullRequestReviewComment
---@return string? err
function PullRequestReviewCommentEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PullRequestReviewCommentListMatch
---@param ctrl? table
---@return PullRequestReviewComment[]
---@return string? err
function PullRequestReviewCommentEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata PullRequestReviewCommentCreateData
---@param ctrl? table
---@return PullRequestReviewComment
---@return string? err
function PullRequestReviewCommentEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata PullRequestReviewCommentUpdateData
---@param ctrl? table
---@return PullRequestReviewComment
---@return string? err
function PullRequestReviewCommentEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function PullRequestReviewCommentEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PullRequestReviewCommentEntity
