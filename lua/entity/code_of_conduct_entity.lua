...
local CodeOfConductEntity = {}
CodeOfConductEntity.__index = CodeOfConductEntity


function CodeOfConductEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CodeOfConductEntity)
  self._name = "code_of_conduct"
  self._client = client
...
function CodeOfConductEntity:get_name()
  return self._name
end


function CodeOfConductEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CodeOfConductEntity.new(self._client, opts)
end
...
function CodeOfConductEntity:mark_deleted()
  self._deleted = true
end


function CodeOfConductEntity:deleted()
  return true == self._deleted
end


function CodeOfConductEntity:data_set(args)
  if args ~= nil then
...
function CodeOfConductEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CodeOfConductEntity:match_set(args)
  if args ~= nil then
...
function CodeOfConductEntity:match_get()
...
function CodeOfConductEntity:stream(action, args, callopts)
...
---@param reqmatch CodeOfConductLoadMatch
---@param ctrl? table
---@return CodeOfConduct
---@return string? err
function CodeOfConductEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch CodeOfConductListMatch
---@param ctrl? table
---@return CodeOfConduct[]
---@return string? err
function CodeOfConductEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function CodeOfConductEntity:_run_op(ctx, post_done)
  local utility = self._utility
