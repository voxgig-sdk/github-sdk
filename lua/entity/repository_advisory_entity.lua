...
local RepositoryAdvisoryEntity = {}
RepositoryAdvisoryEntity.__index = RepositoryAdvisoryEntity


function RepositoryAdvisoryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepositoryAdvisoryEntity)
  self._name = "repository_advisory"
  self._client = client
...
function RepositoryAdvisoryEntity:get_name()
  return self._name
end


function RepositoryAdvisoryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepositoryAdvisoryEntity.new(self._client, opts)
end
...
function RepositoryAdvisoryEntity:mark_deleted()
  self._deleted = true
end


function RepositoryAdvisoryEntity:deleted()
  return true == self._deleted
end


function RepositoryAdvisoryEntity:data_set(args)
  if args ~= nil then
...
function RepositoryAdvisoryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepositoryAdvisoryEntity:match_set(args)
  if args ~= nil then
...
function RepositoryAdvisoryEntity:match_get()
...
function RepositoryAdvisoryEntity:stream(action, args, callopts)
...
---@param reqmatch RepositoryAdvisoryLoadMatch
---@param ctrl? table
---@return RepositoryAdvisory
---@return string? err
function RepositoryAdvisoryEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch RepositoryAdvisoryListMatch
---@param ctrl? table
---@return RepositoryAdvisory[]
---@return string? err
function RepositoryAdvisoryEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata RepositoryAdvisoryCreateData
---@param ctrl? table
---@return RepositoryAdvisory
---@return string? err
function RepositoryAdvisoryEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata RepositoryAdvisoryUpdateData
---@param ctrl? table
---@return RepositoryAdvisory
---@return string? err
function RepositoryAdvisoryEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function RepositoryAdvisoryEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RepositoryAdvisoryEntity
