...
local CodeScanningAlertItemEntity = {}
CodeScanningAlertItemEntity.__index = CodeScanningAlertItemEntity


function CodeScanningAlertItemEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CodeScanningAlertItemEntity)
  self._name = "code_scanning_alert_item"
  self._client = client
...
function CodeScanningAlertItemEntity:get_name()
  return self._name
end


function CodeScanningAlertItemEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CodeScanningAlertItemEntity.new(self._client, opts)
end
...
function CodeScanningAlertItemEntity:mark_deleted()
  self._deleted = true
end


function CodeScanningAlertItemEntity:deleted()
  return true == self._deleted
end


function CodeScanningAlertItemEntity:data_set(args)
  if args ~= nil then
...
function CodeScanningAlertItemEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CodeScanningAlertItemEntity:match_set(args)
  if args ~= nil then
...
function CodeScanningAlertItemEntity:match_get()
...
function CodeScanningAlertItemEntity:stream(action, args, callopts)
...
---@param reqmatch CodeScanningAlertItemListMatch
---@param ctrl? table
---@return CodeScanningAlertItem[]
---@return string? err
function CodeScanningAlertItemEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CodeScanningAlertItemEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CodeScanningAlertItemEntity
