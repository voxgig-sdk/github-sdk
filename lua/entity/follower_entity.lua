...
FollowerEntity.__index = FollowerEntity


function FollowerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FollowerEntity)
  self._name = "follower"
  self._client = client
...
function FollowerEntity:get_name()
  return self._name
end


function FollowerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FollowerEntity.new(self._client, opts)
end
...
function FollowerEntity:mark_deleted()
  self._deleted = true
end


function FollowerEntity:deleted()
  return true == self._deleted
end


function FollowerEntity:data_set(args)
  if args ~= nil then
...
function FollowerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FollowerEntity:match_set(args)
  if args ~= nil then
...
function FollowerEntity:match_get()
...
function FollowerEntity:stream(action, args, callopts)
...
---@param reqmatch FollowerListMatch
---@param ctrl? table
---@return Follower[]
---@return string? err
function FollowerEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function FollowerEntity:_run_op(ctx, post_done)
  local utility = self._utility
