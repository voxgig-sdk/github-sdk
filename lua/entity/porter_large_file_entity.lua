...
local PorterLargeFileEntity = {}
PorterLargeFileEntity.__index = PorterLargeFileEntity


function PorterLargeFileEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PorterLargeFileEntity)
  self._name = "porter_large_file"
  self._client = client
...
function PorterLargeFileEntity:get_name()
  return self._name
end


function PorterLargeFileEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PorterLargeFileEntity.new(self._client, opts)
end
...
function PorterLargeFileEntity:mark_deleted()
  self._deleted = true
end


function PorterLargeFileEntity:deleted()
  return true == self._deleted
end


function PorterLargeFileEntity:data_set(args)
  if args ~= nil then
...
function PorterLargeFileEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PorterLargeFileEntity:match_set(args)
  if args ~= nil then
...
function PorterLargeFileEntity:match_get()
...
function PorterLargeFileEntity:stream(action, args, callopts)
...
---@param reqmatch PorterLargeFileListMatch
---@param ctrl? table
---@return PorterLargeFile[]
---@return string? err
function PorterLargeFileEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function PorterLargeFileEntity:_run_op(ctx, post_done)
  local utility = self._utility
