-- Github SDK ClassroomAcceptedAssignment entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ClassroomAcceptedAssignmentEntity = {}
ClassroomAcceptedAssignmentEntity.__index = ClassroomAcceptedAssignmentEntity


function ClassroomAcceptedAssignmentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ClassroomAcceptedAssignmentEntity)
  self._name = "classroom_accepted_assignment"
  self._client = client
...
function ClassroomAcceptedAssignmentEntity:get_name()
  return self._name
end


function ClassroomAcceptedAssignmentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ClassroomAcceptedAssignmentEntity.new(self._client, opts)
end
...
function ClassroomAcceptedAssignmentEntity:mark_deleted()
  self._deleted = true
end


function ClassroomAcceptedAssignmentEntity:deleted()
  return true == self._deleted
end


function ClassroomAcceptedAssignmentEntity:data_set(args)
  if args ~= nil then
...
function ClassroomAcceptedAssignmentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ClassroomAcceptedAssignmentEntity:match_set(args)
  if args ~= nil then
...
function ClassroomAcceptedAssignmentEntity:match_get()
...
function ClassroomAcceptedAssignmentEntity:stream(action, args, callopts)
...
---@param reqmatch ClassroomAcceptedAssignmentListMatch
---@param ctrl? table
---@return ClassroomAcceptedAssignment[]
---@return string? err
function ClassroomAcceptedAssignmentEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ClassroomAcceptedAssignmentEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ClassroomAcceptedAssignmentEntity
