...
local SecretScanningAlertEntity = {}
SecretScanningAlertEntity.__index = SecretScanningAlertEntity


function SecretScanningAlertEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SecretScanningAlertEntity)
  self._name = "secret_scanning_alert"
  self._client = client
...
function SecretScanningAlertEntity:get_name()
  return self._name
end


function SecretScanningAlertEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SecretScanningAlertEntity.new(self._client, opts)
end
...
function SecretScanningAlertEntity:mark_deleted()
  self._deleted = true
end


function SecretScanningAlertEntity:deleted()
  return true == self._deleted
end


function SecretScanningAlertEntity:data_set(args)
  if args ~= nil then
...
function SecretScanningAlertEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SecretScanningAlertEntity:match_set(args)
  if args ~= nil then
...
function SecretScanningAlertEntity:match_get()
...
function SecretScanningAlertEntity:stream(action, args, callopts)
...
---@param reqmatch SecretScanningAlertLoadMatch
---@param ctrl? table
---@return SecretScanningAlert
---@return string? err
function SecretScanningAlertEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch SecretScanningAlertListMatch
---@param ctrl? table
---@return SecretScanningAlert[]
---@return string? err
function SecretScanningAlertEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata SecretScanningAlertUpdateData
---@param ctrl? table
---@return SecretScanningAlert
---@return string? err
function SecretScanningAlertEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function SecretScanningAlertEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SecretScanningAlertEntity
