...
local CheckAnnotationEntity = {}
CheckAnnotationEntity.__index = CheckAnnotationEntity


function CheckAnnotationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CheckAnnotationEntity)
  self._name = "check_annotation"
  self._client = client
...
function CheckAnnotationEntity:get_name()
  return self._name
end


function CheckAnnotationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CheckAnnotationEntity.new(self._client, opts)
end
...
function CheckAnnotationEntity:mark_deleted()
  self._deleted = true
end


function CheckAnnotationEntity:deleted()
  return true == self._deleted
end


function CheckAnnotationEntity:data_set(args)
  if args ~= nil then
...
function CheckAnnotationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CheckAnnotationEntity:match_set(args)
  if args ~= nil then
...
function CheckAnnotationEntity:match_get()
...
function CheckAnnotationEntity:stream(action, args, callopts)
...
---@param reqmatch CheckAnnotationListMatch
---@param ctrl? table
---@return CheckAnnotation[]
---@return string? err
function CheckAnnotationEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CheckAnnotationEntity:_run_op(ctx, post_done)
  local utility = self._utility
