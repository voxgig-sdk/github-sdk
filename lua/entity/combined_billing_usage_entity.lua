...
local CombinedBillingUsageEntity = {}
CombinedBillingUsageEntity.__index = CombinedBillingUsageEntity


function CombinedBillingUsageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CombinedBillingUsageEntity)
  self._name = "combined_billing_usage"
  self._client = client
...
function CombinedBillingUsageEntity:get_name()
  return self._name
end


function CombinedBillingUsageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CombinedBillingUsageEntity.new(self._client, opts)
end
...
function CombinedBillingUsageEntity:mark_deleted()
  self._deleted = true
end


function CombinedBillingUsageEntity:deleted()
  return true == self._deleted
end


function CombinedBillingUsageEntity:data_set(args)
  if args ~= nil then
...
function CombinedBillingUsageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CombinedBillingUsageEntity:match_set(args)
  if args ~= nil then
...
function CombinedBillingUsageEntity:match_get()
...
function CombinedBillingUsageEntity:stream(action, args, callopts)
...
---@param reqmatch CombinedBillingUsageLoadMatch
---@param ctrl? table
---@return CombinedBillingUsage
---@return string? err
function CombinedBillingUsageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function CombinedBillingUsageEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CombinedBillingUsageEntity
