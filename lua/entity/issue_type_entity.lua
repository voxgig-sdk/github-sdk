...
local IssueTypeEntity = {}
IssueTypeEntity.__index = IssueTypeEntity


function IssueTypeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IssueTypeEntity)
  self._name = "issue_type"
  self._client = client
...
function IssueTypeEntity:get_name()
  return self._name
end


function IssueTypeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IssueTypeEntity.new(self._client, opts)
end
...
function IssueTypeEntity:mark_deleted()
  self._deleted = true
end


function IssueTypeEntity:deleted()
  return true == self._deleted
end


function IssueTypeEntity:data_set(args)
  if args ~= nil then
...
function IssueTypeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IssueTypeEntity:match_set(args)
  if args ~= nil then
...
function IssueTypeEntity:match_get()
...
function IssueTypeEntity:stream(action, args, callopts)
...
---@param reqmatch IssueTypeListMatch
---@param ctrl? table
---@return IssueType[]
---@return string? err
function IssueTypeEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata IssueTypeCreateData
---@param ctrl? table
---@return IssueType
---@return string? err
function IssueTypeEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata IssueTypeUpdateData
---@param ctrl? table
---@return IssueType
---@return string? err
function IssueTypeEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function IssueTypeEntity:_run_op(ctx, post_done)
  local utility = self._utility
