...
local NetworkSettingEntity = {}
NetworkSettingEntity.__index = NetworkSettingEntity


function NetworkSettingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NetworkSettingEntity)
  self._name = "network_setting"
  self._client = client
...
function NetworkSettingEntity:get_name()
  return self._name
end


function NetworkSettingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NetworkSettingEntity.new(self._client, opts)
end
...
function NetworkSettingEntity:mark_deleted()
  self._deleted = true
end


function NetworkSettingEntity:deleted()
  return true == self._deleted
end


function NetworkSettingEntity:data_set(args)
  if args ~= nil then
...
function NetworkSettingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NetworkSettingEntity:match_set(args)
  if args ~= nil then
...
function NetworkSettingEntity:match_get()
...
function NetworkSettingEntity:stream(action, args, callopts)
...
---@param reqmatch NetworkSettingLoadMatch
---@param ctrl? table
---@return NetworkSetting
---@return string? err
function NetworkSettingEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function NetworkSettingEntity:_run_op(ctx, post_done)
  local utility = self._utility
