...
local CodeScanningVariantAnalysiEntity = {}
CodeScanningVariantAnalysiEntity.__index = CodeScanningVariantAnalysiEntity


function CodeScanningVariantAnalysiEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CodeScanningVariantAnalysiEntity)
  self._name = "code_scanning_variant_analysi"
  self._client = client
...
function CodeScanningVariantAnalysiEntity:get_name()
  return self._name
end


function CodeScanningVariantAnalysiEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CodeScanningVariantAnalysiEntity.new(self._client, opts)
end
...
function CodeScanningVariantAnalysiEntity:mark_deleted()
  self._deleted = true
end


function CodeScanningVariantAnalysiEntity:deleted()
  return true == self._deleted
end


function CodeScanningVariantAnalysiEntity:data_set(args)
  if args ~= nil then
...
function CodeScanningVariantAnalysiEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CodeScanningVariantAnalysiEntity:match_set(args)
  if args ~= nil then
...
function CodeScanningVariantAnalysiEntity:match_get()
...
function CodeScanningVariantAnalysiEntity:stream(action, args, callopts)
...
---@param reqmatch CodeScanningVariantAnalysiLoadMatch
---@param ctrl? table
---@return CodeScanningVariantAnalysi
---@return string? err
function CodeScanningVariantAnalysiEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata CodeScanningVariantAnalysiCreateData
---@param ctrl? table
---@return CodeScanningVariantAnalysi
---@return string? err
function CodeScanningVariantAnalysiEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function CodeScanningVariantAnalysiEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CodeScanningVariantAnalysiEntity
