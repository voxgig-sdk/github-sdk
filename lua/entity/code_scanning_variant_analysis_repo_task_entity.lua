-- Github SDK CodeScanningVariantAnalysisRepoTask entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CodeScanningVariantAnalysisRepoTaskEntity = {}
CodeScanningVariantAnalysisRepoTaskEntity.__index = CodeScanningVariantAnalysisRepoTaskEntity


function CodeScanningVariantAnalysisRepoTaskEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CodeScanningVariantAnalysisRepoTaskEntity)
  self._name = "code_scanning_variant_analysis_repo_task"
  self._client = client
...
function CodeScanningVariantAnalysisRepoTaskEntity:get_name()
  return self._name
end


function CodeScanningVariantAnalysisRepoTaskEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CodeScanningVariantAnalysisRepoTaskEntity.new(self._client, opts)
end
...
function CodeScanningVariantAnalysisRepoTaskEntity:mark_deleted()
  self._deleted = true
end


function CodeScanningVariantAnalysisRepoTaskEntity:deleted()
  return true == self._deleted
end


function CodeScanningVariantAnalysisRepoTaskEntity:data_set(args)
  if args ~= nil then
...
function CodeScanningVariantAnalysisRepoTaskEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CodeScanningVariantAnalysisRepoTaskEntity:match_set(args)
  if args ~= nil then
...
function CodeScanningVariantAnalysisRepoTaskEntity:match_get()
...
function CodeScanningVariantAnalysisRepoTaskEntity:stream(action, args, callopts)
...
---@param reqmatch CodeScanningVariantAnalysisRepoTaskLoadMatch
---@param ctrl? table
---@return CodeScanningVariantAnalysisRepoTask
---@return string? err
function CodeScanningVariantAnalysisRepoTaskEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function CodeScanningVariantAnalysisRepoTaskEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CodeScanningVariantAnalysisRepoTaskEntity
