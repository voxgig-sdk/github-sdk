-- Github SDK OrganizationDependabotSecret entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local OrganizationDependabotSecretEntity = {}
OrganizationDependabotSecretEntity.__index = OrganizationDependabotSecretEntity


function OrganizationDependabotSecretEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrganizationDependabotSecretEntity)
  self._name = "organization_dependabot_secret"
  self._client = client
...
function OrganizationDependabotSecretEntity:get_name()
  return self._name
end


function OrganizationDependabotSecretEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrganizationDependabotSecretEntity.new(self._client, opts)
end
...
function OrganizationDependabotSecretEntity:mark_deleted()
  self._deleted = true
end


function OrganizationDependabotSecretEntity:deleted()
  return true == self._deleted
end


function OrganizationDependabotSecretEntity:data_set(args)
  if args ~= nil then
...
function OrganizationDependabotSecretEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrganizationDependabotSecretEntity:match_set(args)
  if args ~= nil then
...
function OrganizationDependabotSecretEntity:match_get()
...
function OrganizationDependabotSecretEntity:stream(action, args, callopts)
...
---@param reqmatch OrganizationDependabotSecretLoadMatch
---@param ctrl? table
---@return OrganizationDependabotSecret
---@return string? err
function OrganizationDependabotSecretEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function OrganizationDependabotSecretEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrganizationDependabotSecretEntity
