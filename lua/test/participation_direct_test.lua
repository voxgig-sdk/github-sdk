...
describe("ParticipationDirect", function()
  it("should direct-list-participation", function()
    local setup = participation_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-participation", setup.live and "live" or "unit")
...
function participation_direct_setup(mockres)
