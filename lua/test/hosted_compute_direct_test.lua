...
describe("HostedComputeDirect", function()
  it("should direct-list-hosted_compute", function()
    local setup = hosted_compute_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-hosted_compute", setup.live and "live" or "unit")
...
function hosted_compute_direct_setup(mockres)
