...
describe("RunnerGroupDirect", function()
  it("should direct-load-runner_group", function()
    local setup = runner_group_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-runner_group", setup.live and "live" or "unit")
...
function runner_group_direct_setup(mockres)
