...
describe("TeamEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set GITHUB_TEST_TEAM_ENTID JSON to run live")
      return
    end
    ...
    local team_ref01_markdef_up0_name = "archive_url"
...
function team_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("GITHUB_TEST_TEAM_ENTID")
