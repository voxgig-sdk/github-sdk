...
describe("FollowingDirect", function()
  it("should direct-list-following", function()
    local setup = following_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-following", setup.live and "live" or "unit")
...
function following_direct_setup(mockres)
