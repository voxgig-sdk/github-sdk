...
describe("CommitComparisonDirect", function()
  it("should direct-load-commit_comparison", function()
    local setup = commit_comparison_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-commit_comparison", setup.live and "live" or "unit")
...
function commit_comparison_direct_setup(mockres)
