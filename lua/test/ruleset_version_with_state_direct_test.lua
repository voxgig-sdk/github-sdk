-- RulesetVersionWithState direct test
...
describe("RulesetVersionWithStateDirect", function()
  it("should direct-load-ruleset_version_with_state", function()
    local setup = ruleset_version_with_state_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ruleset_version_with_state", setup.live and "live" or "unit")
...
function ruleset_version_with_state_direct_setup(mockres)
