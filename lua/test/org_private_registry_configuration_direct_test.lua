-- OrgPrivateRegistryConfiguration direct test
...
describe("OrgPrivateRegistryConfigurationDirect", function()
  it("should direct-load-org_private_registry_configuration", function()
    local setup = org_private_registry_configuration_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-org_private_registry_configuration", setup.live and "live" or "unit")
...
function org_private_registry_configuration_direct_setup(mockres)
