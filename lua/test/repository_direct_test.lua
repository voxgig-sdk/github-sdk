...
describe("RepositoryDirect", function()
  it("should direct-list-repository", function()
    local setup = repository_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-repository", setup.live and "live" or "unit")
...
function repository_direct_setup(mockres)
