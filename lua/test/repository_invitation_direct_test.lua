-- RepositoryInvitation direct test
...
describe("RepositoryInvitationDirect", function()
  it("should direct-list-repository_invitation", function()
    local setup = repository_invitation_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-repository_invitation", setup.live and "live" or "unit")
...
function repository_invitation_direct_setup(mockres)
