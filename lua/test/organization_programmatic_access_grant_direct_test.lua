-- OrganizationProgrammaticAccessGrant direct test
...
describe("OrganizationProgrammaticAccessGrantDirect", function()
  it("should direct-list-organization_programmatic_access_grant", function()
    local setup = organization_programmatic_access_grant_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-organization_programmatic_access_grant", setup.live and "live" or "unit")
...
function organization_programmatic_access_grant_direct_setup(mockres)
