-- ActionsForkPrWorkflowsPrivateRepo direct test
...
describe("ActionsForkPrWorkflowsPrivateRepoDirect", function()
  it("should direct-load-actions_fork_pr_workflows_private_repo", function()
    local setup = actions_fork_pr_workflows_private_repo_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-actions_fork_pr_workflows_private_repo", setup.live and "live" or "unit")
...
function actions_fork_pr_workflows_private_repo_direct_setup(mockres)
