...
describe("ArtifactDirect", function()
  it("should direct-load-artifact", function()
    local setup = artifact_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-artifact", setup.live and "live" or "unit")
...
function artifact_direct_setup(mockres)
