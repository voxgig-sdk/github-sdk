-- CodeScanningAlertInstance direct test
...
describe("CodeScanningAlertInstanceDirect", function()
  it("should direct-list-code_scanning_alert_instance", function()
    local setup = code_scanning_alert_instance_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-code_scanning_alert_instance", setup.live and "live" or "unit")
...
function code_scanning_alert_instance_direct_setup(mockres)
