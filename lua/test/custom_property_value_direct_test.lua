-- CustomPropertyValue direct test
...
describe("CustomPropertyValueDirect", function()
  it("should direct-list-custom_property_value", function()
    local setup = custom_property_value_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-custom_property_value", setup.live and "live" or "unit")
...
function custom_property_value_direct_setup(mockres)
