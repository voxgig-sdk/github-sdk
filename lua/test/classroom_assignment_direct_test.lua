-- ClassroomAssignment direct test
...
describe("ClassroomAssignmentDirect", function()
  it("should direct-load-classroom_assignment", function()
    local setup = classroom_assignment_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-classroom_assignment", setup.live and "live" or "unit")
...
function classroom_assignment_direct_setup(mockres)
