-- CodeScanningAutofix direct test
...
describe("CodeScanningAutofixDirect", function()
  it("should direct-load-code_scanning_autofix", function()
    local setup = code_scanning_autofix_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-code_scanning_autofix", setup.live and "live" or "unit")
...
function code_scanning_autofix_direct_setup(mockres)
