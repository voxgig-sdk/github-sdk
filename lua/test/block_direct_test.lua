...
describe("BlockDirect", function()
  it("should direct-list-block", function()
    local setup = block_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-block", setup.live and "live" or "unit")
...
function block_direct_setup(mockres)
