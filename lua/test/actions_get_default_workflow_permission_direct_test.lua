-- ActionsGetDefaultWorkflowPermission direct test
...
describe("ActionsGetDefaultWorkflowPermissionDirect", function()
  it("should direct-load-actions_get_default_workflow_permission", function()
    local setup = actions_get_default_workflow_permission_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-actions_get_default_workflow_permission", setup.live and "live" or "unit")
...
function actions_get_default_workflow_permission_direct_setup(mockres)
