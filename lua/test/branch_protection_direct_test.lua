...
describe("BranchProtectionDirect", function()
  it("should direct-load-branch_protection", function()
    local setup = branch_protection_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-branch_protection", setup.live and "live" or "unit")
...
function branch_protection_direct_setup(mockres)
