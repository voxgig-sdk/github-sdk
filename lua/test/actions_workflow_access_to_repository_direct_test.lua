-- ActionsWorkflowAccessToRepository direct test
...
describe("ActionsWorkflowAccessToRepositoryDirect", function()
  it("should direct-load-actions_workflow_access_to_repository", function()
    local setup = actions_workflow_access_to_repository_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-actions_workflow_access_to_repository", setup.live and "live" or "unit")
...
function actions_workflow_access_to_repository_direct_setup(mockres)
