...
describe("PackageEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set GITHUB_TEST_PACKAGE_ENTID JSON to run live")
      return
    end
...
function package_basic_setup(extra)
  ...
  local idmap = vs.transform(
    { "package01", "package02", "package03", "org01", "org02", "org03", "user01", "user02", "user03", "version01", "version02", "version03", "package_name01", "package_type01", "username01" },
    {
      ["`$PACK`"] = { "", {
        ["`$KEY`"] = "`$COPY`",
  ...
  local entid_env_raw = os.getenv("GITHUB_TEST_PACKAGE_ENTID")
