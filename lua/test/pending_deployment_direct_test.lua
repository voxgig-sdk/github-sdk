...
describe("PendingDeploymentDirect", function()
  it("should direct-list-pending_deployment", function()
    local setup = pending_deployment_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-pending_deployment", setup.live and "live" or "unit")
...
function pending_deployment_direct_setup(mockres)
