...
describe("EnterpriseTeamDirect", function()
  it("should direct-list-enterprise_team", function()
    local setup = enterprise_team_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-enterprise_team", setup.live and "live" or "unit")
  ...
  it("should direct-load-enterprise_team", function()
    local setup = enterprise_team_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-enterprise_team", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function enterprise_team_direct_setup(mockres)
