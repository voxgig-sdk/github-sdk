-- DependencyGraphDiff direct test
...
describe("DependencyGraphDiffDirect", function()
  it("should direct-load-dependency_graph_diff", function()
    local setup = dependency_graph_diff_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dependency_graph_diff", setup.live and "live" or "unit")
...
function dependency_graph_diff_direct_setup(mockres)
