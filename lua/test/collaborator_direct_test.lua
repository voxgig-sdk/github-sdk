...
describe("CollaboratorDirect", function()
  it("should direct-list-collaborator", function()
    local setup = collaborator_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-collaborator", setup.live and "live" or "unit")
...
function collaborator_direct_setup(mockres)
