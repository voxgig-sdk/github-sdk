...
describe("AssigneeDirect", function()
  it("should direct-list-assignee", function()
    local setup = assignee_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-assignee", setup.live and "live" or "unit")
...
function assignee_direct_setup(mockres)
