...
describe("BlobDirect", function()
  it("should direct-load-blob", function()
    local setup = blob_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-blob", setup.live and "live" or "unit")
...
function blob_direct_setup(mockres)
