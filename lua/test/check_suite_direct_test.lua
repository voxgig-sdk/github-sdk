...
describe("CheckSuiteDirect", function()
  it("should direct-load-check_suite", function()
    local setup = check_suite_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-check_suite", setup.live and "live" or "unit")
...
function check_suite_direct_setup(mockres)
