-- DependabotRepositoryAccessDetail direct test
...
describe("DependabotRepositoryAccessDetailDirect", function()
  it("should direct-list-dependabot_repository_access_detail", function()
    local setup = dependabot_repository_access_detail_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-dependabot_repository_access_detail", setup.live and "live" or "unit")
...
function dependabot_repository_access_detail_direct_setup(mockres)
