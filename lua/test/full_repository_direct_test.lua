...
describe("FullRepositoryDirect", function()
  it("should direct-load-full_repository", function()
    local setup = full_repository_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-full_repository", setup.live and "live" or "unit")
...
function full_repository_direct_setup(mockres)
