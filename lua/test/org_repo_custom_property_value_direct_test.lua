-- OrgRepoCustomPropertyValue direct test
...
describe("OrgRepoCustomPropertyValueDirect", function()
  it("should direct-list-org_repo_custom_property_value", function()
    local setup = org_repo_custom_property_value_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-org_repo_custom_property_value", setup.live and "live" or "unit")
...
function org_repo_custom_property_value_direct_setup(mockres)
