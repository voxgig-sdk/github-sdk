...
describe("WorkflowRunUsageDirect", function()
  it("should direct-load-workflow_run_usage", function()
    local setup = workflow_run_usage_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-workflow_run_usage", setup.live and "live" or "unit")
...
function workflow_run_usage_direct_setup(mockres)
