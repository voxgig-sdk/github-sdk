...
describe("InteractionDirect", function()
  it("should direct-load-interaction", function()
    local setup = interaction_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-interaction", setup.live and "live" or "unit")
