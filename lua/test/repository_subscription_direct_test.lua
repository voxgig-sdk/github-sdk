-- RepositorySubscription direct test
...
describe("RepositorySubscriptionDirect", function()
  it("should direct-load-repository_subscription", function()
    local setup = repository_subscription_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-repository_subscription", setup.live and "live" or "unit")
...
function repository_subscription_direct_setup(mockres)
