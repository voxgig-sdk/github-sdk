-- OrganizationSecretScanningAlert direct test
...
describe("OrganizationSecretScanningAlertDirect", function()
  it("should direct-list-organization_secret_scanning_alert", function()
    local setup = organization_secret_scanning_alert_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-organization_secret_scanning_alert", setup.live and "live" or "unit")
...
function organization_secret_scanning_alert_direct_setup(mockres)
