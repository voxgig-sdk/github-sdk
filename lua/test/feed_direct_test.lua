...
describe("FeedDirect", function()
  it("should direct-list-feed", function()
    local setup = feed_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-feed", setup.live and "live" or "unit")
...
function feed_direct_setup(mockres)
