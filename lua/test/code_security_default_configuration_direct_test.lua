...
describe("CodeSecurityDefaultConfigurationDirect", function()
  it("should direct-list-code_security_default_configuration", function()
    local setup = code_security_default_configuration_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-code_security_default_configuration", setup.live and "live" or "unit")
...
function code_security_default_configuration_direct_setup(mockres)
