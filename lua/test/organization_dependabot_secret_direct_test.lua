-- OrganizationDependabotSecret direct test
...
describe("OrganizationDependabotSecretDirect", function()
  it("should direct-load-organization_dependabot_secret", function()
    local setup = organization_dependabot_secret_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-organization_dependabot_secret", setup.live and "live" or "unit")
...
function organization_dependabot_secret_direct_setup(mockres)
