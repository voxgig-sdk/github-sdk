...
describe("OrgMembershipDirect", function()
  it("should direct-load-org_membership", function()
    local setup = org_membership_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-org_membership", setup.live and "live" or "unit")
...
function org_membership_direct_setup(mockres)
