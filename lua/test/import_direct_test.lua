...
describe("ImportDirect", function()
  it("should direct-list-import", function()
    local setup = import_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-import", setup.live and "live" or "unit")
