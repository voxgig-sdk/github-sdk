-- ProtectedBranchAdminEnforced direct test
...
describe("ProtectedBranchAdminEnforcedDirect", function()
  it("should direct-load-protected_branch_admin_enforced", function()
    local setup = protected_branch_admin_enforced_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-protected_branch_admin_enforced", setup.live and "live" or "unit")
...
function protected_branch_admin_enforced_direct_setup(mockres)
