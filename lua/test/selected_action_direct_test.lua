...
describe("SelectedActionDirect", function()
  it("should direct-list-selected_action", function()
    local setup = selected_action_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-selected_action", setup.live and "live" or "unit")
...
function selected_action_direct_setup(mockres)
