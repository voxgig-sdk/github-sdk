-- CombinedBillingUsage direct test
...
describe("CombinedBillingUsageDirect", function()
  it("should direct-load-combined_billing_usage", function()
    local setup = combined_billing_usage_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-combined_billing_usage", setup.live and "live" or "unit")
...
function combined_billing_usage_direct_setup(mockres)
