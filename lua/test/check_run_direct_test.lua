...
describe("CheckRunDirect", function()
  it("should direct-load-check_run", function()
    local setup = check_run_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-check_run", setup.live and "live" or "unit")
...
function check_run_direct_setup(mockres)
