...
describe("BranchShortDirect", function()
  it("should direct-list-branch_short", function()
    local setup = branch_short_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-branch_short", setup.live and "live" or "unit")
...
function branch_short_direct_setup(mockres)
