...
describe("HovercardDirect", function()
  it("should direct-list-hovercard", function()
    local setup = hovercard_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-hovercard", setup.live and "live" or "unit")
...
function hovercard_direct_setup(mockres)
