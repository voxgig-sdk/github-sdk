...
describe("CloneDirect", function()
  it("should direct-list-clone", function()
    local setup = clone_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-clone", setup.live and "live" or "unit")
...
function clone_direct_setup(mockres)
