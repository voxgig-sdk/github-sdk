...
describe("WebhookConfigDirect", function()
  it("should direct-load-webhook_config", function()
    local setup = webhook_config_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-webhook_config", setup.live and "live" or "unit")
...
function webhook_config_direct_setup(mockres)
