...
describe("GitCommitDirect", function()
  it("should direct-load-git_commit", function()
    local setup = git_commit_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-git_commit", setup.live and "live" or "unit")
...
function git_commit_direct_setup(mockres)
