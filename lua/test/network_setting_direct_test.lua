...
describe("NetworkSettingDirect", function()
  it("should direct-load-network_setting", function()
    local setup = network_setting_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-network_setting", setup.live and "live" or "unit")
...
function network_setting_direct_setup(mockres)
