...
describe("TeamSimpleDirect", function()
  it("should direct-list-team_simple", function()
    local setup = team_simple_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-team_simple", setup.live and "live" or "unit")
...
function team_simple_direct_setup(mockres)
