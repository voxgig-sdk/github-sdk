-- CodeScanningOrganizationAlertItem direct test
...
describe("CodeScanningOrganizationAlertItemDirect", function()
  it("should direct-list-code_scanning_organization_alert_item", function()
    local setup = code_scanning_organization_alert_item_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-code_scanning_organization_alert_item", setup.live and "live" or "unit")
...
function code_scanning_organization_alert_item_direct_setup(mockres)
