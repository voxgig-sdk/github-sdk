-- SecretScanningScanHistory direct test
...
describe("SecretScanningScanHistoryDirect", function()
  it("should direct-list-secret_scanning_scan_history", function()
    local setup = secret_scanning_scan_history_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-secret_scanning_scan_history", setup.live and "live" or "unit")
...
function secret_scanning_scan_history_direct_setup(mockres)
