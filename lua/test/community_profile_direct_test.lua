...
describe("CommunityProfileDirect", function()
  it("should direct-load-community_profile", function()
    local setup = community_profile_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-community_profile", setup.live and "live" or "unit")
...
function community_profile_direct_setup(mockres)
