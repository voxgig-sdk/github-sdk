...
describe("ViewDirect", function()
  it("should direct-list-view", function()
    local setup = view_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-view", setup.live and "live" or "unit")
