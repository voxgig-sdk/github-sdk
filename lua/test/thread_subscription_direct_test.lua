-- ThreadSubscription direct test
...
describe("ThreadSubscriptionDirect", function()
  it("should direct-load-thread_subscription", function()
    local setup = thread_subscription_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-thread_subscription", setup.live and "live" or "unit")
...
function thread_subscription_direct_setup(mockres)
