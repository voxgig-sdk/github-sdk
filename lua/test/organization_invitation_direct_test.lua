-- OrganizationInvitation direct test
...
describe("OrganizationInvitationDirect", function()
  it("should direct-list-organization_invitation", function()
    local setup = organization_invitation_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-organization_invitation", setup.live and "live" or "unit")
...
function organization_invitation_direct_setup(mockres)
