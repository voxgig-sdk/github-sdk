...
describe("RunnerDirect", function()
  it("should direct-load-runner", function()
    local setup = runner_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-runner", setup.live and "live" or "unit")
...
function runner_direct_setup(mockres)
