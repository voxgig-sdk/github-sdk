-- CheckAutomatedSecurityFix direct test
...
describe("CheckAutomatedSecurityFixDirect", function()
  it("should direct-load-check_automated_security_fix", function()
    local setup = check_automated_security_fix_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-check_automated_security_fix", setup.live and "live" or "unit")
...
function check_automated_security_fix_direct_setup(mockres)
