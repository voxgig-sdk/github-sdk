...
describe("SelfHostedRunnerDirect", function()
  it("should direct-load-self_hosted_runner", function()
    local setup = self_hosted_runner_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-self_hosted_runner", setup.live and "live" or "unit")
...
function self_hosted_runner_direct_setup(mockres)
