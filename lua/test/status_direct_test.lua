...
describe("StatusDirect", function()
  it("should direct-list-status", function()
    local setup = status_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-status", setup.live and "live" or "unit")
