...
describe("CommitActivityDirect", function()
  it("should direct-list-commit_activity", function()
    local setup = commit_activity_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-commit_activity", setup.live and "live" or "unit")
...
function commit_activity_direct_setup(mockres)
