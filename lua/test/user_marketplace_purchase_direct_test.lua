-- UserMarketplacePurchase direct test
...
describe("UserMarketplacePurchaseDirect", function()
  it("should direct-list-user_marketplace_purchase", function()
    local setup = user_marketplace_purchase_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-user_marketplace_purchase", setup.live and "live" or "unit")
...
function user_marketplace_purchase_direct_setup(mockres)
