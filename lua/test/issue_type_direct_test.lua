...
describe("IssueTypeDirect", function()
  it("should direct-list-issue_type", function()
    local setup = issue_type_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-issue_type", setup.live and "live" or "unit")
...
function issue_type_direct_setup(mockres)
