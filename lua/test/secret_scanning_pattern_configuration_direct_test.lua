-- SecretScanningPatternConfiguration direct test
...
describe("SecretScanningPatternConfigurationDirect", function()
  it("should direct-list-secret_scanning_pattern_configuration", function()
    local setup = secret_scanning_pattern_configuration_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-secret_scanning_pattern_configuration", setup.live and "live" or "unit")
...
function secret_scanning_pattern_configuration_direct_setup(mockres)
