...
describe("StatusCheckPolicyDirect", function()
  it("should direct-list-status_check_policy", function()
    local setup = status_check_policy_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-status_check_policy", setup.live and "live" or "unit")
...
function status_check_policy_direct_setup(mockres)
