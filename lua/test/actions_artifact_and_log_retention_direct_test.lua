-- ActionsArtifactAndLogRetention direct test
...
describe("ActionsArtifactAndLogRetentionDirect", function()
  it("should direct-load-actions_artifact_and_log_retention", function()
    local setup = actions_artifact_and_log_retention_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-actions_artifact_and_log_retention", setup.live and "live" or "unit")
...
function actions_artifact_and_log_retention_direct_setup(mockres)
