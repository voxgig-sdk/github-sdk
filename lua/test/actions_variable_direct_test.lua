...
describe("ActionsVariableDirect", function()
  it("should direct-load-actions_variable", function()
    local setup = actions_variable_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-actions_variable", setup.live and "live" or "unit")
...
function actions_variable_direct_setup(mockres)
