...
describe("RunnerApplicationDirect", function()
  it("should direct-list-runner_application", function()
    local setup = runner_application_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-runner_application", setup.live and "live" or "unit")
...
function runner_application_direct_setup(mockres)
