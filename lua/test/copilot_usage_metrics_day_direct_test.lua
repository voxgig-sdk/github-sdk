-- CopilotUsageMetricsDay direct test
...
describe("CopilotUsageMetricsDayDirect", function()
  it("should direct-list-copilot_usage_metrics_day", function()
    local setup = copilot_usage_metrics_day_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-copilot_usage_metrics_day", setup.live and "live" or "unit")
...
function copilot_usage_metrics_day_direct_setup(mockres)
