-- OrganizationActionsVariable direct test
...
describe("OrganizationActionsVariableDirect", function()
  it("should direct-load-organization_actions_variable", function()
    local setup = organization_actions_variable_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-organization_actions_variable", setup.live and "live" or "unit")
...
function organization_actions_variable_direct_setup(mockres)
