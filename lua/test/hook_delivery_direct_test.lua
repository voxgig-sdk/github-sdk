...
describe("HookDeliveryDirect", function()
  it("should direct-load-hook_delivery", function()
    local setup = hook_delivery_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-hook_delivery", setup.live and "live" or "unit")
...
function hook_delivery_direct_setup(mockres)
