...
describe("ProjectsV2Direct", function()
  it("should direct-list-projects_v2", function()
    local setup = projects_v2_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-projects_v2", setup.live and "live" or "unit")
  ...
  it("should direct-load-projects_v2", function()
    local setup = projects_v2_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-projects_v2", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function projects_v2_direct_setup(mockres)
