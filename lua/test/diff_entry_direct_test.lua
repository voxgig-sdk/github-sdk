...
describe("DiffEntryDirect", function()
  it("should direct-list-diff_entry", function()
    local setup = diff_entry_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-diff_entry", setup.live and "live" or "unit")
...
function diff_entry_direct_setup(mockres)
