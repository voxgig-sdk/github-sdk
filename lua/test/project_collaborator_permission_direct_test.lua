-- ProjectCollaboratorPermission direct test
...
describe("ProjectCollaboratorPermissionDirect", function()
  it("should direct-load-project_collaborator_permission", function()
    local setup = project_collaborator_permission_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-project_collaborator_permission", setup.live and "live" or "unit")
...
function project_collaborator_permission_direct_setup(mockres)
