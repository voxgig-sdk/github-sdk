-- ClassroomAssignmentGrade direct test
...
describe("ClassroomAssignmentGradeDirect", function()
  it("should direct-list-classroom_assignment_grade", function()
    local setup = classroom_assignment_grade_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-classroom_assignment_grade", setup.live and "live" or "unit")
...
function classroom_assignment_grade_direct_setup(mockres)
