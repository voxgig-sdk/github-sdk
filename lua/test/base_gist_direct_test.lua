...
describe("BaseGistDirect", function()
  it("should direct-list-base_gist", function()
    local setup = base_gist_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-base_gist", setup.live and "live" or "unit")
...
function base_gist_direct_setup(mockres)
