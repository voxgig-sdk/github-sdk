...
describe("ApiOverviewDirect", function()
  it("should direct-list-api_overview", function()
    local setup = api_overview_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-api_overview", setup.live and "live" or "unit")
...
function api_overview_direct_setup(mockres)
