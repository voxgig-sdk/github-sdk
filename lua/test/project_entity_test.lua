...
describe("ProjectEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set GITHUB_TEST_PROJECT_ENTID JSON to run live")
      return
    end
    ...
    local project_ref01_markdef_up0_name = "avatar_url"
...
function project_basic_setup(extra)
  ...
  local idmap = vs.transform(
    { "project01", "project02", "project03", "org01", "org02", "org03", "repo01", "repo02", "repo03", "user01", "user02", "user03", "projects_v201", "projects_v202", "projects_v203", "item01", "item02", "item03", "owner01", "username01" },
    {
      ["`$PACK`"] = { "", {
        ["`$KEY`"] = "`$COPY`",
  ...
  local entid_env_raw = os.getenv("GITHUB_TEST_PROJECT_ENTID")
