...
describe("EmptyObjectDirect", function()
  it("should direct-load-empty_object", function()
    local setup = empty_object_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-empty_object", setup.live and "live" or "unit")
...
function empty_object_direct_setup(mockres)
