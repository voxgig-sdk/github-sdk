-- ActionsHostedRunner direct test
...
describe("ActionsHostedRunnerDirect", function()
  it("should direct-load-actions_hosted_runner", function()
    local setup = actions_hosted_runner_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-actions_hosted_runner", setup.live and "live" or "unit")
...
function actions_hosted_runner_direct_setup(mockres)
