...
describe("IssueEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set GITHUB_TEST_ISSUE_ENTID JSON to run live")
      return
    end
    ...
    local issue_ref01_markdef_up0_name = "active_lock_reason"
...
function issue_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("GITHUB_TEST_ISSUE_ENTID")
