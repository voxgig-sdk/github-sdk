-- ActionsRepositoryPermission direct test
...
describe("ActionsRepositoryPermissionDirect", function()
  it("should direct-load-actions_repository_permission", function()
    local setup = actions_repository_permission_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-actions_repository_permission", setup.live and "live" or "unit")
...
function actions_repository_permission_direct_setup(mockres)
