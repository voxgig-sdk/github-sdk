...
describe("InstallationDirect", function()
  it("should direct-list-installation", function()
    local setup = installation_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-installation", setup.live and "live" or "unit")
  ...
  it("should direct-load-installation", function()
    local setup = installation_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-installation", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function installation_direct_setup(mockres)
