...
describe("PorterAuthorDirect", function()
  it("should direct-list-porter_author", function()
    local setup = porter_author_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-porter_author", setup.live and "live" or "unit")
...
function porter_author_direct_setup(mockres)
