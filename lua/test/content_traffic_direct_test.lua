...
describe("ContentTrafficDirect", function()
  it("should direct-list-content_traffic", function()
    local setup = content_traffic_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-content_traffic", setup.live and "live" or "unit")
...
function content_traffic_direct_setup(mockres)
