...
describe("CodeownersErrorDirect", function()
  it("should direct-list-codeowners_error", function()
    local setup = codeowners_error_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-codeowners_error", setup.live and "live" or "unit")
...
function codeowners_error_direct_setup(mockres)
