...
describe("ActionsSecretDirect", function()
  it("should direct-load-actions_secret", function()
    local setup = actions_secret_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-actions_secret", setup.live and "live" or "unit")
...
function actions_secret_direct_setup(mockres)
