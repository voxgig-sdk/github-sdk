...
describe("MinimalRepositoryDirect", function()
  it("should direct-list-minimal_repository", function()
    local setup = minimal_repository_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-minimal_repository", setup.live and "live" or "unit")
...
function minimal_repository_direct_setup(mockres)
