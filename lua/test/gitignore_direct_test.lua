...
describe("GitignoreDirect", function()
  it("should direct-list-gitignore", function()
    local setup = gitignore_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-gitignore", setup.live and "live" or "unit")
...
function gitignore_direct_setup(mockres)
