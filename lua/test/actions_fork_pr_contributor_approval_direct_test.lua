-- ActionsForkPrContributorApproval direct test
...
describe("ActionsForkPrContributorApprovalDirect", function()
  it("should direct-load-actions_fork_pr_contributor_approval", function()
    local setup = actions_fork_pr_contributor_approval_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-actions_fork_pr_contributor_approval", setup.live and "live" or "unit")
...
function actions_fork_pr_contributor_approval_direct_setup(mockres)
