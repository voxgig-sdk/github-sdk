-- DependabotPublicKey direct test
...
describe("DependabotPublicKeyDirect", function()
  it("should direct-load-dependabot_public_key", function()
    local setup = dependabot_public_key_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dependabot_public_key", setup.live and "live" or "unit")
...
function dependabot_public_key_direct_setup(mockres)
