-- ProtectedBranchPullRequestReview direct test
...
describe("ProtectedBranchPullRequestReviewDirect", function()
  it("should direct-load-protected_branch_pull_request_review", function()
    local setup = protected_branch_pull_request_review_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-protected_branch_pull_request_review", setup.live and "live" or "unit")
...
function protected_branch_pull_request_review_direct_setup(mockres)
