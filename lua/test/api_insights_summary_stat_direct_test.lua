-- ApiInsightsSummaryStat direct test
...
describe("ApiInsightsSummaryStatDirect", function()
  it("should direct-load-api_insights_summary_stat", function()
    local setup = api_insights_summary_stat_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_insights_summary_stat", setup.live and "live" or "unit")
...
function api_insights_summary_stat_direct_setup(mockres)
