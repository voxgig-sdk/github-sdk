-- ApiInsightsSubjectStat direct test
...
describe("ApiInsightsSubjectStatDirect", function()
  it("should direct-list-api_insights_subject_stat", function()
    local setup = api_insights_subject_stat_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-api_insights_subject_stat", setup.live and "live" or "unit")
...
function api_insights_subject_stat_direct_setup(mockres)
