...
describe("ReferrerDirect", function()
  it("should direct-list-referrer", function()
    local setup = referrer_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-referrer", setup.live and "live" or "unit")
...
function referrer_direct_setup(mockres)
