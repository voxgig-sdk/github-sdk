...
describe("MetaDirect", function()
  it("should direct-list-meta", function()
    local setup = meta_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-meta", setup.live and "live" or "unit")
