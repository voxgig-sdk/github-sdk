...
describe("PorterLargeFileDirect", function()
  it("should direct-list-porter_large_file", function()
    local setup = porter_large_file_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-porter_large_file", setup.live and "live" or "unit")
...
function porter_large_file_direct_setup(mockres)
