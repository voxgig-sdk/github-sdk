...
describe("LabelEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set GITHUB_TEST_LABEL_ENTID JSON to run live")
      return
    end
    ...
    local label_ref01_markdef_up0_name = "color"
    local label_ref01_markdef_up0_value = "Mark01-label_ref01_" .. tostring(setup.now)
...
function label_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("GITHUB_TEST_LABEL_ENTID")
