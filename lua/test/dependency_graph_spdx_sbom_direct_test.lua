-- DependencyGraphSpdxSbom direct test
...
describe("DependencyGraphSpdxSbomDirect", function()
  it("should direct-load-dependency_graph_spdx_sbom", function()
    local setup = dependency_graph_spdx_sbom_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dependency_graph_spdx_sbom", setup.live and "live" or "unit")
...
function dependency_graph_spdx_sbom_direct_setup(mockres)
