-- ActionsCacheUsageOrgEnterprise direct test
...
describe("ActionsCacheUsageOrgEnterpriseDirect", function()
  it("should direct-load-actions_cache_usage_org_enterprise", function()
    local setup = actions_cache_usage_org_enterprise_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-actions_cache_usage_org_enterprise", setup.live and "live" or "unit")
...
function actions_cache_usage_org_enterprise_direct_setup(mockres)
