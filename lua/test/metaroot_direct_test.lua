...
describe("MetarootDirect", function()
  it("should direct-load-metaroot", function()
    local setup = metaroot_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-metaroot", setup.live and "live" or "unit")
...
function metaroot_direct_setup(mockres)
