...
describe("PrivateRegistryDirect", function()
  it("should direct-list-private_registry", function()
    local setup = private_registry_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-private_registry", setup.live and "live" or "unit")
  ...
  it("should direct-load-private_registry", function()
    local setup = private_registry_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-private_registry", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function private_registry_direct_setup(mockres)
