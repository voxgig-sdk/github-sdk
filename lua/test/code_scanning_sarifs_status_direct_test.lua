-- CodeScanningSarifsStatus direct test
...
describe("CodeScanningSarifsStatusDirect", function()
  it("should direct-load-code_scanning_sarifs_status", function()
    local setup = code_scanning_sarifs_status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-code_scanning_sarifs_status", setup.live and "live" or "unit")
...
function code_scanning_sarifs_status_direct_setup(mockres)
