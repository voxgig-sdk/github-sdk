...
describe("GitRefDirect", function()
  it("should direct-load-git_ref", function()
    local setup = git_ref_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-git_ref", setup.live and "live" or "unit")
...
function git_ref_direct_setup(mockres)
