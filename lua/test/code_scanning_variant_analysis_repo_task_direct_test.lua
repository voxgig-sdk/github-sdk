-- CodeScanningVariantAnalysisRepoTask direct test
...
describe("CodeScanningVariantAnalysisRepoTaskDirect", function()
  it("should direct-load-code_scanning_variant_analysis_repo_task", function()
    local setup = code_scanning_variant_analysis_repo_task_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-code_scanning_variant_analysis_repo_task", setup.live and "live" or "unit")
...
function code_scanning_variant_analysis_repo_task_direct_setup(mockres)
