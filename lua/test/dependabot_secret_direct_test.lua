...
describe("DependabotSecretDirect", function()
  it("should direct-load-dependabot_secret", function()
    local setup = dependabot_secret_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dependabot_secret", setup.live and "live" or "unit")
...
function dependabot_secret_direct_setup(mockres)
