...
describe("BranchDirect", function()
  it("should direct-load-branch", function()
    local setup = branch_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-branch", setup.live and "live" or "unit")
