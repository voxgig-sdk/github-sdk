-- RepositoryRuleDetailed direct test
...
describe("RepositoryRuleDetailedDirect", function()
  it("should direct-load-repository_rule_detailed", function()
    local setup = repository_rule_detailed_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-repository_rule_detailed", setup.live and "live" or "unit")
...
function repository_rule_detailed_direct_setup(mockres)
