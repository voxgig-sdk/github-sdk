...
describe("GitTreeDirect", function()
  it("should direct-load-git_tree", function()
    local setup = git_tree_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-git_tree", setup.live and "live" or "unit")
...
function git_tree_direct_setup(mockres)
