...
describe("GitignoreTemplateDirect", function()
  it("should direct-load-gitignore_template", function()
    local setup = gitignore_template_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-gitignore_template", setup.live and "live" or "unit")
...
function gitignore_template_direct_setup(mockres)
