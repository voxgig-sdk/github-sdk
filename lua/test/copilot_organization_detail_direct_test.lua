-- CopilotOrganizationDetail direct test
...
describe("CopilotOrganizationDetailDirect", function()
  it("should direct-load-copilot_organization_detail", function()
    local setup = copilot_organization_detail_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-copilot_organization_detail", setup.live and "live" or "unit")
...
function copilot_organization_detail_direct_setup(mockres)
