-- DeploymentProtectionRule direct test
...
describe("DeploymentProtectionRuleDirect", function()
  it("should direct-load-deployment_protection_rule", function()
    local setup = deployment_protection_rule_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-deployment_protection_rule", setup.live and "live" or "unit")
...
function deployment_protection_rule_direct_setup(mockres)
