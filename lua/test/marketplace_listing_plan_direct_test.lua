-- MarketplaceListingPlan direct test
...
describe("MarketplaceListingPlanDirect", function()
  it("should direct-list-marketplace_listing_plan", function()
    local setup = marketplace_listing_plan_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-marketplace_listing_plan", setup.live and "live" or "unit")
...
function marketplace_listing_plan_direct_setup(mockres)
