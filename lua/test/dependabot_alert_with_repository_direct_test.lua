-- DependabotAlertWithRepository direct test
...
describe("DependabotAlertWithRepositoryDirect", function()
  it("should direct-list-dependabot_alert_with_repository", function()
    local setup = dependabot_alert_with_repository_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-dependabot_alert_with_repository", setup.live and "live" or "unit")
...
function dependabot_alert_with_repository_direct_setup(mockres)
