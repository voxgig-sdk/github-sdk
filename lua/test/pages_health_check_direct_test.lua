...
describe("PagesHealthCheckDirect", function()
  it("should direct-load-pages_health_check", function()
    local setup = pages_health_check_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-pages_health_check", setup.live and "live" or "unit")
...
function pages_health_check_direct_setup(mockres)
