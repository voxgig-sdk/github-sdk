...
describe("TagProtectionDirect", function()
  it("should direct-list-tag_protection", function()
    local setup = tag_protection_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-tag_protection", setup.live and "live" or "unit")
...
function tag_protection_direct_setup(mockres)
