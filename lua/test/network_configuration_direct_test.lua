-- NetworkConfiguration direct test
...
describe("NetworkConfigurationDirect", function()
  it("should direct-load-network_configuration", function()
    local setup = network_configuration_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-network_configuration", setup.live and "live" or "unit")
...
function network_configuration_direct_setup(mockres)
