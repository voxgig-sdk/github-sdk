-- IntegrationInstallation direct test
...
describe("IntegrationInstallationDirect", function()
  it("should direct-list-integration_installation", function()
    local setup = integration_installation_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-integration_installation", setup.live and "live" or "unit")
...
function integration_installation_direct_setup(mockres)
