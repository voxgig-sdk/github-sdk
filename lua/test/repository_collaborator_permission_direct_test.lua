-- RepositoryCollaboratorPermission direct test
...
describe("RepositoryCollaboratorPermissionDirect", function()
  it("should direct-load-repository_collaborator_permission", function()
    local setup = repository_collaborator_permission_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-repository_collaborator_permission", setup.live and "live" or "unit")
...
function repository_collaborator_permission_direct_setup(mockres)
