...
describe("LicenseDirect", function()
  it("should direct-list-license", function()
    local setup = license_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-license", setup.live and "live" or "unit")
  ...
  it("should direct-load-license", function()
    local setup = license_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-license", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function license_direct_setup(mockres)
