...
describe("CodeFrequencyStatDirect", function()
  it("should direct-list-code_frequency_stat", function()
    local setup = code_frequency_stat_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-code_frequency_stat", setup.live and "live" or "unit")
...
function code_frequency_stat_direct_setup(mockres)
