...
describe("ShortBranchDirect", function()
  it("should direct-list-short_branch", function()
    local setup = short_branch_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-short_branch", setup.live and "live" or "unit")
...
function short_branch_direct_setup(mockres)
