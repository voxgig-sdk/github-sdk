...
describe("GitTagDirect", function()
  it("should direct-load-git_tag", function()
    local setup = git_tag_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-git_tag", setup.live and "live" or "unit")
...
function git_tag_direct_setup(mockres)
