...
describe("OidcCustomSubRepoDirect", function()
  it("should direct-list-oidc_custom_sub_repo", function()
    local setup = oidc_custom_sub_repo_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-oidc_custom_sub_repo", setup.live and "live" or "unit")
...
function oidc_custom_sub_repo_direct_setup(mockres)
