...
describe("ActionsCacheListDirect", function()
  it("should direct-list-actions_cache_list", function()
    local setup = actions_cache_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-actions_cache_list", setup.live and "live" or "unit")
...
function actions_cache_list_direct_setup(mockres)
