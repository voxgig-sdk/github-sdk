...
describe("FollowerDirect", function()
  it("should direct-list-follower", function()
    local setup = follower_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-follower", setup.live and "live" or "unit")
...
function follower_direct_setup(mockres)
