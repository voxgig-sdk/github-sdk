-- ActionsCacheUsageByRepository direct test
...
describe("ActionsCacheUsageByRepositoryDirect", function()
  it("should direct-load-actions_cache_usage_by_repository", function()
    local setup = actions_cache_usage_by_repository_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-actions_cache_usage_by_repository", setup.live and "live" or "unit")
...
function actions_cache_usage_by_repository_direct_setup(mockres)
