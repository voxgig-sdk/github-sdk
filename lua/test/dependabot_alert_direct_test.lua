...
describe("DependabotAlertDirect", function()
  it("should direct-list-dependabot_alert", function()
    local setup = dependabot_alert_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-dependabot_alert", setup.live and "live" or "unit")
  ...
  it("should direct-load-dependabot_alert", function()
    local setup = dependabot_alert_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dependabot_alert", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function dependabot_alert_direct_setup(mockres)
