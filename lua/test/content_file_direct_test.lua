...
describe("ContentFileDirect", function()
  it("should direct-load-content_file", function()
    local setup = content_file_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-content_file", setup.live and "live" or "unit")
...
function content_file_direct_setup(mockres)
