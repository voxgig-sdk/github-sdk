...
describe("PublicMemberDirect", function()
  it("should direct-list-public_member", function()
    local setup = public_member_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-public_member", setup.live and "live" or "unit")
...
function public_member_direct_setup(mockres)
