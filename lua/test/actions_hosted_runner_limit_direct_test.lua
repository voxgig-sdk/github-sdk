-- ActionsHostedRunnerLimit direct test
...
describe("ActionsHostedRunnerLimitDirect", function()
  it("should direct-load-actions_hosted_runner_limit", function()
    local setup = actions_hosted_runner_limit_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-actions_hosted_runner_limit", setup.live and "live" or "unit")
...
function actions_hosted_runner_limit_direct_setup(mockres)
