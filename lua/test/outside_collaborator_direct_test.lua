-- OutsideCollaborator direct test
...
describe("OutsideCollaboratorDirect", function()
  it("should direct-list-outside_collaborator", function()
    local setup = outside_collaborator_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-outside_collaborator", setup.live and "live" or "unit")
...
function outside_collaborator_direct_setup(mockres)
