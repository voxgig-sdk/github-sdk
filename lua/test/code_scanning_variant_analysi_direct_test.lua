-- CodeScanningVariantAnalysi direct test
...
describe("CodeScanningVariantAnalysiDirect", function()
  it("should direct-load-code_scanning_variant_analysi", function()
    local setup = code_scanning_variant_analysi_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-code_scanning_variant_analysi", setup.live and "live" or "unit")
...
function code_scanning_variant_analysi_direct_setup(mockres)
