-- DeploymentBranchPolicy direct test
...
describe("DeploymentBranchPolicyDirect", function()
  it("should direct-load-deployment_branch_policy", function()
    local setup = deployment_branch_policy_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-deployment_branch_policy", setup.live and "live" or "unit")
...
function deployment_branch_policy_direct_setup(mockres)
