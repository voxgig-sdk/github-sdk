...
describe("ContributorDirect", function()
  it("should direct-list-contributor", function()
    local setup = contributor_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-contributor", setup.live and "live" or "unit")
...
function contributor_direct_setup(mockres)
