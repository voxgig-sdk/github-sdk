...
describe("SocialAccountDirect", function()
  it("should direct-list-social_account", function()
    local setup = social_account_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-social_account", setup.live and "live" or "unit")
...
function social_account_direct_setup(mockres)
