-- BillingUsageReportUser direct test
...
describe("BillingUsageReportUserDirect", function()
  it("should direct-list-billing_usage_report_user", function()
    local setup = billing_usage_report_user_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-billing_usage_report_user", setup.live and "live" or "unit")
...
function billing_usage_report_user_direct_setup(mockres)
