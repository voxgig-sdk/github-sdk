...
describe("CheckDirect", function()
  it("should direct-list-check", function()
    local setup = check_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-check", setup.live and "live" or "unit")
