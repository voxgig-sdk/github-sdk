...
describe("OrganizationRoleDirect", function()
  it("should direct-load-organization_role", function()
    local setup = organization_role_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-organization_role", setup.live and "live" or "unit")
...
function organization_role_direct_setup(mockres)
