-- PagesDeploymentStatus direct test
...
describe("PagesDeploymentStatusDirect", function()
  it("should direct-load-pages_deployment_status", function()
    local setup = pages_deployment_status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-pages_deployment_status", setup.live and "live" or "unit")
...
function pages_deployment_status_direct_setup(mockres)
