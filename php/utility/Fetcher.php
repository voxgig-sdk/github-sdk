...
class GithubFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GithubSDK/1.0)';
    ...
    public static function call(GithubContext $ctx, string $fullurl, array $fetchdef): array
    {
