...
// Github SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class GithubMakeRequest
{
    public static function call(GithubContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new GithubResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new GithubResponse($fetched);
        } else {
