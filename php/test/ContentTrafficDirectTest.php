...
class ContentTrafficDirectTest extends TestCase
{
    public function test_direct_list_content_traffic(): void
    {
        $setup = content_traffic_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-content_traffic", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
