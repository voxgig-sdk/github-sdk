...
class FollowingDirectTest extends TestCase
{
    public function test_direct_list_following(): void
    {
        $setup = following_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-following", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
