...
class ProjectEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set GITHUB_TEST_PROJECT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $project_ref01_markdef_up0_name = "avatar_url";
...
function project_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["project01", "project02", "project03", "org01", "org02", "org03", "repo01", "repo02", "repo03", "user01", "user02", "user03", "projects_v201", "projects_v202", "projects_v203", "item01", "item02", "item03", "owner01", "username01"] as $k) {
    ...
    $entid_env_raw = getenv("GITHUB_TEST_PROJECT_ENTID");
