...
class CommitActivityDirectTest extends TestCase
{
    public function test_direct_list_commit_activity(): void
    {
        $setup = commit_activity_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-commit_activity", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
