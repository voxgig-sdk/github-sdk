...
class TagProtectionDirectTest extends TestCase
{
    public function test_direct_list_tag_protection(): void
    {
        $setup = tag_protection_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-tag_protection", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
