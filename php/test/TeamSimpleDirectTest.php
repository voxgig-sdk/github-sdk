...
class TeamSimpleDirectTest extends TestCase
{
    public function test_direct_list_team_simple(): void
    {
        $setup = team_simple_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-team_simple", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
