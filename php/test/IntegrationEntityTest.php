...
class IntegrationEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set GITHUB_TEST_INTEGRATION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $integration_ref01_markdef_up0_name = "client_id";
...
function integration_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["integration01", "integration02", "integration03", "app01", "app02", "app03", "repo01", "repo02", "repo03", "branch01", "branch02", "branch03", "owner01"] as $k) {
    ...
    $entid_env_raw = getenv("GITHUB_TEST_INTEGRATION_ENTID");
