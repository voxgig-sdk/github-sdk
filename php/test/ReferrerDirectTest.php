...
class ReferrerDirectTest extends TestCase
{
    public function test_direct_list_referrer(): void
    {
        $setup = referrer_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-referrer", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
