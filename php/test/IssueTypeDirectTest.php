...
class IssueTypeDirectTest extends TestCase
{
    public function test_direct_list_issue_type(): void
    {
        $setup = issue_type_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-issue_type", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
