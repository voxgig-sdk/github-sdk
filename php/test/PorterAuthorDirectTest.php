...
class PorterAuthorDirectTest extends TestCase
{
    public function test_direct_list_porter_author(): void
    {
        $setup = porter_author_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-porter_author", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
