...
class CollaboratorDirectTest extends TestCase
{
    public function test_direct_list_collaborator(): void
    {
        $setup = collaborator_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-collaborator", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
