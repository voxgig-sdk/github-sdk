...
class JobEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set GITHUB_TEST_JOB_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function job_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["job01", "job02", "job03", "repo01", "repo02", "repo03", "owner01"] as $k) {
    ...
    $entid_env_raw = getenv("GITHUB_TEST_JOB_ENTID");
