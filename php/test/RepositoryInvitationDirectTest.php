...
class RepositoryInvitationDirectTest extends TestCase
{
    public function test_direct_list_repository_invitation(): void
    {
        $setup = repository_invitation_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-repository_invitation", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
