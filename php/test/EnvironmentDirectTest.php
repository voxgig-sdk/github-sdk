...
class EnvironmentDirectTest extends TestCase
{
    public function test_direct_load_environment(): void
    {
        $setup = environment_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-environment", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
