...
class GithubTestRunner
{
    ...
    {
        $live = self::getenv('GITHUB_TEST_LIVE');
        $override = self::getenv('GITHUB_TEST_OVERRIDE');
        ...
        $explain = self::getenv('GITHUB_TEST_EXPLAIN');
...
class_alias('GithubTestRunner', 'Runner');
class_alias('GithubHelpers', 'Helpers');
