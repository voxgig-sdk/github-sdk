...
class HovercardDirectTest extends TestCase
{
    public function test_direct_list_hovercard(): void
    {
        $setup = hovercard_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-hovercard", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
