...
{
    public function test_direct_list_view(): void
    {
        $setup = view_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-view", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
