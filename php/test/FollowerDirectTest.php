...
class FollowerDirectTest extends TestCase
{
    public function test_direct_list_follower(): void
    {
        $setup = follower_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-follower", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
