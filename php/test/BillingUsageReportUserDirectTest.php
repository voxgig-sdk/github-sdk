...
class BillingUsageReportUserDirectTest extends TestCase
{
    public function test_direct_list_billing_usage_report_user(): void
    {
        $setup = billing_usage_report_user_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-billing_usage_report_user", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
