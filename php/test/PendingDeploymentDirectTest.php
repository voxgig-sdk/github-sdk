...
class PendingDeploymentDirectTest extends TestCase
{
    public function test_direct_list_pending_deployment(): void
    {
        $setup = pending_deployment_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-pending_deployment", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
