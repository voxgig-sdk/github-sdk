...
class OidcCustomSubRepoDirectTest extends TestCase
{
    public function test_direct_list_oidc_custom_sub_repo(): void
    {
        $setup = oidc_custom_sub_repo_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-oidc_custom_sub_repo", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
