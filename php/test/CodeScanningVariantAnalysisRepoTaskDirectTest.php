...
class CodeScanningVariantAnalysisRepoTaskDirectTest extends TestCase
{
    public function test_direct_load_code_scanning_variant_analysis_repo_task(): void
    {
        $setup = code_scanning_variant_analysis_repo_task_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-code_scanning_variant_analysis_repo_task", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
