...
class SocialAccountDirectTest extends TestCase
{
    public function test_direct_list_social_account(): void
    {
        $setup = social_account_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-social_account", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
