...
class CustomPropertyValueDirectTest extends TestCase
{
    public function test_direct_list_custom_property_value(): void
    {
        $setup = custom_property_value_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-custom_property_value", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
