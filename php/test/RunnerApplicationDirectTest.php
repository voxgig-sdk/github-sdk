...
class RunnerApplicationDirectTest extends TestCase
{
    public function test_direct_list_runner_application(): void
    {
        $setup = runner_application_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-runner_application", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
