...
class MinimalRepositoryDirectTest extends TestCase
{
    public function test_direct_list_minimal_repository(): void
    {
        $setup = minimal_repository_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-minimal_repository", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
