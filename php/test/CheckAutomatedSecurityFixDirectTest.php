...
class CheckAutomatedSecurityFixDirectTest extends TestCase
{
    public function test_direct_load_check_automated_security_fix(): void
    {
        $setup = check_automated_security_fix_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-check_automated_security_fix", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
