...
class SelectedActionDirectTest extends TestCase
{
    public function test_direct_list_selected_action(): void
    {
        $setup = selected_action_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-selected_action", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
