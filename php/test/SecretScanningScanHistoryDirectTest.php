...
class SecretScanningScanHistoryDirectTest extends TestCase
{
    public function test_direct_list_secret_scanning_scan_history(): void
    {
        $setup = secret_scanning_scan_history_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-secret_scanning_scan_history", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
