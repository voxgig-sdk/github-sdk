...
class BlobDirectTest extends TestCase
{
    public function test_direct_load_blob(): void
    {
        $setup = blob_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-blob", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
