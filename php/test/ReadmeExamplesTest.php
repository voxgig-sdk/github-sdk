...
// Github SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GithubSDK::test)
...
{
    private const SDK_CLASS = 'GithubSDK';
    ...
    private const SDK_BASE = 'github_sdk';
