...
class CheckRunDirectTest extends TestCase
{
    public function test_direct_load_check_run(): void
    {
        $setup = check_run_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-check_run", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
