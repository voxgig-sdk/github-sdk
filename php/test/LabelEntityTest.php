...
class LabelEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set GITHUB_TEST_LABEL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $label_ref01_data = Helpers::to_map(Vs::getprop(
        ...
        $found_item = sdk_select(
            Runner::entity_list_to_data($label_ref01_list_result),
        ...
        $label_ref01_markdef_up0_name = "color";
        $label_ref01_markdef_up0_value = "Mark01-label_ref01_" . $setup["now"];
...
function label_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["label01", "label02", "label03", "repo01", "repo02", "repo03", "milestone01", "milestone02", "milestone03", "milestone_number01", "owner01"] as $k) {
    ...
    $entid_env_raw = getenv("GITHUB_TEST_LABEL_ENTID");
