...
class CloneDirectTest extends TestCase
{
    public function test_direct_list_clone(): void
    {
        $setup = clone_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-clone", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
