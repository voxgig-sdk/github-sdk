...
class ContributorDirectTest extends TestCase
{
    public function test_direct_list_contributor(): void
    {
        $setup = contributor_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-contributor", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
