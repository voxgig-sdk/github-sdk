...
class CodeownersErrorDirectTest extends TestCase
{
    public function test_direct_list_codeowners_error(): void
    {
        $setup = codeowners_error_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-codeowners_error", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
