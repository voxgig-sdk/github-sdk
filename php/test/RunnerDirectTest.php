...
class RunnerDirectTest extends TestCase
{
    public function test_direct_load_runner(): void
    {
        $setup = runner_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-runner", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
