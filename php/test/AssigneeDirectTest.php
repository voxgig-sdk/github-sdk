...
class AssigneeDirectTest extends TestCase
{
    public function test_direct_list_assignee(): void
    {
        $setup = assignee_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-assignee", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
