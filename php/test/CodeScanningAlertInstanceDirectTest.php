...
class CodeScanningAlertInstanceDirectTest extends TestCase
{
    public function test_direct_list_code_scanning_alert_instance(): void
    {
        $setup = code_scanning_alert_instance_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-code_scanning_alert_instance", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
