...
class GitCommitDirectTest extends TestCase
{
    public function test_direct_load_git_commit(): void
    {
        $setup = git_commit_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-git_commit", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
