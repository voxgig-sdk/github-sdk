...
class BlockDirectTest extends TestCase
{
    public function test_direct_list_block(): void
    {
        $setup = block_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-block", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
