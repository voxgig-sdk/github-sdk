...
{
    private static function utility(): GithubUtility
    {
        return new GithubUtility();
    }
    ...
    private static function ctx(array $over = []): GithubContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new GithubContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new GithubOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof GithubError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new GithubOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = GithubMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new GithubOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = GithubMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new GithubOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = GithubMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new GithubSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = GithubMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        ...
        [, $err] = GithubMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new GithubSpec(['step' => 's']),
            'response' => new GithubResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new GithubResult([]),
        ]);
        [, $err] = GithubMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new GithubSpec(['step' => 's']),
            'response' => new GithubResponse(self::resp(200, ['v' => 1])),
            'result' => new GithubResult([]),
        ]);
        [, $err] = GithubMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new GithubSpec(['step' => 's']),
            'response' => new GithubResponse(self::resp(200, ['v' => 2])),
            'result' => new GithubResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        GithubMakeResponse::call($ctx);
    ...
    {
        $preset = new GithubResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new GithubSpec([]),
            'response' => new GithubResponse([]),
            'result' => new GithubResult([]),
        ...
        [$got, $err] = GithubMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new GithubResult([])]);
        [, $err] = GithubMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new GithubSpec([]), 'result' => null]);
        [, $err] = GithubMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new GithubSpec(['step' => 's']),
            'result' => new GithubResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new GithubOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = GithubMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new GithubSpec(['step' => 's']),
            'result' => new GithubResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new GithubOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = GithubMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new GithubResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new GithubSpec([]),
            'result' => new GithubResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = GithubMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = GithubMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new GithubError('boom', 'boom');
        $utility->fetcher = function (GithubContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new GithubSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = GithubMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (GithubContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = GithubMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(GithubResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (GithubContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new GithubSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = GithubMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new GithubResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new GithubSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = GithubMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = GithubMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = GithubMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new GithubResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, GithubDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new GithubResult(['ok' => false])]);
        $this->expectException(GithubError::class);
        GithubDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new GithubResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', GithubMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new GithubBaseFeature();
        $b = new GithubBaseFeature();
        GithubFeatureAdd::call($ctx, $a);
        GithubFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): GithubBaseFeature
    {
        $f = new GithubBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        GithubFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): GithubContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new GithubSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = GithubPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new GithubResponse(['headers' => null]),
            'result' => new GithubResult([]),
        ]);
        GithubResultHeaders::call($ctx);
