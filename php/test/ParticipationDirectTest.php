...
class ParticipationDirectTest extends TestCase
{
    public function test_direct_list_participation(): void
    {
        $setup = participation_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-participation", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
