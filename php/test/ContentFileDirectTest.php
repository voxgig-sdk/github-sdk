...
class ContentFileDirectTest extends TestCase
{
    public function test_direct_load_content_file(): void
    {
        $setup = content_file_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-content_file", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
