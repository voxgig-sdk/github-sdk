...
class GitRefDirectTest extends TestCase
{
    public function test_direct_load_git_ref(): void
    {
        $setup = git_ref_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-git_ref", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
