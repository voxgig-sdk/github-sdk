...
class ShortBranchDirectTest extends TestCase
{
    public function test_direct_list_short_branch(): void
    {
        $setup = short_branch_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-short_branch", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
