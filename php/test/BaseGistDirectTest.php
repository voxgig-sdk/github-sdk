...
class BaseGistDirectTest extends TestCase
{
    public function test_direct_list_base_gist(): void
    {
        $setup = base_gist_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-base_gist", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
