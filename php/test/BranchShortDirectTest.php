...
class BranchShortDirectTest extends TestCase
{
    public function test_direct_list_branch_short(): void
    {
        $setup = branch_short_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-branch_short", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
