...
{
    public function test_direct_load_branch(): void
    {
        $setup = branch_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-branch", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
