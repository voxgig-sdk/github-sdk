...
class EmptyObjectDirectTest extends TestCase
{
    public function test_direct_load_empty_object(): void
    {
        $setup = empty_object_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-empty_object", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
