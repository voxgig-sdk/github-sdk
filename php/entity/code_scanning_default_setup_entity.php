...
// Github SDK CodeScanningDefaultSetup entity
...
class CodeScanningDefaultSetupEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "code_scanning_default_setup";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CodeScanningDefaultSetupEntity($this->_client, $opts);
    }

    /**
     * @param CodeScanningDefaultSetup|array $args CodeScanningDefaultSetup data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeScanningDefaultSetup|array The current CodeScanningDefaultSetup data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeScanningDefaultSetup fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeScanningDefaultSetup fields).
     */
    ...
    /**
     * List CodeScanningDefaultSetup items matching the given filter.
     *
     * @param CodeScanningDefaultSetupListMatch|array|null $reqmatch Match filter (any subset
     *   of CodeScanningDefaultSetup fields) as an assoc-array; CodeScanningDefaultSetupListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanningDefaultSetup[]|array A list of CodeScanningDefaultSetup items as assoc-arrays at
