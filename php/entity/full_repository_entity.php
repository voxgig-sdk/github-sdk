...
// Github SDK FullRepository entity
...
class FullRepositoryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FullRepositoryEntity($this->_client, $opts);
    }

    /**
     * @param FullRepository|array $args FullRepository data (assoc-array) to store.
     */
    ...
    /**
     * @return FullRepository|array The current FullRepository data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of FullRepository fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of FullRepository fields).
     */
    ...
    /**
     * Load a single FullRepository.
     *
     * @param FullRepositoryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FullRepositoryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FullRepository|array The loaded FullRepository as an assoc-array at the
    ...
    /**
     * Create a new FullRepository.
     *
     * @param FullRepositoryCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FullRepositoryCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FullRepository|array The created FullRepository as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing FullRepository.
     *
     * @param FullRepositoryUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FullRepositoryUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FullRepository|array The updated FullRepository as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
