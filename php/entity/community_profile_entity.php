...
// Github SDK CommunityProfile entity
...
class CommunityProfileEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CommunityProfileEntity($this->_client, $opts);
    }

    /**
     * @param CommunityProfile|array $args CommunityProfile data (assoc-array) to store.
     */
    ...
    /**
     * @return CommunityProfile|array The current CommunityProfile data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CommunityProfile fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CommunityProfile fields).
     */
    ...
    /**
     * Load a single CommunityProfile.
     *
     * @param CommunityProfileLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CommunityProfileLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CommunityProfile|array The loaded CommunityProfile as an assoc-array at the
