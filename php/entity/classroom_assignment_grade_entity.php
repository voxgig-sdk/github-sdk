...
// Github SDK ClassroomAssignmentGrade entity
...
class ClassroomAssignmentGradeEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "classroom_assignment_grade";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ClassroomAssignmentGradeEntity($this->_client, $opts);
    }

    /**
     * @param ClassroomAssignmentGrade|array $args ClassroomAssignmentGrade data (assoc-array) to store.
     */
    ...
    /**
     * @return ClassroomAssignmentGrade|array The current ClassroomAssignmentGrade data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ClassroomAssignmentGrade fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ClassroomAssignmentGrade fields).
     */
    ...
    /**
     * List ClassroomAssignmentGrade items matching the given filter.
     *
     * @param ClassroomAssignmentGradeListMatch|array|null $reqmatch Match filter (any subset
     *   of ClassroomAssignmentGrade fields) as an assoc-array; ClassroomAssignmentGradeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ClassroomAssignmentGrade[]|array A list of ClassroomAssignmentGrade items as assoc-arrays at
