...
// Github SDK GitignoreTemplate entity
...
class GitignoreTemplateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GitignoreTemplateEntity($this->_client, $opts);
    }

    /**
     * @param GitignoreTemplate|array $args GitignoreTemplate data (assoc-array) to store.
     */
    ...
    /**
     * @return GitignoreTemplate|array The current GitignoreTemplate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GitignoreTemplate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GitignoreTemplate fields).
     */
    ...
    /**
     * Load a single GitignoreTemplate.
     *
     * @param GitignoreTemplateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GitignoreTemplateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GitignoreTemplate|array The loaded GitignoreTemplate as an assoc-array at the
