...
// Github SDK ProjectsV2ItemWithContent entity
...
class ProjectsV2ItemWithContentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "projects_v2_item_with_content";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ProjectsV2ItemWithContentEntity($this->_client, $opts);
    }

    /**
     * @param ProjectsV2ItemWithContent|array $args ProjectsV2ItemWithContent data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectsV2ItemWithContent|array The current ProjectsV2ItemWithContent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectsV2ItemWithContent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectsV2ItemWithContent fields).
     */
    ...
    /**
     * Load a single ProjectsV2ItemWithContent.
     *
     * @param ProjectsV2ItemWithContentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ProjectsV2ItemWithContentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectsV2ItemWithContent|array The loaded ProjectsV2ItemWithContent as an assoc-array at the
    ...
    /**
     * List ProjectsV2ItemWithContent items matching the given filter.
     *
     * @param ProjectsV2ItemWithContentListMatch|array|null $reqmatch Match filter (any subset
     *   of ProjectsV2ItemWithContent fields) as an assoc-array; ProjectsV2ItemWithContentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectsV2ItemWithContent[]|array A list of ProjectsV2ItemWithContent items as assoc-arrays at
    ...
    /**
     * Update an existing ProjectsV2ItemWithContent.
     *
     * @param ProjectsV2ItemWithContentUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProjectsV2ItemWithContentUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectsV2ItemWithContent|array The updated ProjectsV2ItemWithContent as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
