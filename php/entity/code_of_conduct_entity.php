...
// Github SDK CodeOfConduct entity
...
class CodeOfConductEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CodeOfConductEntity($this->_client, $opts);
    }

    /**
     * @param CodeOfConduct|array $args CodeOfConduct data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeOfConduct|array The current CodeOfConduct data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeOfConduct fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeOfConduct fields).
     */
    ...
    /**
     * Load a single CodeOfConduct.
     *
     * @param CodeOfConductLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CodeOfConductLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeOfConduct|array The loaded CodeOfConduct as an assoc-array at the
    ...
    /**
     * List CodeOfConduct items matching the given filter.
     *
     * @param CodeOfConductListMatch|array|null $reqmatch Match filter (any subset
     *   of CodeOfConduct fields) as an assoc-array; CodeOfConductListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeOfConduct[]|array A list of CodeOfConduct items as assoc-arrays at
