...
// Github SDK BillingUsageReportUser entity
...
class BillingUsageReportUserEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "billing_usage_report_user";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new BillingUsageReportUserEntity($this->_client, $opts);
    }

    /**
     * @param BillingUsageReportUser|array $args BillingUsageReportUser data (assoc-array) to store.
     */
    ...
    /**
     * @return BillingUsageReportUser|array The current BillingUsageReportUser data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BillingUsageReportUser fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BillingUsageReportUser fields).
     */
    ...
    /**
     * List BillingUsageReportUser items matching the given filter.
     *
     * @param BillingUsageReportUserListMatch|array|null $reqmatch Match filter (any subset
     *   of BillingUsageReportUser fields) as an assoc-array; BillingUsageReportUserListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BillingUsageReportUser[]|array A list of BillingUsageReportUser items as assoc-arrays at
