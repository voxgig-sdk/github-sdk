...
// Github SDK BranchWithProtection entity
...
class BranchWithProtectionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "branch_with_protection";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new BranchWithProtectionEntity($this->_client, $opts);
    }

    /**
     * @param BranchWithProtection|array $args BranchWithProtection data (assoc-array) to store.
     */
    ...
    /**
     * @return BranchWithProtection|array The current BranchWithProtection data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BranchWithProtection fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BranchWithProtection fields).
     */
    ...
    /**
     * Create a new BranchWithProtection.
     *
     * @param BranchWithProtectionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BranchWithProtectionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BranchWithProtection|array The created BranchWithProtection as an assoc-array at the
