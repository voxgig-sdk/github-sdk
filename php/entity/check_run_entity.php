...
class CheckRunEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CheckRunEntity($this->_client, $opts);
    }

    /**
     * @param CheckRun|array $args CheckRun data (assoc-array) to store.
     */
    ...
    /**
     * @return CheckRun|array The current CheckRun data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CheckRun fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CheckRun fields).
     */
    ...
    /**
     * Load a single CheckRun.
     *
     * @param CheckRunLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CheckRunLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CheckRun|array The loaded CheckRun as an assoc-array at the
     ...
     *
     * @param CheckRunCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CheckRunCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CheckRun|array The created CheckRun as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing CheckRun.
     *
     * @param CheckRunUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CheckRunUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CheckRun|array The updated CheckRun as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
