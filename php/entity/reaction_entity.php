...
class ReactionEntity
{
    ...
    /**
     * Remove an Reaction matching the given criteria.
     *
     * @param ReactionRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ReactionRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Reaction|array The removed Reaction as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
