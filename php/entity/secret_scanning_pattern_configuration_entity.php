...
class SecretScanningPatternConfigurationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "secret_scanning_pattern_configuration";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SecretScanningPatternConfigurationEntity($this->_client, $opts);
    }

    /**
     * @param SecretScanningPatternConfiguration|array $args SecretScanningPatternConfiguration data (assoc-array) to store.
     */
    ...
    /**
     * @return SecretScanningPatternConfiguration|array The current SecretScanningPatternConfiguration data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SecretScanningPatternConfiguration fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SecretScanningPatternConfiguration fields).
     */
    ...
    /**
     * List SecretScanningPatternConfiguration items matching the given filter.
     *
     * @param SecretScanningPatternConfigurationListMatch|array|null $reqmatch Match filter (any subset
     *   of SecretScanningPatternConfiguration fields) as an assoc-array; SecretScanningPatternConfigurationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SecretScanningPatternConfiguration[]|array A list of SecretScanningPatternConfiguration items as assoc-arrays at
