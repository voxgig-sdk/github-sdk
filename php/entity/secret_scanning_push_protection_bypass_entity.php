...
class SecretScanningPushProtectionBypassEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "secret_scanning_push_protection_bypass";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SecretScanningPushProtectionBypassEntity($this->_client, $opts);
    }

    /**
     * @param SecretScanningPushProtectionBypass|array $args SecretScanningPushProtectionBypass data (assoc-array) to store.
     */
    ...
    /**
     * @return SecretScanningPushProtectionBypass|array The current SecretScanningPushProtectionBypass data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SecretScanningPushProtectionBypass fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SecretScanningPushProtectionBypass fields).
     */
    ...
    /**
     * Create a new SecretScanningPushProtectionBypass.
     *
     * @param SecretScanningPushProtectionBypassCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SecretScanningPushProtectionBypassCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SecretScanningPushProtectionBypass|array The created SecretScanningPushProtectionBypass as an assoc-array at the
