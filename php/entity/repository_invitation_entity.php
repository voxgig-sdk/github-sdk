...
// Github SDK RepositoryInvitation entity
...
class RepositoryInvitationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "repository_invitation";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RepositoryInvitationEntity($this->_client, $opts);
    }

    /**
     * @param RepositoryInvitation|array $args RepositoryInvitation data (assoc-array) to store.
     */
    ...
    /**
     * @return RepositoryInvitation|array The current RepositoryInvitation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RepositoryInvitation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RepositoryInvitation fields).
     */
    ...
    /**
     * List RepositoryInvitation items matching the given filter.
     *
     * @param RepositoryInvitationListMatch|array|null $reqmatch Match filter (any subset
     *   of RepositoryInvitation fields) as an assoc-array; RepositoryInvitationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryInvitation[]|array A list of RepositoryInvitation items as assoc-arrays at
    ...
    /**
     * Update an existing RepositoryInvitation.
     *
     * @param RepositoryInvitationUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RepositoryInvitationUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryInvitation|array The updated RepositoryInvitation as an assoc-array at the
