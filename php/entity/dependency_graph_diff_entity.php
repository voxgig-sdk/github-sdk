...
// Github SDK DependencyGraphDiff entity
...
class DependencyGraphDiffEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "dependency_graph_diff";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DependencyGraphDiffEntity($this->_client, $opts);
    }

    /**
     * @param DependencyGraphDiff|array $args DependencyGraphDiff data (assoc-array) to store.
     */
    ...
    /**
     * @return DependencyGraphDiff|array The current DependencyGraphDiff data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DependencyGraphDiff fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DependencyGraphDiff fields).
     */
    ...
    /**
     * Load a single DependencyGraphDiff.
     *
     * @param DependencyGraphDiffLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DependencyGraphDiffLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DependencyGraphDiff|array The loaded DependencyGraphDiff as an assoc-array at the
