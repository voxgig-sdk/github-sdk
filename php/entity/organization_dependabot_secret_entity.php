...
class OrganizationDependabotSecretEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "organization_dependabot_secret";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OrganizationDependabotSecretEntity($this->_client, $opts);
    }

    /**
     * @param OrganizationDependabotSecret|array $args OrganizationDependabotSecret data (assoc-array) to store.
     */
    ...
    /**
     * @return OrganizationDependabotSecret|array The current OrganizationDependabotSecret data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrganizationDependabotSecret fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrganizationDependabotSecret fields).
     */
    ...
    /**
     * Load a single OrganizationDependabotSecret.
     *
     * @param OrganizationDependabotSecretLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OrganizationDependabotSecretLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationDependabotSecret|array The loaded OrganizationDependabotSecret as an assoc-array at the
