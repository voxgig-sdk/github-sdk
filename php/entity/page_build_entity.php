...
class PageBuildEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PageBuildEntity($this->_client, $opts);
    }

    /**
     * @param PageBuild|array $args PageBuild data (assoc-array) to store.
     */
    ...
    /**
     * @return PageBuild|array The current PageBuild data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PageBuild fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PageBuild fields).
     */
    ...
    /**
     * Load a single PageBuild.
     *
     * @param PageBuildLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PageBuildLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PageBuild|array The loaded PageBuild as an assoc-array at the
    ...
    /**
     * List PageBuild items matching the given filter.
     *
     * @param PageBuildListMatch|array|null $reqmatch Match filter (any subset
     *   of PageBuild fields) as an assoc-array; PageBuildListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PageBuild[]|array A list of PageBuild items as assoc-arrays at
