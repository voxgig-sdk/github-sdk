...
class CopilotEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CopilotEntity($this->_client, $opts);
    }

    /**
     * @param Copilot|array $args Copilot data (assoc-array) to store.
     */
    ...
    /**
     * @return Copilot|array The current Copilot data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Copilot fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Copilot fields).
     */
    ...
    /**
     * Load a single Copilot.
     *
     * @param CopilotLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CopilotLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Copilot|array The loaded Copilot as an assoc-array at the
    ...
    /**
     * List Copilot items matching the given filter.
     *
     * @param CopilotListMatch|array|null $reqmatch Match filter (any subset
     *   of Copilot fields) as an assoc-array; CopilotListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Copilot[]|array A list of Copilot items as assoc-arrays at
     ...
     *
     * @param CopilotCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CopilotCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Copilot|array The created Copilot as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Copilot matching the given criteria.
     *
     * @param CopilotRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CopilotRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Copilot|array The removed Copilot as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
