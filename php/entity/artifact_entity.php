...
class ArtifactEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ArtifactEntity($this->_client, $opts);
    }

    /**
     * @param Artifact|array $args Artifact data (assoc-array) to store.
     */
    ...
    /**
     * @return Artifact|array The current Artifact data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Artifact fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Artifact fields).
     */
     ...
     *
     * @param ArtifactLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ArtifactLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Artifact|array The loaded Artifact as an assoc-array at the
