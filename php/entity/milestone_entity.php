...
class MilestoneEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MilestoneEntity($this->_client, $opts);
    }

    /**
     * @param Milestone|array $args Milestone data (assoc-array) to store.
     */
    ...
    /**
     * @return Milestone|array The current Milestone data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Milestone fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Milestone fields).
     */
    ...
    /**
     * Load a single Milestone.
     *
     * @param MilestoneLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MilestoneLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Milestone|array The loaded Milestone as an assoc-array at the
    ...
    /**
     * List Milestone items matching the given filter.
     *
     * @param MilestoneListMatch|array|null $reqmatch Match filter (any subset
     *   of Milestone fields) as an assoc-array; MilestoneListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Milestone[]|array A list of Milestone items as assoc-arrays at
     ...
     *
     * @param MilestoneCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MilestoneCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Milestone|array The created Milestone as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
     ...
     *
     * @param MilestoneUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MilestoneUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Milestone|array The updated Milestone as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
