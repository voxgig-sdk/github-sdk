...
class CodeScanningOrganizationAlertItemEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "code_scanning_organization_alert_item";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CodeScanningOrganizationAlertItemEntity($this->_client, $opts);
    }

    /**
     * @param CodeScanningOrganizationAlertItem|array $args CodeScanningOrganizationAlertItem data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeScanningOrganizationAlertItem|array The current CodeScanningOrganizationAlertItem data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeScanningOrganizationAlertItem fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeScanningOrganizationAlertItem fields).
     */
    ...
    /**
     * List CodeScanningOrganizationAlertItem items matching the given filter.
     *
     * @param CodeScanningOrganizationAlertItemListMatch|array|null $reqmatch Match filter (any subset
     *   of CodeScanningOrganizationAlertItem fields) as an assoc-array; CodeScanningOrganizationAlertItemListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanningOrganizationAlertItem[]|array A list of CodeScanningOrganizationAlertItem items as assoc-arrays at
