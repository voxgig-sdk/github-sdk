...
// Github SDK ActionsPublicKey entity
...
class ActionsPublicKeyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ActionsPublicKeyEntity($this->_client, $opts);
    }

    /**
     * @param ActionsPublicKey|array $args ActionsPublicKey data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsPublicKey|array The current ActionsPublicKey data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsPublicKey fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsPublicKey fields).
     */
    ...
    /**
     * Load a single ActionsPublicKey.
     *
     * @param ActionsPublicKeyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionsPublicKeyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsPublicKey|array The loaded ActionsPublicKey as an assoc-array at the
