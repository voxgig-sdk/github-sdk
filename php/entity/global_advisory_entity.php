...
// Github SDK GlobalAdvisory entity
...
class GlobalAdvisoryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GlobalAdvisoryEntity($this->_client, $opts);
    }

    /**
     * @param GlobalAdvisory|array $args GlobalAdvisory data (assoc-array) to store.
     */
    ...
    /**
     * @return GlobalAdvisory|array The current GlobalAdvisory data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GlobalAdvisory fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GlobalAdvisory fields).
     */
    ...
    /**
     * Load a single GlobalAdvisory.
     *
     * @param GlobalAdvisoryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GlobalAdvisoryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GlobalAdvisory|array The loaded GlobalAdvisory as an assoc-array at the
    ...
    /**
     * List GlobalAdvisory items matching the given filter.
     *
     * @param GlobalAdvisoryListMatch|array|null $reqmatch Match filter (any subset
     *   of GlobalAdvisory fields) as an assoc-array; GlobalAdvisoryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GlobalAdvisory[]|array A list of GlobalAdvisory items as assoc-arrays at
