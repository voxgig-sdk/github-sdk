...
class EmptyObjectEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EmptyObjectEntity($this->_client, $opts);
    }

    /**
     * @param EmptyObject|array $args EmptyObject data (assoc-array) to store.
     */
    ...
    /**
     * @return EmptyObject|array The current EmptyObject data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmptyObject fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmptyObject fields).
     */
    ...
    /**
     * Load a single EmptyObject.
     *
     * @param EmptyObjectLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EmptyObjectLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmptyObject|array The loaded EmptyObject as an assoc-array at the
    ...
    /**
     * Create a new EmptyObject.
     *
     * @param EmptyObjectCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EmptyObjectCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmptyObject|array The created EmptyObject as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing EmptyObject.
     *
     * @param EmptyObjectUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EmptyObjectUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmptyObject|array The updated EmptyObject as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
