...
class ApiInsightsRouteStatEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_insights_route_stat";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiInsightsRouteStatEntity($this->_client, $opts);
    }

    /**
     * @param ApiInsightsRouteStat|array $args ApiInsightsRouteStat data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiInsightsRouteStat|array The current ApiInsightsRouteStat data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiInsightsRouteStat fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiInsightsRouteStat fields).
     */
    ...
    /**
     * List ApiInsightsRouteStat items matching the given filter.
     *
     * @param ApiInsightsRouteStatListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiInsightsRouteStat fields) as an assoc-array; ApiInsightsRouteStatListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiInsightsRouteStat[]|array A list of ApiInsightsRouteStat items as assoc-arrays at
