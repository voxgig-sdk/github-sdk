...
// Github SDK InstallationToken entity
...
class InstallationTokenEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InstallationTokenEntity($this->_client, $opts);
    }

    /**
     * @param InstallationToken|array $args InstallationToken data (assoc-array) to store.
     */
    ...
    /**
     * @return InstallationToken|array The current InstallationToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of InstallationToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of InstallationToken fields).
     */
    ...
    /**
     * Create a new InstallationToken.
     *
     * @param InstallationTokenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed InstallationTokenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return InstallationToken|array The created InstallationToken as an assoc-array at the
