...
// Github SDK RulesetVersion entity
...
class RulesetVersionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RulesetVersionEntity($this->_client, $opts);
    }

    /**
     * @param RulesetVersion|array $args RulesetVersion data (assoc-array) to store.
     */
    ...
    /**
     * @return RulesetVersion|array The current RulesetVersion data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RulesetVersion fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RulesetVersion fields).
     */
    ...
    /**
     * List RulesetVersion items matching the given filter.
     *
     * @param RulesetVersionListMatch|array|null $reqmatch Match filter (any subset
     *   of RulesetVersion fields) as an assoc-array; RulesetVersionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RulesetVersion[]|array A list of RulesetVersion items as assoc-arrays at
