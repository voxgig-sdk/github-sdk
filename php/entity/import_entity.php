...
class ImportEntity
{
    ...
    /**
     * List Import items matching the given filter.
     *
     * @param ImportListMatch|array|null $reqmatch Match filter (any subset
     *   of Import fields) as an assoc-array; ImportListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Import[]|array A list of Import items as assoc-arrays at
     ...
     *
     * @param ImportUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ImportUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Import|array The updated Import as an assoc-array at the
