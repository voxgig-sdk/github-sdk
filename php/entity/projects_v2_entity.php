...
class ProjectsV2Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProjectsV2Entity($this->_client, $opts);
    }

    /**
     * @param ProjectsV2|array $args ProjectsV2 data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectsV2|array The current ProjectsV2 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectsV2 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectsV2 fields).
     */
    ...
    /**
     * Load a single ProjectsV2.
     *
     * @param ProjectsV2LoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ProjectsV2LoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectsV2|array The loaded ProjectsV2 as an assoc-array at the
    ...
    /**
     * List ProjectsV2 items matching the given filter.
     *
     * @param ProjectsV2ListMatch|array|null $reqmatch Match filter (any subset
     *   of ProjectsV2 fields) as an assoc-array; ProjectsV2ListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectsV2[]|array A list of ProjectsV2 items as assoc-arrays at
