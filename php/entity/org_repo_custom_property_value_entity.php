...
class OrgRepoCustomPropertyValueEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "org_repo_custom_property_value";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OrgRepoCustomPropertyValueEntity($this->_client, $opts);
    }

    /**
     * @param OrgRepoCustomPropertyValue|array $args OrgRepoCustomPropertyValue data (assoc-array) to store.
     */
    ...
    /**
     * @return OrgRepoCustomPropertyValue|array The current OrgRepoCustomPropertyValue data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrgRepoCustomPropertyValue fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrgRepoCustomPropertyValue fields).
     */
    ...
    /**
     * List OrgRepoCustomPropertyValue items matching the given filter.
     *
     * @param OrgRepoCustomPropertyValueListMatch|array|null $reqmatch Match filter (any subset
     *   of OrgRepoCustomPropertyValue fields) as an assoc-array; OrgRepoCustomPropertyValueListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrgRepoCustomPropertyValue[]|array A list of OrgRepoCustomPropertyValue items as assoc-arrays at
