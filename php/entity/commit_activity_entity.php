...
// Github SDK CommitActivity entity
...
class CommitActivityEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CommitActivityEntity($this->_client, $opts);
    }

    /**
     * @param CommitActivity|array $args CommitActivity data (assoc-array) to store.
     */
    ...
    /**
     * @return CommitActivity|array The current CommitActivity data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CommitActivity fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CommitActivity fields).
     */
    ...
    /**
     * List CommitActivity items matching the given filter.
     *
     * @param CommitActivityListMatch|array|null $reqmatch Match filter (any subset
     *   of CommitActivity fields) as an assoc-array; CommitActivityListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CommitActivity[]|array A list of CommitActivity items as assoc-arrays at
