...
// Github SDK CommitComment entity
...
class CommitCommentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CommitCommentEntity($this->_client, $opts);
    }

    /**
     * @param CommitComment|array $args CommitComment data (assoc-array) to store.
     */
    ...
    /**
     * @return CommitComment|array The current CommitComment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CommitComment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CommitComment fields).
     */
    ...
    /**
     * Load a single CommitComment.
     *
     * @param CommitCommentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CommitCommentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CommitComment|array The loaded CommitComment as an assoc-array at the
    ...
    /**
     * List CommitComment items matching the given filter.
     *
     * @param CommitCommentListMatch|array|null $reqmatch Match filter (any subset
     *   of CommitComment fields) as an assoc-array; CommitCommentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CommitComment[]|array A list of CommitComment items as assoc-arrays at
    ...
    /**
     * Create a new CommitComment.
     *
     * @param CommitCommentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CommitCommentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CommitComment|array The created CommitComment as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing CommitComment.
     *
     * @param CommitCommentUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CommitCommentUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CommitComment|array The updated CommitComment as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
