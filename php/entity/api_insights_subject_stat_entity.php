...
class ApiInsightsSubjectStatEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_insights_subject_stat";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiInsightsSubjectStatEntity($this->_client, $opts);
    }

    /**
     * @param ApiInsightsSubjectStat|array $args ApiInsightsSubjectStat data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiInsightsSubjectStat|array The current ApiInsightsSubjectStat data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiInsightsSubjectStat fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiInsightsSubjectStat fields).
     */
    ...
    /**
     * List ApiInsightsSubjectStat items matching the given filter.
     *
     * @param ApiInsightsSubjectStatListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiInsightsSubjectStat fields) as an assoc-array; ApiInsightsSubjectStatListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiInsightsSubjectStat[]|array A list of ApiInsightsSubjectStat items as assoc-arrays at
