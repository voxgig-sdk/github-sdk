...
// Github SDK Authorization entity
...
class AuthorizationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AuthorizationEntity($this->_client, $opts);
    }

    /**
     * @param Authorization|array $args Authorization data (assoc-array) to store.
     */
    ...
    /**
     * @return Authorization|array The current Authorization data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Authorization fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Authorization fields).
     */
     ...
     *
     * @param AuthorizationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AuthorizationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Authorization|array The created Authorization as an assoc-array at the
     ...
     *
     * @param AuthorizationUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AuthorizationUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Authorization|array The updated Authorization as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
