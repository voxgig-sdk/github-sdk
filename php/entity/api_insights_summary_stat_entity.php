...
// Github SDK ApiInsightsSummaryStat entity
...
class ApiInsightsSummaryStatEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_insights_summary_stat";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiInsightsSummaryStatEntity($this->_client, $opts);
    }

    /**
     * @param ApiInsightsSummaryStat|array $args ApiInsightsSummaryStat data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiInsightsSummaryStat|array The current ApiInsightsSummaryStat data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiInsightsSummaryStat fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiInsightsSummaryStat fields).
     */
    ...
    /**
     * Load a single ApiInsightsSummaryStat.
     *
     * @param ApiInsightsSummaryStatLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiInsightsSummaryStatLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiInsightsSummaryStat|array The loaded ApiInsightsSummaryStat as an assoc-array at the
