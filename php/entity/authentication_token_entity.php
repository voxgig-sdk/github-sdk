...
// Github SDK AuthenticationToken entity
...
class AuthenticationTokenEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "authentication_token";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AuthenticationTokenEntity($this->_client, $opts);
    }

    /**
     * @param AuthenticationToken|array $args AuthenticationToken data (assoc-array) to store.
     */
    ...
    /**
     * @return AuthenticationToken|array The current AuthenticationToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AuthenticationToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AuthenticationToken fields).
     */
     ...
     *
     * @param AuthenticationTokenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AuthenticationTokenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AuthenticationToken|array The created AuthenticationToken as an assoc-array at the
