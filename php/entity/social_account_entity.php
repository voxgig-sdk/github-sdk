...
// Github SDK SocialAccount entity
...
class SocialAccountEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SocialAccountEntity($this->_client, $opts);
    }

    /**
     * @param SocialAccount|array $args SocialAccount data (assoc-array) to store.
     */
    ...
    /**
     * @return SocialAccount|array The current SocialAccount data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SocialAccount fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SocialAccount fields).
     */
    ...
    /**
     * List SocialAccount items matching the given filter.
     *
     * @param SocialAccountListMatch|array|null $reqmatch Match filter (any subset
     *   of SocialAccount fields) as an assoc-array; SocialAccountListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SocialAccount[]|array A list of SocialAccount items as assoc-arrays at
     ...
     *
     * @param SocialAccountCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SocialAccountCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SocialAccount|array The created SocialAccount as an assoc-array at the
