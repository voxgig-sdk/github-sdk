...
// Github SDK CodeFrequency entity
...
class CodeFrequencyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CodeFrequencyEntity($this->_client, $opts);
    }

    /**
     * @param CodeFrequency|array $args CodeFrequency data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeFrequency|array The current CodeFrequency data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeFrequency fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeFrequency fields).
     */
    ...
    /**
     * List CodeFrequency items matching the given filter.
     *
     * @param CodeFrequencyListMatch|array|null $reqmatch Match filter (any subset
     *   of CodeFrequency fields) as an assoc-array; CodeFrequencyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeFrequency[]|array A list of CodeFrequency items as assoc-arrays at
