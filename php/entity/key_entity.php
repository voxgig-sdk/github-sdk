...
class KeyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new KeyEntity($this->_client, $opts);
    }

    /**
     * @param Key|array $args Key data (assoc-array) to store.
     */
    ...
    /**
     * @return Key|array The current Key data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Key fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Key fields).
     */
     ...
     * Load a single Key.
     *
     * @param KeyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed KeyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Key|array The loaded Key as an assoc-array at the
    ...
    /**
     * List Key items matching the given filter.
     *
     * @param KeyListMatch|array|null $reqmatch Match filter (any subset
     *   of Key fields) as an assoc-array; KeyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Key[]|array A list of Key items as assoc-arrays at
     ...
     * Create a new Key.
     *
     * @param KeyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed KeyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Key|array The created Key as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
