...
class DeployKeyEntity
{
    ...
    /**
     * Load a single DeployKey.
     *
     * @param DeployKeyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DeployKeyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeployKey|array The loaded DeployKey as an assoc-array at the
    ...
    /**
     * List DeployKey items matching the given filter.
     *
     * @param DeployKeyListMatch|array|null $reqmatch Match filter (any subset
     *   of DeployKey fields) as an assoc-array; DeployKeyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeployKey[]|array A list of DeployKey items as assoc-arrays at
    ...
    /**
     * Create a new DeployKey.
     *
     * @param DeployKeyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DeployKeyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeployKey|array The created DeployKey as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
