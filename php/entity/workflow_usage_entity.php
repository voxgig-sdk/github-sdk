...
// Github SDK WorkflowUsage entity
...
class WorkflowUsageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WorkflowUsageEntity($this->_client, $opts);
    }

    /**
     * @param WorkflowUsage|array $args WorkflowUsage data (assoc-array) to store.
     */
    ...
    /**
     * @return WorkflowUsage|array The current WorkflowUsage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WorkflowUsage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WorkflowUsage fields).
     */
    ...
    /**
     * Load a single WorkflowUsage.
     *
     * @param WorkflowUsageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WorkflowUsageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WorkflowUsage|array The loaded WorkflowUsage as an assoc-array at the
