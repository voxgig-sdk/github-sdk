...
class RunnerEntity
{
    ...
    /**
     * Load a single Runner.
     *
     * @param RunnerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RunnerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Runner|array The loaded Runner as an assoc-array at the
