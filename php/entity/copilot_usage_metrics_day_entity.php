...
// Github SDK CopilotUsageMetricsDay entity
...
class CopilotUsageMetricsDayEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "copilot_usage_metrics_day";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CopilotUsageMetricsDayEntity($this->_client, $opts);
    }

    /**
     * @param CopilotUsageMetricsDay|array $args CopilotUsageMetricsDay data (assoc-array) to store.
     */
    ...
    /**
     * @return CopilotUsageMetricsDay|array The current CopilotUsageMetricsDay data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CopilotUsageMetricsDay fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CopilotUsageMetricsDay fields).
     */
    ...
    /**
     * List CopilotUsageMetricsDay items matching the given filter.
     *
     * @param CopilotUsageMetricsDayListMatch|array|null $reqmatch Match filter (any subset
     *   of CopilotUsageMetricsDay fields) as an assoc-array; CopilotUsageMetricsDayListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CopilotUsageMetricsDay[]|array A list of CopilotUsageMetricsDay items as assoc-arrays at
