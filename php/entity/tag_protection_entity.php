...
// Github SDK TagProtection entity
...
class TagProtectionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TagProtectionEntity($this->_client, $opts);
    }

    /**
     * @param TagProtection|array $args TagProtection data (assoc-array) to store.
     */
    ...
    /**
     * @return TagProtection|array The current TagProtection data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TagProtection fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TagProtection fields).
     */
    ...
    /**
     * List TagProtection items matching the given filter.
     *
     * @param TagProtectionListMatch|array|null $reqmatch Match filter (any subset
     *   of TagProtection fields) as an assoc-array; TagProtectionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TagProtection[]|array A list of TagProtection items as assoc-arrays at
    ...
    /**
     * Create a new TagProtection.
     *
     * @param TagProtectionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TagProtectionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TagProtection|array The created TagProtection as an assoc-array at the
