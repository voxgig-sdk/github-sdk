...
// Github SDK SecurityAdvisory entity
...
class SecurityAdvisoryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SecurityAdvisoryEntity($this->_client, $opts);
    }

    /**
     * @param SecurityAdvisory|array $args SecurityAdvisory data (assoc-array) to store.
     */
    ...
    /**
     * @return SecurityAdvisory|array The current SecurityAdvisory data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SecurityAdvisory fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SecurityAdvisory fields).
     */
    ...
    /**
     * Create a new SecurityAdvisory.
     *
     * @param SecurityAdvisoryCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SecurityAdvisoryCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SecurityAdvisory|array The created SecurityAdvisory as an assoc-array at the
