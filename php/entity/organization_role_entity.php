...
// Github SDK OrganizationRole entity
...
class OrganizationRoleEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OrganizationRoleEntity($this->_client, $opts);
    }

    /**
     * @param OrganizationRole|array $args OrganizationRole data (assoc-array) to store.
     */
    ...
    /**
     * @return OrganizationRole|array The current OrganizationRole data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrganizationRole fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrganizationRole fields).
     */
    ...
    /**
     * Load a single OrganizationRole.
     *
     * @param OrganizationRoleLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OrganizationRoleLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationRole|array The loaded OrganizationRole as an assoc-array at the
