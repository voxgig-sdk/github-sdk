...
// Github SDK CodeownersError entity
...
class CodeownersErrorEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CodeownersErrorEntity($this->_client, $opts);
    }

    /**
     * @param CodeownersError|array $args CodeownersError data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeownersError|array The current CodeownersError data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeownersError fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeownersError fields).
     */
    ...
    /**
     * List CodeownersError items matching the given filter.
     *
     * @param CodeownersErrorListMatch|array|null $reqmatch Match filter (any subset
     *   of CodeownersError fields) as an assoc-array; CodeownersErrorListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeownersError[]|array A list of CodeownersError items as assoc-arrays at
