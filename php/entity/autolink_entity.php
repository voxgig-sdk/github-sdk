...
class AutolinkEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AutolinkEntity($this->_client, $opts);
    }

    /**
     * @param Autolink|array $args Autolink data (assoc-array) to store.
     */
    ...
    /**
     * @return Autolink|array The current Autolink data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Autolink fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Autolink fields).
     */
    ...
    /**
     * Load a single Autolink.
     *
     * @param AutolinkLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AutolinkLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Autolink|array The loaded Autolink as an assoc-array at the
    ...
    /**
     * List Autolink items matching the given filter.
     *
     * @param AutolinkListMatch|array|null $reqmatch Match filter (any subset
     *   of Autolink fields) as an assoc-array; AutolinkListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Autolink[]|array A list of Autolink items as assoc-arrays at
     ...
     *
     * @param AutolinkCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AutolinkCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Autolink|array The created Autolink as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
