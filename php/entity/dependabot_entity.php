...
class DependabotEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DependabotEntity($this->_client, $opts);
    }

    /**
     * @param Dependabot|array $args Dependabot data (assoc-array) to store.
     */
    ...
    /**
     * @return Dependabot|array The current Dependabot data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Dependabot fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Dependabot fields).
     */
    ...
    /**
     * List Dependabot items matching the given filter.
     *
     * @param DependabotListMatch|array|null $reqmatch Match filter (any subset
     *   of Dependabot fields) as an assoc-array; DependabotListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dependabot[]|array A list of Dependabot items as assoc-arrays at
    ...
    /**
     * Update an existing Dependabot.
     *
     * @param DependabotUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DependabotUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dependabot|array The updated Dependabot as an assoc-array at the
    ...
    /**
     * Remove an Dependabot matching the given criteria.
     *
     * @param DependabotRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DependabotRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dependabot|array The removed Dependabot as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
