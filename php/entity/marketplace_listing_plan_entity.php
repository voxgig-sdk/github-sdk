...
// Github SDK MarketplaceListingPlan entity
...
class MarketplaceListingPlanEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "marketplace_listing_plan";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MarketplaceListingPlanEntity($this->_client, $opts);
    }

    /**
     * @param MarketplaceListingPlan|array $args MarketplaceListingPlan data (assoc-array) to store.
     */
    ...
    /**
     * @return MarketplaceListingPlan|array The current MarketplaceListingPlan data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MarketplaceListingPlan fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MarketplaceListingPlan fields).
     */
    ...
    /**
     * List MarketplaceListingPlan items matching the given filter.
     *
     * @param MarketplaceListingPlanListMatch|array|null $reqmatch Match filter (any subset
     *   of MarketplaceListingPlan fields) as an assoc-array; MarketplaceListingPlanListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MarketplaceListingPlan[]|array A list of MarketplaceListingPlan items as assoc-arrays at
