...
class LicenseEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LicenseEntity($this->_client, $opts);
    }

    /**
     * @param License|array $args License data (assoc-array) to store.
     */
    ...
    /**
     * @return License|array The current License data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of License fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of License fields).
     */
     ...
     *
     * @param LicenseLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LicenseLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return License|array The loaded License as an assoc-array at the
    ...
    /**
     * List License items matching the given filter.
     *
     * @param LicenseListMatch|array|null $reqmatch Match filter (any subset
     *   of License fields) as an assoc-array; LicenseListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return License[]|array A list of License items as assoc-arrays at
