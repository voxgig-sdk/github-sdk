...
// Github SDK PageDeployment entity
...
class PageDeploymentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PageDeploymentEntity($this->_client, $opts);
    }

    /**
     * @param PageDeployment|array $args PageDeployment data (assoc-array) to store.
     */
    ...
    /**
     * @return PageDeployment|array The current PageDeployment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PageDeployment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PageDeployment fields).
     */
    ...
    /**
     * Create a new PageDeployment.
     *
     * @param PageDeploymentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PageDeploymentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PageDeployment|array The created PageDeployment as an assoc-array at the
