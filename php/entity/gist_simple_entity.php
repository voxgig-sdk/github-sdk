...
class GistSimpleEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GistSimpleEntity($this->_client, $opts);
    }

    /**
     * @param GistSimple|array $args GistSimple data (assoc-array) to store.
     */
    ...
    /**
     * @return GistSimple|array The current GistSimple data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GistSimple fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GistSimple fields).
     */
    ...
    /**
     * List GistSimple items matching the given filter.
     *
     * @param GistSimpleListMatch|array|null $reqmatch Match filter (any subset
     *   of GistSimple fields) as an assoc-array; GistSimpleListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GistSimple[]|array A list of GistSimple items as assoc-arrays at
