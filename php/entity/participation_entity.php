...
// Github SDK Participation entity
...
class ParticipationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ParticipationEntity($this->_client, $opts);
    }

    /**
     * @param Participation|array $args Participation data (assoc-array) to store.
     */
    ...
    /**
     * @return Participation|array The current Participation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Participation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Participation fields).
     */
    ...
    /**
     * List Participation items matching the given filter.
     *
     * @param ParticipationListMatch|array|null $reqmatch Match filter (any subset
     *   of Participation fields) as an assoc-array; ParticipationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Participation[]|array A list of Participation items as assoc-arrays at
