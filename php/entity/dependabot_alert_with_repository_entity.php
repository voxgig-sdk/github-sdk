...
class DependabotAlertWithRepositoryEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "dependabot_alert_with_repository";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DependabotAlertWithRepositoryEntity($this->_client, $opts);
    }

    /**
     * @param DependabotAlertWithRepository|array $args DependabotAlertWithRepository data (assoc-array) to store.
     */
    ...
    /**
     * @return DependabotAlertWithRepository|array The current DependabotAlertWithRepository data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DependabotAlertWithRepository fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DependabotAlertWithRepository fields).
     */
    ...
    /**
     * List DependabotAlertWithRepository items matching the given filter.
     *
     * @param DependabotAlertWithRepositoryListMatch|array|null $reqmatch Match filter (any subset
     *   of DependabotAlertWithRepository fields) as an assoc-array; DependabotAlertWithRepositoryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DependabotAlertWithRepository[]|array A list of DependabotAlertWithRepository items as assoc-arrays at
