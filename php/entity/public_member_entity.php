...
// Github SDK PublicMember entity
...
class PublicMemberEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PublicMemberEntity($this->_client, $opts);
    }

    /**
     * @param PublicMember|array $args PublicMember data (assoc-array) to store.
     */
    ...
    /**
     * @return PublicMember|array The current PublicMember data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PublicMember fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PublicMember fields).
     */
    ...
    /**
     * List PublicMember items matching the given filter.
     *
     * @param PublicMemberListMatch|array|null $reqmatch Match filter (any subset
     *   of PublicMember fields) as an assoc-array; PublicMemberListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PublicMember[]|array A list of PublicMember items as assoc-arrays at
