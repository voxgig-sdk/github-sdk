...
class RuleSuiteEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RuleSuiteEntity($this->_client, $opts);
    }

    /**
     * @param RuleSuite|array $args RuleSuite data (assoc-array) to store.
     */
    ...
    /**
     * @return RuleSuite|array The current RuleSuite data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RuleSuite fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RuleSuite fields).
     */
    ...
    /**
     * Load a single RuleSuite.
     *
     * @param RuleSuiteLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RuleSuiteLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RuleSuite|array The loaded RuleSuite as an assoc-array at the
    ...
    /**
     * List RuleSuite items matching the given filter.
     *
     * @param RuleSuiteListMatch|array|null $reqmatch Match filter (any subset
     *   of RuleSuite fields) as an assoc-array; RuleSuiteListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RuleSuite[]|array A list of RuleSuite items as assoc-arrays at
