...
class IssueTypeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IssueTypeEntity($this->_client, $opts);
    }

    /**
     * @param IssueType|array $args IssueType data (assoc-array) to store.
     */
    ...
    /**
     * @return IssueType|array The current IssueType data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IssueType fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IssueType fields).
     */
    ...
    /**
     * List IssueType items matching the given filter.
     *
     * @param IssueTypeListMatch|array|null $reqmatch Match filter (any subset
     *   of IssueType fields) as an assoc-array; IssueTypeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IssueType[]|array A list of IssueType items as assoc-arrays at
     ...
     *
     * @param IssueTypeCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IssueTypeCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IssueType|array The created IssueType as an assoc-array at the
     ...
     *
     * @param IssueTypeUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IssueTypeUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IssueType|array The updated IssueType as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
