...
// Github SDK Collaborator entity
...
class CollaboratorEntity
{
    ...
    /**
     * List Collaborator items matching the given filter.
     *
     * @param CollaboratorListMatch|array|null $reqmatch Match filter (any subset
     *   of Collaborator fields) as an assoc-array; CollaboratorListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Collaborator[]|array A list of Collaborator items as assoc-arrays at
