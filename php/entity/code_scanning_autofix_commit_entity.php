...
class CodeScanningAutofixCommitEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "code_scanning_autofix_commit";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CodeScanningAutofixCommitEntity($this->_client, $opts);
    }

    /**
     * @param CodeScanningAutofixCommit|array $args CodeScanningAutofixCommit data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeScanningAutofixCommit|array The current CodeScanningAutofixCommit data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeScanningAutofixCommit fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeScanningAutofixCommit fields).
     */
    ...
    /**
     * Create a new CodeScanningAutofixCommit.
     *
     * @param CodeScanningAutofixCommitCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CodeScanningAutofixCommitCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanningAutofixCommit|array The created CodeScanningAutofixCommit as an assoc-array at the
