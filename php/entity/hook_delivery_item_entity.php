...
// Github SDK HookDeliveryItem entity
...
class HookDeliveryItemEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new HookDeliveryItemEntity($this->_client, $opts);
    }

    /**
     * @param HookDeliveryItem|array $args HookDeliveryItem data (assoc-array) to store.
     */
    ...
    /**
     * @return HookDeliveryItem|array The current HookDeliveryItem data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of HookDeliveryItem fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of HookDeliveryItem fields).
     */
    ...
    /**
     * List HookDeliveryItem items matching the given filter.
     *
     * @param HookDeliveryItemListMatch|array|null $reqmatch Match filter (any subset
     *   of HookDeliveryItem fields) as an assoc-array; HookDeliveryItemListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return HookDeliveryItem[]|array A list of HookDeliveryItem items as assoc-arrays at
