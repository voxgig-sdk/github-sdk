...
// Github SDK DependencyGraph entity
...
class DependencyGraphEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DependencyGraphEntity($this->_client, $opts);
    }

    /**
     * @param DependencyGraph|array $args DependencyGraph data (assoc-array) to store.
     */
    ...
    /**
     * @return DependencyGraph|array The current DependencyGraph data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DependencyGraph fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DependencyGraph fields).
     */
     ...
     *
     * @param DependencyGraphCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DependencyGraphCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DependencyGraph|array The created DependencyGraph as an assoc-array at the
