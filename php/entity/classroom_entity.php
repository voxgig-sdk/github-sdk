...
class ClassroomEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ClassroomEntity($this->_client, $opts);
    }

    /**
     * @param Classroom|array $args Classroom data (assoc-array) to store.
     */
    ...
    /**
     * @return Classroom|array The current Classroom data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Classroom fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Classroom fields).
     */
    ...
    /**
     * Load a single Classroom.
     *
     * @param ClassroomLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ClassroomLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Classroom|array The loaded Classroom as an assoc-array at the
    ...
    /**
     * List Classroom items matching the given filter.
     *
     * @param ClassroomListMatch|array|null $reqmatch Match filter (any subset
     *   of Classroom fields) as an assoc-array; ClassroomListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Classroom[]|array A list of Classroom items as assoc-arrays at
