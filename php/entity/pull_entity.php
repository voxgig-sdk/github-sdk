...
class PullEntity
{
    ...
    /**
     * Update an existing Pull.
     *
     * @param PullUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PullUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Pull|array The updated Pull as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Pull matching the given criteria.
     *
     * @param PullRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PullRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Pull|array The removed Pull as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
