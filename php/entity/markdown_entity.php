...
class MarkdownEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MarkdownEntity($this->_client, $opts);
    }

    /**
     * @param Markdown|array $args Markdown data (assoc-array) to store.
     */
    ...
    /**
     * @return Markdown|array The current Markdown data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Markdown fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Markdown fields).
     */
     ...
     *
     * @param MarkdownCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MarkdownCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Markdown|array The created Markdown as an assoc-array at the
