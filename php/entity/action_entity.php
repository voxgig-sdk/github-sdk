...
class ActionEntity
{
     ...
     *
     * @param ActionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Action|array The loaded Action as an assoc-array at the
    ...
    /**
     * List Action items matching the given filter.
     *
     * @param ActionListMatch|array|null $reqmatch Match filter (any subset
     *   of Action fields) as an assoc-array; ActionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Action[]|array A list of Action items as assoc-arrays at
     ...
     *
     * @param ActionUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ActionUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Action|array The updated Action as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Action matching the given criteria.
     *
     * @param ActionRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ActionRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Action|array The removed Action as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
