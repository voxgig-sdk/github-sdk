...
class ReleaseEntity
{
     ...
     *
     * @param ReleaseCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ReleaseCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Release|array The created Release as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
     ...
     *
     * @param ReleaseUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ReleaseUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Release|array The updated Release as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
