...
// Github SDK MinimalRepository entity
...
class MinimalRepositoryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MinimalRepositoryEntity($this->_client, $opts);
    }

    /**
     * @param MinimalRepository|array $args MinimalRepository data (assoc-array) to store.
     */
    ...
    /**
     * @return MinimalRepository|array The current MinimalRepository data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MinimalRepository fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MinimalRepository fields).
     */
    ...
    /**
     * List MinimalRepository items matching the given filter.
     *
     * @param MinimalRepositoryListMatch|array|null $reqmatch Match filter (any subset
     *   of MinimalRepository fields) as an assoc-array; MinimalRepositoryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MinimalRepository[]|array A list of MinimalRepository items as assoc-arrays at
