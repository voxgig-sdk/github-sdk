...
class EmailEntity
{
     ...
     * Create a new Email.
     *
     * @param EmailCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EmailCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Email|array The created Email as an assoc-array at the
     ...
     *
     * @param EmailUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EmailUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Email|array The updated Email as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
