...
// Github SDK StatusCheckPolicy entity
...
class StatusCheckPolicyEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "status_check_policy";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new StatusCheckPolicyEntity($this->_client, $opts);
    }

    /**
     * @param StatusCheckPolicy|array $args StatusCheckPolicy data (assoc-array) to store.
     */
    ...
    /**
     * @return StatusCheckPolicy|array The current StatusCheckPolicy data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of StatusCheckPolicy fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of StatusCheckPolicy fields).
     */
    ...
    /**
     * List StatusCheckPolicy items matching the given filter.
     *
     * @param StatusCheckPolicyListMatch|array|null $reqmatch Match filter (any subset
     *   of StatusCheckPolicy fields) as an assoc-array; StatusCheckPolicyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StatusCheckPolicy[]|array A list of StatusCheckPolicy items as assoc-arrays at
    ...
    /**
     * Update an existing StatusCheckPolicy.
     *
     * @param StatusCheckPolicyUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed StatusCheckPolicyUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StatusCheckPolicy|array The updated StatusCheckPolicy as an assoc-array at the
