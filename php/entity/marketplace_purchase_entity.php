...
// Github SDK MarketplacePurchase entity
...
class MarketplacePurchaseEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "marketplace_purchase";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MarketplacePurchaseEntity($this->_client, $opts);
    }

    /**
     * @param MarketplacePurchase|array $args MarketplacePurchase data (assoc-array) to store.
     */
    ...
    /**
     * @return MarketplacePurchase|array The current MarketplacePurchase data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MarketplacePurchase fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MarketplacePurchase fields).
     */
    ...
    /**
     * Load a single MarketplacePurchase.
     *
     * @param MarketplacePurchaseLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MarketplacePurchaseLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MarketplacePurchase|array The loaded MarketplacePurchase as an assoc-array at the
    ...
    /**
     * List MarketplacePurchase items matching the given filter.
     *
     * @param MarketplacePurchaseListMatch|array|null $reqmatch Match filter (any subset
     *   of MarketplacePurchase fields) as an assoc-array; MarketplacePurchaseListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MarketplacePurchase[]|array A list of MarketplacePurchase items as assoc-arrays at
