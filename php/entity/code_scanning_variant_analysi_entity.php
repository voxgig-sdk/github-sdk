...
// Github SDK CodeScanningVariantAnalysi entity
...
class CodeScanningVariantAnalysiEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "code_scanning_variant_analysi";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CodeScanningVariantAnalysiEntity($this->_client, $opts);
    }

    /**
     * @param CodeScanningVariantAnalysi|array $args CodeScanningVariantAnalysi data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeScanningVariantAnalysi|array The current CodeScanningVariantAnalysi data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeScanningVariantAnalysi fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeScanningVariantAnalysi fields).
     */
    ...
    /**
     * Load a single CodeScanningVariantAnalysi.
     *
     * @param CodeScanningVariantAnalysiLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CodeScanningVariantAnalysiLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanningVariantAnalysi|array The loaded CodeScanningVariantAnalysi as an assoc-array at the
    ...
    /**
     * Create a new CodeScanningVariantAnalysi.
     *
     * @param CodeScanningVariantAnalysiCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CodeScanningVariantAnalysiCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanningVariantAnalysi|array The created CodeScanningVariantAnalysi as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
