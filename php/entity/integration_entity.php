...
class IntegrationEntity
{
     ...
     *
     * @param IntegrationUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IntegrationUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Integration|array The updated Integration as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
