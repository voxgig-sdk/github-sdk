...
// Github SDK EnvironmentApproval entity
...
class EnvironmentApprovalEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "environment_approval";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EnvironmentApprovalEntity($this->_client, $opts);
    }

    /**
     * @param EnvironmentApproval|array $args EnvironmentApproval data (assoc-array) to store.
     */
    ...
    /**
     * @return EnvironmentApproval|array The current EnvironmentApproval data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EnvironmentApproval fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EnvironmentApproval fields).
     */
    ...
    /**
     * List EnvironmentApproval items matching the given filter.
     *
     * @param EnvironmentApprovalListMatch|array|null $reqmatch Match filter (any subset
     *   of EnvironmentApproval fields) as an assoc-array; EnvironmentApprovalListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EnvironmentApproval[]|array A list of EnvironmentApproval items as assoc-arrays at
