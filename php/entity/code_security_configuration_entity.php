...
// Github SDK CodeSecurityConfiguration entity
...
class CodeSecurityConfigurationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "code_security_configuration";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CodeSecurityConfigurationEntity($this->_client, $opts);
    }

    /**
     * @param CodeSecurityConfiguration|array $args CodeSecurityConfiguration data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeSecurityConfiguration|array The current CodeSecurityConfiguration data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeSecurityConfiguration fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeSecurityConfiguration fields).
     */
    ...
    /**
     * Load a single CodeSecurityConfiguration.
     *
     * @param CodeSecurityConfigurationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CodeSecurityConfigurationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeSecurityConfiguration|array The loaded CodeSecurityConfiguration as an assoc-array at the
    ...
    /**
     * List CodeSecurityConfiguration items matching the given filter.
     *
     * @param CodeSecurityConfigurationListMatch|array|null $reqmatch Match filter (any subset
     *   of CodeSecurityConfiguration fields) as an assoc-array; CodeSecurityConfigurationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeSecurityConfiguration[]|array A list of CodeSecurityConfiguration items as assoc-arrays at
    ...
    /**
     * Create a new CodeSecurityConfiguration.
     *
     * @param CodeSecurityConfigurationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CodeSecurityConfigurationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeSecurityConfiguration|array The created CodeSecurityConfiguration as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing CodeSecurityConfiguration.
     *
     * @param CodeSecurityConfigurationUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CodeSecurityConfigurationUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeSecurityConfiguration|array The updated CodeSecurityConfiguration as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
