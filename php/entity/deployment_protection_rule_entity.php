...
// Github SDK DeploymentProtectionRule entity
...
class DeploymentProtectionRuleEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "deployment_protection_rule";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DeploymentProtectionRuleEntity($this->_client, $opts);
    }

    /**
     * @param DeploymentProtectionRule|array $args DeploymentProtectionRule data (assoc-array) to store.
     */
    ...
    /**
     * @return DeploymentProtectionRule|array The current DeploymentProtectionRule data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeploymentProtectionRule fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeploymentProtectionRule fields).
     */
    ...
    /**
     * Load a single DeploymentProtectionRule.
     *
     * @param DeploymentProtectionRuleLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DeploymentProtectionRuleLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeploymentProtectionRule|array The loaded DeploymentProtectionRule as an assoc-array at the
    ...
    /**
     * Create a new DeploymentProtectionRule.
     *
     * @param DeploymentProtectionRuleCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DeploymentProtectionRuleCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeploymentProtectionRule|array The created DeploymentProtectionRule as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
