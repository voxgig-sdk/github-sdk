...
class ContentFileEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ContentFileEntity($this->_client, $opts);
    }

    /**
     * @param ContentFile|array $args ContentFile data (assoc-array) to store.
     */
    ...
    /**
     * @return ContentFile|array The current ContentFile data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ContentFile fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ContentFile fields).
     */
    ...
    /**
     * Load a single ContentFile.
     *
     * @param ContentFileLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ContentFileLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContentFile|array The loaded ContentFile as an assoc-array at the
