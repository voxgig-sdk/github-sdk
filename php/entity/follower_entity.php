...
class FollowerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FollowerEntity($this->_client, $opts);
    }

    /**
     * @param Follower|array $args Follower data (assoc-array) to store.
     */
    ...
    /**
     * @return Follower|array The current Follower data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Follower fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Follower fields).
     */
    ...
    /**
     * List Follower items matching the given filter.
     *
     * @param FollowerListMatch|array|null $reqmatch Match filter (any subset
     *   of Follower fields) as an assoc-array; FollowerListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Follower[]|array A list of Follower items as assoc-arrays at
