...
class TopicEntity
{
     ...
     *
     * @param TopicUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TopicUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Topic|array The updated Topic as an assoc-array at the
