...
// Github SDK PagesDeploymentStatus entity
...
class PagesDeploymentStatusEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "pages_deployment_status";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PagesDeploymentStatusEntity($this->_client, $opts);
    }

    /**
     * @param PagesDeploymentStatus|array $args PagesDeploymentStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return PagesDeploymentStatus|array The current PagesDeploymentStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PagesDeploymentStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PagesDeploymentStatus fields).
     */
    ...
    /**
     * Load a single PagesDeploymentStatus.
     *
     * @param PagesDeploymentStatusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PagesDeploymentStatusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PagesDeploymentStatus|array The loaded PagesDeploymentStatus as an assoc-array at the
    ...
    /**
     * Create a new PagesDeploymentStatus.
     *
     * @param PagesDeploymentStatusCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PagesDeploymentStatusCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PagesDeploymentStatus|array The created PagesDeploymentStatus as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
