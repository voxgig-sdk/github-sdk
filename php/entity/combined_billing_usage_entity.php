...
// Github SDK CombinedBillingUsage entity
...
class CombinedBillingUsageEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "combined_billing_usage";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CombinedBillingUsageEntity($this->_client, $opts);
    }

    /**
     * @param CombinedBillingUsage|array $args CombinedBillingUsage data (assoc-array) to store.
     */
    ...
    /**
     * @return CombinedBillingUsage|array The current CombinedBillingUsage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CombinedBillingUsage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CombinedBillingUsage fields).
     */
    ...
    /**
     * Load a single CombinedBillingUsage.
     *
     * @param CombinedBillingUsageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CombinedBillingUsageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CombinedBillingUsage|array The loaded CombinedBillingUsage as an assoc-array at the
