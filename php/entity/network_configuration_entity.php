...
// Github SDK NetworkConfiguration entity
...
class NetworkConfigurationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "network_configuration";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new NetworkConfigurationEntity($this->_client, $opts);
    }

    /**
     * @param NetworkConfiguration|array $args NetworkConfiguration data (assoc-array) to store.
     */
    ...
    /**
     * @return NetworkConfiguration|array The current NetworkConfiguration data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NetworkConfiguration fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NetworkConfiguration fields).
     */
    ...
    /**
     * Load a single NetworkConfiguration.
     *
     * @param NetworkConfigurationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NetworkConfigurationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NetworkConfiguration|array The loaded NetworkConfiguration as an assoc-array at the
    ...
    /**
     * Create a new NetworkConfiguration.
     *
     * @param NetworkConfigurationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NetworkConfigurationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NetworkConfiguration|array The created NetworkConfiguration as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing NetworkConfiguration.
     *
     * @param NetworkConfigurationUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NetworkConfigurationUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NetworkConfiguration|array The updated NetworkConfiguration as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
