...
// Github SDK RepositoryAdvisory entity
...
class RepositoryAdvisoryEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "repository_advisory";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RepositoryAdvisoryEntity($this->_client, $opts);
    }

    /**
     * @param RepositoryAdvisory|array $args RepositoryAdvisory data (assoc-array) to store.
     */
    ...
    /**
     * @return RepositoryAdvisory|array The current RepositoryAdvisory data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RepositoryAdvisory fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RepositoryAdvisory fields).
     */
    ...
    /**
     * Load a single RepositoryAdvisory.
     *
     * @param RepositoryAdvisoryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RepositoryAdvisoryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryAdvisory|array The loaded RepositoryAdvisory as an assoc-array at the
    ...
    /**
     * List RepositoryAdvisory items matching the given filter.
     *
     * @param RepositoryAdvisoryListMatch|array|null $reqmatch Match filter (any subset
     *   of RepositoryAdvisory fields) as an assoc-array; RepositoryAdvisoryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryAdvisory[]|array A list of RepositoryAdvisory items as assoc-arrays at
    ...
    /**
     * Create a new RepositoryAdvisory.
     *
     * @param RepositoryAdvisoryCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RepositoryAdvisoryCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryAdvisory|array The created RepositoryAdvisory as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing RepositoryAdvisory.
     *
     * @param RepositoryAdvisoryUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RepositoryAdvisoryUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryAdvisory|array The updated RepositoryAdvisory as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
