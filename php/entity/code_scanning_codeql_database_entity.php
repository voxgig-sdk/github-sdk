...
// Github SDK CodeScanningCodeqlDatabase entity
...
class CodeScanningCodeqlDatabaseEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "code_scanning_codeql_database";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CodeScanningCodeqlDatabaseEntity($this->_client, $opts);
    }

    /**
     * @param CodeScanningCodeqlDatabase|array $args CodeScanningCodeqlDatabase data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeScanningCodeqlDatabase|array The current CodeScanningCodeqlDatabase data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeScanningCodeqlDatabase fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeScanningCodeqlDatabase fields).
     */
    ...
    /**
     * Load a single CodeScanningCodeqlDatabase.
     *
     * @param CodeScanningCodeqlDatabaseLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CodeScanningCodeqlDatabaseLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanningCodeqlDatabase|array The loaded CodeScanningCodeqlDatabase as an assoc-array at the
    ...
    /**
     * List CodeScanningCodeqlDatabase items matching the given filter.
     *
     * @param CodeScanningCodeqlDatabaseListMatch|array|null $reqmatch Match filter (any subset
     *   of CodeScanningCodeqlDatabase fields) as an assoc-array; CodeScanningCodeqlDatabaseListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanningCodeqlDatabase[]|array A list of CodeScanningCodeqlDatabase items as assoc-arrays at
