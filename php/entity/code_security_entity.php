...
// Github SDK CodeSecurity entity
...
class CodeSecurityEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CodeSecurityEntity($this->_client, $opts);
    }

    /**
     * @param CodeSecurity|array $args CodeSecurity data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeSecurity|array The current CodeSecurity data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeSecurity fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeSecurity fields).
     */
    ...
    /**
     * Update an existing CodeSecurity.
     *
     * @param CodeSecurityUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CodeSecurityUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeSecurity|array The updated CodeSecurity as an assoc-array at the
    ...
    /**
     * Remove an CodeSecurity matching the given criteria.
     *
     * @param CodeSecurityRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CodeSecurityRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeSecurity|array The removed CodeSecurity as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
