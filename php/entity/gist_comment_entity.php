...
class GistCommentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GistCommentEntity($this->_client, $opts);
    }

    /**
     * @param GistComment|array $args GistComment data (assoc-array) to store.
     */
    ...
    /**
     * @return GistComment|array The current GistComment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GistComment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GistComment fields).
     */
    ...
    /**
     * Load a single GistComment.
     *
     * @param GistCommentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GistCommentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GistComment|array The loaded GistComment as an assoc-array at the
    ...
    /**
     * List GistComment items matching the given filter.
     *
     * @param GistCommentListMatch|array|null $reqmatch Match filter (any subset
     *   of GistComment fields) as an assoc-array; GistCommentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GistComment[]|array A list of GistComment items as assoc-arrays at
    ...
    /**
     * Create a new GistComment.
     *
     * @param GistCommentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GistCommentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GistComment|array The created GistComment as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing GistComment.
     *
     * @param GistCommentUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GistCommentUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GistComment|array The updated GistComment as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
