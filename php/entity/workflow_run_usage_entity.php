...
// Github SDK WorkflowRunUsage entity
...
class WorkflowRunUsageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WorkflowRunUsageEntity($this->_client, $opts);
    }

    /**
     * @param WorkflowRunUsage|array $args WorkflowRunUsage data (assoc-array) to store.
     */
    ...
    /**
     * @return WorkflowRunUsage|array The current WorkflowRunUsage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WorkflowRunUsage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WorkflowRunUsage fields).
     */
    ...
    /**
     * Load a single WorkflowRunUsage.
     *
     * @param WorkflowRunUsageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WorkflowRunUsageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WorkflowRunUsage|array The loaded WorkflowRunUsage as an assoc-array at the
