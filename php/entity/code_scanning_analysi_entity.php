...
// Github SDK CodeScanningAnalysi entity
...
class CodeScanningAnalysiEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "code_scanning_analysi";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CodeScanningAnalysiEntity($this->_client, $opts);
    }

    /**
     * @param CodeScanningAnalysi|array $args CodeScanningAnalysi data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeScanningAnalysi|array The current CodeScanningAnalysi data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeScanningAnalysi fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeScanningAnalysi fields).
     */
    ...
    /**
     * Load a single CodeScanningAnalysi.
     *
     * @param CodeScanningAnalysiLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CodeScanningAnalysiLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanningAnalysi|array The loaded CodeScanningAnalysi as an assoc-array at the
    ...
    /**
     * List CodeScanningAnalysi items matching the given filter.
     *
     * @param CodeScanningAnalysiListMatch|array|null $reqmatch Match filter (any subset
     *   of CodeScanningAnalysi fields) as an assoc-array; CodeScanningAnalysiListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanningAnalysi[]|array A list of CodeScanningAnalysi items as assoc-arrays at
