...
class BranchEntity
{
     ...
     *
     * @param BranchLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BranchLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Branch|array The loaded Branch as an assoc-array at the
