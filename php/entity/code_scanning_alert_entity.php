...
// Github SDK CodeScanningAlert entity
...
class CodeScanningAlertEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "code_scanning_alert";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CodeScanningAlertEntity($this->_client, $opts);
    }

    /**
     * @param CodeScanningAlert|array $args CodeScanningAlert data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeScanningAlert|array The current CodeScanningAlert data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeScanningAlert fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeScanningAlert fields).
     */
    ...
    /**
     * Load a single CodeScanningAlert.
     *
     * @param CodeScanningAlertLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CodeScanningAlertLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanningAlert|array The loaded CodeScanningAlert as an assoc-array at the
    ...
    /**
     * Update an existing CodeScanningAlert.
     *
     * @param CodeScanningAlertUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CodeScanningAlertUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanningAlert|array The updated CodeScanningAlert as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
