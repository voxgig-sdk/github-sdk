...
// Github SDK BranchRestrictionPolicy entity
...
class BranchRestrictionPolicyEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "branch_restriction_policy";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new BranchRestrictionPolicyEntity($this->_client, $opts);
    }

    /**
     * @param BranchRestrictionPolicy|array $args BranchRestrictionPolicy data (assoc-array) to store.
     */
    ...
    /**
     * @return BranchRestrictionPolicy|array The current BranchRestrictionPolicy data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BranchRestrictionPolicy fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BranchRestrictionPolicy fields).
     */
    ...
    /**
     * List BranchRestrictionPolicy items matching the given filter.
     *
     * @param BranchRestrictionPolicyListMatch|array|null $reqmatch Match filter (any subset
     *   of BranchRestrictionPolicy fields) as an assoc-array; BranchRestrictionPolicyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BranchRestrictionPolicy[]|array A list of BranchRestrictionPolicy items as assoc-arrays at
