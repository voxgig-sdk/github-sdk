...
class ActionsWorkflowAccessToRepositoryEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "actions_workflow_access_to_repository";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionsWorkflowAccessToRepositoryEntity($this->_client, $opts);
    }

    /**
     * @param ActionsWorkflowAccessToRepository|array $args ActionsWorkflowAccessToRepository data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsWorkflowAccessToRepository|array The current ActionsWorkflowAccessToRepository data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsWorkflowAccessToRepository fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsWorkflowAccessToRepository fields).
     */
    ...
    /**
     * Load a single ActionsWorkflowAccessToRepository.
     *
     * @param ActionsWorkflowAccessToRepositoryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionsWorkflowAccessToRepositoryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsWorkflowAccessToRepository|array The loaded ActionsWorkflowAccessToRepository as an assoc-array at the
