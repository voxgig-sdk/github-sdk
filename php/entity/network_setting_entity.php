...
// Github SDK NetworkSetting entity
...
class NetworkSettingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NetworkSettingEntity($this->_client, $opts);
    }

    /**
     * @param NetworkSetting|array $args NetworkSetting data (assoc-array) to store.
     */
    ...
    /**
     * @return NetworkSetting|array The current NetworkSetting data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NetworkSetting fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NetworkSetting fields).
     */
    ...
    /**
     * Load a single NetworkSetting.
     *
     * @param NetworkSettingLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NetworkSettingLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NetworkSetting|array The loaded NetworkSetting as an assoc-array at the
