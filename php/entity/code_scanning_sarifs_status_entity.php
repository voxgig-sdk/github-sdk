...
// Github SDK CodeScanningSarifsStatus entity
...
class CodeScanningSarifsStatusEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "code_scanning_sarifs_status";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CodeScanningSarifsStatusEntity($this->_client, $opts);
    }

    /**
     * @param CodeScanningSarifsStatus|array $args CodeScanningSarifsStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeScanningSarifsStatus|array The current CodeScanningSarifsStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeScanningSarifsStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeScanningSarifsStatus fields).
     */
    ...
    /**
     * Load a single CodeScanningSarifsStatus.
     *
     * @param CodeScanningSarifsStatusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CodeScanningSarifsStatusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanningSarifsStatus|array The loaded CodeScanningSarifsStatus as an assoc-array at the
