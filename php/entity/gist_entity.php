...
class GistEntity
{
     ...
     * Load a single Gist.
     *
     * @param GistLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GistLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Gist|array The loaded Gist as an assoc-array at the
     ...
     *
     * @param GistUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GistUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Gist|array The updated Gist as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Gist matching the given criteria.
     *
     * @param GistRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; GistRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Gist|array The removed Gist as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
