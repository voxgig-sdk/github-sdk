...
class GitignoreEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GitignoreEntity($this->_client, $opts);
    }

    /**
     * @param Gitignore|array $args Gitignore data (assoc-array) to store.
     */
    ...
    /**
     * @return Gitignore|array The current Gitignore data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Gitignore fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Gitignore fields).
     */
    ...
    /**
     * List Gitignore items matching the given filter.
     *
     * @param GitignoreListMatch|array|null $reqmatch Match filter (any subset
     *   of Gitignore fields) as an assoc-array; GitignoreListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Gitignore[]|array A list of Gitignore items as assoc-arrays at
