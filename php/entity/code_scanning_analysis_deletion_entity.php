...
// Github SDK CodeScanningAnalysisDeletion entity
...
class CodeScanningAnalysisDeletionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "code_scanning_analysis_deletion";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CodeScanningAnalysisDeletionEntity($this->_client, $opts);
    }

    /**
     * @param CodeScanningAnalysisDeletion|array $args CodeScanningAnalysisDeletion data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeScanningAnalysisDeletion|array The current CodeScanningAnalysisDeletion data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeScanningAnalysisDeletion fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeScanningAnalysisDeletion fields).
     */
    ...
    /**
     * Remove an CodeScanningAnalysisDeletion matching the given criteria.
     *
     * @param CodeScanningAnalysisDeletionRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CodeScanningAnalysisDeletionRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanningAnalysisDeletion|array The removed CodeScanningAnalysisDeletion as an assoc-array at the
