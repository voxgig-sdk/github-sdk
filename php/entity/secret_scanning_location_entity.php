...
// Github SDK SecretScanningLocation entity
...
class SecretScanningLocationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "secret_scanning_location";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SecretScanningLocationEntity($this->_client, $opts);
    }

    /**
     * @param SecretScanningLocation|array $args SecretScanningLocation data (assoc-array) to store.
     */
    ...
    /**
     * @return SecretScanningLocation|array The current SecretScanningLocation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SecretScanningLocation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SecretScanningLocation fields).
     */
    ...
    /**
     * List SecretScanningLocation items matching the given filter.
     *
     * @param SecretScanningLocationListMatch|array|null $reqmatch Match filter (any subset
     *   of SecretScanningLocation fields) as an assoc-array; SecretScanningLocationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SecretScanningLocation[]|array A list of SecretScanningLocation items as assoc-arrays at
