...
// Github SDK ClassroomAssignment entity
...
class ClassroomAssignmentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "classroom_assignment";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ClassroomAssignmentEntity($this->_client, $opts);
    }

    /**
     * @param ClassroomAssignment|array $args ClassroomAssignment data (assoc-array) to store.
     */
    ...
    /**
     * @return ClassroomAssignment|array The current ClassroomAssignment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ClassroomAssignment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ClassroomAssignment fields).
     */
    ...
    /**
     * Load a single ClassroomAssignment.
     *
     * @param ClassroomAssignmentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ClassroomAssignmentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ClassroomAssignment|array The loaded ClassroomAssignment as an assoc-array at the
