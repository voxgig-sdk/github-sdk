...
class OrgHookEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OrgHookEntity($this->_client, $opts);
    }

    /**
     * @param OrgHook|array $args OrgHook data (assoc-array) to store.
     */
    ...
    /**
     * @return OrgHook|array The current OrgHook data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrgHook fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrgHook fields).
     */
    ...
    /**
     * Load a single OrgHook.
     *
     * @param OrgHookLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OrgHookLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrgHook|array The loaded OrgHook as an assoc-array at the
    ...
    /**
     * List OrgHook items matching the given filter.
     *
     * @param OrgHookListMatch|array|null $reqmatch Match filter (any subset
     *   of OrgHook fields) as an assoc-array; OrgHookListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrgHook[]|array A list of OrgHook items as assoc-arrays at
    ...
    /**
     * Create a new OrgHook.
     *
     * @param OrgHookCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrgHookCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrgHook|array The created OrgHook as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing OrgHook.
     *
     * @param OrgHookUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrgHookUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrgHook|array The updated OrgHook as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
