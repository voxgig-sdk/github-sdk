...
class GitTreeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GitTreeEntity($this->_client, $opts);
    }

    /**
     * @param GitTree|array $args GitTree data (assoc-array) to store.
     */
    ...
    /**
     * @return GitTree|array The current GitTree data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GitTree fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GitTree fields).
     */
    ...
    /**
     * Load a single GitTree.
     *
     * @param GitTreeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GitTreeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GitTree|array The loaded GitTree as an assoc-array at the
     ...
     *
     * @param GitTreeCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GitTreeCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GitTree|array The created GitTree as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
