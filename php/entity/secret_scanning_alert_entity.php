...
// Github SDK SecretScanningAlert entity
...
class SecretScanningAlertEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "secret_scanning_alert";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SecretScanningAlertEntity($this->_client, $opts);
    }

    /**
     * @param SecretScanningAlert|array $args SecretScanningAlert data (assoc-array) to store.
     */
    ...
    /**
     * @return SecretScanningAlert|array The current SecretScanningAlert data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SecretScanningAlert fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SecretScanningAlert fields).
     */
    ...
    /**
     * Load a single SecretScanningAlert.
     *
     * @param SecretScanningAlertLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SecretScanningAlertLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SecretScanningAlert|array The loaded SecretScanningAlert as an assoc-array at the
    ...
    /**
     * List SecretScanningAlert items matching the given filter.
     *
     * @param SecretScanningAlertListMatch|array|null $reqmatch Match filter (any subset
     *   of SecretScanningAlert fields) as an assoc-array; SecretScanningAlertListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SecretScanningAlert[]|array A list of SecretScanningAlert items as assoc-arrays at
    ...
    /**
     * Update an existing SecretScanningAlert.
     *
     * @param SecretScanningAlertUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SecretScanningAlertUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SecretScanningAlert|array The updated SecretScanningAlert as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
