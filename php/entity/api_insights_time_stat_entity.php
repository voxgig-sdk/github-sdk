...
// Github SDK ApiInsightsTimeStat entity
...
class ApiInsightsTimeStatEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_insights_time_stat";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiInsightsTimeStatEntity($this->_client, $opts);
    }

    /**
     * @param ApiInsightsTimeStat|array $args ApiInsightsTimeStat data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiInsightsTimeStat|array The current ApiInsightsTimeStat data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiInsightsTimeStat fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiInsightsTimeStat fields).
     */
    ...
    /**
     * Load a single ApiInsightsTimeStat.
     *
     * @param ApiInsightsTimeStatLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiInsightsTimeStatLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiInsightsTimeStat|array The loaded ApiInsightsTimeStat as an assoc-array at the
    ...
    /**
     * List ApiInsightsTimeStat items matching the given filter.
     *
     * @param ApiInsightsTimeStatListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiInsightsTimeStat fields) as an assoc-array; ApiInsightsTimeStatListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiInsightsTimeStat[]|array A list of ApiInsightsTimeStat items as assoc-arrays at
