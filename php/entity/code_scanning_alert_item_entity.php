...
// Github SDK CodeScanningAlertItem entity
...
class CodeScanningAlertItemEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "code_scanning_alert_item";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CodeScanningAlertItemEntity($this->_client, $opts);
    }

    /**
     * @param CodeScanningAlertItem|array $args CodeScanningAlertItem data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeScanningAlertItem|array The current CodeScanningAlertItem data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeScanningAlertItem fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeScanningAlertItem fields).
     */
    ...
    /**
     * List CodeScanningAlertItem items matching the given filter.
     *
     * @param CodeScanningAlertItemListMatch|array|null $reqmatch Match filter (any subset
     *   of CodeScanningAlertItem fields) as an assoc-array; CodeScanningAlertItemListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanningAlertItem[]|array A list of CodeScanningAlertItem items as assoc-arrays at
