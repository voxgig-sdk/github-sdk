...
class ActionsHostedRunnerLimitEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "actions_hosted_runner_limit";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionsHostedRunnerLimitEntity($this->_client, $opts);
    }

    /**
     * @param ActionsHostedRunnerLimit|array $args ActionsHostedRunnerLimit data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsHostedRunnerLimit|array The current ActionsHostedRunnerLimit data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsHostedRunnerLimit fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsHostedRunnerLimit fields).
     */
    ...
    /**
     * Load a single ActionsHostedRunnerLimit.
     *
     * @param ActionsHostedRunnerLimitLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionsHostedRunnerLimitLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsHostedRunnerLimit|array The loaded ActionsHostedRunnerLimit as an assoc-array at the
