...
// Github SDK ProtectedBranchPullRequestReview entity
...
class ProtectedBranchPullRequestReviewEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "protected_branch_pull_request_review";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ProtectedBranchPullRequestReviewEntity($this->_client, $opts);
    }

    /**
     * @param ProtectedBranchPullRequestReview|array $args ProtectedBranchPullRequestReview data (assoc-array) to store.
     */
    ...
    /**
     * @return ProtectedBranchPullRequestReview|array The current ProtectedBranchPullRequestReview data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProtectedBranchPullRequestReview fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProtectedBranchPullRequestReview fields).
     */
    ...
    /**
     * Load a single ProtectedBranchPullRequestReview.
     *
     * @param ProtectedBranchPullRequestReviewLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ProtectedBranchPullRequestReviewLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProtectedBranchPullRequestReview|array The loaded ProtectedBranchPullRequestReview as an assoc-array at the
    ...
    /**
     * Update an existing ProtectedBranchPullRequestReview.
     *
     * @param ProtectedBranchPullRequestReviewUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProtectedBranchPullRequestReviewUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProtectedBranchPullRequestReview|array The updated ProtectedBranchPullRequestReview as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
