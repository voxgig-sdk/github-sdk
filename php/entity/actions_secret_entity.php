...
// Github SDK ActionsSecret entity
...
class ActionsSecretEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ActionsSecretEntity($this->_client, $opts);
    }

    /**
     * @param ActionsSecret|array $args ActionsSecret data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsSecret|array The current ActionsSecret data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsSecret fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsSecret fields).
     */
    ...
    /**
     * Load a single ActionsSecret.
     *
     * @param ActionsSecretLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionsSecretLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsSecret|array The loaded ActionsSecret as an assoc-array at the
