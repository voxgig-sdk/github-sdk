...
// Github SDK DependencyGraphSpdxSbom entity
...
class DependencyGraphSpdxSbomEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "dependency_graph_spdx_sbom";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DependencyGraphSpdxSbomEntity($this->_client, $opts);
    }

    /**
     * @param DependencyGraphSpdxSbom|array $args DependencyGraphSpdxSbom data (assoc-array) to store.
     */
    ...
    /**
     * @return DependencyGraphSpdxSbom|array The current DependencyGraphSpdxSbom data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DependencyGraphSpdxSbom fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DependencyGraphSpdxSbom fields).
     */
    ...
    /**
     * Load a single DependencyGraphSpdxSbom.
     *
     * @param DependencyGraphSpdxSbomLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DependencyGraphSpdxSbomLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DependencyGraphSpdxSbom|array The loaded DependencyGraphSpdxSbom as an assoc-array at the
