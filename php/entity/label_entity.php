...
class LabelEntity
{
     ...
     * Create a new Label.
     *
     * @param LabelCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LabelCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Label|array The created Label as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
     ...
     *
     * @param LabelUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LabelUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Label|array The updated Label as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
