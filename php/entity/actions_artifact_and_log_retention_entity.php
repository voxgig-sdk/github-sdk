...
class ActionsArtifactAndLogRetentionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "actions_artifact_and_log_retention";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionsArtifactAndLogRetentionEntity($this->_client, $opts);
    }

    /**
     * @param ActionsArtifactAndLogRetention|array $args ActionsArtifactAndLogRetention data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsArtifactAndLogRetention|array The current ActionsArtifactAndLogRetention data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsArtifactAndLogRetention fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsArtifactAndLogRetention fields).
     */
    ...
    /**
     * Load a single ActionsArtifactAndLogRetention.
     *
     * @param ActionsArtifactAndLogRetentionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionsArtifactAndLogRetentionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsArtifactAndLogRetention|array The loaded ActionsArtifactAndLogRetention as an assoc-array at the
