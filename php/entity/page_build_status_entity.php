...
// Github SDK PageBuildStatus entity
...
class PageBuildStatusEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PageBuildStatusEntity($this->_client, $opts);
    }

    /**
     * @param PageBuildStatus|array $args PageBuildStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return PageBuildStatus|array The current PageBuildStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PageBuildStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PageBuildStatus fields).
     */
    ...
    /**
     * Create a new PageBuildStatus.
     *
     * @param PageBuildStatusCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PageBuildStatusCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PageBuildStatus|array The created PageBuildStatus as an assoc-array at the
