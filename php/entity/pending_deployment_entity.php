...
// Github SDK PendingDeployment entity
...
class PendingDeploymentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PendingDeploymentEntity($this->_client, $opts);
    }

    /**
     * @param PendingDeployment|array $args PendingDeployment data (assoc-array) to store.
     */
    ...
    /**
     * @return PendingDeployment|array The current PendingDeployment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PendingDeployment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PendingDeployment fields).
     */
    ...
    /**
     * List PendingDeployment items matching the given filter.
     *
     * @param PendingDeploymentListMatch|array|null $reqmatch Match filter (any subset
     *   of PendingDeployment fields) as an assoc-array; PendingDeploymentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PendingDeployment[]|array A list of PendingDeployment items as assoc-arrays at
