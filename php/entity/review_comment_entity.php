...
// Github SDK ReviewComment entity
...
class ReviewCommentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReviewCommentEntity($this->_client, $opts);
    }

    /**
     * @param ReviewComment|array $args ReviewComment data (assoc-array) to store.
     */
    ...
    /**
     * @return ReviewComment|array The current ReviewComment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ReviewComment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ReviewComment fields).
     */
    ...
    /**
     * List ReviewComment items matching the given filter.
     *
     * @param ReviewCommentListMatch|array|null $reqmatch Match filter (any subset
     *   of ReviewComment fields) as an assoc-array; ReviewCommentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReviewComment[]|array A list of ReviewComment items as assoc-arrays at
