...
// Github SDK PullRequestSimple entity
...
class PullRequestSimpleEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "pull_request_simple";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PullRequestSimpleEntity($this->_client, $opts);
    }

    /**
     * @param PullRequestSimple|array $args PullRequestSimple data (assoc-array) to store.
     */
    ...
    /**
     * @return PullRequestSimple|array The current PullRequestSimple data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PullRequestSimple fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PullRequestSimple fields).
     */
    ...
    /**
     * Create a new PullRequestSimple.
     *
     * @param PullRequestSimpleCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PullRequestSimpleCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PullRequestSimple|array The created PullRequestSimple as an assoc-array at the
    ...
    /**
     * Remove an PullRequestSimple matching the given criteria.
     *
     * @param PullRequestSimpleRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PullRequestSimpleRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PullRequestSimple|array The removed PullRequestSimple as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
