...
// Github SDK IntegrationInstallation entity
...
class IntegrationInstallationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "integration_installation";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new IntegrationInstallationEntity($this->_client, $opts);
    }

    /**
     * @param IntegrationInstallation|array $args IntegrationInstallation data (assoc-array) to store.
     */
    ...
    /**
     * @return IntegrationInstallation|array The current IntegrationInstallation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IntegrationInstallation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IntegrationInstallation fields).
     */
    ...
    /**
     * List IntegrationInstallation items matching the given filter.
     *
     * @param IntegrationInstallationListMatch|array|null $reqmatch Match filter (any subset
     *   of IntegrationInstallation fields) as an assoc-array; IntegrationInstallationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IntegrationInstallation[]|array A list of IntegrationInstallation items as assoc-arrays at
