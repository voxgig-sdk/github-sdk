...
class MetarootEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MetarootEntity($this->_client, $opts);
    }

    /**
     * @param Metaroot|array $args Metaroot data (assoc-array) to store.
     */
    ...
    /**
     * @return Metaroot|array The current Metaroot data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Metaroot fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Metaroot fields).
     */
    ...
    /**
     * Load a single Metaroot.
     *
     * @param MetarootLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MetarootLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Metaroot|array The loaded Metaroot as an assoc-array at the
