...
class ActionsCacheUsageOrgEnterpriseEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "actions_cache_usage_org_enterprise";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionsCacheUsageOrgEnterpriseEntity($this->_client, $opts);
    }

    /**
     * @param ActionsCacheUsageOrgEnterprise|array $args ActionsCacheUsageOrgEnterprise data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsCacheUsageOrgEnterprise|array The current ActionsCacheUsageOrgEnterprise data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsCacheUsageOrgEnterprise fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsCacheUsageOrgEnterprise fields).
     */
    ...
    /**
     * Load a single ActionsCacheUsageOrgEnterprise.
     *
     * @param ActionsCacheUsageOrgEnterpriseLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionsCacheUsageOrgEnterpriseLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsCacheUsageOrgEnterprise|array The loaded ActionsCacheUsageOrgEnterprise as an assoc-array at the
