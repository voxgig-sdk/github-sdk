...
class ActionsForkPrContributorApprovalEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "actions_fork_pr_contributor_approval";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionsForkPrContributorApprovalEntity($this->_client, $opts);
    }

    /**
     * @param ActionsForkPrContributorApproval|array $args ActionsForkPrContributorApproval data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsForkPrContributorApproval|array The current ActionsForkPrContributorApproval data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsForkPrContributorApproval fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsForkPrContributorApproval fields).
     */
    ...
    /**
     * Load a single ActionsForkPrContributorApproval.
     *
     * @param ActionsForkPrContributorApprovalLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionsForkPrContributorApprovalLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsForkPrContributorApproval|array The loaded ActionsForkPrContributorApproval as an assoc-array at the
