...
class ViewEntity
{
    ...
    /**
     * List View items matching the given filter.
     *
     * @param ViewListMatch|array|null $reqmatch Match filter (any subset
     *   of View fields) as an assoc-array; ViewListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return View[]|array A list of View items as assoc-arrays at
