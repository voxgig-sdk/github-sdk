...
// Github SDK OrgMembership entity
...
class OrgMembershipEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OrgMembershipEntity($this->_client, $opts);
    }

    /**
     * @param OrgMembership|array $args OrgMembership data (assoc-array) to store.
     */
    ...
    /**
     * @return OrgMembership|array The current OrgMembership data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrgMembership fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrgMembership fields).
     */
    ...
    /**
     * Load a single OrgMembership.
     *
     * @param OrgMembershipLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OrgMembershipLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrgMembership|array The loaded OrgMembership as an assoc-array at the
     ...
     *
     * @param OrgMembershipUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrgMembershipUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrgMembership|array The updated OrgMembership as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
