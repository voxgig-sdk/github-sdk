...
class CommitEntity
{
     ...
     *
     * @param CommitLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CommitLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Commit|array The loaded Commit as an assoc-array at the
     ...
     * Create a new Commit.
     *
     * @param CommitCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CommitCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Commit|array The created Commit as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
