...
class GitCommitEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GitCommitEntity($this->_client, $opts);
    }

    /**
     * @param GitCommit|array $args GitCommit data (assoc-array) to store.
     */
    ...
    /**
     * @return GitCommit|array The current GitCommit data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GitCommit fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GitCommit fields).
     */
    ...
    /**
     * Load a single GitCommit.
     *
     * @param GitCommitLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GitCommitLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GitCommit|array The loaded GitCommit as an assoc-array at the
     ...
     *
     * @param GitCommitCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GitCommitCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GitCommit|array The created GitCommit as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
