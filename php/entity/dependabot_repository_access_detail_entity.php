...
class DependabotRepositoryAccessDetailEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "dependabot_repository_access_detail";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DependabotRepositoryAccessDetailEntity($this->_client, $opts);
    }

    /**
     * @param DependabotRepositoryAccessDetail|array $args DependabotRepositoryAccessDetail data (assoc-array) to store.
     */
    ...
    /**
     * @return DependabotRepositoryAccessDetail|array The current DependabotRepositoryAccessDetail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DependabotRepositoryAccessDetail fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DependabotRepositoryAccessDetail fields).
     */
    ...
    /**
     * List DependabotRepositoryAccessDetail items matching the given filter.
     *
     * @param DependabotRepositoryAccessDetailListMatch|array|null $reqmatch Match filter (any subset
     *   of DependabotRepositoryAccessDetail fields) as an assoc-array; DependabotRepositoryAccessDetailListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DependabotRepositoryAccessDetail[]|array A list of DependabotRepositoryAccessDetail items as assoc-arrays at
