...
class HookEntity
{
     ...
     * Load a single Hook.
     *
     * @param HookLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed HookLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Hook|array The loaded Hook as an assoc-array at the
    ...
    /**
     * List Hook items matching the given filter.
     *
     * @param HookListMatch|array|null $reqmatch Match filter (any subset
     *   of Hook fields) as an assoc-array; HookListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Hook[]|array A list of Hook items as assoc-arrays at
