...
class OrgPrivateRegistryConfigurationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "org_private_registry_configuration";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OrgPrivateRegistryConfigurationEntity($this->_client, $opts);
    }

    /**
     * @param OrgPrivateRegistryConfiguration|array $args OrgPrivateRegistryConfiguration data (assoc-array) to store.
     */
    ...
    /**
     * @return OrgPrivateRegistryConfiguration|array The current OrgPrivateRegistryConfiguration data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrgPrivateRegistryConfiguration fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrgPrivateRegistryConfiguration fields).
     */
    ...
    /**
     * Load a single OrgPrivateRegistryConfiguration.
     *
     * @param OrgPrivateRegistryConfigurationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OrgPrivateRegistryConfigurationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrgPrivateRegistryConfiguration|array The loaded OrgPrivateRegistryConfiguration as an assoc-array at the
