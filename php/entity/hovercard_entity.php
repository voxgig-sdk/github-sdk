...
class HovercardEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new HovercardEntity($this->_client, $opts);
    }

    /**
     * @param Hovercard|array $args Hovercard data (assoc-array) to store.
     */
    ...
    /**
     * @return Hovercard|array The current Hovercard data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Hovercard fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Hovercard fields).
     */
    ...
    /**
     * List Hovercard items matching the given filter.
     *
     * @param HovercardListMatch|array|null $reqmatch Match filter (any subset
     *   of Hovercard fields) as an assoc-array; HovercardListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Hovercard[]|array A list of Hovercard items as assoc-arrays at
