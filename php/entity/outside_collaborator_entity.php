...
// Github SDK OutsideCollaborator entity
...
class OutsideCollaboratorEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "outside_collaborator";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutsideCollaboratorEntity($this->_client, $opts);
    }

    /**
     * @param OutsideCollaborator|array $args OutsideCollaborator data (assoc-array) to store.
     */
    ...
    /**
     * @return OutsideCollaborator|array The current OutsideCollaborator data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutsideCollaborator fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutsideCollaborator fields).
     */
    ...
    /**
     * List OutsideCollaborator items matching the given filter.
     *
     * @param OutsideCollaboratorListMatch|array|null $reqmatch Match filter (any subset
     *   of OutsideCollaborator fields) as an assoc-array; OutsideCollaboratorListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutsideCollaborator[]|array A list of OutsideCollaborator items as assoc-arrays at
