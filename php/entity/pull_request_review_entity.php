...
// Github SDK PullRequestReview entity
...
class PullRequestReviewEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "pull_request_review";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PullRequestReviewEntity($this->_client, $opts);
    }

    /**
     * @param PullRequestReview|array $args PullRequestReview data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = GithubHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return PullRequestReview|array The current PullRequestReview data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PullRequestReview fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = GithubHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of PullRequestReview fields).
     */
    ...
    /**
     * Load a single PullRequestReview.
     *
     * @param PullRequestReviewLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PullRequestReviewLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PullRequestReview|array The loaded PullRequestReview as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                ...
                if ($ctx->result->resdata) {
                    $this->_data = GithubHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
    ...
    /**
     * List PullRequestReview items matching the given filter.
     *
     * @param PullRequestReviewListMatch|array|null $reqmatch Match filter (any subset
     *   of PullRequestReview fields) as an assoc-array; PullRequestReviewListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PullRequestReview[]|array A list of PullRequestReview items as assoc-arrays at
     *   the SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Create a new PullRequestReview.
     *
     * @param PullRequestReviewCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PullRequestReviewCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PullRequestReview|array The created PullRequestReview as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing PullRequestReview.
     *
     * @param PullRequestReviewUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PullRequestReviewUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PullRequestReview|array The updated PullRequestReview as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an PullRequestReview matching the given criteria.
     *
     * @param PullRequestReviewRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PullRequestReviewRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PullRequestReview|array The removed PullRequestReview as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
