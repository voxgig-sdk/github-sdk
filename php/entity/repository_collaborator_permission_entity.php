...
class RepositoryCollaboratorPermissionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "repository_collaborator_permission";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RepositoryCollaboratorPermissionEntity($this->_client, $opts);
    }

    /**
     * @param RepositoryCollaboratorPermission|array $args RepositoryCollaboratorPermission data (assoc-array) to store.
     */
    ...
    /**
     * @return RepositoryCollaboratorPermission|array The current RepositoryCollaboratorPermission data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RepositoryCollaboratorPermission fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RepositoryCollaboratorPermission fields).
     */
    ...
    /**
     * Load a single RepositoryCollaboratorPermission.
     *
     * @param RepositoryCollaboratorPermissionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RepositoryCollaboratorPermissionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryCollaboratorPermission|array The loaded RepositoryCollaboratorPermission as an assoc-array at the
