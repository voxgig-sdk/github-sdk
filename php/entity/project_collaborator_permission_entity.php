...
class ProjectCollaboratorPermissionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "project_collaborator_permission";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ProjectCollaboratorPermissionEntity($this->_client, $opts);
    }

    /**
     * @param ProjectCollaboratorPermission|array $args ProjectCollaboratorPermission data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectCollaboratorPermission|array The current ProjectCollaboratorPermission data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectCollaboratorPermission fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectCollaboratorPermission fields).
     */
    ...
    /**
     * Load a single ProjectCollaboratorPermission.
     *
     * @param ProjectCollaboratorPermissionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ProjectCollaboratorPermissionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectCollaboratorPermission|array The loaded ProjectCollaboratorPermission as an assoc-array at the
