...
// Github SDK Installation entity
...
class InstallationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InstallationEntity($this->_client, $opts);
    }

    /**
     * @param Installation|array $args Installation data (assoc-array) to store.
     */
    ...
    /**
     * @return Installation|array The current Installation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Installation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Installation fields).
     */
    ...
    /**
     * Load a single Installation.
     *
     * @param InstallationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed InstallationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Installation|array The loaded Installation as an assoc-array at the
    ...
    /**
     * List Installation items matching the given filter.
     *
     * @param InstallationListMatch|array|null $reqmatch Match filter (any subset
     *   of Installation fields) as an assoc-array; InstallationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Installation[]|array A list of Installation items as assoc-arrays at
     ...
     *
     * @param InstallationUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed InstallationUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Installation|array The updated Installation as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Installation matching the given criteria.
     *
     * @param InstallationRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; InstallationRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Installation|array The removed Installation as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
