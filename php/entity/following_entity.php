...
class FollowingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FollowingEntity($this->_client, $opts);
    }

    /**
     * @param Following|array $args Following data (assoc-array) to store.
     */
    ...
    /**
     * @return Following|array The current Following data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Following fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Following fields).
     */
    ...
    /**
     * List Following items matching the given filter.
     *
     * @param FollowingListMatch|array|null $reqmatch Match filter (any subset
     *   of Following fields) as an assoc-array; FollowingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Following[]|array A list of Following items as assoc-arrays at
