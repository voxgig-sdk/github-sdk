...
class ReferrerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReferrerEntity($this->_client, $opts);
    }

    /**
     * @param Referrer|array $args Referrer data (assoc-array) to store.
     */
    ...
    /**
     * @return Referrer|array The current Referrer data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Referrer fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Referrer fields).
     */
    ...
    /**
     * List Referrer items matching the given filter.
     *
     * @param ReferrerListMatch|array|null $reqmatch Match filter (any subset
     *   of Referrer fields) as an assoc-array; ReferrerListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Referrer[]|array A list of Referrer items as assoc-arrays at
