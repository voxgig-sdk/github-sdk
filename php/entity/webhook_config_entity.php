...
// Github SDK WebhookConfig entity
...
class WebhookConfigEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WebhookConfigEntity($this->_client, $opts);
    }

    /**
     * @param WebhookConfig|array $args WebhookConfig data (assoc-array) to store.
     */
    ...
    /**
     * @return WebhookConfig|array The current WebhookConfig data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WebhookConfig fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WebhookConfig fields).
     */
    ...
    /**
     * Load a single WebhookConfig.
     *
     * @param WebhookConfigLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WebhookConfigLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhookConfig|array The loaded WebhookConfig as an assoc-array at the
    ...
    /**
     * Update an existing WebhookConfig.
     *
     * @param WebhookConfigUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed WebhookConfigUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhookConfig|array The updated WebhookConfig as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
