...
// Github SDK ActionsVariable entity
...
class ActionsVariableEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ActionsVariableEntity($this->_client, $opts);
    }

    /**
     * @param ActionsVariable|array $args ActionsVariable data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsVariable|array The current ActionsVariable data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsVariable fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsVariable fields).
     */
    ...
    /**
     * Load a single ActionsVariable.
     *
     * @param ActionsVariableLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionsVariableLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsVariable|array The loaded ActionsVariable as an assoc-array at the
