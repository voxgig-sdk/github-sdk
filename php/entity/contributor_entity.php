...
class ContributorEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ContributorEntity($this->_client, $opts);
    }

    /**
     * @param Contributor|array $args Contributor data (assoc-array) to store.
     */
    ...
    /**
     * @return Contributor|array The current Contributor data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Contributor fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Contributor fields).
     */
    ...
    /**
     * List Contributor items matching the given filter.
     *
     * @param ContributorListMatch|array|null $reqmatch Match filter (any subset
     *   of Contributor fields) as an assoc-array; ContributorListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Contributor[]|array A list of Contributor items as assoc-arrays at
