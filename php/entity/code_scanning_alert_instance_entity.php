...
// Github SDK CodeScanningAlertInstance entity
...
class CodeScanningAlertInstanceEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "code_scanning_alert_instance";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CodeScanningAlertInstanceEntity($this->_client, $opts);
    }

    /**
     * @param CodeScanningAlertInstance|array $args CodeScanningAlertInstance data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeScanningAlertInstance|array The current CodeScanningAlertInstance data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeScanningAlertInstance fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeScanningAlertInstance fields).
     */
    ...
    /**
     * List CodeScanningAlertInstance items matching the given filter.
     *
     * @param CodeScanningAlertInstanceListMatch|array|null $reqmatch Match filter (any subset
     *   of CodeScanningAlertInstance fields) as an assoc-array; CodeScanningAlertInstanceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanningAlertInstance[]|array A list of CodeScanningAlertInstance items as assoc-arrays at
