...
// Github SDK ContentTraffic entity
...
class ContentTrafficEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ContentTrafficEntity($this->_client, $opts);
    }

    /**
     * @param ContentTraffic|array $args ContentTraffic data (assoc-array) to store.
     */
    ...
    /**
     * @return ContentTraffic|array The current ContentTraffic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ContentTraffic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ContentTraffic fields).
     */
    ...
    /**
     * List ContentTraffic items matching the given filter.
     *
     * @param ContentTrafficListMatch|array|null $reqmatch Match filter (any subset
     *   of ContentTraffic fields) as an assoc-array; ContentTrafficListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContentTraffic[]|array A list of ContentTraffic items as assoc-arrays at
