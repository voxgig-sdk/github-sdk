...
class GitTagEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GitTagEntity($this->_client, $opts);
    }

    /**
     * @param GitTag|array $args GitTag data (assoc-array) to store.
     */
    ...
    /**
     * @return GitTag|array The current GitTag data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GitTag fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GitTag fields).
     */
    ...
    /**
     * Load a single GitTag.
     *
     * @param GitTagLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GitTagLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GitTag|array The loaded GitTag as an assoc-array at the
     ...
     * Create a new GitTag.
     *
     * @param GitTagCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GitTagCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GitTag|array The created GitTag as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
