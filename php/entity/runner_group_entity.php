...
class RunnerGroupEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RunnerGroupEntity($this->_client, $opts);
    }

    /**
     * @param RunnerGroup|array $args RunnerGroup data (assoc-array) to store.
     */
    ...
    /**
     * @return RunnerGroup|array The current RunnerGroup data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RunnerGroup fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RunnerGroup fields).
     */
    ...
    /**
     * Load a single RunnerGroup.
     *
     * @param RunnerGroupLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RunnerGroupLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RunnerGroup|array The loaded RunnerGroup as an assoc-array at the
    ...
    /**
     * Create a new RunnerGroup.
     *
     * @param RunnerGroupCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RunnerGroupCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RunnerGroup|array The created RunnerGroup as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing RunnerGroup.
     *
     * @param RunnerGroupUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RunnerGroupUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RunnerGroup|array The updated RunnerGroup as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
