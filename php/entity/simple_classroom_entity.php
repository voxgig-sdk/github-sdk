...
class SimpleClassroomEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SimpleClassroomEntity($this->_client, $opts);
    }

    /**
     * @param SimpleClassroom|array $args SimpleClassroom data (assoc-array) to store.
     */
    ...
    /**
     * @return SimpleClassroom|array The current SimpleClassroom data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SimpleClassroom fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SimpleClassroom fields).
     */
