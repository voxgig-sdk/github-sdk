...
// Github SDK ProjectsV2Field entity
...
class ProjectsV2FieldEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProjectsV2FieldEntity($this->_client, $opts);
    }

    /**
     * @param ProjectsV2Field|array $args ProjectsV2Field data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectsV2Field|array The current ProjectsV2Field data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectsV2Field fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectsV2Field fields).
     */
    ...
    /**
     * Load a single ProjectsV2Field.
     *
     * @param ProjectsV2FieldLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ProjectsV2FieldLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectsV2Field|array The loaded ProjectsV2Field as an assoc-array at the
    ...
    /**
     * List ProjectsV2Field items matching the given filter.
     *
     * @param ProjectsV2FieldListMatch|array|null $reqmatch Match filter (any subset
     *   of ProjectsV2Field fields) as an assoc-array; ProjectsV2FieldListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectsV2Field[]|array A list of ProjectsV2Field items as assoc-arrays at
