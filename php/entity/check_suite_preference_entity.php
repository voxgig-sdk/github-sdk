...
// Github SDK CheckSuitePreference entity
...
class CheckSuitePreferenceEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "check_suite_preference";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CheckSuitePreferenceEntity($this->_client, $opts);
    }

    /**
     * @param CheckSuitePreference|array $args CheckSuitePreference data (assoc-array) to store.
     */
    ...
    /**
     * @return CheckSuitePreference|array The current CheckSuitePreference data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CheckSuitePreference fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CheckSuitePreference fields).
     */
    ...
    /**
     * Update an existing CheckSuitePreference.
     *
     * @param CheckSuitePreferenceUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CheckSuitePreferenceUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CheckSuitePreference|array The updated CheckSuitePreference as an assoc-array at the
