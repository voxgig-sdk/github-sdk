...
// Github SDK MergedUpstream entity
...
class MergedUpstreamEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MergedUpstreamEntity($this->_client, $opts);
    }

    /**
     * @param MergedUpstream|array $args MergedUpstream data (assoc-array) to store.
     */
    ...
    /**
     * @return MergedUpstream|array The current MergedUpstream data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MergedUpstream fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MergedUpstream fields).
     */
    ...
    /**
     * Create a new MergedUpstream.
     *
     * @param MergedUpstreamCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MergedUpstreamCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MergedUpstream|array The created MergedUpstream as an assoc-array at the
