...
// Github SDK ApiInsightsUserStat entity
...
class ApiInsightsUserStatEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_insights_user_stat";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiInsightsUserStatEntity($this->_client, $opts);
    }

    /**
     * @param ApiInsightsUserStat|array $args ApiInsightsUserStat data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiInsightsUserStat|array The current ApiInsightsUserStat data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiInsightsUserStat fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiInsightsUserStat fields).
     */
    ...
    /**
     * Load a single ApiInsightsUserStat.
     *
     * @param ApiInsightsUserStatLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiInsightsUserStatLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiInsightsUserStat|array The loaded ApiInsightsUserStat as an assoc-array at the
