...
class CopilotOrganizationDetailEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "copilot_organization_detail";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CopilotOrganizationDetailEntity($this->_client, $opts);
    }

    /**
     * @param CopilotOrganizationDetail|array $args CopilotOrganizationDetail data (assoc-array) to store.
     */
    ...
    /**
     * @return CopilotOrganizationDetail|array The current CopilotOrganizationDetail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CopilotOrganizationDetail fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CopilotOrganizationDetail fields).
     */
    ...
    /**
     * Load a single CopilotOrganizationDetail.
     *
     * @param CopilotOrganizationDetailLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CopilotOrganizationDetailLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CopilotOrganizationDetail|array The loaded CopilotOrganizationDetail as an assoc-array at the
