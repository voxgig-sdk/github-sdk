...
class ActionsCacheUsageByRepositoryEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "actions_cache_usage_by_repository";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionsCacheUsageByRepositoryEntity($this->_client, $opts);
    }

    /**
     * @param ActionsCacheUsageByRepository|array $args ActionsCacheUsageByRepository data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsCacheUsageByRepository|array The current ActionsCacheUsageByRepository data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsCacheUsageByRepository fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsCacheUsageByRepository fields).
     */
    ...
    /**
     * Load a single ActionsCacheUsageByRepository.
     *
     * @param ActionsCacheUsageByRepositoryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionsCacheUsageByRepositoryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsCacheUsageByRepository|array The loaded ActionsCacheUsageByRepository as an assoc-array at the
