...
// Github SDK PullRequestReviewComment entity
...
class PullRequestReviewCommentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "pull_request_review_comment";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PullRequestReviewCommentEntity($this->_client, $opts);
    }

    /**
     * @param PullRequestReviewComment|array $args PullRequestReviewComment data (assoc-array) to store.
     */
    ...
    /**
     * @return PullRequestReviewComment|array The current PullRequestReviewComment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PullRequestReviewComment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PullRequestReviewComment fields).
     */
    ...
    /**
     * Load a single PullRequestReviewComment.
     *
     * @param PullRequestReviewCommentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PullRequestReviewCommentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PullRequestReviewComment|array The loaded PullRequestReviewComment as an assoc-array at the
    ...
    /**
     * List PullRequestReviewComment items matching the given filter.
     *
     * @param PullRequestReviewCommentListMatch|array|null $reqmatch Match filter (any subset
     *   of PullRequestReviewComment fields) as an assoc-array; PullRequestReviewCommentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PullRequestReviewComment[]|array A list of PullRequestReviewComment items as assoc-arrays at
    ...
    /**
     * Create a new PullRequestReviewComment.
     *
     * @param PullRequestReviewCommentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PullRequestReviewCommentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PullRequestReviewComment|array The created PullRequestReviewComment as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing PullRequestReviewComment.
     *
     * @param PullRequestReviewCommentUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PullRequestReviewCommentUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PullRequestReviewComment|array The updated PullRequestReviewComment as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
