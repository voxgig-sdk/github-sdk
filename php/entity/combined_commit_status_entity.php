...
// Github SDK CombinedCommitStatus entity
...
class CombinedCommitStatusEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "combined_commit_status";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CombinedCommitStatusEntity($this->_client, $opts);
    }

    /**
     * @param CombinedCommitStatus|array $args CombinedCommitStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return CombinedCommitStatus|array The current CombinedCommitStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CombinedCommitStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CombinedCommitStatus fields).
     */
    ...
    /**
     * List CombinedCommitStatus items matching the given filter.
     *
     * @param CombinedCommitStatusListMatch|array|null $reqmatch Match filter (any subset
     *   of CombinedCommitStatus fields) as an assoc-array; CombinedCommitStatusListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CombinedCommitStatus[]|array A list of CombinedCommitStatus items as assoc-arrays at
