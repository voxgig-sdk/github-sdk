...
class CloneEntity
{
    ...
    /**
     * List Clone items matching the given filter.
     *
     * @param CloneListMatch|array|null $reqmatch Match filter (any subset
     *   of Clone fields) as an assoc-array; CloneListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Clone[]|array A list of Clone items as assoc-arrays at
