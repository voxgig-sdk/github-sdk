...
// Github SDK CodeScanning entity
...
class CodeScanningEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CodeScanningEntity($this->_client, $opts);
    }

    /**
     * @param CodeScanning|array $args CodeScanning data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeScanning|array The current CodeScanning data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeScanning fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeScanning fields).
     */
    ...
    /**
     * Create a new CodeScanning.
     *
     * @param CodeScanningCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CodeScanningCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanning|array The created CodeScanning as an assoc-array at the
    ...
    /**
     * Remove an CodeScanning matching the given criteria.
     *
     * @param CodeScanningRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CodeScanningRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanning|array The removed CodeScanning as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
