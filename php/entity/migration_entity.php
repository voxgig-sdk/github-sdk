...
class MigrationEntity
{
     ...
     *
     * @param MigrationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MigrationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Migration|array The loaded Migration as an assoc-array at the
    ...
    /**
     * Remove an Migration matching the given criteria.
     *
     * @param MigrationRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; MigrationRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Migration|array The removed Migration as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
