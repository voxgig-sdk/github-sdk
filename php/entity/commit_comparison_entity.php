...
// Github SDK CommitComparison entity
...
class CommitComparisonEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CommitComparisonEntity($this->_client, $opts);
    }

    /**
     * @param CommitComparison|array $args CommitComparison data (assoc-array) to store.
     */
    ...
    /**
     * @return CommitComparison|array The current CommitComparison data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CommitComparison fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CommitComparison fields).
     */
    ...
    /**
     * Load a single CommitComparison.
     *
     * @param CommitComparisonLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CommitComparisonLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CommitComparison|array The loaded CommitComparison as an assoc-array at the
