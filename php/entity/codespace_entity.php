...
class CodespaceEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CodespaceEntity($this->_client, $opts);
    }

    /**
     * @param Codespace|array $args Codespace data (assoc-array) to store.
     */
    ...
    /**
     * @return Codespace|array The current Codespace data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Codespace fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Codespace fields).
     */
    ...
    /**
     * Load a single Codespace.
     *
     * @param CodespaceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CodespaceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Codespace|array The loaded Codespace as an assoc-array at the
    ...
    /**
     * List Codespace items matching the given filter.
     *
     * @param CodespaceListMatch|array|null $reqmatch Match filter (any subset
     *   of Codespace fields) as an assoc-array; CodespaceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Codespace[]|array A list of Codespace items as assoc-arrays at
     ...
     *
     * @param CodespaceCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CodespaceCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Codespace|array The created Codespace as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
     ...
     *
     * @param CodespaceUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CodespaceUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Codespace|array The updated Codespace as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Codespace matching the given criteria.
     *
     * @param CodespaceRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CodespaceRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Codespace|array The removed Codespace as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
