...
class GistCommitEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GistCommitEntity($this->_client, $opts);
    }

    /**
     * @param GistCommit|array $args GistCommit data (assoc-array) to store.
     */
    ...
    /**
     * @return GistCommit|array The current GistCommit data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GistCommit fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GistCommit fields).
     */
    ...
    /**
     * List GistCommit items matching the given filter.
     *
     * @param GistCommitListMatch|array|null $reqmatch Match filter (any subset
     *   of GistCommit fields) as an assoc-array; GistCommitListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GistCommit[]|array A list of GistCommit items as assoc-arrays at
