...
class CheckAutomatedSecurityFixEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "check_automated_security_fix";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CheckAutomatedSecurityFixEntity($this->_client, $opts);
    }

    /**
     * @param CheckAutomatedSecurityFix|array $args CheckAutomatedSecurityFix data (assoc-array) to store.
     */
    ...
    /**
     * @return CheckAutomatedSecurityFix|array The current CheckAutomatedSecurityFix data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CheckAutomatedSecurityFix fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CheckAutomatedSecurityFix fields).
     */
    ...
    /**
     * Load a single CheckAutomatedSecurityFix.
     *
     * @param CheckAutomatedSecurityFixLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CheckAutomatedSecurityFixLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CheckAutomatedSecurityFix|array The loaded CheckAutomatedSecurityFix as an assoc-array at the
