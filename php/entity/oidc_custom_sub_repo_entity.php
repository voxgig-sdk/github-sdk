...
// Github SDK OidcCustomSubRepo entity
...
class OidcCustomSubRepoEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "oidc_custom_sub_repo";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OidcCustomSubRepoEntity($this->_client, $opts);
    }

    /**
     * @param OidcCustomSubRepo|array $args OidcCustomSubRepo data (assoc-array) to store.
     */
    ...
    /**
     * @return OidcCustomSubRepo|array The current OidcCustomSubRepo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OidcCustomSubRepo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OidcCustomSubRepo fields).
     */
    ...
    /**
     * List OidcCustomSubRepo items matching the given filter.
     *
     * @param OidcCustomSubRepoListMatch|array|null $reqmatch Match filter (any subset
     *   of OidcCustomSubRepo fields) as an assoc-array; OidcCustomSubRepoListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OidcCustomSubRepo[]|array A list of OidcCustomSubRepo items as assoc-arrays at
