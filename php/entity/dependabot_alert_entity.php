...
// Github SDK DependabotAlert entity
...
class DependabotAlertEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DependabotAlertEntity($this->_client, $opts);
    }

    /**
     * @param DependabotAlert|array $args DependabotAlert data (assoc-array) to store.
     */
    ...
    /**
     * @return DependabotAlert|array The current DependabotAlert data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DependabotAlert fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DependabotAlert fields).
     */
    ...
    /**
     * Load a single DependabotAlert.
     *
     * @param DependabotAlertLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DependabotAlertLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DependabotAlert|array The loaded DependabotAlert as an assoc-array at the
    ...
    /**
     * List DependabotAlert items matching the given filter.
     *
     * @param DependabotAlertListMatch|array|null $reqmatch Match filter (any subset
     *   of DependabotAlert fields) as an assoc-array; DependabotAlertListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DependabotAlert[]|array A list of DependabotAlert items as assoc-arrays at
    ...
    /**
     * Update an existing DependabotAlert.
     *
     * @param DependabotAlertUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DependabotAlertUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DependabotAlert|array The updated DependabotAlert as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
