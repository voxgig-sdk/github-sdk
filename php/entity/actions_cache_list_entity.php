...
// Github SDK ActionsCacheList entity
...
class ActionsCacheListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ActionsCacheListEntity($this->_client, $opts);
    }

    /**
     * @param ActionsCacheList|array $args ActionsCacheList data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsCacheList|array The current ActionsCacheList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsCacheList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsCacheList fields).
     */
    ...
    /**
     * List ActionsCacheList items matching the given filter.
     *
     * @param ActionsCacheListListMatch|array|null $reqmatch Match filter (any subset
     *   of ActionsCacheList fields) as an assoc-array; ActionsCacheListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsCacheList[]|array A list of ActionsCacheList items as assoc-arrays at
    ...
    /**
     * Remove an ActionsCacheList matching the given criteria.
     *
     * @param ActionsCacheListRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ActionsCacheListRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsCacheList|array The removed ActionsCacheList as an assoc-array at the
