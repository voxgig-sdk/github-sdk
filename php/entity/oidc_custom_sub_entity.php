...
// Github SDK OidcCustomSub entity
...
class OidcCustomSubEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OidcCustomSubEntity($this->_client, $opts);
    }

    /**
     * @param OidcCustomSub|array $args OidcCustomSub data (assoc-array) to store.
     */
    ...
    /**
     * @return OidcCustomSub|array The current OidcCustomSub data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OidcCustomSub fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OidcCustomSub fields).
     */
    ...
    /**
     * List OidcCustomSub items matching the given filter.
     *
     * @param OidcCustomSubListMatch|array|null $reqmatch Match filter (any subset
     *   of OidcCustomSub fields) as an assoc-array; OidcCustomSubListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OidcCustomSub[]|array A list of OidcCustomSub items as assoc-arrays at
