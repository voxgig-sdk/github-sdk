...
// Github SDK UserMarketplacePurchase entity
...
class UserMarketplacePurchaseEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "user_marketplace_purchase";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new UserMarketplacePurchaseEntity($this->_client, $opts);
    }

    /**
     * @param UserMarketplacePurchase|array $args UserMarketplacePurchase data (assoc-array) to store.
     */
    ...
    /**
     * @return UserMarketplacePurchase|array The current UserMarketplacePurchase data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserMarketplacePurchase fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserMarketplacePurchase fields).
     */
    ...
    /**
     * List UserMarketplacePurchase items matching the given filter.
     *
     * @param UserMarketplacePurchaseListMatch|array|null $reqmatch Match filter (any subset
     *   of UserMarketplacePurchase fields) as an assoc-array; UserMarketplacePurchaseListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserMarketplacePurchase[]|array A list of UserMarketplacePurchase items as assoc-arrays at
