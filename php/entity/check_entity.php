...
class CheckEntity
{
    ...
    /**
     * List Check items matching the given filter.
     *
     * @param CheckListMatch|array|null $reqmatch Match filter (any subset
     *   of Check fields) as an assoc-array; CheckListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Check[]|array A list of Check items as assoc-arrays at
