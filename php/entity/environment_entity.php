...
class EnvironmentEntity
{
     ...
     *
     * @param EnvironmentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EnvironmentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Environment|array The loaded Environment as an assoc-array at the
     ...
     *
     * @param EnvironmentUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EnvironmentUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Environment|array The updated Environment as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
