...
// Github SDK ReleaseNotesContent entity
...
class ReleaseNotesContentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "release_notes_content";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ReleaseNotesContentEntity($this->_client, $opts);
    }

    /**
     * @param ReleaseNotesContent|array $args ReleaseNotesContent data (assoc-array) to store.
     */
    ...
    /**
     * @return ReleaseNotesContent|array The current ReleaseNotesContent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ReleaseNotesContent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ReleaseNotesContent fields).
     */
    ...
    /**
     * Create a new ReleaseNotesContent.
     *
     * @param ReleaseNotesContentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ReleaseNotesContentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReleaseNotesContent|array The created ReleaseNotesContent as an assoc-array at the
