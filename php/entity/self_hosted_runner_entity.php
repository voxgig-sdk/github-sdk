...
// Github SDK SelfHostedRunner entity
...
class SelfHostedRunnerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SelfHostedRunnerEntity($this->_client, $opts);
    }

    /**
     * @param SelfHostedRunner|array $args SelfHostedRunner data (assoc-array) to store.
     */
    ...
    /**
     * @return SelfHostedRunner|array The current SelfHostedRunner data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SelfHostedRunner fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SelfHostedRunner fields).
     */
    ...
    /**
     * Load a single SelfHostedRunner.
     *
     * @param SelfHostedRunnerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SelfHostedRunnerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SelfHostedRunner|array The loaded SelfHostedRunner as an assoc-array at the
