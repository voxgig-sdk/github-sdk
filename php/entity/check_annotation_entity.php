...
// Github SDK CheckAnnotation entity
...
class CheckAnnotationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CheckAnnotationEntity($this->_client, $opts);
    }

    /**
     * @param CheckAnnotation|array $args CheckAnnotation data (assoc-array) to store.
     */
    ...
    /**
     * @return CheckAnnotation|array The current CheckAnnotation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CheckAnnotation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CheckAnnotation fields).
     */
    ...
    /**
     * List CheckAnnotation items matching the given filter.
     *
     * @param CheckAnnotationListMatch|array|null $reqmatch Match filter (any subset
     *   of CheckAnnotation fields) as an assoc-array; CheckAnnotationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CheckAnnotation[]|array A list of CheckAnnotation items as assoc-arrays at
