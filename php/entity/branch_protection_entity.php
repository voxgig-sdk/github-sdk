...
// Github SDK BranchProtection entity
...
class BranchProtectionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BranchProtectionEntity($this->_client, $opts);
    }

    /**
     * @param BranchProtection|array $args BranchProtection data (assoc-array) to store.
     */
    ...
    /**
     * @return BranchProtection|array The current BranchProtection data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BranchProtection fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BranchProtection fields).
     */
    ...
    /**
     * Load a single BranchProtection.
     *
     * @param BranchProtectionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BranchProtectionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BranchProtection|array The loaded BranchProtection as an assoc-array at the
