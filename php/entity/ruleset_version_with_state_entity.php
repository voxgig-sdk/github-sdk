...
// Github SDK RulesetVersionWithState entity
...
class RulesetVersionWithStateEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "ruleset_version_with_state";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RulesetVersionWithStateEntity($this->_client, $opts);
    }

    /**
     * @param RulesetVersionWithState|array $args RulesetVersionWithState data (assoc-array) to store.
     */
    ...
    /**
     * @return RulesetVersionWithState|array The current RulesetVersionWithState data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RulesetVersionWithState fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RulesetVersionWithState fields).
     */
    ...
    /**
     * Load a single RulesetVersionWithState.
     *
     * @param RulesetVersionWithStateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RulesetVersionWithStateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RulesetVersionWithState|array The loaded RulesetVersionWithState as an assoc-array at the
