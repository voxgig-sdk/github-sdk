...
// Github SDK OrganizationActionsSecret entity
...
class OrganizationActionsSecretEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "organization_actions_secret";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OrganizationActionsSecretEntity($this->_client, $opts);
    }

    /**
     * @param OrganizationActionsSecret|array $args OrganizationActionsSecret data (assoc-array) to store.
     */
    ...
    /**
     * @return OrganizationActionsSecret|array The current OrganizationActionsSecret data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrganizationActionsSecret fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrganizationActionsSecret fields).
     */
    ...
    /**
     * Load a single OrganizationActionsSecret.
     *
     * @param OrganizationActionsSecretLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OrganizationActionsSecretLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationActionsSecret|array The loaded OrganizationActionsSecret as an assoc-array at the
