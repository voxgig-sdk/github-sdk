...
class CheckSuiteEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CheckSuiteEntity($this->_client, $opts);
    }

    /**
     * @param CheckSuite|array $args CheckSuite data (assoc-array) to store.
     */
    ...
    /**
     * @return CheckSuite|array The current CheckSuite data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CheckSuite fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CheckSuite fields).
     */
    ...
    /**
     * Load a single CheckSuite.
     *
     * @param CheckSuiteLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CheckSuiteLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CheckSuite|array The loaded CheckSuite as an assoc-array at the
    ...
    /**
     * Create a new CheckSuite.
     *
     * @param CheckSuiteCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CheckSuiteCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CheckSuite|array The created CheckSuite as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
