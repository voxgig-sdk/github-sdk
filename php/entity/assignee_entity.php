...
class AssigneeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AssigneeEntity($this->_client, $opts);
    }

    /**
     * @param Assignee|array $args Assignee data (assoc-array) to store.
     */
    ...
    /**
     * @return Assignee|array The current Assignee data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Assignee fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Assignee fields).
     */
    ...
    /**
     * List Assignee items matching the given filter.
     *
     * @param AssigneeListMatch|array|null $reqmatch Match filter (any subset
     *   of Assignee fields) as an assoc-array; AssigneeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Assignee[]|array A list of Assignee items as assoc-arrays at
