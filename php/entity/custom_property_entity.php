...
// Github SDK CustomProperty entity
...
class CustomPropertyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CustomPropertyEntity($this->_client, $opts);
    }

    /**
     * @param CustomProperty|array $args CustomProperty data (assoc-array) to store.
     */
    ...
    /**
     * @return CustomProperty|array The current CustomProperty data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CustomProperty fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CustomProperty fields).
     */
    ...
    /**
     * Load a single CustomProperty.
     *
     * @param CustomPropertyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CustomPropertyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomProperty|array The loaded CustomProperty as an assoc-array at the
    ...
    /**
     * List CustomProperty items matching the given filter.
     *
     * @param CustomPropertyListMatch|array|null $reqmatch Match filter (any subset
     *   of CustomProperty fields) as an assoc-array; CustomPropertyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomProperty[]|array A list of CustomProperty items as assoc-arrays at
    ...
    /**
     * Update an existing CustomProperty.
     *
     * @param CustomPropertyUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CustomPropertyUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomProperty|array The updated CustomProperty as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
