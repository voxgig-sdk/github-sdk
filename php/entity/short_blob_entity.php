...
class ShortBlobEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ShortBlobEntity($this->_client, $opts);
    }

    /**
     * @param ShortBlob|array $args ShortBlob data (assoc-array) to store.
     */
    ...
    /**
     * @return ShortBlob|array The current ShortBlob data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ShortBlob fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ShortBlob fields).
     */
    ...
    /**
     * Create a new ShortBlob.
     *
     * @param ShortBlobCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ShortBlobCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ShortBlob|array The created ShortBlob as an assoc-array at the
