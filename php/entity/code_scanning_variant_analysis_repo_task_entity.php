...
class CodeScanningVariantAnalysisRepoTaskEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "code_scanning_variant_analysis_repo_task";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CodeScanningVariantAnalysisRepoTaskEntity($this->_client, $opts);
    }

    /**
     * @param CodeScanningVariantAnalysisRepoTask|array $args CodeScanningVariantAnalysisRepoTask data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeScanningVariantAnalysisRepoTask|array The current CodeScanningVariantAnalysisRepoTask data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeScanningVariantAnalysisRepoTask fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeScanningVariantAnalysisRepoTask fields).
     */
    ...
    /**
     * Load a single CodeScanningVariantAnalysisRepoTask.
     *
     * @param CodeScanningVariantAnalysisRepoTaskLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CodeScanningVariantAnalysisRepoTaskLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanningVariantAnalysisRepoTask|array The loaded CodeScanningVariantAnalysisRepoTask as an assoc-array at the
