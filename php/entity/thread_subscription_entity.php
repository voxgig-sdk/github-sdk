...
// Github SDK ThreadSubscription entity
...
class ThreadSubscriptionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "thread_subscription";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ThreadSubscriptionEntity($this->_client, $opts);
    }

    /**
     * @param ThreadSubscription|array $args ThreadSubscription data (assoc-array) to store.
     */
    ...
    /**
     * @return ThreadSubscription|array The current ThreadSubscription data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ThreadSubscription fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ThreadSubscription fields).
     */
    ...
    /**
     * Load a single ThreadSubscription.
     *
     * @param ThreadSubscriptionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ThreadSubscriptionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ThreadSubscription|array The loaded ThreadSubscription as an assoc-array at the
    ...
    /**
     * Update an existing ThreadSubscription.
     *
     * @param ThreadSubscriptionUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ThreadSubscriptionUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ThreadSubscription|array The updated ThreadSubscription as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
