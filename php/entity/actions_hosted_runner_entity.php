...
// Github SDK ActionsHostedRunner entity
...
class ActionsHostedRunnerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "actions_hosted_runner";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionsHostedRunnerEntity($this->_client, $opts);
    }

    /**
     * @param ActionsHostedRunner|array $args ActionsHostedRunner data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsHostedRunner|array The current ActionsHostedRunner data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsHostedRunner fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsHostedRunner fields).
     */
    ...
    /**
     * Load a single ActionsHostedRunner.
     *
     * @param ActionsHostedRunnerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionsHostedRunnerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsHostedRunner|array The loaded ActionsHostedRunner as an assoc-array at the
    ...
    /**
     * Create a new ActionsHostedRunner.
     *
     * @param ActionsHostedRunnerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ActionsHostedRunnerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsHostedRunner|array The created ActionsHostedRunner as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ActionsHostedRunner.
     *
     * @param ActionsHostedRunnerUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ActionsHostedRunnerUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsHostedRunner|array The updated ActionsHostedRunner as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
