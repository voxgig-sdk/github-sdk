...
// Github SDK RepositoryRuleset entity
...
class RepositoryRulesetEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RepositoryRulesetEntity($this->_client, $opts);
    }

    /**
     * @param RepositoryRuleset|array $args RepositoryRuleset data (assoc-array) to store.
     */
    ...
    /**
     * @return RepositoryRuleset|array The current RepositoryRuleset data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RepositoryRuleset fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RepositoryRuleset fields).
     */
    ...
    /**
     * Load a single RepositoryRuleset.
     *
     * @param RepositoryRulesetLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RepositoryRulesetLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryRuleset|array The loaded RepositoryRuleset as an assoc-array at the
    ...
    /**
     * List RepositoryRuleset items matching the given filter.
     *
     * @param RepositoryRulesetListMatch|array|null $reqmatch Match filter (any subset
     *   of RepositoryRuleset fields) as an assoc-array; RepositoryRulesetListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryRuleset[]|array A list of RepositoryRuleset items as assoc-arrays at
    ...
    /**
     * Create a new RepositoryRuleset.
     *
     * @param RepositoryRulesetCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RepositoryRulesetCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryRuleset|array The created RepositoryRuleset as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing RepositoryRuleset.
     *
     * @param RepositoryRulesetUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RepositoryRulesetUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryRuleset|array The updated RepositoryRuleset as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
