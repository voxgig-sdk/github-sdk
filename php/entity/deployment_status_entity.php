...
// Github SDK DeploymentStatus entity
...
class DeploymentStatusEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeploymentStatusEntity($this->_client, $opts);
    }

    /**
     * @param DeploymentStatus|array $args DeploymentStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return DeploymentStatus|array The current DeploymentStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeploymentStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeploymentStatus fields).
     */
    ...
    /**
     * Load a single DeploymentStatus.
     *
     * @param DeploymentStatusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DeploymentStatusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeploymentStatus|array The loaded DeploymentStatus as an assoc-array at the
    ...
    /**
     * List DeploymentStatus items matching the given filter.
     *
     * @param DeploymentStatusListMatch|array|null $reqmatch Match filter (any subset
     *   of DeploymentStatus fields) as an assoc-array; DeploymentStatusListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeploymentStatus[]|array A list of DeploymentStatus items as assoc-arrays at
    ...
    /**
     * Create a new DeploymentStatus.
     *
     * @param DeploymentStatusCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DeploymentStatusCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeploymentStatus|array The created DeploymentStatus as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
