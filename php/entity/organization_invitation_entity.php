...
// Github SDK OrganizationInvitation entity
...
class OrganizationInvitationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "organization_invitation";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OrganizationInvitationEntity($this->_client, $opts);
    }

    /**
     * @param OrganizationInvitation|array $args OrganizationInvitation data (assoc-array) to store.
     */
    ...
    /**
     * @return OrganizationInvitation|array The current OrganizationInvitation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrganizationInvitation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrganizationInvitation fields).
     */
    ...
    /**
     * List OrganizationInvitation items matching the given filter.
     *
     * @param OrganizationInvitationListMatch|array|null $reqmatch Match filter (any subset
     *   of OrganizationInvitation fields) as an assoc-array; OrganizationInvitationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationInvitation[]|array A list of OrganizationInvitation items as assoc-arrays at
     ...
     *
     * @param OrganizationInvitationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrganizationInvitationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationInvitation|array The created OrganizationInvitation as an assoc-array at the
