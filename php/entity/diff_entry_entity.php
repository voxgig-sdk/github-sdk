...
class DiffEntryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DiffEntryEntity($this->_client, $opts);
    }

    /**
     * @param DiffEntry|array $args DiffEntry data (assoc-array) to store.
     */
    ...
    /**
     * @return DiffEntry|array The current DiffEntry data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DiffEntry fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DiffEntry fields).
     */
    ...
    /**
     * List DiffEntry items matching the given filter.
     *
     * @param DiffEntryListMatch|array|null $reqmatch Match filter (any subset
     *   of DiffEntry fields) as an assoc-array; DiffEntryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DiffEntry[]|array A list of DiffEntry items as assoc-arrays at
