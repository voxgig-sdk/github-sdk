...
// Github SDK RepositorySubscription entity
...
class RepositorySubscriptionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "repository_subscription";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RepositorySubscriptionEntity($this->_client, $opts);
    }

    /**
     * @param RepositorySubscription|array $args RepositorySubscription data (assoc-array) to store.
     */
    ...
    /**
     * @return RepositorySubscription|array The current RepositorySubscription data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RepositorySubscription fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RepositorySubscription fields).
     */
    ...
    /**
     * Load a single RepositorySubscription.
     *
     * @param RepositorySubscriptionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RepositorySubscriptionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositorySubscription|array The loaded RepositorySubscription as an assoc-array at the
    ...
    /**
     * Update an existing RepositorySubscription.
     *
     * @param RepositorySubscriptionUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RepositorySubscriptionUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositorySubscription|array The updated RepositorySubscription as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
