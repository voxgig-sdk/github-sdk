...
class FeedEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FeedEntity($this->_client, $opts);
    }

    /**
     * @param Feed|array $args Feed data (assoc-array) to store.
     */
    ...
    /**
     * @return Feed|array The current Feed data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Feed fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Feed fields).
     */
    ...
    /**
     * List Feed items matching the given filter.
     *
     * @param FeedListMatch|array|null $reqmatch Match filter (any subset
     *   of Feed fields) as an assoc-array; FeedListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Feed[]|array A list of Feed items as assoc-arrays at
