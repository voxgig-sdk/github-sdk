...
// Github SDK BillingUsageReport entity
...
class BillingUsageReportEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "billing_usage_report";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new BillingUsageReportEntity($this->_client, $opts);
    }

    /**
     * @param BillingUsageReport|array $args BillingUsageReport data (assoc-array) to store.
     */
    ...
    /**
     * @return BillingUsageReport|array The current BillingUsageReport data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BillingUsageReport fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BillingUsageReport fields).
     */
    ...
    /**
     * List BillingUsageReport items matching the given filter.
     *
     * @param BillingUsageReportListMatch|array|null $reqmatch Match filter (any subset
     *   of BillingUsageReport fields) as an assoc-array; BillingUsageReportListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BillingUsageReport[]|array A list of BillingUsageReport items as assoc-arrays at
