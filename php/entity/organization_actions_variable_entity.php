...
// Github SDK OrganizationActionsVariable entity
...
class OrganizationActionsVariableEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "organization_actions_variable";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OrganizationActionsVariableEntity($this->_client, $opts);
    }

    /**
     * @param OrganizationActionsVariable|array $args OrganizationActionsVariable data (assoc-array) to store.
     */
    ...
    /**
     * @return OrganizationActionsVariable|array The current OrganizationActionsVariable data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrganizationActionsVariable fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrganizationActionsVariable fields).
     */
    ...
    /**
     * Load a single OrganizationActionsVariable.
     *
     * @param OrganizationActionsVariableLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OrganizationActionsVariableLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationActionsVariable|array The loaded OrganizationActionsVariable as an assoc-array at the
