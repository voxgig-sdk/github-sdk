...
// Github SDK EnterpriseTeamMembership entity
...
class EnterpriseTeamMembershipEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "enterprise_team_membership";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EnterpriseTeamMembershipEntity($this->_client, $opts);
    }

    /**
     * @param EnterpriseTeamMembership|array $args EnterpriseTeamMembership data (assoc-array) to store.
     */
    ...
    /**
     * @return EnterpriseTeamMembership|array The current EnterpriseTeamMembership data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EnterpriseTeamMembership fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EnterpriseTeamMembership fields).
     */
    ...
    /**
     * Remove an EnterpriseTeamMembership matching the given criteria.
     *
     * @param EnterpriseTeamMembershipRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; EnterpriseTeamMembershipRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EnterpriseTeamMembership|array The removed EnterpriseTeamMembership as an assoc-array at the
