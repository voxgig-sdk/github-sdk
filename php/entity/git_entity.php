...
class GitEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GitEntity($this->_client, $opts);
    }

    /**
     * @param Git|array $args Git data (assoc-array) to store.
     */
    ...
    /**
     * @return Git|array The current Git data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Git fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Git fields).
     */
    ...
    /**
     * Remove an Git matching the given criteria.
     *
     * @param GitRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; GitRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Git|array The removed Git as an assoc-array at the
