...
class RepositoryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RepositoryEntity($this->_client, $opts);
    }

    /**
     * @param Repository|array $args Repository data (assoc-array) to store.
     */
    ...
    /**
     * @return Repository|array The current Repository data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Repository fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Repository fields).
     */
    ...
    /**
     * List Repository items matching the given filter.
     *
     * @param RepositoryListMatch|array|null $reqmatch Match filter (any subset
     *   of Repository fields) as an assoc-array; RepositoryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Repository[]|array A list of Repository items as assoc-arrays at
