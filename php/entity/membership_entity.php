...
class MembershipEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MembershipEntity($this->_client, $opts);
    }

    /**
     * @param Membership|array $args Membership data (assoc-array) to store.
     */
    ...
    /**
     * @return Membership|array The current Membership data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Membership fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Membership fields).
     */
    ...
    /**
     * Load a single Membership.
     *
     * @param MembershipLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MembershipLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Membership|array The loaded Membership as an assoc-array at the
    ...
    /**
     * List Membership items matching the given filter.
     *
     * @param MembershipListMatch|array|null $reqmatch Match filter (any subset
     *   of Membership fields) as an assoc-array; MembershipListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Membership[]|array A list of Membership items as assoc-arrays at
     ...
     *
     * @param MembershipUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MembershipUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Membership|array The updated Membership as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
