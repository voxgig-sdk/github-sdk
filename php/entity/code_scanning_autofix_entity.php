...
// Github SDK CodeScanningAutofix entity
...
class CodeScanningAutofixEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "code_scanning_autofix";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CodeScanningAutofixEntity($this->_client, $opts);
    }

    /**
     * @param CodeScanningAutofix|array $args CodeScanningAutofix data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeScanningAutofix|array The current CodeScanningAutofix data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeScanningAutofix fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeScanningAutofix fields).
     */
    ...
    /**
     * Load a single CodeScanningAutofix.
     *
     * @param CodeScanningAutofixLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CodeScanningAutofixLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanningAutofix|array The loaded CodeScanningAutofix as an assoc-array at the
    ...
    /**
     * Create a new CodeScanningAutofix.
     *
     * @param CodeScanningAutofixCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CodeScanningAutofixCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeScanningAutofix|array The created CodeScanningAutofix as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
