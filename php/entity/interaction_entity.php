...
class InteractionEntity
{
     ...
     *
     * @param InteractionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed InteractionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Interaction|array The loaded Interaction as an assoc-array at the
    ...
    /**
     * Remove an Interaction matching the given criteria.
     *
     * @param InteractionRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; InteractionRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Interaction|array The removed Interaction as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
