...
// Github SDK CodeFrequencyStat entity
...
class CodeFrequencyStatEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "code_frequency_stat";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CodeFrequencyStatEntity($this->_client, $opts);
    }

    /**
     * @param CodeFrequencyStat|array $args CodeFrequencyStat data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeFrequencyStat|array The current CodeFrequencyStat data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeFrequencyStat fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeFrequencyStat fields).
     */
    ...
    /**
     * List CodeFrequencyStat items matching the given filter.
     *
     * @param CodeFrequencyStatListMatch|array|null $reqmatch Match filter (any subset
     *   of CodeFrequencyStat fields) as an assoc-array; CodeFrequencyStatListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeFrequencyStat[]|array A list of CodeFrequencyStat items as assoc-arrays at
