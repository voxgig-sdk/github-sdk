...
class BlobEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BlobEntity($this->_client, $opts);
    }

    /**
     * @param Blob|array $args Blob data (assoc-array) to store.
     */
    ...
    /**
     * @return Blob|array The current Blob data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Blob fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Blob fields).
     */
     ...
     * Load a single Blob.
     *
     * @param BlobLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BlobLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Blob|array The loaded Blob as an assoc-array at the
