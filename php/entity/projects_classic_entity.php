...
// Github SDK ProjectsClassic entity
...
class ProjectsClassicEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProjectsClassicEntity($this->_client, $opts);
    }

    /**
     * @param ProjectsClassic|array $args ProjectsClassic data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectsClassic|array The current ProjectsClassic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectsClassic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectsClassic fields).
     */
    ...
    /**
     * Create a new ProjectsClassic.
     *
     * @param ProjectsClassicCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProjectsClassicCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectsClassic|array The created ProjectsClassic as an assoc-array at the
    ...
    /**
     * Update an existing ProjectsClassic.
     *
     * @param ProjectsClassicUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProjectsClassicUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectsClassic|array The updated ProjectsClassic as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an ProjectsClassic matching the given criteria.
     *
     * @param ProjectsClassicRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ProjectsClassicRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectsClassic|array The removed ProjectsClassic as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
