...
class BranchShortEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BranchShortEntity($this->_client, $opts);
    }

    /**
     * @param BranchShort|array $args BranchShort data (assoc-array) to store.
     */
    ...
    /**
     * @return BranchShort|array The current BranchShort data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BranchShort fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BranchShort fields).
     */
    ...
    /**
     * List BranchShort items matching the given filter.
     *
     * @param BranchShortListMatch|array|null $reqmatch Match filter (any subset
     *   of BranchShort fields) as an assoc-array; BranchShortListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BranchShort[]|array A list of BranchShort items as assoc-arrays at
