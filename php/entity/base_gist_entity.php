...
class BaseGistEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BaseGistEntity($this->_client, $opts);
    }

    /**
     * @param BaseGist|array $args BaseGist data (assoc-array) to store.
     */
    ...
    /**
     * @return BaseGist|array The current BaseGist data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BaseGist fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BaseGist fields).
     */
    ...
    /**
     * List BaseGist items matching the given filter.
     *
     * @param BaseGistListMatch|array|null $reqmatch Match filter (any subset
     *   of BaseGist fields) as an assoc-array; BaseGistListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BaseGist[]|array A list of BaseGist items as assoc-arrays at
    ...
    /**
     * Create a new BaseGist.
     *
     * @param BaseGistCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BaseGistCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BaseGist|array The created BaseGist as an assoc-array at the
