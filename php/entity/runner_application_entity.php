...
// Github SDK RunnerApplication entity
...
class RunnerApplicationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RunnerApplicationEntity($this->_client, $opts);
    }

    /**
     * @param RunnerApplication|array $args RunnerApplication data (assoc-array) to store.
     */
    ...
    /**
     * @return RunnerApplication|array The current RunnerApplication data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RunnerApplication fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RunnerApplication fields).
     */
    ...
    /**
     * List RunnerApplication items matching the given filter.
     *
     * @param RunnerApplicationListMatch|array|null $reqmatch Match filter (any subset
     *   of RunnerApplication fields) as an assoc-array; RunnerApplicationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RunnerApplication[]|array A list of RunnerApplication items as assoc-arrays at
