...
// Github SDK SshSigningKey entity
...
class SshSigningKeyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SshSigningKeyEntity($this->_client, $opts);
    }

    /**
     * @param SshSigningKey|array $args SshSigningKey data (assoc-array) to store.
     */
    ...
    /**
     * @return SshSigningKey|array The current SshSigningKey data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SshSigningKey fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SshSigningKey fields).
     */
    ...
    /**
     * Load a single SshSigningKey.
     *
     * @param SshSigningKeyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SshSigningKeyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SshSigningKey|array The loaded SshSigningKey as an assoc-array at the
    ...
    /**
     * List SshSigningKey items matching the given filter.
     *
     * @param SshSigningKeyListMatch|array|null $reqmatch Match filter (any subset
     *   of SshSigningKey fields) as an assoc-array; SshSigningKeyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SshSigningKey[]|array A list of SshSigningKey items as assoc-arrays at
    ...
    /**
     * Create a new SshSigningKey.
     *
     * @param SshSigningKeyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SshSigningKeyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SshSigningKey|array The created SshSigningKey as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
