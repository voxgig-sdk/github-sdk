...
// Github SDK DeploymentBranchPolicy entity
...
class DeploymentBranchPolicyEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "deployment_branch_policy";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DeploymentBranchPolicyEntity($this->_client, $opts);
    }

    /**
     * @param DeploymentBranchPolicy|array $args DeploymentBranchPolicy data (assoc-array) to store.
     */
    ...
    /**
     * @return DeploymentBranchPolicy|array The current DeploymentBranchPolicy data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeploymentBranchPolicy fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeploymentBranchPolicy fields).
     */
    ...
    /**
     * Load a single DeploymentBranchPolicy.
     *
     * @param DeploymentBranchPolicyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DeploymentBranchPolicyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeploymentBranchPolicy|array The loaded DeploymentBranchPolicy as an assoc-array at the
    ...
    /**
     * Create a new DeploymentBranchPolicy.
     *
     * @param DeploymentBranchPolicyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DeploymentBranchPolicyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeploymentBranchPolicy|array The created DeploymentBranchPolicy as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing DeploymentBranchPolicy.
     *
     * @param DeploymentBranchPolicyUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DeploymentBranchPolicyUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeploymentBranchPolicy|array The updated DeploymentBranchPolicy as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
