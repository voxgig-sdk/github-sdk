...
// Github SDK EnterpriseTeam entity
...
class EnterpriseTeamEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EnterpriseTeamEntity($this->_client, $opts);
    }

    /**
     * @param EnterpriseTeam|array $args EnterpriseTeam data (assoc-array) to store.
     */
    ...
    /**
     * @return EnterpriseTeam|array The current EnterpriseTeam data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EnterpriseTeam fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EnterpriseTeam fields).
     */
    ...
    /**
     * Load a single EnterpriseTeam.
     *
     * @param EnterpriseTeamLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EnterpriseTeamLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EnterpriseTeam|array The loaded EnterpriseTeam as an assoc-array at the
    ...
    /**
     * List EnterpriseTeam items matching the given filter.
     *
     * @param EnterpriseTeamListMatch|array|null $reqmatch Match filter (any subset
     *   of EnterpriseTeam fields) as an assoc-array; EnterpriseTeamListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EnterpriseTeam[]|array A list of EnterpriseTeam items as assoc-arrays at
    ...
    /**
     * Create a new EnterpriseTeam.
     *
     * @param EnterpriseTeamCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EnterpriseTeamCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EnterpriseTeam|array The created EnterpriseTeam as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing EnterpriseTeam.
     *
     * @param EnterpriseTeamUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EnterpriseTeamUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EnterpriseTeam|array The updated EnterpriseTeam as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an EnterpriseTeam matching the given criteria.
     *
     * @param EnterpriseTeamRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; EnterpriseTeamRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EnterpriseTeam|array The removed EnterpriseTeam as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
