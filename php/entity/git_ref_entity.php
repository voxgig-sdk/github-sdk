...
class GitRefEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GitRefEntity($this->_client, $opts);
    }

    /**
     * @param GitRef|array $args GitRef data (assoc-array) to store.
     */
    ...
    /**
     * @return GitRef|array The current GitRef data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GitRef fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GitRef fields).
     */
    ...
    /**
     * Load a single GitRef.
     *
     * @param GitRefLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GitRefLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GitRef|array The loaded GitRef as an assoc-array at the
     ...
     * Create a new GitRef.
     *
     * @param GitRefCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GitRefCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GitRef|array The created GitRef as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing GitRef.
     *
     * @param GitRefUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GitRefUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GitRef|array The updated GitRef as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
