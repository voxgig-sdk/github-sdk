...
class OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "org_private_registry_configuration_with_selected_repository";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity($this->_client, $opts);
    }

    /**
     * @param OrgPrivateRegistryConfigurationWithSelectedRepository|array $args OrgPrivateRegistryConfigurationWithSelectedRepository data (assoc-array) to store.
     */
    ...
    /**
     * @return OrgPrivateRegistryConfigurationWithSelectedRepository|array The current OrgPrivateRegistryConfigurationWithSelectedRepository data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrgPrivateRegistryConfigurationWithSelectedRepository fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrgPrivateRegistryConfigurationWithSelectedRepository fields).
     */
    ...
    /**
     * Create a new OrgPrivateRegistryConfigurationWithSelectedRepository.
     *
     * @param OrgPrivateRegistryConfigurationWithSelectedRepositoryCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrgPrivateRegistryConfigurationWithSelectedRepositoryCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrgPrivateRegistryConfigurationWithSelectedRepository|array The created OrgPrivateRegistryConfigurationWithSelectedRepository as an assoc-array at the
