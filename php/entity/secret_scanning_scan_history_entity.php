...
// Github SDK SecretScanningScanHistory entity
...
class SecretScanningScanHistoryEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "secret_scanning_scan_history";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SecretScanningScanHistoryEntity($this->_client, $opts);
    }

    /**
     * @param SecretScanningScanHistory|array $args SecretScanningScanHistory data (assoc-array) to store.
     */
    ...
    /**
     * @return SecretScanningScanHistory|array The current SecretScanningScanHistory data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SecretScanningScanHistory fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SecretScanningScanHistory fields).
     */
    ...
    /**
     * List SecretScanningScanHistory items matching the given filter.
     *
     * @param SecretScanningScanHistoryListMatch|array|null $reqmatch Match filter (any subset
     *   of SecretScanningScanHistory fields) as an assoc-array; SecretScanningScanHistoryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SecretScanningScanHistory[]|array A list of SecretScanningScanHistory items as assoc-arrays at
