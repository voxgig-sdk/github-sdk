...
class RemoveEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RemoveEntity($this->_client, $opts);
    }

    /**
     * @param Remove|array $args Remove data (assoc-array) to store.
     */
    ...
    /**
     * @return Remove|array The current Remove data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Remove fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Remove fields).
     */
     ...
     * Create a new Remove.
     *
     * @param RemoveCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RemoveCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Remove|array The created Remove as an assoc-array at the
