...
class CampaignEntity
{
     ...
     *
     * @param CampaignLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CampaignLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Campaign|array The loaded Campaign as an assoc-array at the
    ...
    /**
     * List Campaign items matching the given filter.
     *
     * @param CampaignListMatch|array|null $reqmatch Match filter (any subset
     *   of Campaign fields) as an assoc-array; CampaignListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Campaign[]|array A list of Campaign items as assoc-arrays at
     ...
     *
     * @param CampaignCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CampaignCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Campaign|array The created Campaign as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
     ...
     *
     * @param CampaignUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CampaignUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Campaign|array The updated Campaign as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Campaign matching the given criteria.
     *
     * @param CampaignRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CampaignRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Campaign|array The removed Campaign as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
