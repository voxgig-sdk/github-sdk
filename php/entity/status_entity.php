...
class StatusEntity
{
    ...
    /**
     * List Status items matching the given filter.
     *
     * @param StatusListMatch|array|null $reqmatch Match filter (any subset
     *   of Status fields) as an assoc-array; StatusListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Status[]|array A list of Status items as assoc-arrays at
     ...
     * Create a new Status.
     *
     * @param StatusCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed StatusCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Status|array The created Status as an assoc-array at the
