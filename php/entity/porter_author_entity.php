...
// Github SDK PorterAuthor entity
...
class PorterAuthorEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PorterAuthorEntity($this->_client, $opts);
    }

    /**
     * @param PorterAuthor|array $args PorterAuthor data (assoc-array) to store.
     */
    ...
    /**
     * @return PorterAuthor|array The current PorterAuthor data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PorterAuthor fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PorterAuthor fields).
     */
    ...
    /**
     * List PorterAuthor items matching the given filter.
     *
     * @param PorterAuthorListMatch|array|null $reqmatch Match filter (any subset
     *   of PorterAuthor fields) as an assoc-array; PorterAuthorListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PorterAuthor[]|array A list of PorterAuthor items as assoc-arrays at
    ...
    /**
     * Update an existing PorterAuthor.
     *
     * @param PorterAuthorUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PorterAuthorUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PorterAuthor|array The updated PorterAuthor as an assoc-array at the
