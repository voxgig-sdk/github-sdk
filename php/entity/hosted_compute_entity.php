...
// Github SDK HostedCompute entity
...
class HostedComputeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new HostedComputeEntity($this->_client, $opts);
    }

    /**
     * @param HostedCompute|array $args HostedCompute data (assoc-array) to store.
     */
    ...
    /**
     * @return HostedCompute|array The current HostedCompute data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of HostedCompute fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of HostedCompute fields).
     */
    ...
    /**
     * List HostedCompute items matching the given filter.
     *
     * @param HostedComputeListMatch|array|null $reqmatch Match filter (any subset
     *   of HostedCompute fields) as an assoc-array; HostedComputeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return HostedCompute[]|array A list of HostedCompute items as assoc-arrays at
    ...
    /**
     * Remove an HostedCompute matching the given criteria.
     *
     * @param HostedComputeRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; HostedComputeRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return HostedCompute|array The removed HostedCompute as an assoc-array at the
