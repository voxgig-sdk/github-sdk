...
class ActionsOrganizationPermissionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "actions_organization_permission";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionsOrganizationPermissionEntity($this->_client, $opts);
    }

    /**
     * @param ActionsOrganizationPermission|array $args ActionsOrganizationPermission data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsOrganizationPermission|array The current ActionsOrganizationPermission data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsOrganizationPermission fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsOrganizationPermission fields).
     */
    ...
    /**
     * Load a single ActionsOrganizationPermission.
     *
     * @param ActionsOrganizationPermissionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionsOrganizationPermissionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsOrganizationPermission|array The loaded ActionsOrganizationPermission as an assoc-array at the
