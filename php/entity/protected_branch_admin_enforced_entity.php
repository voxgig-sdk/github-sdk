...
// Github SDK ProtectedBranchAdminEnforced entity
...
class ProtectedBranchAdminEnforcedEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "protected_branch_admin_enforced";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ProtectedBranchAdminEnforcedEntity($this->_client, $opts);
    }

    /**
     * @param ProtectedBranchAdminEnforced|array $args ProtectedBranchAdminEnforced data (assoc-array) to store.
     */
    ...
    /**
     * @return ProtectedBranchAdminEnforced|array The current ProtectedBranchAdminEnforced data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProtectedBranchAdminEnforced fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProtectedBranchAdminEnforced fields).
     */
    ...
    /**
     * Load a single ProtectedBranchAdminEnforced.
     *
     * @param ProtectedBranchAdminEnforcedLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ProtectedBranchAdminEnforcedLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProtectedBranchAdminEnforced|array The loaded ProtectedBranchAdminEnforced as an assoc-array at the
    ...
    /**
     * Create a new ProtectedBranchAdminEnforced.
     *
     * @param ProtectedBranchAdminEnforcedCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProtectedBranchAdminEnforcedCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProtectedBranchAdminEnforced|array The created ProtectedBranchAdminEnforced as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
