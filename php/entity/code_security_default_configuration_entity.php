...
class CodeSecurityDefaultConfigurationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "code_security_default_configuration";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CodeSecurityDefaultConfigurationEntity($this->_client, $opts);
    }

    /**
     * @param CodeSecurityDefaultConfiguration|array $args CodeSecurityDefaultConfiguration data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeSecurityDefaultConfiguration|array The current CodeSecurityDefaultConfiguration data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeSecurityDefaultConfiguration fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeSecurityDefaultConfiguration fields).
     */
    ...
    /**
     * List CodeSecurityDefaultConfiguration items matching the given filter.
     *
     * @param CodeSecurityDefaultConfigurationListMatch|array|null $reqmatch Match filter (any subset
     *   of CodeSecurityDefaultConfiguration fields) as an assoc-array; CodeSecurityDefaultConfigurationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeSecurityDefaultConfiguration[]|array A list of CodeSecurityDefaultConfiguration items as assoc-arrays at
