...
class WorkflowRunEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WorkflowRunEntity($this->_client, $opts);
    }

    /**
     * @param WorkflowRun|array $args WorkflowRun data (assoc-array) to store.
     */
    ...
    /**
     * @return WorkflowRun|array The current WorkflowRun data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WorkflowRun fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WorkflowRun fields).
     */
    ...
    /**
     * Load a single WorkflowRun.
     *
     * @param WorkflowRunLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WorkflowRunLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WorkflowRun|array The loaded WorkflowRun as an assoc-array at the
     ...
     *
     * @param WorkflowRunCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed WorkflowRunCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WorkflowRun|array The created WorkflowRun as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
