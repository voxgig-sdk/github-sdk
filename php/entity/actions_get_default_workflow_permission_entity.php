...
class ActionsGetDefaultWorkflowPermissionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "actions_get_default_workflow_permission";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionsGetDefaultWorkflowPermissionEntity($this->_client, $opts);
    }

    /**
     * @param ActionsGetDefaultWorkflowPermission|array $args ActionsGetDefaultWorkflowPermission data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsGetDefaultWorkflowPermission|array The current ActionsGetDefaultWorkflowPermission data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsGetDefaultWorkflowPermission fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsGetDefaultWorkflowPermission fields).
     */
    ...
    /**
     * Load a single ActionsGetDefaultWorkflowPermission.
     *
     * @param ActionsGetDefaultWorkflowPermissionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionsGetDefaultWorkflowPermissionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsGetDefaultWorkflowPermission|array The loaded ActionsGetDefaultWorkflowPermission as an assoc-array at the
