...
// Github SDK CustomPropertyValue entity
...
class CustomPropertyValueEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "custom_property_value";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CustomPropertyValueEntity($this->_client, $opts);
    }

    /**
     * @param CustomPropertyValue|array $args CustomPropertyValue data (assoc-array) to store.
     */
    ...
    /**
     * @return CustomPropertyValue|array The current CustomPropertyValue data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CustomPropertyValue fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CustomPropertyValue fields).
     */
    ...
    /**
     * List CustomPropertyValue items matching the given filter.
     *
     * @param CustomPropertyValueListMatch|array|null $reqmatch Match filter (any subset
     *   of CustomPropertyValue fields) as an assoc-array; CustomPropertyValueListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomPropertyValue[]|array A list of CustomPropertyValue items as assoc-arrays at
