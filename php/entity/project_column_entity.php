...
// Github SDK ProjectColumn entity
...
class ProjectColumnEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProjectColumnEntity($this->_client, $opts);
    }

    /**
     * @param ProjectColumn|array $args ProjectColumn data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectColumn|array The current ProjectColumn data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectColumn fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectColumn fields).
     */
    ...
    /**
     * Load a single ProjectColumn.
     *
     * @param ProjectColumnLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ProjectColumnLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectColumn|array The loaded ProjectColumn as an assoc-array at the
    ...
    /**
     * List ProjectColumn items matching the given filter.
     *
     * @param ProjectColumnListMatch|array|null $reqmatch Match filter (any subset
     *   of ProjectColumn fields) as an assoc-array; ProjectColumnListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectColumn[]|array A list of ProjectColumn items as assoc-arrays at
    ...
    /**
     * Create a new ProjectColumn.
     *
     * @param ProjectColumnCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProjectColumnCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectColumn|array The created ProjectColumn as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ProjectColumn.
     *
     * @param ProjectColumnUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProjectColumnUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectColumn|array The updated ProjectColumn as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
