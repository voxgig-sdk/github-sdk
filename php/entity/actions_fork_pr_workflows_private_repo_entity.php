...
class ActionsForkPrWorkflowsPrivateRepoEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "actions_fork_pr_workflows_private_repo";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionsForkPrWorkflowsPrivateRepoEntity($this->_client, $opts);
    }

    /**
     * @param ActionsForkPrWorkflowsPrivateRepo|array $args ActionsForkPrWorkflowsPrivateRepo data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsForkPrWorkflowsPrivateRepo|array The current ActionsForkPrWorkflowsPrivateRepo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsForkPrWorkflowsPrivateRepo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsForkPrWorkflowsPrivateRepo fields).
     */
    ...
    /**
     * Load a single ActionsForkPrWorkflowsPrivateRepo.
     *
     * @param ActionsForkPrWorkflowsPrivateRepoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionsForkPrWorkflowsPrivateRepoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsForkPrWorkflowsPrivateRepo|array The loaded ActionsForkPrWorkflowsPrivateRepo as an assoc-array at the
