...
// Github SDK PrivateRegistry entity
...
class PrivateRegistryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PrivateRegistryEntity($this->_client, $opts);
    }

    /**
     * @param PrivateRegistry|array $args PrivateRegistry data (assoc-array) to store.
     */
    ...
    /**
     * @return PrivateRegistry|array The current PrivateRegistry data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PrivateRegistry fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PrivateRegistry fields).
     */
    ...
    /**
     * Load a single PrivateRegistry.
     *
     * @param PrivateRegistryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PrivateRegistryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PrivateRegistry|array The loaded PrivateRegistry as an assoc-array at the
    ...
    /**
     * List PrivateRegistry items matching the given filter.
     *
     * @param PrivateRegistryListMatch|array|null $reqmatch Match filter (any subset
     *   of PrivateRegistry fields) as an assoc-array; PrivateRegistryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PrivateRegistry[]|array A list of PrivateRegistry items as assoc-arrays at
    ...
    /**
     * Update an existing PrivateRegistry.
     *
     * @param PrivateRegistryUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PrivateRegistryUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PrivateRegistry|array The updated PrivateRegistry as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an PrivateRegistry matching the given criteria.
     *
     * @param PrivateRegistryRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PrivateRegistryRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PrivateRegistry|array The removed PrivateRegistry as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
