...
class CodeSecurityConfigurationRepositoryEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "code_security_configuration_repository";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CodeSecurityConfigurationRepositoryEntity($this->_client, $opts);
    }

    /**
     * @param CodeSecurityConfigurationRepository|array $args CodeSecurityConfigurationRepository data (assoc-array) to store.
     */
    ...
    /**
     * @return CodeSecurityConfigurationRepository|array The current CodeSecurityConfigurationRepository data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CodeSecurityConfigurationRepository fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CodeSecurityConfigurationRepository fields).
     */
    ...
    /**
     * List CodeSecurityConfigurationRepository items matching the given filter.
     *
     * @param CodeSecurityConfigurationRepositoryListMatch|array|null $reqmatch Match filter (any subset
     *   of CodeSecurityConfigurationRepository fields) as an assoc-array; CodeSecurityConfigurationRepositoryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CodeSecurityConfigurationRepository[]|array A list of CodeSecurityConfigurationRepository items as assoc-arrays at
