...
class FileCommitEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FileCommitEntity($this->_client, $opts);
    }

    /**
     * @param FileCommit|array $args FileCommit data (assoc-array) to store.
     */
    ...
    /**
     * @return FileCommit|array The current FileCommit data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of FileCommit fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of FileCommit fields).
     */
    ...
    /**
     * Update an existing FileCommit.
     *
     * @param FileCommitUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FileCommitUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FileCommit|array The updated FileCommit as an assoc-array at the
    ...
    /**
     * Remove an FileCommit matching the given criteria.
     *
     * @param FileCommitRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; FileCommitRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FileCommit|array The removed FileCommit as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
