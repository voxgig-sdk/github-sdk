...
class BlockEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BlockEntity($this->_client, $opts);
    }

    /**
     * @param Block|array $args Block data (assoc-array) to store.
     */
    ...
    /**
     * @return Block|array The current Block data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Block fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Block fields).
     */
    ...
    /**
     * List Block items matching the given filter.
     *
     * @param BlockListMatch|array|null $reqmatch Match filter (any subset
     *   of Block fields) as an assoc-array; BlockListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Block[]|array A list of Block items as assoc-arrays at
