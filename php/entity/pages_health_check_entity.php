...
// Github SDK PagesHealthCheck entity
...
class PagesHealthCheckEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PagesHealthCheckEntity($this->_client, $opts);
    }

    /**
     * @param PagesHealthCheck|array $args PagesHealthCheck data (assoc-array) to store.
     */
    ...
    /**
     * @return PagesHealthCheck|array The current PagesHealthCheck data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PagesHealthCheck fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PagesHealthCheck fields).
     */
    ...
    /**
     * Load a single PagesHealthCheck.
     *
     * @param PagesHealthCheckLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PagesHealthCheckLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PagesHealthCheck|array The loaded PagesHealthCheck as an assoc-array at the
