...
// Github SDK InteractionLimit entity
...
class InteractionLimitEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InteractionLimitEntity($this->_client, $opts);
    }

    /**
     * @param InteractionLimit|array $args InteractionLimit data (assoc-array) to store.
     */
    ...
    /**
     * @return InteractionLimit|array The current InteractionLimit data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of InteractionLimit fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of InteractionLimit fields).
     */
    ...
    /**
     * Update an existing InteractionLimit.
     *
     * @param InteractionLimitUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed InteractionLimitUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return InteractionLimit|array The updated InteractionLimit as an assoc-array at the
