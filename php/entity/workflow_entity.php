...
class WorkflowEntity
{
     ...
     *
     * @param WorkflowUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed WorkflowUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Workflow|array The updated Workflow as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
