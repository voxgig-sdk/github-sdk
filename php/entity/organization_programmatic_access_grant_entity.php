...
class OrganizationProgrammaticAccessGrantEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "organization_programmatic_access_grant";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OrganizationProgrammaticAccessGrantEntity($this->_client, $opts);
    }

    /**
     * @param OrganizationProgrammaticAccessGrant|array $args OrganizationProgrammaticAccessGrant data (assoc-array) to store.
     */
    ...
    /**
     * @return OrganizationProgrammaticAccessGrant|array The current OrganizationProgrammaticAccessGrant data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrganizationProgrammaticAccessGrant fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrganizationProgrammaticAccessGrant fields).
     */
    ...
    /**
     * List OrganizationProgrammaticAccessGrant items matching the given filter.
     *
     * @param OrganizationProgrammaticAccessGrantListMatch|array|null $reqmatch Match filter (any subset
     *   of OrganizationProgrammaticAccessGrant fields) as an assoc-array; OrganizationProgrammaticAccessGrantListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationProgrammaticAccessGrant[]|array A list of OrganizationProgrammaticAccessGrant items as assoc-arrays at
