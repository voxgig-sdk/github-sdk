...
class TeamSimpleEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TeamSimpleEntity($this->_client, $opts);
    }

    /**
     * @param TeamSimple|array $args TeamSimple data (assoc-array) to store.
     */
    ...
    /**
     * @return TeamSimple|array The current TeamSimple data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TeamSimple fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TeamSimple fields).
     */
    ...
    /**
     * List TeamSimple items matching the given filter.
     *
     * @param TeamSimpleListMatch|array|null $reqmatch Match filter (any subset
     *   of TeamSimple fields) as an assoc-array; TeamSimpleListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TeamSimple[]|array A list of TeamSimple items as assoc-arrays at
