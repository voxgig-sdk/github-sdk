...
class ApiOverviewEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ApiOverviewEntity($this->_client, $opts);
    }

    /**
     * @param ApiOverview|array $args ApiOverview data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiOverview|array The current ApiOverview data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiOverview fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiOverview fields).
     */
    ...
    /**
     * List ApiOverview items matching the given filter.
     *
     * @param ApiOverviewListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiOverview fields) as an assoc-array; ApiOverviewListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiOverview[]|array A list of ApiOverview items as assoc-arrays at
