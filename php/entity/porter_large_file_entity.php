...
// Github SDK PorterLargeFile entity
...
class PorterLargeFileEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PorterLargeFileEntity($this->_client, $opts);
    }

    /**
     * @param PorterLargeFile|array $args PorterLargeFile data (assoc-array) to store.
     */
    ...
    /**
     * @return PorterLargeFile|array The current PorterLargeFile data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PorterLargeFile fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PorterLargeFile fields).
     */
    ...
    /**
     * List PorterLargeFile items matching the given filter.
     *
     * @param PorterLargeFileListMatch|array|null $reqmatch Match filter (any subset
     *   of PorterLargeFile fields) as an assoc-array; PorterLargeFileListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PorterLargeFile[]|array A list of PorterLargeFile items as assoc-arrays at
