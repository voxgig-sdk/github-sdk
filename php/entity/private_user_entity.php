...
class PrivateUserEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PrivateUserEntity($this->_client, $opts);
    }

    /**
     * @param PrivateUser|array $args PrivateUser data (assoc-array) to store.
     */
    ...
    /**
     * @return PrivateUser|array The current PrivateUser data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PrivateUser fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PrivateUser fields).
     */
