...
class OrganizationSecretScanningAlertEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "organization_secret_scanning_alert";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OrganizationSecretScanningAlertEntity($this->_client, $opts);
    }

    /**
     * @param OrganizationSecretScanningAlert|array $args OrganizationSecretScanningAlert data (assoc-array) to store.
     */
    ...
    /**
     * @return OrganizationSecretScanningAlert|array The current OrganizationSecretScanningAlert data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrganizationSecretScanningAlert fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrganizationSecretScanningAlert fields).
     */
    ...
    /**
     * List OrganizationSecretScanningAlert items matching the given filter.
     *
     * @param OrganizationSecretScanningAlertListMatch|array|null $reqmatch Match filter (any subset
     *   of OrganizationSecretScanningAlert fields) as an assoc-array; OrganizationSecretScanningAlertListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationSecretScanningAlert[]|array A list of OrganizationSecretScanningAlert items as assoc-arrays at
