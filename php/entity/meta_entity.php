...
class MetaEntity
{
    ...
    /**
     * List Meta items matching the given filter.
     *
     * @param MetaListMatch|array|null $reqmatch Match filter (any subset
     *   of Meta fields) as an assoc-array; MetaListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Meta[]|array A list of Meta items as assoc-arrays at
