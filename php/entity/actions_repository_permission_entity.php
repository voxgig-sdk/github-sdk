...
class ActionsRepositoryPermissionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "actions_repository_permission";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionsRepositoryPermissionEntity($this->_client, $opts);
    }

    /**
     * @param ActionsRepositoryPermission|array $args ActionsRepositoryPermission data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsRepositoryPermission|array The current ActionsRepositoryPermission data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsRepositoryPermission fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsRepositoryPermission fields).
     */
    ...
    /**
     * Load a single ActionsRepositoryPermission.
     *
     * @param ActionsRepositoryPermissionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionsRepositoryPermissionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsRepositoryPermission|array The loaded ActionsRepositoryPermission as an assoc-array at the
