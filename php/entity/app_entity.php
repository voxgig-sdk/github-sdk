...
class AppEntity
{
    ...
    /**
     * List App items matching the given filter.
     *
     * @param AppListMatch|array|null $reqmatch Match filter (any subset
     *   of App fields) as an assoc-array; AppListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return App[]|array A list of App items as assoc-arrays at
     ...
     * Create a new App.
     *
     * @param AppCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AppCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return App|array The created App as an assoc-array at the
     ...
     *
     * @param AppUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AppUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return App|array The updated App as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an App matching the given criteria.
     *
     * @param AppRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; AppRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return App|array The removed App as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
