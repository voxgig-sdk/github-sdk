...
// Github SDK HookDelivery entity
...
class HookDeliveryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new HookDeliveryEntity($this->_client, $opts);
    }

    /**
     * @param HookDelivery|array $args HookDelivery data (assoc-array) to store.
     */
    ...
    /**
     * @return HookDelivery|array The current HookDelivery data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of HookDelivery fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of HookDelivery fields).
     */
    ...
    /**
     * Load a single HookDelivery.
     *
     * @param HookDeliveryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed HookDeliveryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return HookDelivery|array The loaded HookDelivery as an assoc-array at the
