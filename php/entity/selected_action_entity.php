...
// Github SDK SelectedAction entity
...
class SelectedActionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SelectedActionEntity($this->_client, $opts);
    }

    /**
     * @param SelectedAction|array $args SelectedAction data (assoc-array) to store.
     */
    ...
    /**
     * @return SelectedAction|array The current SelectedAction data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SelectedAction fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SelectedAction fields).
     */
    ...
    /**
     * List SelectedAction items matching the given filter.
     *
     * @param SelectedActionListMatch|array|null $reqmatch Match filter (any subset
     *   of SelectedAction fields) as an assoc-array; SelectedActionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SelectedAction[]|array A list of SelectedAction items as assoc-arrays at
