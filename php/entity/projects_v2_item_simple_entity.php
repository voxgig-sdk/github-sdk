...
class ProjectsV2ItemSimpleEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "projects_v2_item_simple";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ProjectsV2ItemSimpleEntity($this->_client, $opts);
    }

    /**
     * @param ProjectsV2ItemSimple|array $args ProjectsV2ItemSimple data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectsV2ItemSimple|array The current ProjectsV2ItemSimple data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectsV2ItemSimple fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectsV2ItemSimple fields).
     */
    ...
    /**
     * Create a new ProjectsV2ItemSimple.
     *
     * @param ProjectsV2ItemSimpleCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProjectsV2ItemSimpleCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectsV2ItemSimple|array The created ProjectsV2ItemSimple as an assoc-array at the
