...
class GpgKeyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GpgKeyEntity($this->_client, $opts);
    }

    /**
     * @param GpgKey|array $args GpgKey data (assoc-array) to store.
     */
    ...
    /**
     * @return GpgKey|array The current GpgKey data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GpgKey fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GpgKey fields).
     */
    ...
    /**
     * Load a single GpgKey.
     *
     * @param GpgKeyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GpgKeyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GpgKey|array The loaded GpgKey as an assoc-array at the
    ...
    /**
     * List GpgKey items matching the given filter.
     *
     * @param GpgKeyListMatch|array|null $reqmatch Match filter (any subset
     *   of GpgKey fields) as an assoc-array; GpgKeyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GpgKey[]|array A list of GpgKey items as assoc-arrays at
     ...
     * Create a new GpgKey.
     *
     * @param GpgKeyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GpgKeyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GpgKey|array The created GpgKey as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
