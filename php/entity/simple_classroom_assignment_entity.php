...
// Github SDK SimpleClassroomAssignment entity
...
class SimpleClassroomAssignmentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "simple_classroom_assignment";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SimpleClassroomAssignmentEntity($this->_client, $opts);
    }

    /**
     * @param SimpleClassroomAssignment|array $args SimpleClassroomAssignment data (assoc-array) to store.
     */
    ...
    /**
     * @return SimpleClassroomAssignment|array The current SimpleClassroomAssignment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SimpleClassroomAssignment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SimpleClassroomAssignment fields).
     */
    ...
    /**
     * List SimpleClassroomAssignment items matching the given filter.
     *
     * @param SimpleClassroomAssignmentListMatch|array|null $reqmatch Match filter (any subset
     *   of SimpleClassroomAssignment fields) as an assoc-array; SimpleClassroomAssignmentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SimpleClassroomAssignment[]|array A list of SimpleClassroomAssignment items as assoc-arrays at
