...
class AddEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AddEntity($this->_client, $opts);
    }

    /**
     * @param Add|array $args Add data (assoc-array) to store.
     */
    ...
    /**
     * @return Add|array The current Add data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Add fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Add fields).
     */
     ...
     * Create a new Add.
     *
     * @param AddCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AddCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Add|array The created Add as an assoc-array at the
