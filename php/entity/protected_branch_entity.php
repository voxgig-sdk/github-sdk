...
// Github SDK ProtectedBranch entity
...
class ProtectedBranchEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProtectedBranchEntity($this->_client, $opts);
    }

    /**
     * @param ProtectedBranch|array $args ProtectedBranch data (assoc-array) to store.
     */
    ...
    /**
     * @return ProtectedBranch|array The current ProtectedBranch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProtectedBranch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProtectedBranch fields).
     */
    ...
    /**
     * Update an existing ProtectedBranch.
     *
     * @param ProtectedBranchUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProtectedBranchUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProtectedBranch|array The updated ProtectedBranch as an assoc-array at the
