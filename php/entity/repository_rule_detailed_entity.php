...
// Github SDK RepositoryRuleDetailed entity
...
class RepositoryRuleDetailedEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "repository_rule_detailed";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RepositoryRuleDetailedEntity($this->_client, $opts);
    }

    /**
     * @param RepositoryRuleDetailed|array $args RepositoryRuleDetailed data (assoc-array) to store.
     */
    ...
    /**
     * @return RepositoryRuleDetailed|array The current RepositoryRuleDetailed data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RepositoryRuleDetailed fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RepositoryRuleDetailed fields).
     */
    ...
    /**
     * Load a single RepositoryRuleDetailed.
     *
     * @param RepositoryRuleDetailedLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RepositoryRuleDetailedLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryRuleDetailed|array The loaded RepositoryRuleDetailed as an assoc-array at the
