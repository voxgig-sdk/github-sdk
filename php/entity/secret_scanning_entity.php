...
// Github SDK SecretScanning entity
...
class SecretScanningEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SecretScanningEntity($this->_client, $opts);
    }

    /**
     * @param SecretScanning|array $args SecretScanning data (assoc-array) to store.
     */
    ...
    /**
     * @return SecretScanning|array The current SecretScanning data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SecretScanning fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SecretScanning fields).
     */
    ...
    /**
     * Update an existing SecretScanning.
     *
     * @param SecretScanningUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SecretScanningUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SecretScanning|array The updated SecretScanning as an assoc-array at the
