...
class ClassroomAcceptedAssignmentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "classroom_accepted_assignment";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ClassroomAcceptedAssignmentEntity($this->_client, $opts);
    }

    /**
     * @param ClassroomAcceptedAssignment|array $args ClassroomAcceptedAssignment data (assoc-array) to store.
     */
    ...
    /**
     * @return ClassroomAcceptedAssignment|array The current ClassroomAcceptedAssignment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ClassroomAcceptedAssignment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ClassroomAcceptedAssignment fields).
     */
    ...
    /**
     * List ClassroomAcceptedAssignment items matching the given filter.
     *
     * @param ClassroomAcceptedAssignmentListMatch|array|null $reqmatch Match filter (any subset
     *   of ClassroomAcceptedAssignment fields) as an assoc-array; ClassroomAcceptedAssignmentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ClassroomAcceptedAssignment[]|array A list of ClassroomAcceptedAssignment items as assoc-arrays at
