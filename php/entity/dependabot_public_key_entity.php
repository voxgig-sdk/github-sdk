...
// Github SDK DependabotPublicKey entity
...
class DependabotPublicKeyEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "dependabot_public_key";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DependabotPublicKeyEntity($this->_client, $opts);
    }

    /**
     * @param DependabotPublicKey|array $args DependabotPublicKey data (assoc-array) to store.
     */
    ...
    /**
     * @return DependabotPublicKey|array The current DependabotPublicKey data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DependabotPublicKey fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DependabotPublicKey fields).
     */
    ...
    /**
     * Load a single DependabotPublicKey.
     *
     * @param DependabotPublicKeyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DependabotPublicKeyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DependabotPublicKey|array The loaded DependabotPublicKey as an assoc-array at the
