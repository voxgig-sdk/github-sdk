...
class ThreadEntity
{
     ...
     *
     * @param ThreadLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ThreadLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Thread|array The loaded Thread as an assoc-array at the
