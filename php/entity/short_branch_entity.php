...
class ShortBranchEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ShortBranchEntity($this->_client, $opts);
    }

    /**
     * @param ShortBranch|array $args ShortBranch data (assoc-array) to store.
     */
    ...
    /**
     * @return ShortBranch|array The current ShortBranch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ShortBranch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ShortBranch fields).
     */
    ...
    /**
     * List ShortBranch items matching the given filter.
     *
     * @param ShortBranchListMatch|array|null $reqmatch Match filter (any subset
     *   of ShortBranch fields) as an assoc-array; ShortBranchListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ShortBranch[]|array A list of ShortBranch items as assoc-arrays at
