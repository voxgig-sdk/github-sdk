...
// Github SDK ReleaseAsset entity
...
class ReleaseAssetEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReleaseAssetEntity($this->_client, $opts);
    }

    /**
     * @param ReleaseAsset|array $args ReleaseAsset data (assoc-array) to store.
     */
    ...
    /**
     * @return ReleaseAsset|array The current ReleaseAsset data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ReleaseAsset fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ReleaseAsset fields).
     */
    ...
    /**
     * Load a single ReleaseAsset.
     *
     * @param ReleaseAssetLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ReleaseAssetLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReleaseAsset|array The loaded ReleaseAsset as an assoc-array at the
    ...
    /**
     * List ReleaseAsset items matching the given filter.
     *
     * @param ReleaseAssetListMatch|array|null $reqmatch Match filter (any subset
     *   of ReleaseAsset fields) as an assoc-array; ReleaseAssetListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReleaseAsset[]|array A list of ReleaseAsset items as assoc-arrays at
    ...
    /**
     * Create a new ReleaseAsset.
     *
     * @param ReleaseAssetCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ReleaseAssetCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReleaseAsset|array The created ReleaseAsset as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ReleaseAsset.
     *
     * @param ReleaseAssetUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ReleaseAssetUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReleaseAsset|array The updated ReleaseAsset as an assoc-array at the
     *   SDK boundary; throws GithubError on failure (item-5 convention).
     */
