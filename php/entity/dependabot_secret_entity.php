...
// Github SDK DependabotSecret entity
...
class DependabotSecretEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DependabotSecretEntity($this->_client, $opts);
    }

    /**
     * @param DependabotSecret|array $args DependabotSecret data (assoc-array) to store.
     */
    ...
    /**
     * @return DependabotSecret|array The current DependabotSecret data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DependabotSecret fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DependabotSecret fields).
     */
    ...
    /**
     * Load a single DependabotSecret.
     *
     * @param DependabotSecretLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DependabotSecretLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DependabotSecret|array The loaded DependabotSecret as an assoc-array at the
