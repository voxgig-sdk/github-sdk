...
from projectname_sdk.core.control import GithubControl
...
class GithubContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, GithubResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return GithubError(code, msg, self)
