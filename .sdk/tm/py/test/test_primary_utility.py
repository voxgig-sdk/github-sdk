...
from projectname_sdk import GithubSDK
from projectname_sdk.core.spec import GithubSpec
from projectname_sdk.core.result import GithubResult
from projectname_sdk.core.response import GithubResponse
from projectname_sdk.core.operation import GithubOperation
from projectname_sdk.core.error import GithubError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import GithubBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = GithubSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = GithubSDK.test(None, None)
        ...
        class TestInitFeature(GithubBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(GithubBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = GithubSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = GithubSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = GithubSDK.test(None, setup_opts)
