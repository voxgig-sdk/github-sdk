...
// Github SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = GithubOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(GithubOmni::structfix($now, Struct::undef()))
                        !== json_encode(GithubOmni::structfix($val, Struct::undef()))) {
