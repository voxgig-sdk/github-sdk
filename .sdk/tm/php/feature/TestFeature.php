...
// Github SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class GithubTestFeature extends GithubBaseFeature
{
    ...
    public function init(GithubContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (GithubContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (GithubContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(GithubContext $ctx, $op, $args): array
    {
