...
func eventBasicSetup(extra map[string]any) *entityTestSetup {
	...
	idmap, _ := vs.Transform(
		[]any{"event01", "event02", "event03", "network01", "network02", "network03", "repo01", "repo02", "repo03", "user01", "user02", "user03", "org01", "org02", "org03", "username01"},
		map[string]any{
	...
	entidEnvRaw := os.Getenv("GITHUB_TEST_EVENT_ENTID")
	...
	idmapResolved := core.ToMapAny(env["GITHUB_TEST_EVENT_ENTID"])
