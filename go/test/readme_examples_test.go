...
const testSeed = `map[string]any{"entity": map[string]any{"pull": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "repo": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
