...
func TestWorkflowEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		workflowRef01MarkdefUp0Name := "badge_url"
...
func workflowBasicSetup(extra map[string]any) *entityTestSetup {
	...
	idmap, _ := vs.Transform(
		[]any{"workflow01", "workflow02", "workflow03", "repo01", "repo02", "repo03", "owner01"},
		map[string]any{
	...
	entidEnvRaw := os.Getenv("GITHUB_TEST_WORKFLOW_ENTID")
