...
func TestPullEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		pullRef01Data["repo_id"] = setup.idmap["repo01"]
...
func pullBasicSetup(extra map[string]any) *entityTestSetup {
	...
	idmap := vs.Transform(
		[]any{"pull01", "pull02", "pull03", "repo01", "repo02", "repo03"},
		map[string]any{
	...
	// Add repo_id alias for update test.
	if idmapResolved["repo_id"] == nil {
		idmapResolved["repo_id"] = idmapResolved["repo01"]
	}
