...
func topicBasicSetup(extra map[string]any) *entityTestSetup {
	...
	idmap, _ := vs.Transform(
		[]any{"topic01", "topic02", "topic03", "repo01", "repo02", "repo03", "owner01"},
		map[string]any{
	...
	entidEnvRaw := os.Getenv("GITHUB_TEST_TOPIC_ENTID")
	...
	idmapResolved := core.ToMapAny(env["GITHUB_TEST_TOPIC_ENTID"])
