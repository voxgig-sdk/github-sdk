...
func TestLabelEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		labelRef01Data["milestone_number"] = setup.idmap["milestone_number01"]
		labelRef01Data["owner"] = setup.idmap["owner01"]
		labelRef01Data["repo"] = setup.idmap["repo01"]
		...
		labelRef01MarkdefUp0Name := "color"
...
func labelBasicSetup(extra map[string]any) *entityTestSetup {
	...
	idmap, _ := vs.Transform(
		[]any{"label01", "label02", "label03", "repo01", "repo02", "repo03", "milestone01", "milestone02", "milestone03", "milestone_number01", "owner01"},
		map[string]any{
	...
	entidEnvRaw := os.Getenv("GITHUB_TEST_LABEL_ENTID")
	...
	idmapResolved := core.ToMapAny(env["GITHUB_TEST_LABEL_ENTID"])
