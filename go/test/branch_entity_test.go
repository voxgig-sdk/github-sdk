...
func TestBranchEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set GITHUB_TEST_BRANCH_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func branchBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("GITHUB_TEST_BRANCH_ENTID")
	...
	idmapResolved := core.ToMapAny(env["GITHUB_TEST_BRANCH_ENTID"])
