...
type NetworkSettingEntity struct {
	name    string
...
func NewNetworkSettingEntity(client *core.GithubSDK, entopts map[string]any) *NetworkSettingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NetworkSettingEntity) GetName() string { return e.name }
...
func (e *NetworkSettingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NetworkSettingEntity) Deleted() bool {
	return e.deleted
}


func (e *NetworkSettingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNetworkSettingEntity(e.client, opts)
}

func (e *NetworkSettingEntity) Data(args ...any) any {
...
func (e *NetworkSettingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an NetworkSetting; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NetworkSettingEntity) DataTyped(data ...NetworkSetting) NetworkSetting {
	if len(data) > 0 {
		return typedFrom[NetworkSetting](e.Data(asMap(data[0])))
	}
	return typedFrom[NetworkSetting](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through NetworkSetting (all fields
// optional at the wire level).
func (e *NetworkSettingEntity) MatchTyped(match ...NetworkSetting) NetworkSetting {
	if len(match) > 0 {
		return typedFrom[NetworkSetting](e.Match(asMap(match[0])))
	}
	return typedFrom[NetworkSetting](e.Match())
}
...
func (e *NetworkSettingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NetworkSettingEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NetworkSettingLoadMatch and returns an NetworkSetting. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NetworkSettingEntity) LoadTyped(reqmatch NetworkSettingLoadMatch, ctrl map[string]any) (NetworkSetting, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return NetworkSetting{}, err
	}
	return typedFrom[NetworkSetting](res), nil
}



func (e *NetworkSettingEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NetworkSettingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NetworkSettingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NetworkSettingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NetworkSettingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
