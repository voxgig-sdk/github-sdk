...
type ProtectedBranchEntity struct {
	name    string
...
func NewProtectedBranchEntity(client *core.GithubSDK, entopts map[string]any) *ProtectedBranchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProtectedBranchEntity) GetName() string { return e.name }
...
func (e *ProtectedBranchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProtectedBranchEntity) Deleted() bool {
	return e.deleted
}


func (e *ProtectedBranchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProtectedBranchEntity(e.client, opts)
}

func (e *ProtectedBranchEntity) Data(args ...any) any {
...
func (e *ProtectedBranchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ProtectedBranch; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProtectedBranchEntity) DataTyped(data ...ProtectedBranch) ProtectedBranch {
	if len(data) > 0 {
		return typedFrom[ProtectedBranch](e.Data(asMap(data[0])))
	}
	return typedFrom[ProtectedBranch](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ProtectedBranch (all fields
// optional at the wire level).
func (e *ProtectedBranchEntity) MatchTyped(match ...ProtectedBranch) ProtectedBranch {
	if len(match) > 0 {
		return typedFrom[ProtectedBranch](e.Match(asMap(match[0])))
	}
	return typedFrom[ProtectedBranch](e.Match())
}
...
func (e *ProtectedBranchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProtectedBranchEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ProtectedBranchEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ProtectedBranchEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *ProtectedBranchEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProtectedBranchUpdateData and returns an ProtectedBranch. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *ProtectedBranchEntity) UpdateTyped(reqdata ProtectedBranchUpdateData, ctrl map[string]any) (ProtectedBranch, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return ProtectedBranch{}, err
	}
	return typedFrom[ProtectedBranch](res), nil
}



func (e *ProtectedBranchEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ProtectedBranchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
