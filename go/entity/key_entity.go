...
func NewKeyEntity(client *core.GithubSDK, entopts map[string]any) *KeyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *KeyEntity) GetName() string { return e.name }
...
func (e *KeyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *KeyEntity) Deleted() bool {
	return e.deleted
}


func (e *KeyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewKeyEntity(e.client, opts)
}

func (e *KeyEntity) Data(args ...any) any {
...
func (e *KeyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Key; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *KeyEntity) DataTyped(data ...Key) Key {
	if len(data) > 0 {
		return typedFrom[Key](e.Data(asMap(data[0])))
	}
	return typedFrom[Key](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Key (all fields
// optional at the wire level).
func (e *KeyEntity) MatchTyped(match ...Key) Key {
	if len(match) > 0 {
		return typedFrom[Key](e.Match(asMap(match[0])))
	}
	return typedFrom[Key](e.Match())
}
...
func (e *KeyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *KeyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// KeyLoadMatch and returns an Key. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *KeyEntity) LoadTyped(reqmatch KeyLoadMatch, ctrl map[string]any) (Key, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Key{}, err
	}
	return typedFrom[Key](res), nil
}




func (e *KeyEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// KeyListMatch and returns []Key. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *KeyEntity) ListTyped(reqmatch KeyListMatch, ctrl map[string]any) ([]Key, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Key](res), nil
}




func (e *KeyEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// KeyCreateData and returns an Key. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *KeyEntity) CreateTyped(reqdata KeyCreateData, ctrl map[string]any) (Key, error) {
...
func (e *KeyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *KeyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *KeyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
