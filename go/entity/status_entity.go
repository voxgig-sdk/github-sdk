...
func NewStatusEntity(client *core.GithubSDK, entopts map[string]any) *StatusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StatusEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StatusListMatch and returns []Status. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *StatusEntity) ListTyped(reqmatch StatusListMatch, ctrl map[string]any) ([]Status, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Status](res), nil
}




func (e *StatusEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// StatusCreateData and returns an Status. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *StatusEntity) CreateTyped(reqdata StatusCreateData, ctrl map[string]any) (Status, error) {
