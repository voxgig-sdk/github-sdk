...
func NewMetarootEntity(client *core.GithubSDK, entopts map[string]any) *MetarootEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MetarootEntity) GetName() string { return e.name }
...
func (e *MetarootEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MetarootEntity) Deleted() bool {
	return e.deleted
}


func (e *MetarootEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMetarootEntity(e.client, opts)
}

func (e *MetarootEntity) Data(args ...any) any {
...
func (e *MetarootEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Metaroot; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MetarootEntity) DataTyped(data ...Metaroot) Metaroot {
	if len(data) > 0 {
		return typedFrom[Metaroot](e.Data(asMap(data[0])))
	}
	return typedFrom[Metaroot](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Metaroot (all fields
// optional at the wire level).
func (e *MetarootEntity) MatchTyped(match ...Metaroot) Metaroot {
	if len(match) > 0 {
		return typedFrom[Metaroot](e.Match(asMap(match[0])))
	}
	return typedFrom[Metaroot](e.Match())
}
...
func (e *MetarootEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MetarootEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MetarootLoadMatch and returns an Metaroot. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MetarootEntity) LoadTyped(reqmatch MetarootLoadMatch, ctrl map[string]any) (Metaroot, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Metaroot{}, err
	}
	return typedFrom[Metaroot](res), nil
}



func (e *MetarootEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MetarootEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MetarootEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MetarootEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MetarootEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
