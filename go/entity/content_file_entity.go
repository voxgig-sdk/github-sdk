...
func NewContentFileEntity(client *core.GithubSDK, entopts map[string]any) *ContentFileEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ContentFileEntity) GetName() string { return e.name }
...
func (e *ContentFileEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ContentFileEntity) Deleted() bool {
	return e.deleted
}


func (e *ContentFileEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewContentFileEntity(e.client, opts)
}

func (e *ContentFileEntity) Data(args ...any) any {
...
func (e *ContentFileEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ContentFile; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ContentFileEntity) DataTyped(data ...ContentFile) ContentFile {
	if len(data) > 0 {
		return typedFrom[ContentFile](e.Data(asMap(data[0])))
	}
	return typedFrom[ContentFile](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ContentFile (all fields
// optional at the wire level).
func (e *ContentFileEntity) MatchTyped(match ...ContentFile) ContentFile {
	if len(match) > 0 {
		return typedFrom[ContentFile](e.Match(asMap(match[0])))
	}
	return typedFrom[ContentFile](e.Match())
}
...
func (e *ContentFileEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ContentFileEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ContentFileLoadMatch and returns an ContentFile. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ContentFileEntity) LoadTyped(reqmatch ContentFileLoadMatch, ctrl map[string]any) (ContentFile, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ContentFile{}, err
	}
	return typedFrom[ContentFile](res), nil
}



func (e *ContentFileEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ContentFileEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ContentFileEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ContentFileEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ContentFileEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
