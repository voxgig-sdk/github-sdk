...
func NewAppEntity(client *core.GithubSDK, entopts map[string]any) *AppEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AppEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AppEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AppListMatch and returns []App. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AppEntity) ListTyped(reqmatch AppListMatch, ctrl map[string]any) ([]App, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[App](res), nil
}




func (e *AppEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AppCreateData and returns an App. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AppEntity) CreateTyped(reqdata AppCreateData, ctrl map[string]any) (App, error) {
...
func (e *AppEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// AppUpdateData and returns an App. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *AppEntity) UpdateTyped(reqdata AppUpdateData, ctrl map[string]any) (App, error) {
...
func (e *AppEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// AppRemoveMatch and returns an App. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *AppEntity) RemoveTyped(reqmatch AppRemoveMatch, ctrl map[string]any) (App, error) {
