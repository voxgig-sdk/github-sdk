...
func NewCloneEntity(client *core.GithubSDK, entopts map[string]any) *CloneEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CloneEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CloneListMatch and returns []Clone. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CloneEntity) ListTyped(reqmatch CloneListMatch, ctrl map[string]any) ([]Clone, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Clone](res), nil
}



func (e *CloneEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
