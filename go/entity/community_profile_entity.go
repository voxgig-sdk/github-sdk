...
type CommunityProfileEntity struct {
	name    string
...
func NewCommunityProfileEntity(client *core.GithubSDK, entopts map[string]any) *CommunityProfileEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CommunityProfileEntity) GetName() string { return e.name }
...
func (e *CommunityProfileEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CommunityProfileEntity) Deleted() bool {
	return e.deleted
}


func (e *CommunityProfileEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCommunityProfileEntity(e.client, opts)
}

func (e *CommunityProfileEntity) Data(args ...any) any {
...
func (e *CommunityProfileEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CommunityProfile; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CommunityProfileEntity) DataTyped(data ...CommunityProfile) CommunityProfile {
	if len(data) > 0 {
		return typedFrom[CommunityProfile](e.Data(asMap(data[0])))
	}
	return typedFrom[CommunityProfile](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CommunityProfile (all fields
// optional at the wire level).
func (e *CommunityProfileEntity) MatchTyped(match ...CommunityProfile) CommunityProfile {
	if len(match) > 0 {
		return typedFrom[CommunityProfile](e.Match(asMap(match[0])))
	}
	return typedFrom[CommunityProfile](e.Match())
}
...
func (e *CommunityProfileEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CommunityProfileEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CommunityProfileLoadMatch and returns an CommunityProfile. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CommunityProfileEntity) LoadTyped(reqmatch CommunityProfileLoadMatch, ctrl map[string]any) (CommunityProfile, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CommunityProfile{}, err
	}
	return typedFrom[CommunityProfile](res), nil
}



func (e *CommunityProfileEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CommunityProfileEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CommunityProfileEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CommunityProfileEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CommunityProfileEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
