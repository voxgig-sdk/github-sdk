...
func NewTeamSimpleEntity(client *core.GithubSDK, entopts map[string]any) *TeamSimpleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TeamSimpleEntity) GetName() string { return e.name }
...
func (e *TeamSimpleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TeamSimpleEntity) Deleted() bool {
	return e.deleted
}


func (e *TeamSimpleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTeamSimpleEntity(e.client, opts)
}

func (e *TeamSimpleEntity) Data(args ...any) any {
...
func (e *TeamSimpleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TeamSimple; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TeamSimpleEntity) DataTyped(data ...TeamSimple) TeamSimple {
	if len(data) > 0 {
		return typedFrom[TeamSimple](e.Data(asMap(data[0])))
	}
	return typedFrom[TeamSimple](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TeamSimple (all fields
// optional at the wire level).
func (e *TeamSimpleEntity) MatchTyped(match ...TeamSimple) TeamSimple {
	if len(match) > 0 {
		return typedFrom[TeamSimple](e.Match(asMap(match[0])))
	}
	return typedFrom[TeamSimple](e.Match())
}
...
func (e *TeamSimpleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TeamSimpleEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TeamSimpleEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TeamSimpleListMatch and returns []TeamSimple. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TeamSimpleEntity) ListTyped(reqmatch TeamSimpleListMatch, ctrl map[string]any) ([]TeamSimple, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TeamSimple](res), nil
}



func (e *TeamSimpleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TeamSimpleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TeamSimpleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TeamSimpleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
