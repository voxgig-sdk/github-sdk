...
func NewShortBlobEntity(client *core.GithubSDK, entopts map[string]any) *ShortBlobEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ShortBlobEntity) GetName() string { return e.name }
...
func (e *ShortBlobEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ShortBlobEntity) Deleted() bool {
	return e.deleted
}


func (e *ShortBlobEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewShortBlobEntity(e.client, opts)
}

func (e *ShortBlobEntity) Data(args ...any) any {
...
func (e *ShortBlobEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ShortBlob; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ShortBlobEntity) DataTyped(data ...ShortBlob) ShortBlob {
	if len(data) > 0 {
		return typedFrom[ShortBlob](e.Data(asMap(data[0])))
	}
	return typedFrom[ShortBlob](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ShortBlob (all fields
// optional at the wire level).
func (e *ShortBlobEntity) MatchTyped(match ...ShortBlob) ShortBlob {
	if len(match) > 0 {
		return typedFrom[ShortBlob](e.Match(asMap(match[0])))
	}
	return typedFrom[ShortBlob](e.Match())
}
...
func (e *ShortBlobEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ShortBlobEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ShortBlobEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ShortBlobEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ShortBlobCreateData and returns an ShortBlob. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ShortBlobEntity) CreateTyped(reqdata ShortBlobCreateData, ctrl map[string]any) (ShortBlob, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return ShortBlob{}, err
	}
	return typedFrom[ShortBlob](res), nil
}



func (e *ShortBlobEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ShortBlobEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ShortBlobEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
