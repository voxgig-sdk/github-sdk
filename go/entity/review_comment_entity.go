...
func NewReviewCommentEntity(client *core.GithubSDK, entopts map[string]any) *ReviewCommentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReviewCommentEntity) GetName() string { return e.name }
...
func (e *ReviewCommentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReviewCommentEntity) Deleted() bool {
	return e.deleted
}


func (e *ReviewCommentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReviewCommentEntity(e.client, opts)
}

func (e *ReviewCommentEntity) Data(args ...any) any {
...
func (e *ReviewCommentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ReviewComment; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReviewCommentEntity) DataTyped(data ...ReviewComment) ReviewComment {
	if len(data) > 0 {
		return typedFrom[ReviewComment](e.Data(asMap(data[0])))
	}
	return typedFrom[ReviewComment](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ReviewComment (all fields
// optional at the wire level).
func (e *ReviewCommentEntity) MatchTyped(match ...ReviewComment) ReviewComment {
	if len(match) > 0 {
		return typedFrom[ReviewComment](e.Match(asMap(match[0])))
	}
	return typedFrom[ReviewComment](e.Match())
}
...
func (e *ReviewCommentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReviewCommentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ReviewCommentEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReviewCommentListMatch and returns []ReviewComment. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ReviewCommentEntity) ListTyped(reqmatch ReviewCommentListMatch, ctrl map[string]any) ([]ReviewComment, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ReviewComment](res), nil
}



func (e *ReviewCommentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReviewCommentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReviewCommentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReviewCommentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
