...
func NewCheckSuiteEntity(client *core.GithubSDK, entopts map[string]any) *CheckSuiteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CheckSuiteEntity) GetName() string { return e.name }
...
func (e *CheckSuiteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CheckSuiteEntity) Deleted() bool {
	return e.deleted
}


func (e *CheckSuiteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCheckSuiteEntity(e.client, opts)
}

func (e *CheckSuiteEntity) Data(args ...any) any {
...
func (e *CheckSuiteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CheckSuite; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CheckSuiteEntity) DataTyped(data ...CheckSuite) CheckSuite {
	if len(data) > 0 {
		return typedFrom[CheckSuite](e.Data(asMap(data[0])))
	}
	return typedFrom[CheckSuite](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CheckSuite (all fields
// optional at the wire level).
func (e *CheckSuiteEntity) MatchTyped(match ...CheckSuite) CheckSuite {
	if len(match) > 0 {
		return typedFrom[CheckSuite](e.Match(asMap(match[0])))
	}
	return typedFrom[CheckSuite](e.Match())
}
...
func (e *CheckSuiteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CheckSuiteEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CheckSuiteLoadMatch and returns an CheckSuite. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CheckSuiteEntity) LoadTyped(reqmatch CheckSuiteLoadMatch, ctrl map[string]any) (CheckSuite, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CheckSuite{}, err
	}
	return typedFrom[CheckSuite](res), nil
}



func (e *CheckSuiteEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CheckSuiteEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CheckSuiteCreateData and returns an CheckSuite. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CheckSuiteEntity) CreateTyped(reqdata CheckSuiteCreateData, ctrl map[string]any) (CheckSuite, error) {
...
func (e *CheckSuiteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CheckSuiteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CheckSuiteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
