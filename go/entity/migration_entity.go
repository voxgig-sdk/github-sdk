...
func NewMigrationEntity(client *core.GithubSDK, entopts map[string]any) *MigrationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MigrationEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MigrationLoadMatch and returns an Migration. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MigrationEntity) LoadTyped(reqmatch MigrationLoadMatch, ctrl map[string]any) (Migration, error) {
...
func (e *MigrationEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// MigrationRemoveMatch and returns an Migration. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *MigrationEntity) RemoveTyped(reqmatch MigrationRemoveMatch, ctrl map[string]any) (Migration, error) {
