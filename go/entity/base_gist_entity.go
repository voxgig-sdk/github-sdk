...
func NewBaseGistEntity(client *core.GithubSDK, entopts map[string]any) *BaseGistEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BaseGistEntity) GetName() string { return e.name }
...
func (e *BaseGistEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BaseGistEntity) Deleted() bool {
	return e.deleted
}


func (e *BaseGistEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBaseGistEntity(e.client, opts)
}

func (e *BaseGistEntity) Data(args ...any) any {
...
func (e *BaseGistEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BaseGist; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BaseGistEntity) DataTyped(data ...BaseGist) BaseGist {
	if len(data) > 0 {
		return typedFrom[BaseGist](e.Data(asMap(data[0])))
	}
	return typedFrom[BaseGist](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BaseGist (all fields
// optional at the wire level).
func (e *BaseGistEntity) MatchTyped(match ...BaseGist) BaseGist {
	if len(match) > 0 {
		return typedFrom[BaseGist](e.Match(asMap(match[0])))
	}
	return typedFrom[BaseGist](e.Match())
}
...
func (e *BaseGistEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BaseGistEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *BaseGistEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BaseGistListMatch and returns []BaseGist. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BaseGistEntity) ListTyped(reqmatch BaseGistListMatch, ctrl map[string]any) ([]BaseGist, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[BaseGist](res), nil
}




func (e *BaseGistEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// BaseGistCreateData and returns an BaseGist. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *BaseGistEntity) CreateTyped(reqdata BaseGistCreateData, ctrl map[string]any) (BaseGist, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return BaseGist{}, err
	}
	return typedFrom[BaseGist](res), nil
}



func (e *BaseGistEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BaseGistEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BaseGistEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
