...
type ContentTrafficEntity struct {
	name    string
...
func NewContentTrafficEntity(client *core.GithubSDK, entopts map[string]any) *ContentTrafficEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ContentTrafficEntity) GetName() string { return e.name }
...
func (e *ContentTrafficEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ContentTrafficEntity) Deleted() bool {
	return e.deleted
}


func (e *ContentTrafficEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewContentTrafficEntity(e.client, opts)
}

func (e *ContentTrafficEntity) Data(args ...any) any {
...
func (e *ContentTrafficEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ContentTraffic; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ContentTrafficEntity) DataTyped(data ...ContentTraffic) ContentTraffic {
	if len(data) > 0 {
		return typedFrom[ContentTraffic](e.Data(asMap(data[0])))
	}
	return typedFrom[ContentTraffic](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ContentTraffic (all fields
// optional at the wire level).
func (e *ContentTrafficEntity) MatchTyped(match ...ContentTraffic) ContentTraffic {
	if len(match) > 0 {
		return typedFrom[ContentTraffic](e.Match(asMap(match[0])))
	}
	return typedFrom[ContentTraffic](e.Match())
}
...
func (e *ContentTrafficEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ContentTrafficEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ContentTrafficEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ContentTrafficListMatch and returns []ContentTraffic. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ContentTrafficEntity) ListTyped(reqmatch ContentTrafficListMatch, ctrl map[string]any) ([]ContentTraffic, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ContentTraffic](res), nil
}



func (e *ContentTrafficEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ContentTrafficEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ContentTrafficEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ContentTrafficEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
