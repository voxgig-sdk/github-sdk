...
func NewGitCommitEntity(client *core.GithubSDK, entopts map[string]any) *GitCommitEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GitCommitEntity) GetName() string { return e.name }
...
func (e *GitCommitEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GitCommitEntity) Deleted() bool {
	return e.deleted
}


func (e *GitCommitEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGitCommitEntity(e.client, opts)
}

func (e *GitCommitEntity) Data(args ...any) any {
...
func (e *GitCommitEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GitCommit; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GitCommitEntity) DataTyped(data ...GitCommit) GitCommit {
	if len(data) > 0 {
		return typedFrom[GitCommit](e.Data(asMap(data[0])))
	}
	return typedFrom[GitCommit](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GitCommit (all fields
// optional at the wire level).
func (e *GitCommitEntity) MatchTyped(match ...GitCommit) GitCommit {
	if len(match) > 0 {
		return typedFrom[GitCommit](e.Match(asMap(match[0])))
	}
	return typedFrom[GitCommit](e.Match())
}
...
func (e *GitCommitEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GitCommitEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GitCommitLoadMatch and returns an GitCommit. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GitCommitEntity) LoadTyped(reqmatch GitCommitLoadMatch, ctrl map[string]any) (GitCommit, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GitCommit{}, err
	}
	return typedFrom[GitCommit](res), nil
}



func (e *GitCommitEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *GitCommitEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// GitCommitCreateData and returns an GitCommit. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GitCommitEntity) CreateTyped(reqdata GitCommitCreateData, ctrl map[string]any) (GitCommit, error) {
...
func (e *GitCommitEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GitCommitEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GitCommitEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
