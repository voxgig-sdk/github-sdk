...
type ActionsSecretEntity struct {
	name    string
...
func NewActionsSecretEntity(client *core.GithubSDK, entopts map[string]any) *ActionsSecretEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ActionsSecretEntity) GetName() string { return e.name }
...
func (e *ActionsSecretEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ActionsSecretEntity) Deleted() bool {
	return e.deleted
}


func (e *ActionsSecretEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewActionsSecretEntity(e.client, opts)
}

func (e *ActionsSecretEntity) Data(args ...any) any {
...
func (e *ActionsSecretEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ActionsSecret; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ActionsSecretEntity) DataTyped(data ...ActionsSecret) ActionsSecret {
	if len(data) > 0 {
		return typedFrom[ActionsSecret](e.Data(asMap(data[0])))
	}
	return typedFrom[ActionsSecret](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ActionsSecret (all fields
// optional at the wire level).
func (e *ActionsSecretEntity) MatchTyped(match ...ActionsSecret) ActionsSecret {
	if len(match) > 0 {
		return typedFrom[ActionsSecret](e.Match(asMap(match[0])))
	}
	return typedFrom[ActionsSecret](e.Match())
}
...
func (e *ActionsSecretEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ActionsSecretEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ActionsSecretLoadMatch and returns an ActionsSecret. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ActionsSecretEntity) LoadTyped(reqmatch ActionsSecretLoadMatch, ctrl map[string]any) (ActionsSecret, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ActionsSecret{}, err
	}
	return typedFrom[ActionsSecret](res), nil
}



func (e *ActionsSecretEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ActionsSecretEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ActionsSecretEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ActionsSecretEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ActionsSecretEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
