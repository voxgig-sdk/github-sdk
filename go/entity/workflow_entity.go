...
func NewWorkflowEntity(client *core.GithubSDK, entopts map[string]any) *WorkflowEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WorkflowEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// WorkflowUpdateData and returns an Workflow. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *WorkflowEntity) UpdateTyped(reqdata WorkflowUpdateData, ctrl map[string]any) (Workflow, error) {
