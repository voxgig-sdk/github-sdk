...
func NewRuleSuiteEntity(client *core.GithubSDK, entopts map[string]any) *RuleSuiteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RuleSuiteEntity) GetName() string { return e.name }
...
func (e *RuleSuiteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RuleSuiteEntity) Deleted() bool {
	return e.deleted
}


func (e *RuleSuiteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRuleSuiteEntity(e.client, opts)
}

func (e *RuleSuiteEntity) Data(args ...any) any {
...
func (e *RuleSuiteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RuleSuite; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RuleSuiteEntity) DataTyped(data ...RuleSuite) RuleSuite {
	if len(data) > 0 {
		return typedFrom[RuleSuite](e.Data(asMap(data[0])))
	}
	return typedFrom[RuleSuite](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RuleSuite (all fields
// optional at the wire level).
func (e *RuleSuiteEntity) MatchTyped(match ...RuleSuite) RuleSuite {
	if len(match) > 0 {
		return typedFrom[RuleSuite](e.Match(asMap(match[0])))
	}
	return typedFrom[RuleSuite](e.Match())
}
...
func (e *RuleSuiteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RuleSuiteEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RuleSuiteLoadMatch and returns an RuleSuite. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RuleSuiteEntity) LoadTyped(reqmatch RuleSuiteLoadMatch, ctrl map[string]any) (RuleSuite, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return RuleSuite{}, err
	}
	return typedFrom[RuleSuite](res), nil
}




func (e *RuleSuiteEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// RuleSuiteListMatch and returns []RuleSuite. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RuleSuiteEntity) ListTyped(reqmatch RuleSuiteListMatch, ctrl map[string]any) ([]RuleSuite, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[RuleSuite](res), nil
}



func (e *RuleSuiteEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RuleSuiteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RuleSuiteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RuleSuiteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
