...
func NewFollowingEntity(client *core.GithubSDK, entopts map[string]any) *FollowingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FollowingEntity) GetName() string { return e.name }
...
func (e *FollowingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FollowingEntity) Deleted() bool {
	return e.deleted
}


func (e *FollowingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFollowingEntity(e.client, opts)
}

func (e *FollowingEntity) Data(args ...any) any {
...
func (e *FollowingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Following; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FollowingEntity) DataTyped(data ...Following) Following {
	if len(data) > 0 {
		return typedFrom[Following](e.Data(asMap(data[0])))
	}
	return typedFrom[Following](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Following (all fields
// optional at the wire level).
func (e *FollowingEntity) MatchTyped(match ...Following) Following {
	if len(match) > 0 {
		return typedFrom[Following](e.Match(asMap(match[0])))
	}
	return typedFrom[Following](e.Match())
}
...
func (e *FollowingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FollowingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *FollowingEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FollowingListMatch and returns []Following. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FollowingEntity) ListTyped(reqmatch FollowingListMatch, ctrl map[string]any) ([]Following, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Following](res), nil
}



func (e *FollowingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FollowingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FollowingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FollowingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
