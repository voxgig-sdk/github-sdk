...
func NewReactionEntity(client *core.GithubSDK, entopts map[string]any) *ReactionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReactionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *ReactionEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// ReactionRemoveMatch and returns an Reaction. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ReactionEntity) RemoveTyped(reqmatch ReactionRemoveMatch, ctrl map[string]any) (Reaction, error) {
