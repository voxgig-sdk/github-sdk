...
type SecretScanningEntity struct {
	name    string
...
func NewSecretScanningEntity(client *core.GithubSDK, entopts map[string]any) *SecretScanningEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SecretScanningEntity) GetName() string { return e.name }
...
func (e *SecretScanningEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SecretScanningEntity) Deleted() bool {
	return e.deleted
}


func (e *SecretScanningEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSecretScanningEntity(e.client, opts)
}

func (e *SecretScanningEntity) Data(args ...any) any {
...
func (e *SecretScanningEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SecretScanning; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SecretScanningEntity) DataTyped(data ...SecretScanning) SecretScanning {
	if len(data) > 0 {
		return typedFrom[SecretScanning](e.Data(asMap(data[0])))
	}
	return typedFrom[SecretScanning](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SecretScanning (all fields
// optional at the wire level).
func (e *SecretScanningEntity) MatchTyped(match ...SecretScanning) SecretScanning {
	if len(match) > 0 {
		return typedFrom[SecretScanning](e.Match(asMap(match[0])))
	}
	return typedFrom[SecretScanning](e.Match())
}
...
func (e *SecretScanningEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SecretScanningEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SecretScanningEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SecretScanningEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *SecretScanningEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SecretScanningUpdateData and returns an SecretScanning. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *SecretScanningEntity) UpdateTyped(reqdata SecretScanningUpdateData, ctrl map[string]any) (SecretScanning, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return SecretScanning{}, err
	}
	return typedFrom[SecretScanning](res), nil
}



func (e *SecretScanningEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SecretScanningEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
