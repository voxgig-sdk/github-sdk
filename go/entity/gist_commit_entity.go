...
func NewGistCommitEntity(client *core.GithubSDK, entopts map[string]any) *GistCommitEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GistCommitEntity) GetName() string { return e.name }
...
func (e *GistCommitEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GistCommitEntity) Deleted() bool {
	return e.deleted
}


func (e *GistCommitEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGistCommitEntity(e.client, opts)
}

func (e *GistCommitEntity) Data(args ...any) any {
...
func (e *GistCommitEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GistCommit; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GistCommitEntity) DataTyped(data ...GistCommit) GistCommit {
	if len(data) > 0 {
		return typedFrom[GistCommit](e.Data(asMap(data[0])))
	}
	return typedFrom[GistCommit](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GistCommit (all fields
// optional at the wire level).
func (e *GistCommitEntity) MatchTyped(match ...GistCommit) GistCommit {
	if len(match) > 0 {
		return typedFrom[GistCommit](e.Match(asMap(match[0])))
	}
	return typedFrom[GistCommit](e.Match())
}
...
func (e *GistCommitEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GistCommitEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GistCommitEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GistCommitListMatch and returns []GistCommit. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GistCommitEntity) ListTyped(reqmatch GistCommitListMatch, ctrl map[string]any) ([]GistCommit, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GistCommit](res), nil
}



func (e *GistCommitEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GistCommitEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GistCommitEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GistCommitEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
