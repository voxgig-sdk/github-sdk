...
func NewApiOverviewEntity(client *core.GithubSDK, entopts map[string]any) *ApiOverviewEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ApiOverviewEntity) GetName() string { return e.name }
...
func (e *ApiOverviewEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ApiOverviewEntity) Deleted() bool {
	return e.deleted
}


func (e *ApiOverviewEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewApiOverviewEntity(e.client, opts)
}

func (e *ApiOverviewEntity) Data(args ...any) any {
...
func (e *ApiOverviewEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ApiOverview; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ApiOverviewEntity) DataTyped(data ...ApiOverview) ApiOverview {
	if len(data) > 0 {
		return typedFrom[ApiOverview](e.Data(asMap(data[0])))
	}
	return typedFrom[ApiOverview](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ApiOverview (all fields
// optional at the wire level).
func (e *ApiOverviewEntity) MatchTyped(match ...ApiOverview) ApiOverview {
	if len(match) > 0 {
		return typedFrom[ApiOverview](e.Match(asMap(match[0])))
	}
	return typedFrom[ApiOverview](e.Match())
}
...
func (e *ApiOverviewEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ApiOverviewEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ApiOverviewEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ApiOverviewListMatch and returns []ApiOverview. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ApiOverviewEntity) ListTyped(reqmatch ApiOverviewListMatch, ctrl map[string]any) ([]ApiOverview, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ApiOverview](res), nil
}



func (e *ApiOverviewEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ApiOverviewEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ApiOverviewEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ApiOverviewEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
