...
func NewWorkflowRunEntity(client *core.GithubSDK, entopts map[string]any) *WorkflowRunEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WorkflowRunEntity) GetName() string { return e.name }
...
func (e *WorkflowRunEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WorkflowRunEntity) Deleted() bool {
	return e.deleted
}


func (e *WorkflowRunEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWorkflowRunEntity(e.client, opts)
}

func (e *WorkflowRunEntity) Data(args ...any) any {
...
func (e *WorkflowRunEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WorkflowRun; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WorkflowRunEntity) DataTyped(data ...WorkflowRun) WorkflowRun {
	if len(data) > 0 {
		return typedFrom[WorkflowRun](e.Data(asMap(data[0])))
	}
	return typedFrom[WorkflowRun](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WorkflowRun (all fields
// optional at the wire level).
func (e *WorkflowRunEntity) MatchTyped(match ...WorkflowRun) WorkflowRun {
	if len(match) > 0 {
		return typedFrom[WorkflowRun](e.Match(asMap(match[0])))
	}
	return typedFrom[WorkflowRun](e.Match())
}
...
func (e *WorkflowRunEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WorkflowRunEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WorkflowRunLoadMatch and returns an WorkflowRun. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WorkflowRunEntity) LoadTyped(reqmatch WorkflowRunLoadMatch, ctrl map[string]any) (WorkflowRun, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return WorkflowRun{}, err
	}
	return typedFrom[WorkflowRun](res), nil
}



func (e *WorkflowRunEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *WorkflowRunEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// WorkflowRunCreateData and returns an WorkflowRun. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *WorkflowRunEntity) CreateTyped(reqdata WorkflowRunCreateData, ctrl map[string]any) (WorkflowRun, error) {
...
func (e *WorkflowRunEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WorkflowRunEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WorkflowRunEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
