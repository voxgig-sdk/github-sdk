...
func NewCollaboratorEntity(client *core.GithubSDK, entopts map[string]any) *CollaboratorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CollaboratorEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CollaboratorListMatch and returns []Collaborator. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CollaboratorEntity) ListTyped(reqmatch CollaboratorListMatch, ctrl map[string]any) ([]Collaborator, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Collaborator](res), nil
}



func (e *CollaboratorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
