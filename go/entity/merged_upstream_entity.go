...
type MergedUpstreamEntity struct {
	name    string
...
func NewMergedUpstreamEntity(client *core.GithubSDK, entopts map[string]any) *MergedUpstreamEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &MergedUpstreamEntity{
		name:    "merged_upstream",
		client:  client,
...
func (e *MergedUpstreamEntity) GetName() string { return e.name }
...
func (e *MergedUpstreamEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MergedUpstreamEntity) Deleted() bool {
	return e.deleted
}


func (e *MergedUpstreamEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMergedUpstreamEntity(e.client, opts)
}

func (e *MergedUpstreamEntity) Data(args ...any) any {
...
func (e *MergedUpstreamEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MergedUpstream; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MergedUpstreamEntity) DataTyped(data ...MergedUpstream) MergedUpstream {
	if len(data) > 0 {
		return typedFrom[MergedUpstream](e.Data(asMap(data[0])))
	}
	return typedFrom[MergedUpstream](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MergedUpstream (all fields
// optional at the wire level).
func (e *MergedUpstreamEntity) MatchTyped(match ...MergedUpstream) MergedUpstream {
	if len(match) > 0 {
		return typedFrom[MergedUpstream](e.Match(asMap(match[0])))
	}
	return typedFrom[MergedUpstream](e.Match())
}
...
func (e *MergedUpstreamEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MergedUpstreamEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *MergedUpstreamEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *MergedUpstreamEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MergedUpstreamCreateData and returns an MergedUpstream. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *MergedUpstreamEntity) CreateTyped(reqdata MergedUpstreamCreateData, ctrl map[string]any) (MergedUpstream, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return MergedUpstream{}, err
	}
	return typedFrom[MergedUpstream](res), nil
}



func (e *MergedUpstreamEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MergedUpstreamEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MergedUpstreamEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
