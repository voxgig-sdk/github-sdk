...
func NewGistSimpleEntity(client *core.GithubSDK, entopts map[string]any) *GistSimpleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GistSimpleEntity) GetName() string { return e.name }
...
func (e *GistSimpleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GistSimpleEntity) Deleted() bool {
	return e.deleted
}


func (e *GistSimpleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGistSimpleEntity(e.client, opts)
}

func (e *GistSimpleEntity) Data(args ...any) any {
...
func (e *GistSimpleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GistSimple; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GistSimpleEntity) DataTyped(data ...GistSimple) GistSimple {
	if len(data) > 0 {
		return typedFrom[GistSimple](e.Data(asMap(data[0])))
	}
	return typedFrom[GistSimple](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GistSimple (all fields
// optional at the wire level).
func (e *GistSimpleEntity) MatchTyped(match ...GistSimple) GistSimple {
	if len(match) > 0 {
		return typedFrom[GistSimple](e.Match(asMap(match[0])))
	}
	return typedFrom[GistSimple](e.Match())
}
...
func (e *GistSimpleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GistSimpleEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GistSimpleEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GistSimpleListMatch and returns []GistSimple. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GistSimpleEntity) ListTyped(reqmatch GistSimpleListMatch, ctrl map[string]any) ([]GistSimple, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GistSimple](res), nil
}



func (e *GistSimpleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GistSimpleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GistSimpleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GistSimpleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
