...
type BranchProtectionEntity struct {
	name    string
...
func NewBranchProtectionEntity(client *core.GithubSDK, entopts map[string]any) *BranchProtectionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BranchProtectionEntity) GetName() string { return e.name }
...
func (e *BranchProtectionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BranchProtectionEntity) Deleted() bool {
	return e.deleted
}


func (e *BranchProtectionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBranchProtectionEntity(e.client, opts)
}

func (e *BranchProtectionEntity) Data(args ...any) any {
...
func (e *BranchProtectionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BranchProtection; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BranchProtectionEntity) DataTyped(data ...BranchProtection) BranchProtection {
	if len(data) > 0 {
		return typedFrom[BranchProtection](e.Data(asMap(data[0])))
	}
	return typedFrom[BranchProtection](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BranchProtection (all fields
// optional at the wire level).
func (e *BranchProtectionEntity) MatchTyped(match ...BranchProtection) BranchProtection {
	if len(match) > 0 {
		return typedFrom[BranchProtection](e.Match(asMap(match[0])))
	}
	return typedFrom[BranchProtection](e.Match())
}
...
func (e *BranchProtectionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BranchProtectionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BranchProtectionLoadMatch and returns an BranchProtection. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BranchProtectionEntity) LoadTyped(reqmatch BranchProtectionLoadMatch, ctrl map[string]any) (BranchProtection, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return BranchProtection{}, err
	}
	return typedFrom[BranchProtection](res), nil
}



func (e *BranchProtectionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BranchProtectionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BranchProtectionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BranchProtectionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BranchProtectionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
