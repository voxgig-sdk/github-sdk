...
func NewArtifactEntity(client *core.GithubSDK, entopts map[string]any) *ArtifactEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ArtifactEntity) GetName() string { return e.name }
...
func (e *ArtifactEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ArtifactEntity) Deleted() bool {
	return e.deleted
}


func (e *ArtifactEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewArtifactEntity(e.client, opts)
}

func (e *ArtifactEntity) Data(args ...any) any {
...
func (e *ArtifactEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Artifact; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ArtifactEntity) DataTyped(data ...Artifact) Artifact {
	if len(data) > 0 {
		return typedFrom[Artifact](e.Data(asMap(data[0])))
	}
	return typedFrom[Artifact](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Artifact (all fields
// optional at the wire level).
func (e *ArtifactEntity) MatchTyped(match ...Artifact) Artifact {
	if len(match) > 0 {
		return typedFrom[Artifact](e.Match(asMap(match[0])))
	}
	return typedFrom[Artifact](e.Match())
}
...
func (e *ArtifactEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ArtifactEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ArtifactLoadMatch and returns an Artifact. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ArtifactEntity) LoadTyped(reqmatch ArtifactLoadMatch, ctrl map[string]any) (Artifact, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Artifact{}, err
	}
	return typedFrom[Artifact](res), nil
}



func (e *ArtifactEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ArtifactEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ArtifactEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ArtifactEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ArtifactEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
