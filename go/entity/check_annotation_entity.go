...
type CheckAnnotationEntity struct {
	name    string
...
func NewCheckAnnotationEntity(client *core.GithubSDK, entopts map[string]any) *CheckAnnotationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &CheckAnnotationEntity{
		name:    "check_annotation",
		client:  client,
...
func (e *CheckAnnotationEntity) GetName() string { return e.name }
...
func (e *CheckAnnotationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CheckAnnotationEntity) Deleted() bool {
	return e.deleted
}


func (e *CheckAnnotationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCheckAnnotationEntity(e.client, opts)
}

func (e *CheckAnnotationEntity) Data(args ...any) any {
...
func (e *CheckAnnotationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CheckAnnotation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CheckAnnotationEntity) DataTyped(data ...CheckAnnotation) CheckAnnotation {
	if len(data) > 0 {
		return typedFrom[CheckAnnotation](e.Data(asMap(data[0])))
	}
	return typedFrom[CheckAnnotation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CheckAnnotation (all fields
// optional at the wire level).
func (e *CheckAnnotationEntity) MatchTyped(match ...CheckAnnotation) CheckAnnotation {
	if len(match) > 0 {
		return typedFrom[CheckAnnotation](e.Match(asMap(match[0])))
	}
	return typedFrom[CheckAnnotation](e.Match())
}
...
func (e *CheckAnnotationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CheckAnnotationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CheckAnnotationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CheckAnnotationListMatch and returns []CheckAnnotation. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CheckAnnotationEntity) ListTyped(reqmatch CheckAnnotationListMatch, ctrl map[string]any) ([]CheckAnnotation, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CheckAnnotation](res), nil
}



func (e *CheckAnnotationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CheckAnnotationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CheckAnnotationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CheckAnnotationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
