...
func NewPageBuildEntity(client *core.GithubSDK, entopts map[string]any) *PageBuildEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PageBuildEntity) GetName() string { return e.name }
...
func (e *PageBuildEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PageBuildEntity) Deleted() bool {
	return e.deleted
}


func (e *PageBuildEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPageBuildEntity(e.client, opts)
}

func (e *PageBuildEntity) Data(args ...any) any {
...
func (e *PageBuildEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PageBuild; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PageBuildEntity) DataTyped(data ...PageBuild) PageBuild {
	if len(data) > 0 {
		return typedFrom[PageBuild](e.Data(asMap(data[0])))
	}
	return typedFrom[PageBuild](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PageBuild (all fields
// optional at the wire level).
func (e *PageBuildEntity) MatchTyped(match ...PageBuild) PageBuild {
	if len(match) > 0 {
		return typedFrom[PageBuild](e.Match(asMap(match[0])))
	}
	return typedFrom[PageBuild](e.Match())
}
...
func (e *PageBuildEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PageBuildEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PageBuildLoadMatch and returns an PageBuild. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PageBuildEntity) LoadTyped(reqmatch PageBuildLoadMatch, ctrl map[string]any) (PageBuild, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PageBuild{}, err
	}
	return typedFrom[PageBuild](res), nil
}




func (e *PageBuildEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PageBuildListMatch and returns []PageBuild. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PageBuildEntity) ListTyped(reqmatch PageBuildListMatch, ctrl map[string]any) ([]PageBuild, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PageBuild](res), nil
}



func (e *PageBuildEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PageBuildEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PageBuildEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PageBuildEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
