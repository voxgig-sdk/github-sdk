...
func NewRemoveEntity(client *core.GithubSDK, entopts map[string]any) *RemoveEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RemoveEntity) GetName() string { return e.name }
...
func (e *RemoveEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RemoveEntity) Deleted() bool {
	return e.deleted
}


func (e *RemoveEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRemoveEntity(e.client, opts)
}

func (e *RemoveEntity) Data(args ...any) any {
...
func (e *RemoveEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Remove; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RemoveEntity) DataTyped(data ...Remove) Remove {
	if len(data) > 0 {
		return typedFrom[Remove](e.Data(asMap(data[0])))
	}
	return typedFrom[Remove](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Remove (all fields
// optional at the wire level).
func (e *RemoveEntity) MatchTyped(match ...Remove) Remove {
	if len(match) > 0 {
		return typedFrom[Remove](e.Match(asMap(match[0])))
	}
	return typedFrom[Remove](e.Match())
}
...
func (e *RemoveEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RemoveEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RemoveEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *RemoveEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RemoveCreateData and returns an Remove. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *RemoveEntity) CreateTyped(reqdata RemoveCreateData, ctrl map[string]any) (Remove, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Remove{}, err
	}
	return typedFrom[Remove](res), nil
}



func (e *RemoveEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RemoveEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RemoveEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
