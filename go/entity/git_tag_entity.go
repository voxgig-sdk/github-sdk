...
func NewGitTagEntity(client *core.GithubSDK, entopts map[string]any) *GitTagEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GitTagEntity) GetName() string { return e.name }
...
func (e *GitTagEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GitTagEntity) Deleted() bool {
	return e.deleted
}


func (e *GitTagEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGitTagEntity(e.client, opts)
}

func (e *GitTagEntity) Data(args ...any) any {
...
func (e *GitTagEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GitTag; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GitTagEntity) DataTyped(data ...GitTag) GitTag {
	if len(data) > 0 {
		return typedFrom[GitTag](e.Data(asMap(data[0])))
	}
	return typedFrom[GitTag](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GitTag (all fields
// optional at the wire level).
func (e *GitTagEntity) MatchTyped(match ...GitTag) GitTag {
	if len(match) > 0 {
		return typedFrom[GitTag](e.Match(asMap(match[0])))
	}
	return typedFrom[GitTag](e.Match())
}
...
func (e *GitTagEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GitTagEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GitTagLoadMatch and returns an GitTag. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GitTagEntity) LoadTyped(reqmatch GitTagLoadMatch, ctrl map[string]any) (GitTag, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GitTag{}, err
	}
	return typedFrom[GitTag](res), nil
}



func (e *GitTagEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *GitTagEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// GitTagCreateData and returns an GitTag. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GitTagEntity) CreateTyped(reqdata GitTagCreateData, ctrl map[string]any) (GitTag, error) {
...
func (e *GitTagEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GitTagEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GitTagEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
