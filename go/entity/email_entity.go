...
func NewEmailEntity(client *core.GithubSDK, entopts map[string]any) *EmailEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EmailEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// EmailCreateData and returns an Email. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EmailEntity) CreateTyped(reqdata EmailCreateData, ctrl map[string]any) (Email, error) {
...
func (e *EmailEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// EmailUpdateData and returns an Email. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *EmailEntity) UpdateTyped(reqdata EmailUpdateData, ctrl map[string]any) (Email, error) {
