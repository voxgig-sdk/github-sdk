...
func NewGitRefEntity(client *core.GithubSDK, entopts map[string]any) *GitRefEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GitRefEntity) GetName() string { return e.name }
...
func (e *GitRefEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GitRefEntity) Deleted() bool {
	return e.deleted
}


func (e *GitRefEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGitRefEntity(e.client, opts)
}

func (e *GitRefEntity) Data(args ...any) any {
...
func (e *GitRefEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GitRef; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GitRefEntity) DataTyped(data ...GitRef) GitRef {
	if len(data) > 0 {
		return typedFrom[GitRef](e.Data(asMap(data[0])))
	}
	return typedFrom[GitRef](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GitRef (all fields
// optional at the wire level).
func (e *GitRefEntity) MatchTyped(match ...GitRef) GitRef {
	if len(match) > 0 {
		return typedFrom[GitRef](e.Match(asMap(match[0])))
	}
	return typedFrom[GitRef](e.Match())
}
...
func (e *GitRefEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GitRefEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GitRefLoadMatch and returns an GitRef. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GitRefEntity) LoadTyped(reqmatch GitRefLoadMatch, ctrl map[string]any) (GitRef, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GitRef{}, err
	}
	return typedFrom[GitRef](res), nil
}



func (e *GitRefEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *GitRefEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// GitRefCreateData and returns an GitRef. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GitRefEntity) CreateTyped(reqdata GitRefCreateData, ctrl map[string]any) (GitRef, error) {
...
func (e *GitRefEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// GitRefUpdateData and returns an GitRef. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *GitRefEntity) UpdateTyped(reqdata GitRefUpdateData, ctrl map[string]any) (GitRef, error) {
...
func (e *GitRefEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GitRefEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
