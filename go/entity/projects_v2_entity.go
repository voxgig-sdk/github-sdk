...
func NewProjectsV2Entity(client *core.GithubSDK, entopts map[string]any) *ProjectsV2Entity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProjectsV2Entity) GetName() string { return e.name }
...
func (e *ProjectsV2Entity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProjectsV2Entity) Deleted() bool {
	return e.deleted
}


func (e *ProjectsV2Entity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProjectsV2Entity(e.client, opts)
}

func (e *ProjectsV2Entity) Data(args ...any) any {
...
func (e *ProjectsV2Entity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ProjectsV2; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProjectsV2Entity) DataTyped(data ...ProjectsV2) ProjectsV2 {
	if len(data) > 0 {
		return typedFrom[ProjectsV2](e.Data(asMap(data[0])))
	}
	return typedFrom[ProjectsV2](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ProjectsV2 (all fields
// optional at the wire level).
func (e *ProjectsV2Entity) MatchTyped(match ...ProjectsV2) ProjectsV2 {
	if len(match) > 0 {
		return typedFrom[ProjectsV2](e.Match(asMap(match[0])))
	}
	return typedFrom[ProjectsV2](e.Match())
}
...
func (e *ProjectsV2Entity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProjectsV2Entity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProjectsV2LoadMatch and returns an ProjectsV2. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ProjectsV2Entity) LoadTyped(reqmatch ProjectsV2LoadMatch, ctrl map[string]any) (ProjectsV2, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ProjectsV2{}, err
	}
	return typedFrom[ProjectsV2](res), nil
}




func (e *ProjectsV2Entity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ProjectsV2ListMatch and returns []ProjectsV2. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ProjectsV2Entity) ListTyped(reqmatch ProjectsV2ListMatch, ctrl map[string]any) ([]ProjectsV2, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ProjectsV2](res), nil
}



func (e *ProjectsV2Entity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ProjectsV2Entity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ProjectsV2Entity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ProjectsV2Entity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
