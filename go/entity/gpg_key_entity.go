...
func NewGpgKeyEntity(client *core.GithubSDK, entopts map[string]any) *GpgKeyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GpgKeyEntity) GetName() string { return e.name }
...
func (e *GpgKeyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GpgKeyEntity) Deleted() bool {
	return e.deleted
}


func (e *GpgKeyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGpgKeyEntity(e.client, opts)
}

func (e *GpgKeyEntity) Data(args ...any) any {
...
func (e *GpgKeyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GpgKey; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GpgKeyEntity) DataTyped(data ...GpgKey) GpgKey {
	if len(data) > 0 {
		return typedFrom[GpgKey](e.Data(asMap(data[0])))
	}
	return typedFrom[GpgKey](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GpgKey (all fields
// optional at the wire level).
func (e *GpgKeyEntity) MatchTyped(match ...GpgKey) GpgKey {
	if len(match) > 0 {
		return typedFrom[GpgKey](e.Match(asMap(match[0])))
	}
	return typedFrom[GpgKey](e.Match())
}
...
func (e *GpgKeyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GpgKeyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GpgKeyLoadMatch and returns an GpgKey. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GpgKeyEntity) LoadTyped(reqmatch GpgKeyLoadMatch, ctrl map[string]any) (GpgKey, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GpgKey{}, err
	}
	return typedFrom[GpgKey](res), nil
}




func (e *GpgKeyEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// GpgKeyListMatch and returns []GpgKey. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GpgKeyEntity) ListTyped(reqmatch GpgKeyListMatch, ctrl map[string]any) ([]GpgKey, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GpgKey](res), nil
}




func (e *GpgKeyEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// GpgKeyCreateData and returns an GpgKey. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GpgKeyEntity) CreateTyped(reqdata GpgKeyCreateData, ctrl map[string]any) (GpgKey, error) {
...
func (e *GpgKeyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GpgKeyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GpgKeyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
