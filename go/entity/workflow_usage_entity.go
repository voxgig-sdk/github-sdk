...
type WorkflowUsageEntity struct {
	name    string
...
func NewWorkflowUsageEntity(client *core.GithubSDK, entopts map[string]any) *WorkflowUsageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WorkflowUsageEntity) GetName() string { return e.name }
...
func (e *WorkflowUsageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WorkflowUsageEntity) Deleted() bool {
	return e.deleted
}


func (e *WorkflowUsageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWorkflowUsageEntity(e.client, opts)
}

func (e *WorkflowUsageEntity) Data(args ...any) any {
...
func (e *WorkflowUsageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WorkflowUsage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WorkflowUsageEntity) DataTyped(data ...WorkflowUsage) WorkflowUsage {
	if len(data) > 0 {
		return typedFrom[WorkflowUsage](e.Data(asMap(data[0])))
	}
	return typedFrom[WorkflowUsage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WorkflowUsage (all fields
// optional at the wire level).
func (e *WorkflowUsageEntity) MatchTyped(match ...WorkflowUsage) WorkflowUsage {
	if len(match) > 0 {
		return typedFrom[WorkflowUsage](e.Match(asMap(match[0])))
	}
	return typedFrom[WorkflowUsage](e.Match())
}
...
func (e *WorkflowUsageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WorkflowUsageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WorkflowUsageLoadMatch and returns an WorkflowUsage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WorkflowUsageEntity) LoadTyped(reqmatch WorkflowUsageLoadMatch, ctrl map[string]any) (WorkflowUsage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return WorkflowUsage{}, err
	}
	return typedFrom[WorkflowUsage](res), nil
}



func (e *WorkflowUsageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WorkflowUsageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WorkflowUsageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WorkflowUsageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WorkflowUsageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
