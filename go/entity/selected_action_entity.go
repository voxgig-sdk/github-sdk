...
type SelectedActionEntity struct {
	name    string
...
func NewSelectedActionEntity(client *core.GithubSDK, entopts map[string]any) *SelectedActionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SelectedActionEntity) GetName() string { return e.name }
...
func (e *SelectedActionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SelectedActionEntity) Deleted() bool {
	return e.deleted
}


func (e *SelectedActionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSelectedActionEntity(e.client, opts)
}

func (e *SelectedActionEntity) Data(args ...any) any {
...
func (e *SelectedActionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SelectedAction; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SelectedActionEntity) DataTyped(data ...SelectedAction) SelectedAction {
	if len(data) > 0 {
		return typedFrom[SelectedAction](e.Data(asMap(data[0])))
	}
	return typedFrom[SelectedAction](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SelectedAction (all fields
// optional at the wire level).
func (e *SelectedActionEntity) MatchTyped(match ...SelectedAction) SelectedAction {
	if len(match) > 0 {
		return typedFrom[SelectedAction](e.Match(asMap(match[0])))
	}
	return typedFrom[SelectedAction](e.Match())
}
...
func (e *SelectedActionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SelectedActionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SelectedActionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SelectedActionListMatch and returns []SelectedAction. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SelectedActionEntity) ListTyped(reqmatch SelectedActionListMatch, ctrl map[string]any) ([]SelectedAction, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[SelectedAction](res), nil
}



func (e *SelectedActionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SelectedActionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SelectedActionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SelectedActionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
