...
func NewOrganizationRoleEntity(client *core.GithubSDK, entopts map[string]any) *OrganizationRoleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OrganizationRoleEntity) GetName() string { return e.name }
...
func (e *OrganizationRoleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OrganizationRoleEntity) Deleted() bool {
	return e.deleted
}


func (e *OrganizationRoleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOrganizationRoleEntity(e.client, opts)
}

func (e *OrganizationRoleEntity) Data(args ...any) any {
...
func (e *OrganizationRoleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OrganizationRole; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OrganizationRoleEntity) DataTyped(data ...OrganizationRole) OrganizationRole {
	if len(data) > 0 {
		return typedFrom[OrganizationRole](e.Data(asMap(data[0])))
	}
	return typedFrom[OrganizationRole](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OrganizationRole (all fields
// optional at the wire level).
func (e *OrganizationRoleEntity) MatchTyped(match ...OrganizationRole) OrganizationRole {
	if len(match) > 0 {
		return typedFrom[OrganizationRole](e.Match(asMap(match[0])))
	}
	return typedFrom[OrganizationRole](e.Match())
}
...
func (e *OrganizationRoleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OrganizationRoleEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OrganizationRoleLoadMatch and returns an OrganizationRole. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *OrganizationRoleEntity) LoadTyped(reqmatch OrganizationRoleLoadMatch, ctrl map[string]any) (OrganizationRole, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return OrganizationRole{}, err
	}
	return typedFrom[OrganizationRole](res), nil
}



func (e *OrganizationRoleEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *OrganizationRoleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OrganizationRoleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OrganizationRoleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OrganizationRoleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
