...
func NewViewEntity(client *core.GithubSDK, entopts map[string]any) *ViewEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ViewEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ViewEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ViewListMatch and returns []View. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ViewEntity) ListTyped(reqmatch ViewListMatch, ctrl map[string]any) ([]View, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[View](res), nil
}
