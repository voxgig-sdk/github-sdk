...
func NewRepositoryEntity(client *core.GithubSDK, entopts map[string]any) *RepositoryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RepositoryEntity) GetName() string { return e.name }
...
func (e *RepositoryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RepositoryEntity) Deleted() bool {
	return e.deleted
}


func (e *RepositoryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRepositoryEntity(e.client, opts)
}

func (e *RepositoryEntity) Data(args ...any) any {
...
func (e *RepositoryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Repository; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RepositoryEntity) DataTyped(data ...Repository) Repository {
	if len(data) > 0 {
		return typedFrom[Repository](e.Data(asMap(data[0])))
	}
	return typedFrom[Repository](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Repository (all fields
// optional at the wire level).
func (e *RepositoryEntity) MatchTyped(match ...Repository) Repository {
	if len(match) > 0 {
		return typedFrom[Repository](e.Match(asMap(match[0])))
	}
	return typedFrom[Repository](e.Match())
}
...
func (e *RepositoryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RepositoryEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RepositoryEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RepositoryListMatch and returns []Repository. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RepositoryEntity) ListTyped(reqmatch RepositoryListMatch, ctrl map[string]any) ([]Repository, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Repository](res), nil
}



func (e *RepositoryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RepositoryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RepositoryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RepositoryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
