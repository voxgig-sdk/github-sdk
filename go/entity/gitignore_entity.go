...
func NewGitignoreEntity(client *core.GithubSDK, entopts map[string]any) *GitignoreEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GitignoreEntity) GetName() string { return e.name }
...
func (e *GitignoreEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GitignoreEntity) Deleted() bool {
	return e.deleted
}


func (e *GitignoreEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGitignoreEntity(e.client, opts)
}

func (e *GitignoreEntity) Data(args ...any) any {
...
func (e *GitignoreEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Gitignore; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GitignoreEntity) DataTyped(data ...Gitignore) Gitignore {
	if len(data) > 0 {
		return typedFrom[Gitignore](e.Data(asMap(data[0])))
	}
	return typedFrom[Gitignore](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Gitignore (all fields
// optional at the wire level).
func (e *GitignoreEntity) MatchTyped(match ...Gitignore) Gitignore {
	if len(match) > 0 {
		return typedFrom[Gitignore](e.Match(asMap(match[0])))
	}
	return typedFrom[Gitignore](e.Match())
}
...
func (e *GitignoreEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GitignoreEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GitignoreEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GitignoreListMatch and returns []Gitignore. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GitignoreEntity) ListTyped(reqmatch GitignoreListMatch, ctrl map[string]any) ([]Gitignore, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Gitignore](res), nil
}



func (e *GitignoreEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GitignoreEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GitignoreEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GitignoreEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
