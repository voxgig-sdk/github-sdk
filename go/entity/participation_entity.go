...
type ParticipationEntity struct {
	name    string
...
func NewParticipationEntity(client *core.GithubSDK, entopts map[string]any) *ParticipationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ParticipationEntity) GetName() string { return e.name }
...
func (e *ParticipationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ParticipationEntity) Deleted() bool {
	return e.deleted
}


func (e *ParticipationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewParticipationEntity(e.client, opts)
}

func (e *ParticipationEntity) Data(args ...any) any {
...
func (e *ParticipationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Participation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ParticipationEntity) DataTyped(data ...Participation) Participation {
	if len(data) > 0 {
		return typedFrom[Participation](e.Data(asMap(data[0])))
	}
	return typedFrom[Participation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Participation (all fields
// optional at the wire level).
func (e *ParticipationEntity) MatchTyped(match ...Participation) Participation {
	if len(match) > 0 {
		return typedFrom[Participation](e.Match(asMap(match[0])))
	}
	return typedFrom[Participation](e.Match())
}
...
func (e *ParticipationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ParticipationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ParticipationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ParticipationListMatch and returns []Participation. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ParticipationEntity) ListTyped(reqmatch ParticipationListMatch, ctrl map[string]any) ([]Participation, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Participation](res), nil
}



func (e *ParticipationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ParticipationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ParticipationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ParticipationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
