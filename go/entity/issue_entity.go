...
func NewIssueEntity(client *core.GithubSDK, entopts map[string]any) *IssueEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IssueEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// IssueRemoveMatch and returns an Issue. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *IssueEntity) RemoveTyped(reqmatch IssueRemoveMatch, ctrl map[string]any) (Issue, error) {
