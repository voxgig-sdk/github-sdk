...
func NewAddEntity(client *core.GithubSDK, entopts map[string]any) *AddEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AddEntity) GetName() string { return e.name }
...
func (e *AddEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AddEntity) Deleted() bool {
	return e.deleted
}


func (e *AddEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAddEntity(e.client, opts)
}

func (e *AddEntity) Data(args ...any) any {
...
func (e *AddEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Add; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AddEntity) DataTyped(data ...Add) Add {
	if len(data) > 0 {
		return typedFrom[Add](e.Data(asMap(data[0])))
	}
	return typedFrom[Add](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Add (all fields
// optional at the wire level).
func (e *AddEntity) MatchTyped(match ...Add) Add {
	if len(match) > 0 {
		return typedFrom[Add](e.Match(asMap(match[0])))
	}
	return typedFrom[Add](e.Match())
}
...
func (e *AddEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AddEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AddEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AddEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AddCreateData and returns an Add. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AddEntity) CreateTyped(reqdata AddCreateData, ctrl map[string]any) (Add, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Add{}, err
	}
	return typedFrom[Add](res), nil
}



func (e *AddEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AddEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AddEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
