...
func NewContributorEntity(client *core.GithubSDK, entopts map[string]any) *ContributorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ContributorEntity) GetName() string { return e.name }
...
func (e *ContributorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ContributorEntity) Deleted() bool {
	return e.deleted
}


func (e *ContributorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewContributorEntity(e.client, opts)
}

func (e *ContributorEntity) Data(args ...any) any {
...
func (e *ContributorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Contributor; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ContributorEntity) DataTyped(data ...Contributor) Contributor {
	if len(data) > 0 {
		return typedFrom[Contributor](e.Data(asMap(data[0])))
	}
	return typedFrom[Contributor](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Contributor (all fields
// optional at the wire level).
func (e *ContributorEntity) MatchTyped(match ...Contributor) Contributor {
	if len(match) > 0 {
		return typedFrom[Contributor](e.Match(asMap(match[0])))
	}
	return typedFrom[Contributor](e.Match())
}
...
func (e *ContributorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ContributorEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ContributorEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ContributorListMatch and returns []Contributor. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ContributorEntity) ListTyped(reqmatch ContributorListMatch, ctrl map[string]any) ([]Contributor, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Contributor](res), nil
}



func (e *ContributorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ContributorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ContributorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ContributorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
