...
type PageDeploymentEntity struct {
	name    string
...
func NewPageDeploymentEntity(client *core.GithubSDK, entopts map[string]any) *PageDeploymentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &PageDeploymentEntity{
		name:    "page_deployment",
		client:  client,
...
func (e *PageDeploymentEntity) GetName() string { return e.name }
...
func (e *PageDeploymentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PageDeploymentEntity) Deleted() bool {
	return e.deleted
}


func (e *PageDeploymentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPageDeploymentEntity(e.client, opts)
}

func (e *PageDeploymentEntity) Data(args ...any) any {
...
func (e *PageDeploymentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PageDeployment; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PageDeploymentEntity) DataTyped(data ...PageDeployment) PageDeployment {
	if len(data) > 0 {
		return typedFrom[PageDeployment](e.Data(asMap(data[0])))
	}
	return typedFrom[PageDeployment](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PageDeployment (all fields
// optional at the wire level).
func (e *PageDeploymentEntity) MatchTyped(match ...PageDeployment) PageDeployment {
	if len(match) > 0 {
		return typedFrom[PageDeployment](e.Match(asMap(match[0])))
	}
	return typedFrom[PageDeployment](e.Match())
}
...
func (e *PageDeploymentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PageDeploymentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PageDeploymentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PageDeploymentEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PageDeploymentCreateData and returns an PageDeployment. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PageDeploymentEntity) CreateTyped(reqdata PageDeploymentCreateData, ctrl map[string]any) (PageDeployment, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return PageDeployment{}, err
	}
	return typedFrom[PageDeployment](res), nil
}



func (e *PageDeploymentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PageDeploymentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PageDeploymentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
