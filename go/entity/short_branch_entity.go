...
func NewShortBranchEntity(client *core.GithubSDK, entopts map[string]any) *ShortBranchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ShortBranchEntity) GetName() string { return e.name }
...
func (e *ShortBranchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ShortBranchEntity) Deleted() bool {
	return e.deleted
}


func (e *ShortBranchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewShortBranchEntity(e.client, opts)
}

func (e *ShortBranchEntity) Data(args ...any) any {
...
func (e *ShortBranchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ShortBranch; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ShortBranchEntity) DataTyped(data ...ShortBranch) ShortBranch {
	if len(data) > 0 {
		return typedFrom[ShortBranch](e.Data(asMap(data[0])))
	}
	return typedFrom[ShortBranch](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ShortBranch (all fields
// optional at the wire level).
func (e *ShortBranchEntity) MatchTyped(match ...ShortBranch) ShortBranch {
	if len(match) > 0 {
		return typedFrom[ShortBranch](e.Match(asMap(match[0])))
	}
	return typedFrom[ShortBranch](e.Match())
}
...
func (e *ShortBranchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ShortBranchEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ShortBranchEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ShortBranchListMatch and returns []ShortBranch. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ShortBranchEntity) ListTyped(reqmatch ShortBranchListMatch, ctrl map[string]any) ([]ShortBranch, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ShortBranch](res), nil
}



func (e *ShortBranchEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ShortBranchEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ShortBranchEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ShortBranchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
