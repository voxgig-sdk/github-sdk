...
func NewImportEntity(client *core.GithubSDK, entopts map[string]any) *ImportEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ImportEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ImportListMatch and returns []Import. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ImportEntity) ListTyped(reqmatch ImportListMatch, ctrl map[string]any) ([]Import, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Import](res), nil
}
...
func (e *ImportEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// ImportUpdateData and returns an Import. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *ImportEntity) UpdateTyped(reqdata ImportUpdateData, ctrl map[string]any) (Import, error) {
