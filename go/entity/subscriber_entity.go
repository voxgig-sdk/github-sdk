...
func NewSubscriberEntity(client *core.GithubSDK, entopts map[string]any) *SubscriberEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SubscriberEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *SubscriberEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SubscriberEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SubscriberEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
