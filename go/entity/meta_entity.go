...
func NewMetaEntity(client *core.GithubSDK, entopts map[string]any) *MetaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MetaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// MetaListMatch and returns []Meta. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MetaEntity) ListTyped(reqmatch MetaListMatch, ctrl map[string]any) ([]Meta, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Meta](res), nil
}
