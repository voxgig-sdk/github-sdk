...
func NewReferrerEntity(client *core.GithubSDK, entopts map[string]any) *ReferrerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReferrerEntity) GetName() string { return e.name }
...
func (e *ReferrerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReferrerEntity) Deleted() bool {
	return e.deleted
}


func (e *ReferrerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReferrerEntity(e.client, opts)
}

func (e *ReferrerEntity) Data(args ...any) any {
...
func (e *ReferrerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Referrer; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReferrerEntity) DataTyped(data ...Referrer) Referrer {
	if len(data) > 0 {
		return typedFrom[Referrer](e.Data(asMap(data[0])))
	}
	return typedFrom[Referrer](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Referrer (all fields
// optional at the wire level).
func (e *ReferrerEntity) MatchTyped(match ...Referrer) Referrer {
	if len(match) > 0 {
		return typedFrom[Referrer](e.Match(asMap(match[0])))
	}
	return typedFrom[Referrer](e.Match())
}
...
func (e *ReferrerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReferrerEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ReferrerEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReferrerListMatch and returns []Referrer. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ReferrerEntity) ListTyped(reqmatch ReferrerListMatch, ctrl map[string]any) ([]Referrer, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Referrer](res), nil
}



func (e *ReferrerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReferrerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReferrerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReferrerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
