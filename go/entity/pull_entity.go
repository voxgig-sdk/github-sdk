...
func NewPullEntity(client *core.GithubSDK, entopts map[string]any) *PullEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PullEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// PullUpdateData and returns an Pull. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *PullEntity) UpdateTyped(reqdata PullUpdateData, ctrl map[string]any) (Pull, error) {
