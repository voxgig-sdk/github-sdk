...
type CodeFrequencyEntity struct {
	name    string
...
func NewCodeFrequencyEntity(client *core.GithubSDK, entopts map[string]any) *CodeFrequencyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CodeFrequencyEntity) GetName() string { return e.name }
...
func (e *CodeFrequencyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CodeFrequencyEntity) Deleted() bool {
	return e.deleted
}


func (e *CodeFrequencyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCodeFrequencyEntity(e.client, opts)
}

func (e *CodeFrequencyEntity) Data(args ...any) any {
...
func (e *CodeFrequencyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CodeFrequency; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CodeFrequencyEntity) DataTyped(data ...CodeFrequency) CodeFrequency {
	if len(data) > 0 {
		return typedFrom[CodeFrequency](e.Data(asMap(data[0])))
	}
	return typedFrom[CodeFrequency](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CodeFrequency (all fields
// optional at the wire level).
func (e *CodeFrequencyEntity) MatchTyped(match ...CodeFrequency) CodeFrequency {
	if len(match) > 0 {
		return typedFrom[CodeFrequency](e.Match(asMap(match[0])))
	}
	return typedFrom[CodeFrequency](e.Match())
}
...
func (e *CodeFrequencyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CodeFrequencyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CodeFrequencyEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CodeFrequencyListMatch and returns []CodeFrequency. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CodeFrequencyEntity) ListTyped(reqmatch CodeFrequencyListMatch, ctrl map[string]any) ([]CodeFrequency, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CodeFrequency](res), nil
}



func (e *CodeFrequencyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CodeFrequencyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CodeFrequencyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CodeFrequencyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
