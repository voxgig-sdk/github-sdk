...
func NewLicenseEntity(client *core.GithubSDK, entopts map[string]any) *LicenseEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LicenseEntity) GetName() string { return e.name }
...
func (e *LicenseEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LicenseEntity) Deleted() bool {
	return e.deleted
}


func (e *LicenseEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLicenseEntity(e.client, opts)
}

func (e *LicenseEntity) Data(args ...any) any {
...
func (e *LicenseEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an License; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LicenseEntity) DataTyped(data ...License) License {
	if len(data) > 0 {
		return typedFrom[License](e.Data(asMap(data[0])))
	}
	return typedFrom[License](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through License (all fields
// optional at the wire level).
func (e *LicenseEntity) MatchTyped(match ...License) License {
	if len(match) > 0 {
		return typedFrom[License](e.Match(asMap(match[0])))
	}
	return typedFrom[License](e.Match())
}
...
func (e *LicenseEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LicenseEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LicenseLoadMatch and returns an License. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LicenseEntity) LoadTyped(reqmatch LicenseLoadMatch, ctrl map[string]any) (License, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return License{}, err
	}
	return typedFrom[License](res), nil
}




func (e *LicenseEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// LicenseListMatch and returns []License. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LicenseEntity) ListTyped(reqmatch LicenseListMatch, ctrl map[string]any) ([]License, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[License](res), nil
}



func (e *LicenseEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LicenseEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LicenseEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LicenseEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
