...
func NewCommitEntity(client *core.GithubSDK, entopts map[string]any) *CommitEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CommitEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CommitLoadMatch and returns an Commit. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CommitEntity) LoadTyped(reqmatch CommitLoadMatch, ctrl map[string]any) (Commit, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Commit{}, err
	}
	return typedFrom[Commit](res), nil
}
...
func (e *CommitEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CommitCreateData and returns an Commit. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CommitEntity) CreateTyped(reqdata CommitCreateData, ctrl map[string]any) (Commit, error) {
