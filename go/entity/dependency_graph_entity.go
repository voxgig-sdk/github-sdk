...
type DependencyGraphEntity struct {
	name    string
...
func NewDependencyGraphEntity(client *core.GithubSDK, entopts map[string]any) *DependencyGraphEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DependencyGraphEntity) GetName() string { return e.name }
...
func (e *DependencyGraphEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DependencyGraphEntity) Deleted() bool {
	return e.deleted
}


func (e *DependencyGraphEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDependencyGraphEntity(e.client, opts)
}

func (e *DependencyGraphEntity) Data(args ...any) any {
...
func (e *DependencyGraphEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DependencyGraph; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DependencyGraphEntity) DataTyped(data ...DependencyGraph) DependencyGraph {
	if len(data) > 0 {
		return typedFrom[DependencyGraph](e.Data(asMap(data[0])))
	}
	return typedFrom[DependencyGraph](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DependencyGraph (all fields
// optional at the wire level).
func (e *DependencyGraphEntity) MatchTyped(match ...DependencyGraph) DependencyGraph {
	if len(match) > 0 {
		return typedFrom[DependencyGraph](e.Match(asMap(match[0])))
	}
	return typedFrom[DependencyGraph](e.Match())
}
...
func (e *DependencyGraphEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DependencyGraphEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DependencyGraphEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DependencyGraphEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DependencyGraphCreateData and returns an DependencyGraph. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DependencyGraphEntity) CreateTyped(reqdata DependencyGraphCreateData, ctrl map[string]any) (DependencyGraph, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return DependencyGraph{}, err
	}
	return typedFrom[DependencyGraph](res), nil
}



func (e *DependencyGraphEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DependencyGraphEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DependencyGraphEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
