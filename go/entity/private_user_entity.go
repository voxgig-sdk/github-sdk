...
func NewPrivateUserEntity(client *core.GithubSDK, entopts map[string]any) *PrivateUserEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PrivateUserEntity) GetName() string { return e.name }
...
func (e *PrivateUserEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PrivateUserEntity) Deleted() bool {
	return e.deleted
}


func (e *PrivateUserEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPrivateUserEntity(e.client, opts)
}

func (e *PrivateUserEntity) Data(args ...any) any {
...
func (e *PrivateUserEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PrivateUser; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PrivateUserEntity) DataTyped(data ...PrivateUser) PrivateUser {
	if len(data) > 0 {
		return typedFrom[PrivateUser](e.Data(asMap(data[0])))
	}
	return typedFrom[PrivateUser](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PrivateUser (all fields
// optional at the wire level).
func (e *PrivateUserEntity) MatchTyped(match ...PrivateUser) PrivateUser {
	if len(match) > 0 {
		return typedFrom[PrivateUser](e.Match(asMap(match[0])))
	}
	return typedFrom[PrivateUser](e.Match())
}
...
func (e *PrivateUserEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PrivateUserEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PrivateUserEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PrivateUserEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PrivateUserEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PrivateUserEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PrivateUserEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
