...
func NewFeedEntity(client *core.GithubSDK, entopts map[string]any) *FeedEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FeedEntity) GetName() string { return e.name }
...
func (e *FeedEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FeedEntity) Deleted() bool {
	return e.deleted
}


func (e *FeedEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFeedEntity(e.client, opts)
}

func (e *FeedEntity) Data(args ...any) any {
...
func (e *FeedEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Feed; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FeedEntity) DataTyped(data ...Feed) Feed {
	if len(data) > 0 {
		return typedFrom[Feed](e.Data(asMap(data[0])))
	}
	return typedFrom[Feed](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Feed (all fields
// optional at the wire level).
func (e *FeedEntity) MatchTyped(match ...Feed) Feed {
	if len(match) > 0 {
		return typedFrom[Feed](e.Match(asMap(match[0])))
	}
	return typedFrom[Feed](e.Match())
}
...
func (e *FeedEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FeedEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *FeedEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FeedListMatch and returns []Feed. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FeedEntity) ListTyped(reqmatch FeedListMatch, ctrl map[string]any) ([]Feed, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Feed](res), nil
}



func (e *FeedEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FeedEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FeedEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FeedEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
