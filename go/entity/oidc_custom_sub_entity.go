...
type OidcCustomSubEntity struct {
	name    string
...
func NewOidcCustomSubEntity(client *core.GithubSDK, entopts map[string]any) *OidcCustomSubEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &OidcCustomSubEntity{
		name:    "oidc_custom_sub",
		client:  client,
...
func (e *OidcCustomSubEntity) GetName() string { return e.name }
...
func (e *OidcCustomSubEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OidcCustomSubEntity) Deleted() bool {
	return e.deleted
}


func (e *OidcCustomSubEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOidcCustomSubEntity(e.client, opts)
}

func (e *OidcCustomSubEntity) Data(args ...any) any {
...
func (e *OidcCustomSubEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OidcCustomSub; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OidcCustomSubEntity) DataTyped(data ...OidcCustomSub) OidcCustomSub {
	if len(data) > 0 {
		return typedFrom[OidcCustomSub](e.Data(asMap(data[0])))
	}
	return typedFrom[OidcCustomSub](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OidcCustomSub (all fields
// optional at the wire level).
func (e *OidcCustomSubEntity) MatchTyped(match ...OidcCustomSub) OidcCustomSub {
	if len(match) > 0 {
		return typedFrom[OidcCustomSub](e.Match(asMap(match[0])))
	}
	return typedFrom[OidcCustomSub](e.Match())
}
...
func (e *OidcCustomSubEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OidcCustomSubEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *OidcCustomSubEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OidcCustomSubListMatch and returns []OidcCustomSub. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *OidcCustomSubEntity) ListTyped(reqmatch OidcCustomSubListMatch, ctrl map[string]any) ([]OidcCustomSub, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[OidcCustomSub](res), nil
}



func (e *OidcCustomSubEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OidcCustomSubEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OidcCustomSubEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OidcCustomSubEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
