...
func NewFileCommitEntity(client *core.GithubSDK, entopts map[string]any) *FileCommitEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FileCommitEntity) GetName() string { return e.name }
...
func (e *FileCommitEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FileCommitEntity) Deleted() bool {
	return e.deleted
}


func (e *FileCommitEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFileCommitEntity(e.client, opts)
}

func (e *FileCommitEntity) Data(args ...any) any {
...
func (e *FileCommitEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FileCommit; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FileCommitEntity) DataTyped(data ...FileCommit) FileCommit {
	if len(data) > 0 {
		return typedFrom[FileCommit](e.Data(asMap(data[0])))
	}
	return typedFrom[FileCommit](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FileCommit (all fields
// optional at the wire level).
func (e *FileCommitEntity) MatchTyped(match ...FileCommit) FileCommit {
	if len(match) > 0 {
		return typedFrom[FileCommit](e.Match(asMap(match[0])))
	}
	return typedFrom[FileCommit](e.Match())
}
...
func (e *FileCommitEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FileCommitEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *FileCommitEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FileCommitEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *FileCommitEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FileCommitUpdateData and returns an FileCommit. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *FileCommitEntity) UpdateTyped(reqdata FileCommitUpdateData, ctrl map[string]any) (FileCommit, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return FileCommit{}, err
	}
	return typedFrom[FileCommit](res), nil
}




func (e *FileCommitEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// FileCommitRemoveMatch and returns an FileCommit. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *FileCommitEntity) RemoveTyped(reqmatch FileCommitRemoveMatch, ctrl map[string]any) (FileCommit, error) {
...
func (e *FileCommitEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
