...
type CodeSecurityEntity struct {
	name    string
...
func NewCodeSecurityEntity(client *core.GithubSDK, entopts map[string]any) *CodeSecurityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CodeSecurityEntity) GetName() string { return e.name }
...
func (e *CodeSecurityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CodeSecurityEntity) Deleted() bool {
	return e.deleted
}


func (e *CodeSecurityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCodeSecurityEntity(e.client, opts)
}

func (e *CodeSecurityEntity) Data(args ...any) any {
...
func (e *CodeSecurityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CodeSecurity; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CodeSecurityEntity) DataTyped(data ...CodeSecurity) CodeSecurity {
	if len(data) > 0 {
		return typedFrom[CodeSecurity](e.Data(asMap(data[0])))
	}
	return typedFrom[CodeSecurity](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CodeSecurity (all fields
// optional at the wire level).
func (e *CodeSecurityEntity) MatchTyped(match ...CodeSecurity) CodeSecurity {
	if len(match) > 0 {
		return typedFrom[CodeSecurity](e.Match(asMap(match[0])))
	}
	return typedFrom[CodeSecurity](e.Match())
}
...
func (e *CodeSecurityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CodeSecurityEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CodeSecurityEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CodeSecurityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *CodeSecurityEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CodeSecurityUpdateData and returns an CodeSecurity. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *CodeSecurityEntity) UpdateTyped(reqdata CodeSecurityUpdateData, ctrl map[string]any) (CodeSecurity, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return CodeSecurity{}, err
	}
	return typedFrom[CodeSecurity](res), nil
}




func (e *CodeSecurityEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// CodeSecurityRemoveMatch and returns an CodeSecurity. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *CodeSecurityEntity) RemoveTyped(reqmatch CodeSecurityRemoveMatch, ctrl map[string]any) (CodeSecurity, error) {
...
func (e *CodeSecurityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
