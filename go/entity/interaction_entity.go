...
func NewInteractionEntity(client *core.GithubSDK, entopts map[string]any) *InteractionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InteractionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// InteractionLoadMatch and returns an Interaction. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *InteractionEntity) LoadTyped(reqmatch InteractionLoadMatch, ctrl map[string]any) (Interaction, error) {
...
func (e *InteractionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *InteractionEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// InteractionRemoveMatch and returns an Interaction. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *InteractionEntity) RemoveTyped(reqmatch InteractionRemoveMatch, ctrl map[string]any) (Interaction, error) {
