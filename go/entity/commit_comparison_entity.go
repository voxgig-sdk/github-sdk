...
type CommitComparisonEntity struct {
	name    string
...
func NewCommitComparisonEntity(client *core.GithubSDK, entopts map[string]any) *CommitComparisonEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CommitComparisonEntity) GetName() string { return e.name }
...
func (e *CommitComparisonEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CommitComparisonEntity) Deleted() bool {
	return e.deleted
}


func (e *CommitComparisonEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCommitComparisonEntity(e.client, opts)
}

func (e *CommitComparisonEntity) Data(args ...any) any {
...
func (e *CommitComparisonEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CommitComparison; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CommitComparisonEntity) DataTyped(data ...CommitComparison) CommitComparison {
	if len(data) > 0 {
		return typedFrom[CommitComparison](e.Data(asMap(data[0])))
	}
	return typedFrom[CommitComparison](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CommitComparison (all fields
// optional at the wire level).
func (e *CommitComparisonEntity) MatchTyped(match ...CommitComparison) CommitComparison {
	if len(match) > 0 {
		return typedFrom[CommitComparison](e.Match(asMap(match[0])))
	}
	return typedFrom[CommitComparison](e.Match())
}
...
func (e *CommitComparisonEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CommitComparisonEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CommitComparisonLoadMatch and returns an CommitComparison. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CommitComparisonEntity) LoadTyped(reqmatch CommitComparisonLoadMatch, ctrl map[string]any) (CommitComparison, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CommitComparison{}, err
	}
	return typedFrom[CommitComparison](res), nil
}



func (e *CommitComparisonEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CommitComparisonEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CommitComparisonEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CommitComparisonEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CommitComparisonEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
