...
func NewClassroomEntity(client *core.GithubSDK, entopts map[string]any) *ClassroomEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ClassroomEntity) GetName() string { return e.name }
...
func (e *ClassroomEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ClassroomEntity) Deleted() bool {
	return e.deleted
}


func (e *ClassroomEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewClassroomEntity(e.client, opts)
}

func (e *ClassroomEntity) Data(args ...any) any {
...
func (e *ClassroomEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Classroom; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ClassroomEntity) DataTyped(data ...Classroom) Classroom {
	if len(data) > 0 {
		return typedFrom[Classroom](e.Data(asMap(data[0])))
	}
	return typedFrom[Classroom](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Classroom (all fields
// optional at the wire level).
func (e *ClassroomEntity) MatchTyped(match ...Classroom) Classroom {
	if len(match) > 0 {
		return typedFrom[Classroom](e.Match(asMap(match[0])))
	}
	return typedFrom[Classroom](e.Match())
}
...
func (e *ClassroomEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ClassroomEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ClassroomLoadMatch and returns an Classroom. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ClassroomEntity) LoadTyped(reqmatch ClassroomLoadMatch, ctrl map[string]any) (Classroom, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Classroom{}, err
	}
	return typedFrom[Classroom](res), nil
}




func (e *ClassroomEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ClassroomListMatch and returns []Classroom. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ClassroomEntity) ListTyped(reqmatch ClassroomListMatch, ctrl map[string]any) ([]Classroom, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Classroom](res), nil
}



func (e *ClassroomEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ClassroomEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ClassroomEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ClassroomEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
