...
func NewBranchEntity(client *core.GithubSDK, entopts map[string]any) *BranchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BranchEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BranchLoadMatch and returns an Branch. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BranchEntity) LoadTyped(reqmatch BranchLoadMatch, ctrl map[string]any) (Branch, error) {
