...
type PublicMemberEntity struct {
	name    string
...
func NewPublicMemberEntity(client *core.GithubSDK, entopts map[string]any) *PublicMemberEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PublicMemberEntity) GetName() string { return e.name }
...
func (e *PublicMemberEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PublicMemberEntity) Deleted() bool {
	return e.deleted
}


func (e *PublicMemberEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPublicMemberEntity(e.client, opts)
}

func (e *PublicMemberEntity) Data(args ...any) any {
...
func (e *PublicMemberEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PublicMember; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PublicMemberEntity) DataTyped(data ...PublicMember) PublicMember {
	if len(data) > 0 {
		return typedFrom[PublicMember](e.Data(asMap(data[0])))
	}
	return typedFrom[PublicMember](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PublicMember (all fields
// optional at the wire level).
func (e *PublicMemberEntity) MatchTyped(match ...PublicMember) PublicMember {
	if len(match) > 0 {
		return typedFrom[PublicMember](e.Match(asMap(match[0])))
	}
	return typedFrom[PublicMember](e.Match())
}
...
func (e *PublicMemberEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PublicMemberEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PublicMemberEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PublicMemberListMatch and returns []PublicMember. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PublicMemberEntity) ListTyped(reqmatch PublicMemberListMatch, ctrl map[string]any) ([]PublicMember, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PublicMember](res), nil
}



func (e *PublicMemberEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PublicMemberEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PublicMemberEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PublicMemberEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
