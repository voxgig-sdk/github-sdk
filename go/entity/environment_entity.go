...
func NewEnvironmentEntity(client *core.GithubSDK, entopts map[string]any) *EnvironmentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EnvironmentEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EnvironmentLoadMatch and returns an Environment. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EnvironmentEntity) LoadTyped(reqmatch EnvironmentLoadMatch, ctrl map[string]any) (Environment, error) {
...
func (e *EnvironmentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *EnvironmentEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// EnvironmentUpdateData and returns an Environment. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *EnvironmentEntity) UpdateTyped(reqdata EnvironmentUpdateData, ctrl map[string]any) (Environment, error) {
...
func (e *EnvironmentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
