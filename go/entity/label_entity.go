...
func NewLabelEntity(client *core.GithubSDK, entopts map[string]any) *LabelEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LabelEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// LabelCreateData and returns an Label. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *LabelEntity) CreateTyped(reqdata LabelCreateData, ctrl map[string]any) (Label, error) {
...
func (e *LabelEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// LabelUpdateData and returns an Label. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *LabelEntity) UpdateTyped(reqdata LabelUpdateData, ctrl map[string]any) (Label, error) {
