...
func NewFollowerEntity(client *core.GithubSDK, entopts map[string]any) *FollowerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FollowerEntity) GetName() string { return e.name }
...
func (e *FollowerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FollowerEntity) Deleted() bool {
	return e.deleted
}


func (e *FollowerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFollowerEntity(e.client, opts)
}

func (e *FollowerEntity) Data(args ...any) any {
...
func (e *FollowerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Follower; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FollowerEntity) DataTyped(data ...Follower) Follower {
	if len(data) > 0 {
		return typedFrom[Follower](e.Data(asMap(data[0])))
	}
	return typedFrom[Follower](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Follower (all fields
// optional at the wire level).
func (e *FollowerEntity) MatchTyped(match ...Follower) Follower {
	if len(match) > 0 {
		return typedFrom[Follower](e.Match(asMap(match[0])))
	}
	return typedFrom[Follower](e.Match())
}
...
func (e *FollowerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FollowerEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *FollowerEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FollowerListMatch and returns []Follower. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FollowerEntity) ListTyped(reqmatch FollowerListMatch, ctrl map[string]any) ([]Follower, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Follower](res), nil
}



func (e *FollowerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FollowerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FollowerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FollowerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
