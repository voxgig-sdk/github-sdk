...
func NewCredentialEntity(client *core.GithubSDK, entopts map[string]any) *CredentialEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CredentialEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *CredentialEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CredentialCreateData and returns an Credential. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CredentialEntity) CreateTyped(reqdata CredentialCreateData, ctrl map[string]any) (Credential, error) {
