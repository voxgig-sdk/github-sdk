...
func NewBranchShortEntity(client *core.GithubSDK, entopts map[string]any) *BranchShortEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BranchShortEntity) GetName() string { return e.name }
...
func (e *BranchShortEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BranchShortEntity) Deleted() bool {
	return e.deleted
}


func (e *BranchShortEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBranchShortEntity(e.client, opts)
}

func (e *BranchShortEntity) Data(args ...any) any {
...
func (e *BranchShortEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BranchShort; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BranchShortEntity) DataTyped(data ...BranchShort) BranchShort {
	if len(data) > 0 {
		return typedFrom[BranchShort](e.Data(asMap(data[0])))
	}
	return typedFrom[BranchShort](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BranchShort (all fields
// optional at the wire level).
func (e *BranchShortEntity) MatchTyped(match ...BranchShort) BranchShort {
	if len(match) > 0 {
		return typedFrom[BranchShort](e.Match(asMap(match[0])))
	}
	return typedFrom[BranchShort](e.Match())
}
...
func (e *BranchShortEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BranchShortEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *BranchShortEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BranchShortListMatch and returns []BranchShort. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BranchShortEntity) ListTyped(reqmatch BranchShortListMatch, ctrl map[string]any) ([]BranchShort, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[BranchShort](res), nil
}



func (e *BranchShortEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BranchShortEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BranchShortEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BranchShortEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
