...
type RulesetVersionEntity struct {
	name    string
...
func NewRulesetVersionEntity(client *core.GithubSDK, entopts map[string]any) *RulesetVersionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RulesetVersionEntity) GetName() string { return e.name }
...
func (e *RulesetVersionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RulesetVersionEntity) Deleted() bool {
	return e.deleted
}


func (e *RulesetVersionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRulesetVersionEntity(e.client, opts)
}

func (e *RulesetVersionEntity) Data(args ...any) any {
...
func (e *RulesetVersionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RulesetVersion; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RulesetVersionEntity) DataTyped(data ...RulesetVersion) RulesetVersion {
	if len(data) > 0 {
		return typedFrom[RulesetVersion](e.Data(asMap(data[0])))
	}
	return typedFrom[RulesetVersion](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RulesetVersion (all fields
// optional at the wire level).
func (e *RulesetVersionEntity) MatchTyped(match ...RulesetVersion) RulesetVersion {
	if len(match) > 0 {
		return typedFrom[RulesetVersion](e.Match(asMap(match[0])))
	}
	return typedFrom[RulesetVersion](e.Match())
}
...
func (e *RulesetVersionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RulesetVersionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RulesetVersionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RulesetVersionListMatch and returns []RulesetVersion. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RulesetVersionEntity) ListTyped(reqmatch RulesetVersionListMatch, ctrl map[string]any) ([]RulesetVersion, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[RulesetVersion](res), nil
}



func (e *RulesetVersionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RulesetVersionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RulesetVersionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RulesetVersionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
