...
func NewAssigneeEntity(client *core.GithubSDK, entopts map[string]any) *AssigneeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AssigneeEntity) GetName() string { return e.name }
...
func (e *AssigneeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AssigneeEntity) Deleted() bool {
	return e.deleted
}


func (e *AssigneeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAssigneeEntity(e.client, opts)
}

func (e *AssigneeEntity) Data(args ...any) any {
...
func (e *AssigneeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Assignee; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AssigneeEntity) DataTyped(data ...Assignee) Assignee {
	if len(data) > 0 {
		return typedFrom[Assignee](e.Data(asMap(data[0])))
	}
	return typedFrom[Assignee](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Assignee (all fields
// optional at the wire level).
func (e *AssigneeEntity) MatchTyped(match ...Assignee) Assignee {
	if len(match) > 0 {
		return typedFrom[Assignee](e.Match(asMap(match[0])))
	}
	return typedFrom[Assignee](e.Match())
}
...
func (e *AssigneeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AssigneeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AssigneeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AssigneeListMatch and returns []Assignee. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AssigneeEntity) ListTyped(reqmatch AssigneeListMatch, ctrl map[string]any) ([]Assignee, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Assignee](res), nil
}



func (e *AssigneeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AssigneeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AssigneeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AssigneeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
