...
func NewActionEntity(client *core.GithubSDK, entopts map[string]any) *ActionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ActionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ActionLoadMatch and returns an Action. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ActionEntity) LoadTyped(reqmatch ActionLoadMatch, ctrl map[string]any) (Action, error) {
...
func (e *ActionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ActionListMatch and returns []Action. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ActionEntity) ListTyped(reqmatch ActionListMatch, ctrl map[string]any) ([]Action, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Action](res), nil
}
...
func (e *ActionEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// ActionUpdateData and returns an Action. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *ActionEntity) UpdateTyped(reqdata ActionUpdateData, ctrl map[string]any) (Action, error) {
...
func (e *ActionEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// ActionRemoveMatch and returns an Action. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ActionEntity) RemoveTyped(reqmatch ActionRemoveMatch, ctrl map[string]any) (Action, error) {
