...
func NewMarkdownEntity(client *core.GithubSDK, entopts map[string]any) *MarkdownEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MarkdownEntity) GetName() string { return e.name }
...
func (e *MarkdownEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MarkdownEntity) Deleted() bool {
	return e.deleted
}


func (e *MarkdownEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMarkdownEntity(e.client, opts)
}

func (e *MarkdownEntity) Data(args ...any) any {
...
func (e *MarkdownEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Markdown; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MarkdownEntity) DataTyped(data ...Markdown) Markdown {
	if len(data) > 0 {
		return typedFrom[Markdown](e.Data(asMap(data[0])))
	}
	return typedFrom[Markdown](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Markdown (all fields
// optional at the wire level).
func (e *MarkdownEntity) MatchTyped(match ...Markdown) Markdown {
	if len(match) > 0 {
		return typedFrom[Markdown](e.Match(asMap(match[0])))
	}
	return typedFrom[Markdown](e.Match())
}
...
func (e *MarkdownEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MarkdownEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *MarkdownEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *MarkdownEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MarkdownCreateData and returns an Markdown. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *MarkdownEntity) CreateTyped(reqdata MarkdownCreateData, ctrl map[string]any) (Markdown, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Markdown{}, err
	}
	return typedFrom[Markdown](res), nil
}



func (e *MarkdownEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MarkdownEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MarkdownEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
