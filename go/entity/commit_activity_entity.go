...
type CommitActivityEntity struct {
	name    string
...
func NewCommitActivityEntity(client *core.GithubSDK, entopts map[string]any) *CommitActivityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CommitActivityEntity) GetName() string { return e.name }
...
func (e *CommitActivityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CommitActivityEntity) Deleted() bool {
	return e.deleted
}


func (e *CommitActivityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCommitActivityEntity(e.client, opts)
}

func (e *CommitActivityEntity) Data(args ...any) any {
...
func (e *CommitActivityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CommitActivity; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CommitActivityEntity) DataTyped(data ...CommitActivity) CommitActivity {
	if len(data) > 0 {
		return typedFrom[CommitActivity](e.Data(asMap(data[0])))
	}
	return typedFrom[CommitActivity](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CommitActivity (all fields
// optional at the wire level).
func (e *CommitActivityEntity) MatchTyped(match ...CommitActivity) CommitActivity {
	if len(match) > 0 {
		return typedFrom[CommitActivity](e.Match(asMap(match[0])))
	}
	return typedFrom[CommitActivity](e.Match())
}
...
func (e *CommitActivityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CommitActivityEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CommitActivityEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CommitActivityListMatch and returns []CommitActivity. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CommitActivityEntity) ListTyped(reqmatch CommitActivityListMatch, ctrl map[string]any) ([]CommitActivity, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CommitActivity](res), nil
}



func (e *CommitActivityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CommitActivityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CommitActivityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CommitActivityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
