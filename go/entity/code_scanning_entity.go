...
type CodeScanningEntity struct {
	name    string
...
func NewCodeScanningEntity(client *core.GithubSDK, entopts map[string]any) *CodeScanningEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CodeScanningEntity) GetName() string { return e.name }
...
func (e *CodeScanningEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CodeScanningEntity) Deleted() bool {
	return e.deleted
}


func (e *CodeScanningEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCodeScanningEntity(e.client, opts)
}

func (e *CodeScanningEntity) Data(args ...any) any {
...
func (e *CodeScanningEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CodeScanning; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CodeScanningEntity) DataTyped(data ...CodeScanning) CodeScanning {
	if len(data) > 0 {
		return typedFrom[CodeScanning](e.Data(asMap(data[0])))
	}
	return typedFrom[CodeScanning](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CodeScanning (all fields
// optional at the wire level).
func (e *CodeScanningEntity) MatchTyped(match ...CodeScanning) CodeScanning {
	if len(match) > 0 {
		return typedFrom[CodeScanning](e.Match(asMap(match[0])))
	}
	return typedFrom[CodeScanning](e.Match())
}
...
func (e *CodeScanningEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CodeScanningEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CodeScanningEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CodeScanningEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CodeScanningCreateData and returns an CodeScanning. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CodeScanningEntity) CreateTyped(reqdata CodeScanningCreateData, ctrl map[string]any) (CodeScanning, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return CodeScanning{}, err
	}
	return typedFrom[CodeScanning](res), nil
}



func (e *CodeScanningEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *CodeScanningEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// CodeScanningRemoveMatch and returns an CodeScanning. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *CodeScanningEntity) RemoveTyped(reqmatch CodeScanningRemoveMatch, ctrl map[string]any) (CodeScanning, error) {
...
func (e *CodeScanningEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
