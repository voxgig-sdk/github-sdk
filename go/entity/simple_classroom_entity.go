...
type SimpleClassroomEntity struct {
	name    string
...
func NewSimpleClassroomEntity(client *core.GithubSDK, entopts map[string]any) *SimpleClassroomEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &SimpleClassroomEntity{
		name:    "simple_classroom",
		client:  client,
...
func (e *SimpleClassroomEntity) GetName() string { return e.name }
...
func (e *SimpleClassroomEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SimpleClassroomEntity) Deleted() bool {
	return e.deleted
}


func (e *SimpleClassroomEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSimpleClassroomEntity(e.client, opts)
}

func (e *SimpleClassroomEntity) Data(args ...any) any {
...
func (e *SimpleClassroomEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SimpleClassroom; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SimpleClassroomEntity) DataTyped(data ...SimpleClassroom) SimpleClassroom {
	if len(data) > 0 {
		return typedFrom[SimpleClassroom](e.Data(asMap(data[0])))
	}
	return typedFrom[SimpleClassroom](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SimpleClassroom (all fields
// optional at the wire level).
func (e *SimpleClassroomEntity) MatchTyped(match ...SimpleClassroom) SimpleClassroom {
	if len(match) > 0 {
		return typedFrom[SimpleClassroom](e.Match(asMap(match[0])))
	}
	return typedFrom[SimpleClassroom](e.Match())
}
...
func (e *SimpleClassroomEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SimpleClassroomEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SimpleClassroomEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SimpleClassroomEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SimpleClassroomEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SimpleClassroomEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SimpleClassroomEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
