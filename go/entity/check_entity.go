...
func NewCheckEntity(client *core.GithubSDK, entopts map[string]any) *CheckEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CheckEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CheckEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CheckListMatch and returns []Check. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CheckEntity) ListTyped(reqmatch CheckListMatch, ctrl map[string]any) ([]Check, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Check](res), nil
}
