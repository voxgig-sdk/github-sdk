...
func NewBlobEntity(client *core.GithubSDK, entopts map[string]any) *BlobEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BlobEntity) GetName() string { return e.name }
...
func (e *BlobEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BlobEntity) Deleted() bool {
	return e.deleted
}


func (e *BlobEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBlobEntity(e.client, opts)
}

func (e *BlobEntity) Data(args ...any) any {
...
func (e *BlobEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Blob; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BlobEntity) DataTyped(data ...Blob) Blob {
	if len(data) > 0 {
		return typedFrom[Blob](e.Data(asMap(data[0])))
	}
	return typedFrom[Blob](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Blob (all fields
// optional at the wire level).
func (e *BlobEntity) MatchTyped(match ...Blob) Blob {
	if len(match) > 0 {
		return typedFrom[Blob](e.Match(asMap(match[0])))
	}
	return typedFrom[Blob](e.Match())
}
...
func (e *BlobEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BlobEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BlobLoadMatch and returns an Blob. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BlobEntity) LoadTyped(reqmatch BlobLoadMatch, ctrl map[string]any) (Blob, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Blob{}, err
	}
	return typedFrom[Blob](res), nil
}



func (e *BlobEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BlobEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BlobEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BlobEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BlobEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
