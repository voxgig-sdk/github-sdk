...
func NewRunnerEntity(client *core.GithubSDK, entopts map[string]any) *RunnerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RunnerEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RunnerLoadMatch and returns an Runner. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RunnerEntity) LoadTyped(reqmatch RunnerLoadMatch, ctrl map[string]any) (Runner, error) {
...
func (e *RunnerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *RunnerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
