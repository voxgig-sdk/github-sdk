...
type ActionsVariableEntity struct {
	name    string
...
func NewActionsVariableEntity(client *core.GithubSDK, entopts map[string]any) *ActionsVariableEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ActionsVariableEntity) GetName() string { return e.name }
...
func (e *ActionsVariableEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ActionsVariableEntity) Deleted() bool {
	return e.deleted
}


func (e *ActionsVariableEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewActionsVariableEntity(e.client, opts)
}

func (e *ActionsVariableEntity) Data(args ...any) any {
...
func (e *ActionsVariableEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ActionsVariable; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ActionsVariableEntity) DataTyped(data ...ActionsVariable) ActionsVariable {
	if len(data) > 0 {
		return typedFrom[ActionsVariable](e.Data(asMap(data[0])))
	}
	return typedFrom[ActionsVariable](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ActionsVariable (all fields
// optional at the wire level).
func (e *ActionsVariableEntity) MatchTyped(match ...ActionsVariable) ActionsVariable {
	if len(match) > 0 {
		return typedFrom[ActionsVariable](e.Match(asMap(match[0])))
	}
	return typedFrom[ActionsVariable](e.Match())
}
...
func (e *ActionsVariableEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ActionsVariableEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ActionsVariableLoadMatch and returns an ActionsVariable. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ActionsVariableEntity) LoadTyped(reqmatch ActionsVariableLoadMatch, ctrl map[string]any) (ActionsVariable, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ActionsVariable{}, err
	}
	return typedFrom[ActionsVariable](res), nil
}



func (e *ActionsVariableEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ActionsVariableEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ActionsVariableEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ActionsVariableEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ActionsVariableEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
