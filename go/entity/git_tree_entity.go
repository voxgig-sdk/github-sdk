...
func NewGitTreeEntity(client *core.GithubSDK, entopts map[string]any) *GitTreeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GitTreeEntity) GetName() string { return e.name }
...
func (e *GitTreeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GitTreeEntity) Deleted() bool {
	return e.deleted
}


func (e *GitTreeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGitTreeEntity(e.client, opts)
}

func (e *GitTreeEntity) Data(args ...any) any {
...
func (e *GitTreeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GitTree; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GitTreeEntity) DataTyped(data ...GitTree) GitTree {
	if len(data) > 0 {
		return typedFrom[GitTree](e.Data(asMap(data[0])))
	}
	return typedFrom[GitTree](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GitTree (all fields
// optional at the wire level).
func (e *GitTreeEntity) MatchTyped(match ...GitTree) GitTree {
	if len(match) > 0 {
		return typedFrom[GitTree](e.Match(asMap(match[0])))
	}
	return typedFrom[GitTree](e.Match())
}
...
func (e *GitTreeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GitTreeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GitTreeLoadMatch and returns an GitTree. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GitTreeEntity) LoadTyped(reqmatch GitTreeLoadMatch, ctrl map[string]any) (GitTree, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GitTree{}, err
	}
	return typedFrom[GitTree](res), nil
}



func (e *GitTreeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *GitTreeEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// GitTreeCreateData and returns an GitTree. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GitTreeEntity) CreateTyped(reqdata GitTreeCreateData, ctrl map[string]any) (GitTree, error) {
...
func (e *GitTreeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GitTreeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GitTreeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
