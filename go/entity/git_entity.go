...
func NewGitEntity(client *core.GithubSDK, entopts map[string]any) *GitEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GitEntity) GetName() string { return e.name }
...
func (e *GitEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GitEntity) Deleted() bool {
	return e.deleted
}


func (e *GitEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGitEntity(e.client, opts)
}

func (e *GitEntity) Data(args ...any) any {
...
func (e *GitEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Git; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GitEntity) DataTyped(data ...Git) Git {
	if len(data) > 0 {
		return typedFrom[Git](e.Data(asMap(data[0])))
	}
	return typedFrom[Git](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Git (all fields
// optional at the wire level).
func (e *GitEntity) MatchTyped(match ...Git) Git {
	if len(match) > 0 {
		return typedFrom[Git](e.Match(asMap(match[0])))
	}
	return typedFrom[Git](e.Match())
}
...
func (e *GitEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GitEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *GitEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GitEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GitEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *GitEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GitRemoveMatch and returns an Git. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *GitEntity) RemoveTyped(reqmatch GitRemoveMatch, ctrl map[string]any) (Git, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return Git{}, err
	}
	return typedFrom[Git](res), nil
}



func (e *GitEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
