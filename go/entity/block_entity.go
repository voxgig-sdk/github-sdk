...
func NewBlockEntity(client *core.GithubSDK, entopts map[string]any) *BlockEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BlockEntity) GetName() string { return e.name }
...
func (e *BlockEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BlockEntity) Deleted() bool {
	return e.deleted
}


func (e *BlockEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBlockEntity(e.client, opts)
}

func (e *BlockEntity) Data(args ...any) any {
...
func (e *BlockEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Block; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BlockEntity) DataTyped(data ...Block) Block {
	if len(data) > 0 {
		return typedFrom[Block](e.Data(asMap(data[0])))
	}
	return typedFrom[Block](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Block (all fields
// optional at the wire level).
func (e *BlockEntity) MatchTyped(match ...Block) Block {
	if len(match) > 0 {
		return typedFrom[Block](e.Match(asMap(match[0])))
	}
	return typedFrom[Block](e.Match())
}
...
func (e *BlockEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BlockEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *BlockEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BlockListMatch and returns []Block. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BlockEntity) ListTyped(reqmatch BlockListMatch, ctrl map[string]any) ([]Block, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Block](res), nil
}



func (e *BlockEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BlockEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BlockEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BlockEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
