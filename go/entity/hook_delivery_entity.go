...
type HookDeliveryEntity struct {
	name    string
...
func NewHookDeliveryEntity(client *core.GithubSDK, entopts map[string]any) *HookDeliveryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HookDeliveryEntity) GetName() string { return e.name }
...
func (e *HookDeliveryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HookDeliveryEntity) Deleted() bool {
	return e.deleted
}


func (e *HookDeliveryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHookDeliveryEntity(e.client, opts)
}

func (e *HookDeliveryEntity) Data(args ...any) any {
...
func (e *HookDeliveryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an HookDelivery; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *HookDeliveryEntity) DataTyped(data ...HookDelivery) HookDelivery {
	if len(data) > 0 {
		return typedFrom[HookDelivery](e.Data(asMap(data[0])))
	}
	return typedFrom[HookDelivery](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through HookDelivery (all fields
// optional at the wire level).
func (e *HookDeliveryEntity) MatchTyped(match ...HookDelivery) HookDelivery {
	if len(match) > 0 {
		return typedFrom[HookDelivery](e.Match(asMap(match[0])))
	}
	return typedFrom[HookDelivery](e.Match())
}
...
func (e *HookDeliveryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HookDeliveryEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HookDeliveryLoadMatch and returns an HookDelivery. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *HookDeliveryEntity) LoadTyped(reqmatch HookDeliveryLoadMatch, ctrl map[string]any) (HookDelivery, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return HookDelivery{}, err
	}
	return typedFrom[HookDelivery](res), nil
}



func (e *HookDeliveryEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *HookDeliveryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *HookDeliveryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HookDeliveryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HookDeliveryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
