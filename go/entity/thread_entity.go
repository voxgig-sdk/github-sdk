...
func NewThreadEntity(client *core.GithubSDK, entopts map[string]any) *ThreadEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ThreadEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ThreadLoadMatch and returns an Thread. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ThreadEntity) LoadTyped(reqmatch ThreadLoadMatch, ctrl map[string]any) (Thread, error) {
