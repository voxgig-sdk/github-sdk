...
class TestImportDirect:
    ...
    def test_should_direct_list_import(self):
        setup = _import_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-import", "live" if setup["live"] else "unit")
        if _skip:
