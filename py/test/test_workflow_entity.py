    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set GITHUB_TEST_WORKFLOW_ENTID JSON to run live")
        client = setup["client"]
        ...
        workflow_ref01_markdef_up0_value = "Mark01-workflow_ref01_" + str(setup["now"])
        workflow_ref01_data_up0_up[workflow_ref01_markdef_up0_name] = workflow_ref01_markdef_up0_value

        workflow_ref01_resdata_up0 = helpers.to_map(runner.entity_data(workflow_ref01_ent.update(workflow_ref01_data_up0_up, None)))
        assert workflow_ref01_resdata_up0 is not None
        assert workflow_ref01_resdata_up0["id"] == workflow_ref01_data_up0_up["id"]
        assert workflow_ref01_resdata_up0[workflow_ref01_markdef_up0_name] == workflow_ref01_markdef_up0_value
...
def _workflow_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("GITHUB_TEST_WORKFLOW_ENTID"))
