...
class TestInteractionDirect:
    ...
    def test_should_direct_load_interaction(self):
        setup = _interaction_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-interaction", "live" if setup["live"] else "unit")
        if _skip:
