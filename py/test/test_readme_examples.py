# Github SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GithubSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GithubSDK(...) and GithubSDK.test(...) become
#      GithubSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "github_sdk"
_SDK_CLASS = "GithubSDK"
...
_ENTITIES = {
    "Action": "action",
    "ActionsArtifactAndLogRetention": "actions_artifact_and_log_retention",
    "ActionsCacheList": "actions_cache_list",
    "ActionsCacheUsageByRepository": "actions_cache_usage_by_repository",
    "ActionsCacheUsageOrgEnterprise": "actions_cache_usage_org_enterprise",
    "ActionsForkPrContributorApproval": "actions_fork_pr_contributor_approval",
    "ActionsForkPrWorkflowsPrivateRepo": "actions_fork_pr_workflows_private_repo",
    "ActionsGetDefaultWorkflowPermission": "actions_get_default_workflow_permission",
    "ActionsHostedRunner": "actions_hosted_runner",
    "ActionsHostedRunnerLimit": "actions_hosted_runner_limit",
    "ActionsOrganizationPermission": "actions_organization_permission",
    "ActionsPublicKey": "actions_public_key",
    "ActionsRepositoryPermission": "actions_repository_permission",
    "ActionsSecret": "actions_secret",
    "ActionsVariable": "actions_variable",
    "ActionsWorkflowAccessToRepository": "actions_workflow_access_to_repository",
    "Activity": "activity",
    "Add": "add",
    "ApiInsightsRouteStat": "api_insights_route_stat",
    "ApiInsightsSubjectStat": "api_insights_subject_stat",
    "ApiInsightsSummaryStat": "api_insights_summary_stat",
    "ApiInsightsTimeStat": "api_insights_time_stat",
    "ApiInsightsUserStat": "api_insights_user_stat",
    "ApiOverview": "api_overview",
    "App": "app",
    "Artifact": "artifact",
    "Assignee": "assignee",
    ...
    "Autolink": "autolink",
    "BaseGist": "base_gist",
    "BillingUsageReport": "billing_usage_report",
    "BillingUsageReportUser": "billing_usage_report_user",
    "Blob": "blob",
    "Block": "block",
    "Branch": "branch",
    "BranchProtection": "branch_protection",
    "BranchRestrictionPolicy": "branch_restriction_policy",
    "BranchShort": "branch_short",
    "BranchWithProtection": "branch_with_protection",
    "Campaign": "campaign",
    "Check": "check",
    "CheckAnnotation": "check_annotation",
    "CheckAutomatedSecurityFix": "check_automated_security_fix",
    "CheckRun": "check_run",
    "CheckSuite": "check_suite",
    "CheckSuitePreference": "check_suite_preference",
    "Classroom": "classroom",
    "ClassroomAcceptedAssignment": "classroom_accepted_assignment",
    "ClassroomAssignment": "classroom_assignment",
    "ClassroomAssignmentGrade": "classroom_assignment_grade",
    "Clone": "clone",
    "CodeFrequency": "code_frequency",
    "CodeFrequencyStat": "code_frequency_stat",
    "CodeOfConduct": "code_of_conduct",
    "CodeScanning": "code_scanning",
    "CodeScanningAlert": "code_scanning_alert",
    "CodeScanningAlertInstance": "code_scanning_alert_instance",
    "CodeScanningAlertItem": "code_scanning_alert_item",
    "CodeScanningAnalysi": "code_scanning_analysi",
    "CodeScanningAnalysisDeletion": "code_scanning_analysis_deletion",
    "CodeScanningAutofix": "code_scanning_autofix",
    "CodeScanningAutofixCommit": "code_scanning_autofix_commit",
    "CodeScanningCodeqlDatabase": "code_scanning_codeql_database",
    "CodeScanningDefaultSetup": "code_scanning_default_setup",
    "CodeScanningOrganizationAlertItem": "code_scanning_organization_alert_item",
    "CodeScanningSarifsStatus": "code_scanning_sarifs_status",
    "CodeScanningVariantAnalysi": "code_scanning_variant_analysi",
    "CodeScanningVariantAnalysisRepoTask": "code_scanning_variant_analysis_repo_task",
    "CodeSecurity": "code_security",
    "CodeSecurityConfiguration": "code_security_configuration",
    "CodeSecurityConfigurationRepository": "code_security_configuration_repository",
    "CodeSecurityDefaultConfiguration": "code_security_default_configuration",
    "CodeownersError": "codeowners_error",
    "Codespace": "codespace",
    "Collaborator": "collaborator",
    "CombinedBillingUsage": "combined_billing_usage",
    "CombinedCommitStatus": "combined_commit_status",
    "Commit": "commit",
    "CommitActivity": "commit_activity",
    "CommitComment": "commit_comment",
    "CommitComparison": "commit_comparison",
    "CommunityProfile": "community_profile",
    "ContentFile": "content_file",
    "ContentTraffic": "content_traffic",
    "Contributor": "contributor",
    "Copilot": "copilot",
    "CopilotOrganizationDetail": "copilot_organization_detail",
    "CopilotUsageMetricsDay": "copilot_usage_metrics_day",
    "Credential": "credential",
    "CustomProperty": "custom_property",
    "CustomPropertyValue": "custom_property_value",
    "Dependabot": "dependabot",
    "DependabotAlert": "dependabot_alert",
    "DependabotAlertWithRepository": "dependabot_alert_with_repository",
    "DependabotPublicKey": "dependabot_public_key",
    "DependabotRepositoryAccessDetail": "dependabot_repository_access_detail",
    "DependabotSecret": "dependabot_secret",
    "DependencyGraph": "dependency_graph",
    "DependencyGraphDiff": "dependency_graph_diff",
    "DependencyGraphSpdxSbom": "dependency_graph_spdx_sbom",
    ...
    "EnterpriseTeamMembership": "enterprise_team_membership",
    ...
    "GistCommit": "gist_commit",
    "GistSimple": "gist_simple",
    "Git": "git",
    ...
    "GlobalAdvisory": "global_advisory",
    "GpgKey": "gpg_key",
    "Hook": "hook",
    "HookDelivery": "hook_delivery",
    "HookDeliveryItem": "hook_delivery_item",
    "HostedCompute": "hosted_compute",
    "Hovercard": "hovercard",
    "Import": "import",
    ...
    "License": "license",
    "Markdown": "markdown",
    "MarketplaceListingPlan": "marketplace_listing_plan",
    "MarketplacePurchase": "marketplace_purchase",
    "Member": "member",
    "Membership": "membership",
    "MergedUpstream": "merged_upstream",
    "Meta": "meta",
    "Metaroot": "metaroot",
    "Migration": "migration",
    "Milestone": "milestone",
    "MinimalRepository": "minimal_repository",
    "NetworkConfiguration": "network_configuration",
    "NetworkSetting": "network_setting",
    "OidcCustomSub": "oidc_custom_sub",
    "OidcCustomSubRepo": "oidc_custom_sub_repo",
    "Org": "org",
    "OrgHook": "org_hook",
    "OrgMembership": "org_membership",
    "OrgPrivateRegistryConfiguration": "org_private_registry_configuration",
    "OrgPrivateRegistryConfigurationWithSelectedRepository": "org_private_registry_configuration_with_selected_repository",
    "OrgRepoCustomPropertyValue": "org_repo_custom_property_value",
    "Organization": "organization",
    "OrganizationActionsSecret": "organization_actions_secret",
    "OrganizationActionsVariable": "organization_actions_variable",
    "OrganizationDependabotSecret": "organization_dependabot_secret",
    "OrganizationInvitation": "organization_invitation",
    "OrganizationProgrammaticAccessGrant": "organization_programmatic_access_grant",
    "OrganizationRole": "organization_role",
    "OrganizationSecretScanningAlert": "organization_secret_scanning_alert",
    "OutsideCollaborator": "outside_collaborator",
    "Package": "package",
    "Page": "page",
    "PageBuild": "page_build",
    "PageBuildStatus": "page_build_status",
    "PageDeployment": "page_deployment",
    "PagesDeploymentStatus": "pages_deployment_status",
    "PagesHealthCheck": "pages_health_check",
    "Participation": "participation",
    "PendingDeployment": "pending_deployment",
    "PorterAuthor": "porter_author",
    "PorterLargeFile": "porter_large_file",
    "PrivateRegistry": "private_registry",
    "PrivateUser": "private_user",
    "Project": "project",
    "ProjectCollaboratorPermission": "project_collaborator_permission",
    "ProjectColumn": "project_column",
    "ProjectsClassic": "projects_classic",
    "ProjectsV2": "projects_v2",
    "ProjectsV2Field": "projects_v2_field",
    "ProjectsV2ItemSimple": "projects_v2_item_simple",
    "ProjectsV2ItemWithContent": "projects_v2_item_with_content",
    "ProtectedBranch": "protected_branch",
    "ProtectedBranchAdminEnforced": "protected_branch_admin_enforced",
    "ProtectedBranchPullRequestReview": "protected_branch_pull_request_review",
    "PublicMember": "public_member",
    "Pull": "pull",
    "PullRequestReview": "pull_request_review",
    "PullRequestReviewComment": "pull_request_review_comment",
    "PullRequestSimple": "pull_request_simple",
    "RateLimit": "rate_limit",
    "Reaction": "reaction",
    "Referrer": "referrer",
    "Release": "release",
    "ReleaseAsset": "release_asset",
    "ReleaseNotesContent": "release_notes_content",
    "Remove": "remove",
    "Repo": "repo",
    "Repository": "repository",
    "RepositoryAdvisory": "repository_advisory",
    "RepositoryCollaboratorPermission": "repository_collaborator_permission",
    "RepositoryInvitation": "repository_invitation",
    "RepositoryRuleDetailed": "repository_rule_detailed",
    "RepositoryRuleset": "repository_ruleset",
    "RepositorySubscription": "repository_subscription",
    "ReviewComment": "review_comment",
    "RuleSuite": "rule_suite",
    "RulesetVersion": "ruleset_version",
    "RulesetVersionWithState": "ruleset_version_with_state",
    "Runner": "runner",
    "RunnerApplication": "runner_application",
    "RunnerGroup": "runner_group",
    "Search": "search",
    "SecretScanning": "secret_scanning",
    "SecretScanningAlert": "secret_scanning_alert",
    "SecretScanningLocation": "secret_scanning_location",
    "SecretScanningPatternConfiguration": "secret_scanning_pattern_configuration",
    "SecretScanningPushProtectionBypass": "secret_scanning_push_protection_bypass",
    "SecretScanningScanHistory": "secret_scanning_scan_history",
    "SecurityAdvisory": "security_advisory",
    "SelectedAction": "selected_action",
    "SelfHostedRunner": "self_hosted_runner",
    "ShortBlob": "short_blob",
    "ShortBranch": "short_branch",
    "SimpleClassroom": "simple_classroom",
    "SimpleClassroomAssignment": "simple_classroom_assignment",
    "SocialAccount": "social_account",
    "SshSigningKey": "ssh_signing_key",
    "Status": "status",
    "StatusCheckPolicy": "status_check_policy",
    "Subscriber": "subscriber",
    "Tag": "tag",
    "TagProtection": "tag_protection",
    "Team": "team",
    "TeamSimple": "team_simple",
    "Thread": "thread",
    "ThreadSubscription": "thread_subscription",
    "Topic": "topic",
    "User": "user",
    "UserMarketplacePurchase": "user_marketplace_purchase",
    "View": "view",
