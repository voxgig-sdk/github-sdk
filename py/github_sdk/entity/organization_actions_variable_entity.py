...
class OrganizationActionsVariableEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrganizationActionsVariableEntity(self._client, opts)
    ...
    def data_get(self) -> OrganizationActionsVariable:
    ...
    def match_get(self) -> OrganizationActionsVariable:
    ...
    def load(self, reqmatch=None, ctrl=None) -> OrganizationActionsVariable:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.OrganizationActionsVariable().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
