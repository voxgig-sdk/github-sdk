...
class GistCommitEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GistCommitEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GistCommit]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GistCommit().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
