...
class AuthenticationTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AuthenticationTokenEntity(self._client, opts)
    ...
    def data_get(self) -> AuthenticationToken:
    ...
    def match_get(self) -> AuthenticationToken:
    ...
    def create(self, reqdata: AuthenticationTokenCreateData, ctrl=None) -> AuthenticationToken:
        utility = self._utility
