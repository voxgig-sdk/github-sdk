...
class PagesDeploymentStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PagesDeploymentStatusEntity(self._client, opts)
    ...
    def data_get(self) -> PagesDeploymentStatus:
    ...
    def match_get(self) -> PagesDeploymentStatus:
    ...
    def load(self, reqmatch=None, ctrl=None) -> PagesDeploymentStatus:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.PagesDeploymentStatus().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: PagesDeploymentStatusCreateData, ctrl=None) -> PagesDeploymentStatus:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
