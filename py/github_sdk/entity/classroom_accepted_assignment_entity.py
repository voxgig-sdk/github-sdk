...
class ClassroomAcceptedAssignmentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ClassroomAcceptedAssignmentEntity(self._client, opts)
    ...
    def data_get(self) -> ClassroomAcceptedAssignment:
    ...
    def match_get(self) -> ClassroomAcceptedAssignment:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ClassroomAcceptedAssignment]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ClassroomAcceptedAssignment().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
