...
class CodeScanningAutofixCommitEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CodeScanningAutofixCommitEntity(self._client, opts)
    ...
    def data_get(self) -> CodeScanningAutofixCommit:
    ...
    def match_get(self) -> CodeScanningAutofixCommit:
    ...
    def create(self, reqdata: CodeScanningAutofixCommitCreateData, ctrl=None) -> CodeScanningAutofixCommit:
        utility = self._utility
