...
class UserMarketplacePurchaseEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UserMarketplacePurchaseEntity(self._client, opts)
    ...
    def data_get(self) -> UserMarketplacePurchase:
    ...
    def match_get(self) -> UserMarketplacePurchase:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[UserMarketplacePurchase]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.UserMarketplacePurchase().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
