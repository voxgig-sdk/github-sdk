...
class PorterLargeFileEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PorterLargeFileEntity(self._client, opts)
    ...
    def data_get(self) -> PorterLargeFile:
    ...
    def match_get(self) -> PorterLargeFile:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PorterLargeFile]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PorterLargeFile().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
