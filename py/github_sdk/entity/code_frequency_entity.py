...
class CodeFrequencyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CodeFrequencyEntity(self._client, opts)
    ...
    def data_get(self) -> CodeFrequency:
    ...
    def match_get(self) -> CodeFrequency:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CodeFrequency]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CodeFrequency().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
