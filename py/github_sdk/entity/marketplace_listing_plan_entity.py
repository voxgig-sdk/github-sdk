...
class MarketplaceListingPlanEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MarketplaceListingPlanEntity(self._client, opts)
    ...
    def data_get(self) -> MarketplaceListingPlan:
    ...
    def match_get(self) -> MarketplaceListingPlan:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MarketplaceListingPlan]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MarketplaceListingPlan().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
