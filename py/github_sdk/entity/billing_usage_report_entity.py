...
class BillingUsageReportEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BillingUsageReportEntity(self._client, opts)
    ...
    def data_get(self) -> BillingUsageReport:
    ...
    def match_get(self) -> BillingUsageReport:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[BillingUsageReport]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.BillingUsageReport().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
