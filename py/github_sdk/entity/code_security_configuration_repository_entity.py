...
class CodeSecurityConfigurationRepositoryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CodeSecurityConfigurationRepositoryEntity(self._client, opts)
    ...
    def data_get(self) -> CodeSecurityConfigurationRepository:
    ...
    def match_get(self) -> CodeSecurityConfigurationRepository:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CodeSecurityConfigurationRepository]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CodeSecurityConfigurationRepository().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
