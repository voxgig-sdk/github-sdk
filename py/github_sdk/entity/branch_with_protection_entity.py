...
class BranchWithProtectionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BranchWithProtectionEntity(self._client, opts)
    ...
    def data_get(self) -> BranchWithProtection:
    ...
    def match_get(self) -> BranchWithProtection:
    ...
    def create(self, reqdata: BranchWithProtectionCreateData, ctrl=None) -> BranchWithProtection:
        utility = self._utility
