...
class CheckAutomatedSecurityFixEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CheckAutomatedSecurityFixEntity(self._client, opts)
    ...
    def data_get(self) -> CheckAutomatedSecurityFix:
    ...
    def match_get(self) -> CheckAutomatedSecurityFix:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CheckAutomatedSecurityFix:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CheckAutomatedSecurityFix().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
