...
class ApiInsightsSubjectStatEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiInsightsSubjectStatEntity(self._client, opts)
    ...
    def data_get(self) -> ApiInsightsSubjectStat:
    ...
    def match_get(self) -> ApiInsightsSubjectStat:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiInsightsSubjectStat]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiInsightsSubjectStat().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
