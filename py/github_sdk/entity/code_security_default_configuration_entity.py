...
class CodeSecurityDefaultConfigurationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CodeSecurityDefaultConfigurationEntity(self._client, opts)
    ...
    def data_get(self) -> CodeSecurityDefaultConfiguration:
    ...
    def match_get(self) -> CodeSecurityDefaultConfiguration:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CodeSecurityDefaultConfiguration]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CodeSecurityDefaultConfiguration().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
