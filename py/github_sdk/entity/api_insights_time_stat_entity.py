...
class ApiInsightsTimeStatEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiInsightsTimeStatEntity(self._client, opts)
    ...
    def data_get(self) -> ApiInsightsTimeStat:
    ...
    def match_get(self) -> ApiInsightsTimeStat:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiInsightsTimeStat:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiInsightsTimeStat().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiInsightsTimeStat]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiInsightsTimeStat().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
