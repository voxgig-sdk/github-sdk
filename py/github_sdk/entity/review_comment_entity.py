...
class ReviewCommentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ReviewCommentEntity(self._client, opts)
    ...
    def data_get(self) -> ReviewComment:
    ...
    def match_get(self) -> ReviewComment:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ReviewComment]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ReviewComment().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
