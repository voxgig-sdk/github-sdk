...
class CodeScanningAlertItemEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CodeScanningAlertItemEntity(self._client, opts)
    ...
    def data_get(self) -> CodeScanningAlertItem:
    ...
    def match_get(self) -> CodeScanningAlertItem:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CodeScanningAlertItem]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CodeScanningAlertItem().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
