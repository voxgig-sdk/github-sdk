...
class OrgRepoCustomPropertyValueEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrgRepoCustomPropertyValueEntity(self._client, opts)
    ...
    def data_get(self) -> OrgRepoCustomPropertyValue:
    ...
    def match_get(self) -> OrgRepoCustomPropertyValue:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[OrgRepoCustomPropertyValue]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.OrgRepoCustomPropertyValue().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
