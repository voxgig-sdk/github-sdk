...
class HookDeliveryItemEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return HookDeliveryItemEntity(self._client, opts)
    ...
    def data_get(self) -> HookDeliveryItem:
    ...
    def match_get(self) -> HookDeliveryItem:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[HookDeliveryItem]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.HookDeliveryItem().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
