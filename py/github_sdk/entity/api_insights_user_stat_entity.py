...
class ApiInsightsUserStatEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiInsightsUserStatEntity(self._client, opts)
    ...
    def data_get(self) -> ApiInsightsUserStat:
    ...
    def match_get(self) -> ApiInsightsUserStat:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiInsightsUserStat:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiInsightsUserStat().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
