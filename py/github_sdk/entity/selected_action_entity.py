...
class SelectedActionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SelectedActionEntity(self._client, opts)
    ...
    def data_get(self) -> SelectedAction:
    ...
    def match_get(self) -> SelectedAction:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[SelectedAction]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.SelectedAction().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
