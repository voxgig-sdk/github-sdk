...
class IntegrationInstallationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return IntegrationInstallationEntity(self._client, opts)
    ...
    def data_get(self) -> IntegrationInstallation:
    ...
    def match_get(self) -> IntegrationInstallation:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[IntegrationInstallation]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.IntegrationInstallation().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
