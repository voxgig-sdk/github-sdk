...
class RepositorySubscriptionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RepositorySubscriptionEntity(self._client, opts)
    ...
    def data_get(self) -> RepositorySubscription:
    ...
    def match_get(self) -> RepositorySubscription:
    ...
    def load(self, reqmatch=None, ctrl=None) -> RepositorySubscription:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.RepositorySubscription().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: RepositorySubscriptionUpdateData, ctrl=None) -> RepositorySubscription:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
