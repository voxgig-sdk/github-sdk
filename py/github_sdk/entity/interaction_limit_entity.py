...
class InteractionLimitEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return InteractionLimitEntity(self._client, opts)
    ...
    def data_get(self) -> InteractionLimit:
    ...
    def match_get(self) -> InteractionLimit:
    ...
    def update(self, reqdata: InteractionLimitUpdateData, ctrl=None) -> InteractionLimit:
        utility = self._utility
