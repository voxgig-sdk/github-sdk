...
class DependencyGraphSpdxSbomEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DependencyGraphSpdxSbomEntity(self._client, opts)
    ...
    def data_get(self) -> DependencyGraphSpdxSbom:
    ...
    def match_get(self) -> DependencyGraphSpdxSbom:
    ...
    def load(self, reqmatch=None, ctrl=None) -> DependencyGraphSpdxSbom:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.DependencyGraphSpdxSbom().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
