...
class CombinedBillingUsageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CombinedBillingUsageEntity(self._client, opts)
    ...
    def data_get(self) -> CombinedBillingUsage:
    ...
    def match_get(self) -> CombinedBillingUsage:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CombinedBillingUsage:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CombinedBillingUsage().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
