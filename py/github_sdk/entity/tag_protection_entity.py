...
class TagProtectionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TagProtectionEntity(self._client, opts)
    ...
    def data_get(self) -> TagProtection:
    ...
    def match_get(self) -> TagProtection:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[TagProtection]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.TagProtection().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: TagProtectionCreateData, ctrl=None) -> TagProtection:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
