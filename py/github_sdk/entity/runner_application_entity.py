...
class RunnerApplicationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RunnerApplicationEntity(self._client, opts)
    ...
    def data_get(self) -> RunnerApplication:
    ...
    def match_get(self) -> RunnerApplication:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[RunnerApplication]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.RunnerApplication().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
