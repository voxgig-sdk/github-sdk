...
class MarkdownEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MarkdownEntity(self._client, opts)
    ...
    def create(self, reqdata: MarkdownCreateData, ctrl=None) -> Markdown:
        utility = self._utility
