...
class CodeScanningVariantAnalysiEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CodeScanningVariantAnalysiEntity(self._client, opts)
    ...
    def data_get(self) -> CodeScanningVariantAnalysi:
    ...
    def match_get(self) -> CodeScanningVariantAnalysi:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CodeScanningVariantAnalysi:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CodeScanningVariantAnalysi().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: CodeScanningVariantAnalysiCreateData, ctrl=None) -> CodeScanningVariantAnalysi:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
