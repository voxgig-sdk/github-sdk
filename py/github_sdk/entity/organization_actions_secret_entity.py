...
class OrganizationActionsSecretEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrganizationActionsSecretEntity(self._client, opts)
    ...
    def data_get(self) -> OrganizationActionsSecret:
    ...
    def match_get(self) -> OrganizationActionsSecret:
    ...
    def load(self, reqmatch=None, ctrl=None) -> OrganizationActionsSecret:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.OrganizationActionsSecret().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
