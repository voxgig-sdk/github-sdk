...
class OrganizationInvitationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrganizationInvitationEntity(self._client, opts)
    ...
    def data_get(self) -> OrganizationInvitation:
    ...
    def match_get(self) -> OrganizationInvitation:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[OrganizationInvitation]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.OrganizationInvitation().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: OrganizationInvitationCreateData, ctrl=None) -> OrganizationInvitation:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
