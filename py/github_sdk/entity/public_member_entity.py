...
class PublicMemberEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PublicMemberEntity(self._client, opts)
    ...
    def data_get(self) -> PublicMember:
    ...
    def match_get(self) -> PublicMember:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PublicMember]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PublicMember().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
