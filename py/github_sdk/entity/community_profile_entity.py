...
class CommunityProfileEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CommunityProfileEntity(self._client, opts)
    ...
    def data_get(self) -> CommunityProfile:
    ...
    def match_get(self) -> CommunityProfile:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CommunityProfile:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CommunityProfile().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
