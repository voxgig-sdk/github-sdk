...
class CheckSuitePreferenceEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CheckSuitePreferenceEntity(self._client, opts)
    ...
    def data_get(self) -> CheckSuitePreference:
    ...
    def match_get(self) -> CheckSuitePreference:
    ...
    def update(self, reqdata: CheckSuitePreferenceUpdateData, ctrl=None) -> CheckSuitePreference:
        utility = self._utility
