...
class RepositoryRuleDetailedEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RepositoryRuleDetailedEntity(self._client, opts)
    ...
    def data_get(self) -> RepositoryRuleDetailed:
    ...
    def match_get(self) -> RepositoryRuleDetailed:
    ...
    def load(self, reqmatch=None, ctrl=None) -> RepositoryRuleDetailed:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.RepositoryRuleDetailed().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
