...
class ReleaseNotesContentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ReleaseNotesContentEntity(self._client, opts)
    ...
    def data_get(self) -> ReleaseNotesContent:
    ...
    def match_get(self) -> ReleaseNotesContent:
    ...
    def create(self, reqdata: ReleaseNotesContentCreateData, ctrl=None) -> ReleaseNotesContent:
        utility = self._utility
