...
class SecretScanningLocationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SecretScanningLocationEntity(self._client, opts)
    ...
    def data_get(self) -> SecretScanningLocation:
    ...
    def match_get(self) -> SecretScanningLocation:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[SecretScanningLocation]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.SecretScanningLocation().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
