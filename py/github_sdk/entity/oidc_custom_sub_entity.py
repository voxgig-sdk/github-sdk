...
class OidcCustomSubEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OidcCustomSubEntity(self._client, opts)
    ...
    def data_get(self) -> OidcCustomSub:
    ...
    def match_get(self) -> OidcCustomSub:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[OidcCustomSub]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.OidcCustomSub().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
