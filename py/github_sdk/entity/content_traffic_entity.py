...
class ContentTrafficEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ContentTrafficEntity(self._client, opts)
    ...
    def data_get(self) -> ContentTraffic:
    ...
    def match_get(self) -> ContentTraffic:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ContentTraffic]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ContentTraffic().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
