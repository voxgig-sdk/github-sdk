...
class ClassroomAssignmentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ClassroomAssignmentEntity(self._client, opts)
    ...
    def data_get(self) -> ClassroomAssignment:
    ...
    def match_get(self) -> ClassroomAssignment:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ClassroomAssignment:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ClassroomAssignment().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
