...
class BranchProtectionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BranchProtectionEntity(self._client, opts)
    ...
    def data_get(self) -> BranchProtection:
    ...
    def match_get(self) -> BranchProtection:
    ...
    def load(self, reqmatch=None, ctrl=None) -> BranchProtection:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.BranchProtection().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
