...
from github_sdk.github_types import (
    RepositoryRuleset,
    RepositoryRulesetLoadMatch,
    RepositoryRulesetListMatch,
    RepositoryRulesetCreateData,
    RepositoryRulesetUpdateData,
)
...
class RepositoryRulesetEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RepositoryRulesetEntity(self._client, opts)
    ...
    def data_get(self) -> RepositoryRuleset:
    ...
    def match_get(self) -> RepositoryRuleset:
    ...
    def load(self, reqmatch=None, ctrl=None) -> RepositoryRuleset:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.RepositoryRuleset().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[RepositoryRuleset]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.RepositoryRuleset().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: RepositoryRulesetCreateData, ctrl=None) -> RepositoryRuleset:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: RepositoryRulesetUpdateData, ctrl=None) -> RepositoryRuleset:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
