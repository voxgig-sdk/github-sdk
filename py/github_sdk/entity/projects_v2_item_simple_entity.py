...
class ProjectsV2ItemSimpleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ProjectsV2ItemSimpleEntity(self._client, opts)
    ...
    def data_get(self) -> ProjectsV2ItemSimple:
    ...
    def match_get(self) -> ProjectsV2ItemSimple:
    ...
    def create(self, reqdata: ProjectsV2ItemSimpleCreateData, ctrl=None) -> ProjectsV2ItemSimple:
        utility = self._utility
