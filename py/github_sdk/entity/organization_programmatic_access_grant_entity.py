...
class OrganizationProgrammaticAccessGrantEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrganizationProgrammaticAccessGrantEntity(self._client, opts)
    ...
    def data_get(self) -> OrganizationProgrammaticAccessGrant:
    ...
    def match_get(self) -> OrganizationProgrammaticAccessGrant:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[OrganizationProgrammaticAccessGrant]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.OrganizationProgrammaticAccessGrant().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
