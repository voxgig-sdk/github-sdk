...
class CodeScanningAutofixEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CodeScanningAutofixEntity(self._client, opts)
    ...
    def data_get(self) -> CodeScanningAutofix:
    ...
    def match_get(self) -> CodeScanningAutofix:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CodeScanningAutofix:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CodeScanningAutofix().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: CodeScanningAutofixCreateData, ctrl=None) -> CodeScanningAutofix:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
