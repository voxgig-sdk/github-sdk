...
class MinimalRepositoryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MinimalRepositoryEntity(self._client, opts)
    ...
    def data_get(self) -> MinimalRepository:
    ...
    def match_get(self) -> MinimalRepository:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MinimalRepository]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MinimalRepository().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
