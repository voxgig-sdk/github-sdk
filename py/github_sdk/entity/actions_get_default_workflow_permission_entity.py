...
class ActionsGetDefaultWorkflowPermissionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsGetDefaultWorkflowPermissionEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsGetDefaultWorkflowPermission:
    ...
    def match_get(self) -> ActionsGetDefaultWorkflowPermission:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ActionsGetDefaultWorkflowPermission:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ActionsGetDefaultWorkflowPermission().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
