...
class OutsideCollaboratorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutsideCollaboratorEntity(self._client, opts)
    ...
    def data_get(self) -> OutsideCollaborator:
    ...
    def match_get(self) -> OutsideCollaborator:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[OutsideCollaborator]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.OutsideCollaborator().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
