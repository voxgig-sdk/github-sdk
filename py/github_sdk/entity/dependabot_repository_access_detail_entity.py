...
class DependabotRepositoryAccessDetailEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DependabotRepositoryAccessDetailEntity(self._client, opts)
    ...
    def data_get(self) -> DependabotRepositoryAccessDetail:
    ...
    def match_get(self) -> DependabotRepositoryAccessDetail:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[DependabotRepositoryAccessDetail]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.DependabotRepositoryAccessDetail().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
