...
class CodeScanningAlertInstanceEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CodeScanningAlertInstanceEntity(self._client, opts)
    ...
    def data_get(self) -> CodeScanningAlertInstance:
    ...
    def match_get(self) -> CodeScanningAlertInstance:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CodeScanningAlertInstance]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CodeScanningAlertInstance().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
