...
class ProtectedBranchPullRequestReviewEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ProtectedBranchPullRequestReviewEntity(self._client, opts)
    ...
    def data_get(self) -> ProtectedBranchPullRequestReview:
    ...
    def match_get(self) -> ProtectedBranchPullRequestReview:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ProtectedBranchPullRequestReview:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ProtectedBranchPullRequestReview().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: ProtectedBranchPullRequestReviewUpdateData, ctrl=None) -> ProtectedBranchPullRequestReview:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
