...
class BlockEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BlockEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Block]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Block().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
