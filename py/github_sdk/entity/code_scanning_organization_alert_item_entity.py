...
class CodeScanningOrganizationAlertItemEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CodeScanningOrganizationAlertItemEntity(self._client, opts)
    ...
    def data_get(self) -> CodeScanningOrganizationAlertItem:
    ...
    def match_get(self) -> CodeScanningOrganizationAlertItem:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CodeScanningOrganizationAlertItem]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CodeScanningOrganizationAlertItem().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
