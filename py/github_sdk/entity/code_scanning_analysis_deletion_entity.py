...
class CodeScanningAnalysisDeletionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CodeScanningAnalysisDeletionEntity(self._client, opts)
    ...
    def data_get(self) -> CodeScanningAnalysisDeletion:
    ...
    def match_get(self) -> CodeScanningAnalysisDeletion:
    ...
    def remove(self, reqmatch=None, ctrl=None) -> CodeScanningAnalysisDeletion:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key removes with no
        # match. Treat None as an empty match so client.CodeScanningAnalysisDeletion().remove()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
