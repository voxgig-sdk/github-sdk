...
class CodeScanningSarifsStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CodeScanningSarifsStatusEntity(self._client, opts)
    ...
    def data_get(self) -> CodeScanningSarifsStatus:
    ...
    def match_get(self) -> CodeScanningSarifsStatus:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CodeScanningSarifsStatus:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CodeScanningSarifsStatus().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
