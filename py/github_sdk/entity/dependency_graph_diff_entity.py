...
class DependencyGraphDiffEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DependencyGraphDiffEntity(self._client, opts)
    ...
    def data_get(self) -> DependencyGraphDiff:
    ...
    def match_get(self) -> DependencyGraphDiff:
    ...
    def load(self, reqmatch=None, ctrl=None) -> DependencyGraphDiff:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.DependencyGraphDiff().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
