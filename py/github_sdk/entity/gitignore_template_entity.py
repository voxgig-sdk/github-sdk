...
class GitignoreTemplateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GitignoreTemplateEntity(self._client, opts)
    ...
    def data_get(self) -> GitignoreTemplate:
    ...
    def match_get(self) -> GitignoreTemplate:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GitignoreTemplate:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GitignoreTemplate().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
