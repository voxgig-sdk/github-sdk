...
class StatusCheckPolicyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return StatusCheckPolicyEntity(self._client, opts)
    ...
    def data_get(self) -> StatusCheckPolicy:
    ...
    def match_get(self) -> StatusCheckPolicy:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[StatusCheckPolicy]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.StatusCheckPolicy().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: StatusCheckPolicyUpdateData, ctrl=None) -> StatusCheckPolicy:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
