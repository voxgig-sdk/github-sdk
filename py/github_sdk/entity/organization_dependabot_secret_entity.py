...
class OrganizationDependabotSecretEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrganizationDependabotSecretEntity(self._client, opts)
    ...
    def data_get(self) -> OrganizationDependabotSecret:
    ...
    def match_get(self) -> OrganizationDependabotSecret:
    ...
    def load(self, reqmatch=None, ctrl=None) -> OrganizationDependabotSecret:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.OrganizationDependabotSecret().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
