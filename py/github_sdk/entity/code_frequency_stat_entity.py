...
class CodeFrequencyStatEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CodeFrequencyStatEntity(self._client, opts)
    ...
    def data_get(self) -> CodeFrequencyStat:
    ...
    def match_get(self) -> CodeFrequencyStat:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CodeFrequencyStat]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CodeFrequencyStat().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
