...
class ActionsCacheUsageByRepositoryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsCacheUsageByRepositoryEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsCacheUsageByRepository:
    ...
    def match_get(self) -> ActionsCacheUsageByRepository:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ActionsCacheUsageByRepository:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ActionsCacheUsageByRepository().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
