...
class ApiInsightsRouteStatEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiInsightsRouteStatEntity(self._client, opts)
    ...
    def data_get(self) -> ApiInsightsRouteStat:
    ...
    def match_get(self) -> ApiInsightsRouteStat:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiInsightsRouteStat]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiInsightsRouteStat().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
