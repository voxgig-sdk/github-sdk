...
class ActionsForkPrWorkflowsPrivateRepoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsForkPrWorkflowsPrivateRepoEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsForkPrWorkflowsPrivateRepo:
    ...
    def match_get(self) -> ActionsForkPrWorkflowsPrivateRepo:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ActionsForkPrWorkflowsPrivateRepo:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ActionsForkPrWorkflowsPrivateRepo().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
