...
class SocialAccountEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SocialAccountEntity(self._client, opts)
    ...
    def data_get(self) -> SocialAccount:
    ...
    def match_get(self) -> SocialAccount:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[SocialAccount]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.SocialAccount().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: SocialAccountCreateData, ctrl=None) -> SocialAccount:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
