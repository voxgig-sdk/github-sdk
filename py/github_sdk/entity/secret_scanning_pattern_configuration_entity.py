...
class SecretScanningPatternConfigurationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SecretScanningPatternConfigurationEntity(self._client, opts)
    ...
    def data_get(self) -> SecretScanningPatternConfiguration:
    ...
    def match_get(self) -> SecretScanningPatternConfiguration:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[SecretScanningPatternConfiguration]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.SecretScanningPatternConfiguration().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
