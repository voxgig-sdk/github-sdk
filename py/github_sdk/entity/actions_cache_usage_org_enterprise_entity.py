...
class ActionsCacheUsageOrgEnterpriseEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsCacheUsageOrgEnterpriseEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsCacheUsageOrgEnterprise:
    ...
    def match_get(self) -> ActionsCacheUsageOrgEnterprise:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ActionsCacheUsageOrgEnterprise:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ActionsCacheUsageOrgEnterprise().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
