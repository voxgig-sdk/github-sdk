...
class PorterAuthorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PorterAuthorEntity(self._client, opts)
    ...
    def data_get(self) -> PorterAuthor:
    ...
    def match_get(self) -> PorterAuthor:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PorterAuthor]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PorterAuthor().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: PorterAuthorUpdateData, ctrl=None) -> PorterAuthor:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
