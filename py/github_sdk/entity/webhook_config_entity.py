...
class WebhookConfigEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WebhookConfigEntity(self._client, opts)
    ...
    def data_get(self) -> WebhookConfig:
    ...
    def match_get(self) -> WebhookConfig:
    ...
    def load(self, reqmatch=None, ctrl=None) -> WebhookConfig:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.WebhookConfig().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: WebhookConfigUpdateData, ctrl=None) -> WebhookConfig:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
