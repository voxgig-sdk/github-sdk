...
class CodeScanningDefaultSetupEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CodeScanningDefaultSetupEntity(self._client, opts)
    ...
    def data_get(self) -> CodeScanningDefaultSetup:
    ...
    def match_get(self) -> CodeScanningDefaultSetup:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CodeScanningDefaultSetup]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CodeScanningDefaultSetup().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
