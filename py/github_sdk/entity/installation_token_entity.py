...
class InstallationTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return InstallationTokenEntity(self._client, opts)
    ...
    def data_get(self) -> InstallationToken:
    ...
    def match_get(self) -> InstallationToken:
    ...
    def create(self, reqdata: InstallationTokenCreateData, ctrl=None) -> InstallationToken:
        utility = self._utility
