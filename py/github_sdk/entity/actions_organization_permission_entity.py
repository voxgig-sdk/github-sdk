...
class ActionsOrganizationPermissionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsOrganizationPermissionEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsOrganizationPermission:
    ...
    def match_get(self) -> ActionsOrganizationPermission:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ActionsOrganizationPermission:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ActionsOrganizationPermission().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
