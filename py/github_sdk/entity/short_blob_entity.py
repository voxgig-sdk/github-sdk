...
class ShortBlobEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ShortBlobEntity(self._client, opts)
    ...
    def create(self, reqdata: ShortBlobCreateData, ctrl=None) -> ShortBlob:
        utility = self._utility
