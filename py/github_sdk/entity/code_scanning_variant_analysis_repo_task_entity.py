...
class CodeScanningVariantAnalysisRepoTaskEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CodeScanningVariantAnalysisRepoTaskEntity(self._client, opts)
    ...
    def data_get(self) -> CodeScanningVariantAnalysisRepoTask:
    ...
    def match_get(self) -> CodeScanningVariantAnalysisRepoTask:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CodeScanningVariantAnalysisRepoTask:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CodeScanningVariantAnalysisRepoTask().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
