...
class PendingDeploymentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PendingDeploymentEntity(self._client, opts)
    ...
    def data_get(self) -> PendingDeployment:
    ...
    def match_get(self) -> PendingDeployment:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PendingDeployment]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PendingDeployment().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
