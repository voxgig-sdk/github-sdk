...
class SecretScanningScanHistoryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SecretScanningScanHistoryEntity(self._client, opts)
    ...
    def data_get(self) -> SecretScanningScanHistory:
    ...
    def match_get(self) -> SecretScanningScanHistory:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[SecretScanningScanHistory]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.SecretScanningScanHistory().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
