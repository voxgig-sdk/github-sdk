...
class OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrgPrivateRegistryConfigurationWithSelectedRepositoryEntity(self._client, opts)
    ...
    def data_get(self) -> OrgPrivateRegistryConfigurationWithSelectedRepository:
    ...
    def match_get(self) -> OrgPrivateRegistryConfigurationWithSelectedRepository:
    ...
    def create(self, reqdata: OrgPrivateRegistryConfigurationWithSelectedRepositoryCreateData, ctrl=None) -> OrgPrivateRegistryConfigurationWithSelectedRepository:
        utility = self._utility
