...
class CheckAnnotationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CheckAnnotationEntity(self._client, opts)
    ...
    def data_get(self) -> CheckAnnotation:
    ...
    def match_get(self) -> CheckAnnotation:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CheckAnnotation]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CheckAnnotation().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
