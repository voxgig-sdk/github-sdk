...
class CodeownersErrorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CodeownersErrorEntity(self._client, opts)
    ...
    def data_get(self) -> CodeownersError:
    ...
    def match_get(self) -> CodeownersError:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CodeownersError]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CodeownersError().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
