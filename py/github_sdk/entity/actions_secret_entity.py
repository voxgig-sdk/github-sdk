...
class ActionsSecretEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsSecretEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsSecret:
    ...
    def match_get(self) -> ActionsSecret:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ActionsSecret:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ActionsSecret().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
