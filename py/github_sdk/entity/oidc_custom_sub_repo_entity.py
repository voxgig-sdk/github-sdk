...
class OidcCustomSubRepoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OidcCustomSubRepoEntity(self._client, opts)
    ...
    def data_get(self) -> OidcCustomSubRepo:
    ...
    def match_get(self) -> OidcCustomSubRepo:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[OidcCustomSubRepo]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.OidcCustomSubRepo().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
