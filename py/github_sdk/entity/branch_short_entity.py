...
class BranchShortEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BranchShortEntity(self._client, opts)
    ...
    def match_get(self) -> BranchShort:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[BranchShort]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.BranchShort().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
