...
class ActionsForkPrContributorApprovalEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsForkPrContributorApprovalEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsForkPrContributorApproval:
    ...
    def match_get(self) -> ActionsForkPrContributorApproval:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ActionsForkPrContributorApproval:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ActionsForkPrContributorApproval().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
