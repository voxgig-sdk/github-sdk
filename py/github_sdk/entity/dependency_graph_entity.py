...
class DependencyGraphEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DependencyGraphEntity(self._client, opts)
    ...
    def data_get(self) -> DependencyGraph:
    ...
    def match_get(self) -> DependencyGraph:
    ...
    def create(self, reqdata: DependencyGraphCreateData, ctrl=None) -> DependencyGraph:
        utility = self._utility
