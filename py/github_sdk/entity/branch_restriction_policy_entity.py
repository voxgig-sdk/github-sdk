...
class BranchRestrictionPolicyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BranchRestrictionPolicyEntity(self._client, opts)
    ...
    def data_get(self) -> BranchRestrictionPolicy:
    ...
    def match_get(self) -> BranchRestrictionPolicy:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[BranchRestrictionPolicy]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.BranchRestrictionPolicy().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
