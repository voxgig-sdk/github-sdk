...
class ActionsHostedRunnerLimitEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsHostedRunnerLimitEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsHostedRunnerLimit:
    ...
    def match_get(self) -> ActionsHostedRunnerLimit:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ActionsHostedRunnerLimit:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ActionsHostedRunnerLimit().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
