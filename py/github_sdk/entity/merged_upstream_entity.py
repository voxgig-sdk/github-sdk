...
class MergedUpstreamEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MergedUpstreamEntity(self._client, opts)
    ...
    def data_get(self) -> MergedUpstream:
    ...
    def match_get(self) -> MergedUpstream:
    ...
    def create(self, reqdata: MergedUpstreamCreateData, ctrl=None) -> MergedUpstream:
        utility = self._utility
