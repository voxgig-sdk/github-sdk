...
class BillingUsageReportUserEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BillingUsageReportUserEntity(self._client, opts)
    ...
    def data_get(self) -> BillingUsageReportUser:
    ...
    def match_get(self) -> BillingUsageReportUser:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[BillingUsageReportUser]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.BillingUsageReportUser().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
