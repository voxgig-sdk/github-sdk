...
class CustomPropertyValueEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CustomPropertyValueEntity(self._client, opts)
    ...
    def data_get(self) -> CustomPropertyValue:
    ...
    def match_get(self) -> CustomPropertyValue:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CustomPropertyValue]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CustomPropertyValue().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
