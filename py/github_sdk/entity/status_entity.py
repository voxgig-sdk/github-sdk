...
class StatusEntity:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Status]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Status().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: StatusCreateData, ctrl=None) -> Status:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
