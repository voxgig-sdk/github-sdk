...
from github_sdk.github_types import (
    PullRequestReview,
...
class PullRequestReviewEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PullRequestReviewEntity(self._client, opts)
    ...
    def data_get(self) -> PullRequestReview:
    ...
    def match_get(self) -> PullRequestReview:
    ...
    def load(self, reqmatch=None, ctrl=None) -> PullRequestReview:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.PullRequestReview().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PullRequestReview]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PullRequestReview().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: PullRequestReviewCreateData, ctrl=None) -> PullRequestReview:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: PullRequestReviewUpdateData, ctrl=None) -> PullRequestReview:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
    ...
    def remove(self, reqmatch=None, ctrl=None) -> PullRequestReview:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key removes with no
        # match. Treat None as an empty match so client.PullRequestReview().remove()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
