...
class CopilotOrganizationDetailEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CopilotOrganizationDetailEntity(self._client, opts)
    ...
    def data_get(self) -> CopilotOrganizationDetail:
    ...
    def match_get(self) -> CopilotOrganizationDetail:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CopilotOrganizationDetail:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CopilotOrganizationDetail().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
