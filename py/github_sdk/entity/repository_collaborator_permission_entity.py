...
class RepositoryCollaboratorPermissionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RepositoryCollaboratorPermissionEntity(self._client, opts)
    ...
    def data_get(self) -> RepositoryCollaboratorPermission:
    ...
    def match_get(self) -> RepositoryCollaboratorPermission:
    ...
    def load(self, reqmatch=None, ctrl=None) -> RepositoryCollaboratorPermission:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.RepositoryCollaboratorPermission().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
