...
class RepositoryInvitationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RepositoryInvitationEntity(self._client, opts)
    ...
    def data_get(self) -> RepositoryInvitation:
    ...
    def match_get(self) -> RepositoryInvitation:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[RepositoryInvitation]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.RepositoryInvitation().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: RepositoryInvitationUpdateData, ctrl=None) -> RepositoryInvitation:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
