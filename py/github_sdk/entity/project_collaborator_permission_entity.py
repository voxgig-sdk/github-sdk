...
class ProjectCollaboratorPermissionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ProjectCollaboratorPermissionEntity(self._client, opts)
    ...
    def data_get(self) -> ProjectCollaboratorPermission:
    ...
    def match_get(self) -> ProjectCollaboratorPermission:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ProjectCollaboratorPermission:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ProjectCollaboratorPermission().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
