...
class ShortBranchEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ShortBranchEntity(self._client, opts)
    ...
    def match_get(self) -> ShortBranch:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ShortBranch]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ShortBranch().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
