...
class PageBuildStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PageBuildStatusEntity(self._client, opts)
    ...
    def data_get(self) -> PageBuildStatus:
    ...
    def match_get(self) -> PageBuildStatus:
    ...
    def create(self, reqdata: PageBuildStatusCreateData, ctrl=None) -> PageBuildStatus:
        utility = self._utility
