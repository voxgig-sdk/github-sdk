...
class ParticipationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ParticipationEntity(self._client, opts)
    ...
    def data_get(self) -> Participation:
    ...
    def match_get(self) -> Participation:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Participation]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Participation().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
