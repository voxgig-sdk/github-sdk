...
class OrgMembershipEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrgMembershipEntity(self._client, opts)
    ...
    def data_get(self) -> OrgMembership:
    ...
    def match_get(self) -> OrgMembership:
    ...
    def load(self, reqmatch=None, ctrl=None) -> OrgMembership:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.OrgMembership().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: OrgMembershipUpdateData, ctrl=None) -> OrgMembership:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
