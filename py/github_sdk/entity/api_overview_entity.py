...
class ApiOverviewEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiOverviewEntity(self._client, opts)
    ...
    def match_get(self) -> ApiOverview:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiOverview]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiOverview().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
