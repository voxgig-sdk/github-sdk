...
class ProtectedBranchEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ProtectedBranchEntity(self._client, opts)
    ...
    def data_get(self) -> ProtectedBranch:
    ...
    def match_get(self) -> ProtectedBranch:
    ...
    def update(self, reqdata: ProtectedBranchUpdateData, ctrl=None) -> ProtectedBranch:
        utility = self._utility
