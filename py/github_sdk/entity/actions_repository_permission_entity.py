...
class ActionsRepositoryPermissionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsRepositoryPermissionEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsRepositoryPermission:
    ...
    def match_get(self) -> ActionsRepositoryPermission:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ActionsRepositoryPermission:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ActionsRepositoryPermission().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
