...
class IssueTypeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return IssueTypeEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[IssueType]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.IssueType().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: IssueTypeCreateData, ctrl=None) -> IssueType:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: IssueTypeUpdateData, ctrl=None) -> IssueType:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
