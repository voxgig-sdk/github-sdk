...
class SecurityAdvisoryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SecurityAdvisoryEntity(self._client, opts)
    ...
    def data_get(self) -> SecurityAdvisory:
    ...
    def match_get(self) -> SecurityAdvisory:
    ...
    def create(self, reqdata: SecurityAdvisoryCreateData, ctrl=None) -> SecurityAdvisory:
        utility = self._utility
