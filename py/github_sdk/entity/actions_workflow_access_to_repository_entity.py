...
class ActionsWorkflowAccessToRepositoryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsWorkflowAccessToRepositoryEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsWorkflowAccessToRepository:
    ...
    def match_get(self) -> ActionsWorkflowAccessToRepository:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ActionsWorkflowAccessToRepository:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ActionsWorkflowAccessToRepository().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
