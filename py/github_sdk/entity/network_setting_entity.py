...
class NetworkSettingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return NetworkSettingEntity(self._client, opts)
    ...
    def data_get(self) -> NetworkSetting:
    ...
    def match_get(self) -> NetworkSetting:
    ...
    def load(self, reqmatch=None, ctrl=None) -> NetworkSetting:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.NetworkSetting().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
