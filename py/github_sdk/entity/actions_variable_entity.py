...
class ActionsVariableEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsVariableEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsVariable:
    ...
    def match_get(self) -> ActionsVariable:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ActionsVariable:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ActionsVariable().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
