...
class ProtectedBranchAdminEnforcedEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ProtectedBranchAdminEnforcedEntity(self._client, opts)
    ...
    def data_get(self) -> ProtectedBranchAdminEnforced:
    ...
    def match_get(self) -> ProtectedBranchAdminEnforced:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ProtectedBranchAdminEnforced:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ProtectedBranchAdminEnforced().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ProtectedBranchAdminEnforcedCreateData, ctrl=None) -> ProtectedBranchAdminEnforced:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
