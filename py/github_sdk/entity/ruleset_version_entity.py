...
class RulesetVersionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RulesetVersionEntity(self._client, opts)
    ...
    def data_get(self) -> RulesetVersion:
    ...
    def match_get(self) -> RulesetVersion:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[RulesetVersion]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.RulesetVersion().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
