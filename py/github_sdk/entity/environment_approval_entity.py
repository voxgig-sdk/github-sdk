...
class EnvironmentApprovalEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EnvironmentApprovalEntity(self._client, opts)
    ...
    def data_get(self) -> EnvironmentApproval:
    ...
    def match_get(self) -> EnvironmentApproval:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EnvironmentApproval]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EnvironmentApproval().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
