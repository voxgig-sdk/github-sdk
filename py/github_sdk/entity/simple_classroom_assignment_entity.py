...
class SimpleClassroomAssignmentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SimpleClassroomAssignmentEntity(self._client, opts)
    ...
    def data_get(self) -> SimpleClassroomAssignment:
    ...
    def match_get(self) -> SimpleClassroomAssignment:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[SimpleClassroomAssignment]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.SimpleClassroomAssignment().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
