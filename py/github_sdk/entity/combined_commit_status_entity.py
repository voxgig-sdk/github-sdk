...
class CombinedCommitStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CombinedCommitStatusEntity(self._client, opts)
    ...
    def data_get(self) -> CombinedCommitStatus:
    ...
    def match_get(self) -> CombinedCommitStatus:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CombinedCommitStatus]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CombinedCommitStatus().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
