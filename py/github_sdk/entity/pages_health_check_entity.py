...
class PagesHealthCheckEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PagesHealthCheckEntity(self._client, opts)
    ...
    def data_get(self) -> PagesHealthCheck:
    ...
    def match_get(self) -> PagesHealthCheck:
    ...
    def load(self, reqmatch=None, ctrl=None) -> PagesHealthCheck:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.PagesHealthCheck().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
