...
class ClassroomAssignmentGradeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ClassroomAssignmentGradeEntity(self._client, opts)
    ...
    def data_get(self) -> ClassroomAssignmentGrade:
    ...
    def match_get(self) -> ClassroomAssignmentGrade:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ClassroomAssignmentGrade]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ClassroomAssignmentGrade().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
