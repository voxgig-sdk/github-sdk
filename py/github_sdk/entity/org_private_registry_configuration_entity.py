...
class OrgPrivateRegistryConfigurationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrgPrivateRegistryConfigurationEntity(self._client, opts)
    ...
    def data_get(self) -> OrgPrivateRegistryConfiguration:
    ...
    def match_get(self) -> OrgPrivateRegistryConfiguration:
    ...
    def load(self, reqmatch=None, ctrl=None) -> OrgPrivateRegistryConfiguration:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.OrgPrivateRegistryConfiguration().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
