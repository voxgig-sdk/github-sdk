...
class SecretScanningPushProtectionBypassEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SecretScanningPushProtectionBypassEntity(self._client, opts)
    ...
    def data_get(self) -> SecretScanningPushProtectionBypass:
    ...
    def match_get(self) -> SecretScanningPushProtectionBypass:
    ...
    def create(self, reqdata: SecretScanningPushProtectionBypassCreateData, ctrl=None) -> SecretScanningPushProtectionBypass:
        utility = self._utility
