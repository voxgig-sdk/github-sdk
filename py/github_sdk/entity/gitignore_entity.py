...
class GitignoreEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GitignoreEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Gitignore]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Gitignore().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
