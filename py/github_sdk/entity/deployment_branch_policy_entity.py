...
class DeploymentBranchPolicyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DeploymentBranchPolicyEntity(self._client, opts)
    ...
    def data_get(self) -> DeploymentBranchPolicy:
    ...
    def match_get(self) -> DeploymentBranchPolicy:
    ...
    def load(self, reqmatch=None, ctrl=None) -> DeploymentBranchPolicy:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.DeploymentBranchPolicy().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: DeploymentBranchPolicyCreateData, ctrl=None) -> DeploymentBranchPolicy:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: DeploymentBranchPolicyUpdateData, ctrl=None) -> DeploymentBranchPolicy:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
