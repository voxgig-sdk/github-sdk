...
class OrganizationRoleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrganizationRoleEntity(self._client, opts)
    ...
    def data_get(self) -> OrganizationRole:
    ...
    def match_get(self) -> OrganizationRole:
    ...
    def load(self, reqmatch=None, ctrl=None) -> OrganizationRole:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.OrganizationRole().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
