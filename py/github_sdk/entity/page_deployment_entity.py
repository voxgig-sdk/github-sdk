...
class PageDeploymentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PageDeploymentEntity(self._client, opts)
    ...
    def data_get(self) -> PageDeployment:
    ...
    def match_get(self) -> PageDeployment:
    ...
    def create(self, reqdata: PageDeploymentCreateData, ctrl=None) -> PageDeployment:
        utility = self._utility
