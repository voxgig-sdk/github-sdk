...
class RulesetVersionWithStateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RulesetVersionWithStateEntity(self._client, opts)
    ...
    def data_get(self) -> RulesetVersionWithState:
    ...
    def match_get(self) -> RulesetVersionWithState:
    ...
    def load(self, reqmatch=None, ctrl=None) -> RulesetVersionWithState:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.RulesetVersionWithState().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
