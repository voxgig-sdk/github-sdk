...
class ApiInsightsSummaryStatEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiInsightsSummaryStatEntity(self._client, opts)
    ...
    def data_get(self) -> ApiInsightsSummaryStat:
    ...
    def match_get(self) -> ApiInsightsSummaryStat:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiInsightsSummaryStat:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiInsightsSummaryStat().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
