...
class CommitActivityEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CommitActivityEntity(self._client, opts)
    ...
    def data_get(self) -> CommitActivity:
    ...
    def match_get(self) -> CommitActivity:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CommitActivity]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CommitActivity().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
