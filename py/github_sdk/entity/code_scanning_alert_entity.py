...
class CodeScanningAlertEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CodeScanningAlertEntity(self._client, opts)
    ...
    def data_get(self) -> CodeScanningAlert:
    ...
    def match_get(self) -> CodeScanningAlert:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CodeScanningAlert:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CodeScanningAlert().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: CodeScanningAlertUpdateData, ctrl=None) -> CodeScanningAlert:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
