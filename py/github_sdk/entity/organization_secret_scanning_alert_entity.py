...
class OrganizationSecretScanningAlertEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrganizationSecretScanningAlertEntity(self._client, opts)
    ...
    def data_get(self) -> OrganizationSecretScanningAlert:
    ...
    def match_get(self) -> OrganizationSecretScanningAlert:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[OrganizationSecretScanningAlert]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.OrganizationSecretScanningAlert().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
