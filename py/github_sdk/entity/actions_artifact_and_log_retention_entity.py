...
class ActionsArtifactAndLogRetentionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsArtifactAndLogRetentionEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsArtifactAndLogRetention:
    ...
    def match_get(self) -> ActionsArtifactAndLogRetention:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ActionsArtifactAndLogRetention:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ActionsArtifactAndLogRetention().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
