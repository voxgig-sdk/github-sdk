...
class CopilotUsageMetricsDayEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CopilotUsageMetricsDayEntity(self._client, opts)
    ...
    def data_get(self) -> CopilotUsageMetricsDay:
    ...
    def match_get(self) -> CopilotUsageMetricsDay:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CopilotUsageMetricsDay]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CopilotUsageMetricsDay().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
