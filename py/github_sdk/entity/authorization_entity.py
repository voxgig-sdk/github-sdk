...
class AuthorizationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AuthorizationEntity(self._client, opts)
    ...
    def data_get(self) -> Authorization:
    ...
    def match_get(self) -> Authorization:
    ...
    def create(self, reqdata: AuthorizationCreateData, ctrl=None) -> Authorization:
        utility = self._utility
    ...
    def update(self, reqdata: AuthorizationUpdateData, ctrl=None) -> Authorization:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
