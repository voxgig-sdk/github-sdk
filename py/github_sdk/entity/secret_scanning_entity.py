...
class SecretScanningEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SecretScanningEntity(self._client, opts)
    ...
    def data_get(self) -> SecretScanning:
    ...
    def match_get(self) -> SecretScanning:
    ...
    def update(self, reqdata: SecretScanningUpdateData, ctrl=None) -> SecretScanning:
        utility = self._utility
