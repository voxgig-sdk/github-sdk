...
```js
const action = await client.Action().load({ archive_format: 'example_archive_format', artifact_id: 1, owner: 'example_owner', repo: 'example_repo' })
console.log(action)
```
...
```js
await client.Action().remove({ hosted_runner_id: 1, org_id: 'example_org_id' })
```
...
| `image_details` | `Object` | Provides details of a hosted runner image |
| `inherited` | `boolean` |  |
...
| `machine_size_details` | `Object` | Provides details of a particular machine spec. |
...
| `image` | `Object` | The image of runner. |
| `image_details` | `Object` | Provides details of a hosted runner image |
| `last_active_on` | `string` | The time at which the runner was last used, in ISO 8601 format. |
| `machine_size_details` | `Object` | Provides details of a particular machine spec. |
| `maximum_runners` | `number` | The maximum amount of hosted runners. |
...
| `allow_fork_syncing` | `Object` | Whether users can pull changes from upstream when the branch is locked. |
| `block_creations` | `Object` |  |
| `enabled` | `boolean` |  |
| `enforce_admins` | `Object` | Protected Branch Admin Enforced |
| `id` | `string` |  |
| `lock_branch` | `Object` | Whether to set the branch as read-only. |
| `name` | `string` |  |
| `protection_url` | `string` |  |
...
| --- | --- | --- |
| `after` | `string` |  |
| `app` | `Object` | GitHub apps are a new way to extend GitHub. |
| `before` | `string` |  |
...
| `classroom` | `Object` | A GitHub Classroom classroom |
...
| `starter_code_repository` | `Object` | A GitHub repository view for Classroom |
...
| `dismissal_approved_by` | `Object` | A GitHub user. |
...
| `controller_repo` | `Object` | A GitHub repository. |
...
| `skipped_repositories` | `Object` | Information about repositories that were skipped from processing. |
| `status` | `string` |  |
...
| `payload` | `*` |  |
| `performed_via_github_app` | `Object` | GitHub apps are a new way to extend GitHub. |
...
| `deployment_branch_policy` | `Object` | The type of deployment branch policy for this environment. |
| `html_url` | `string` |  |
...
| Field | Type | Description |
| --- | --- | --- |
| `author` | `Object` | The author of the file. |
| `branch` | `string` | The branch name. |
| `commit` | `Object` |  |
| `committer` | `Object` | The person that committed the file. |
| `content` | `Object` | The new file content, using Base64 encoding. |
...
| `tree` | `Object` | The SHA of the tree object this commit points to |
| `url` | `string` |  |
| `verification` | `Object` |  |
...
| `node_id` | `string` |  |
| `object` | `Object` | The SHA of the git object this is tagging. |
| `sha` | `string` |  |
...
| `epss` | `Object` | The EPSS scores as calculated by the [Exploit Prediction Scoring System](https://www.first.org/epss). |
...
| `push_protection_bypass_request_reviewer` | `Object` | A GitHub user. |
...
| `deleted_by` | `Object` | A GitHub user. |
...
| `latest_status_update` | `Object` | An status update belonging to a project |
...
| Field | Type | Description |
| --- | --- | --- |
| `allow_deletions` | `Object` | Allows deletion of the protected branch by anyone with write access to the repository. |
| `allow_force_pushes` | `Object` | Permits force pushes to the protected branch by anyone with write access to the repository. |
| `allow_fork_syncing` | `Object` | Whether users can pull changes from upstream when the branch is locked. |
| `block_creations` | `Object` | If set to `true`, the `restrictions` branch protection settings which limits who can push will also block pushes which create new branches, unless the push is initiated by a user, team, or app which has the ability to push. |
| `enforce_admins` | `Object` | Enforce all configured restrictions for administrators. |
| `lock_branch` | `Object` | Whether to set the branch as read-only. |
| `required_conversation_resolution` | `Object` | Requires all conversations on code to be resolved before a pull request can be merged into a branch that matches this rule. |
| `required_linear_history` | `Object` | Enforces a linear commit Git history, which prevents anyone from pushing merge commits to a branch. |
| `required_pull_request_reviews` | `Object` | Require at least one approving review on a pull request, before merging. |
| `required_signatures` | `Object` |  |
| `required_status_checks` | `Object` | Status Check Policy |
| `restrictions` | `Object` | Branch Restriction Policy |
| `url` | `string` |  |
...
| `dismissal_restrictions` | `Object` | Specify which users, teams, and apps can dismiss pull request reviews. |
...
| `base` | `Object` | The name of the branch you want the changes pulled into. |
...
| `head` | `Object` | The name of the branch where your changes are implemented. |
...
| `client_payload` | `Object` | JSON payload with extra information about the webhook event that your action or workflow may use. |
| `clone_url` | `string` |  |
...
| Field | Type | Description |
| --- | --- | --- |
| `actor` | `Object` | The actor who updated the ruleset |
| `id` | `string` |  |
| `updated_at` | `string` |  |
...
| --- | --- | --- |
| `actor` | `Object` | The actor who updated the ruleset |
| `state` | `Object` | The state of the ruleset version |
| `updated_at` | `string` |  |
| `version_id` | `number` | The ID of the previous version of the ruleset |
