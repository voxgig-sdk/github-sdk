...
class PullEntity extends GithubEntityBase {
  ...
  /**
   * @param {PullRemoveMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Pull>}
   */
