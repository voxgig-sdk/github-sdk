...
class CampaignEntity extends GithubEntityBase {
  ...
  /**
   * @param {CampaignLoadMatch} [reqmatch]
   * @param {Object} [ctrl]
  ...
  /**
   * @param {CampaignListMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Campaign[]>}
   */
  ...
  /**
   * @param {CampaignCreateData} [reqdata]
   * @param {Object} [ctrl]
   * @returns {Promise<Campaign>}
   */
  ...
  /**
   * @param {CampaignUpdateData} [reqdata]
   * @param {Object} [ctrl]
   * @returns {Promise<Campaign>}
   */
  ...
  /**
   * @param {CampaignRemoveMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Campaign>}
   */
