...
class GistEntity extends GithubEntityBase {
  ...
  /**
   * @param {GistRemoveMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Gist>}
   */
