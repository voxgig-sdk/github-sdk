...
class ClassroomAcceptedAssignmentEntity extends GithubEntityBase {
  ...
  /**
   * @param {ClassroomAcceptedAssignmentListMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<ClassroomAcceptedAssignment[]>}
   */
