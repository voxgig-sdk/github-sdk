...
class ActionEntity extends GithubEntityBase {
  ...
  /**
   * @param {ActionLoadMatch} [reqmatch]
   * @param {Object} [ctrl]
  ...
  /**
   * @param {ActionListMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Action[]>}
   */
  ...
  /**
   * @param {ActionUpdateData} [reqdata]
   * @param {Object} [ctrl]
   * @returns {Promise<Action>}
   */
  ...
  /**
   * @param {ActionRemoveMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Action>}
   */
