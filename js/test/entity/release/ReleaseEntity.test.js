...
describe('ReleaseEntity', async () => {
  ...
  test('basic', async () => {
    ...
    assert(release_ref01_resdata_up0[release_ref01_markdef_up0.name] === release_ref01_markdef_up0.value)
...
function basicSetup(extra) {
  ...
  let idmap = transform(
    ['release01','release02','release03','repo01','repo02','repo03','repo01','repo02','repo03','tag01','tag02','tag03'],
    {
      '`$PACK`': ['', {
        '`$KEY`': '`$COPY`',
