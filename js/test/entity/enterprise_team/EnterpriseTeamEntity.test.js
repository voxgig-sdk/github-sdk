...
describe('EnterpriseTeamEntity', async () => {
  ...
  test('basic', async () => {
    ...
    assert(enterprise_team_ref01_resdata_up0[enterprise_team_ref01_markdef_up0.name] === enterprise_team_ref01_markdef_up0.value)
    ...
    // REMOVE
    const enterprise_team_ref01_match_rm0 = {}
    enterprise_team_ref01_match_rm0.id = enterprise_team_ref01_data.id
