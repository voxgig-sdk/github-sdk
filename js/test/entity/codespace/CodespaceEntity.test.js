...
describe('CodespaceEntity', async () => {
  ...
  test('basic', async () => {
    ...
    assert(codespace_ref01_resdata_up0[codespace_ref01_markdef_up0.name] === codespace_ref01_markdef_up0.value)
    ...
    // REMOVE
    const codespace_ref01_match_rm0 = {}
    codespace_ref01_match_rm0.id = codespace_ref01_data.id
