...
describe('CodeSecurityConfigurationEntity', async () => {
  ...
  test('basic', async () => {
    ...
    assert(code_security_configuration_ref01_resdata_up0[code_security_configuration_ref01_markdef_up0.name] === code_security_configuration_ref01_markdef_up0.value)
